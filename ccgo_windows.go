...
func Xgzseek64(tls *libc.TLS, file TgzFile, offset int32, whence int32) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fmode == int32(m_GZ_READ) {
		if libc.Bool(uint64(4) == uint64(4)) && (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave > Xgz_intmax(tls) || int32((*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave) > offset {
			v1 = uint32(offset)
		} else {
...
func _gz_look(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fsize == uint32(0) {
		...
		if XinflateInit2_(tls, state+120, libc.Int32FromInt32(15)+libc.Int32FromInt32(16), __ccgo_ts, libc.Int32FromInt64(88)) != m_Z_OK { /* gunzip */
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
...
func _gz_skip(tls *libc.TLS, state Tgz_statep, len1 int32) (r int32) {
	...
	for len1 != 0 {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave != 0 {
			if libc.Bool(uint64(4) == uint64(4)) && (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave > Xgz_intmax(tls) || int32((*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave) > len1 {
				v1 = uint32(len1)
			} else {
				v1 = (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave
			}
...
func _gz_zero(tls *libc.TLS, state Tgz_statep, len1 int32) (r int32) {
	...
	first = int32(1)
	for len1 != 0 {
		if libc.Bool(uint64(4) == uint64(4)) && (*Tgz_state)(unsafe.Pointer(state)).Fsize > Xgz_intmax(tls) || int32((*Tgz_state)(unsafe.Pointer(state)).Fsize) > len1 {
			v1 = uint32(len1)
		} else {
...
func XinflatePrime(tls *libc.TLS, strm Tz_streamp, bits int32, value int32) (r int32) {
	...
	*(*uint32)(unsafe.Pointer(state + 72)) += uint32(uint32(value) << (*Tinflate_state)(unsafe.Pointer(state)).Fbits)
