...
func Xgzseek64(tls *libc.TLS, file TgzFile, offset int32, whence int32) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fmode == int32(m_GZ_READ) {
		if libc.Bool(uint64(4) == uint64(4)) && (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave > Xgz_intmax(tls) || libc.Int32FromUint32((*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave) > offset {
...
func _gz_skip(tls *libc.TLS, state Tgz_statep, len1 int32) (r int32) {
	...
	for len1 != 0 {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave != 0 {
			if libc.Bool(uint64(4) == uint64(4)) && (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave > Xgz_intmax(tls) || libc.Int32FromUint32((*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave) > len1 {
...
func _gz_zero(tls *libc.TLS, state Tgz_statep, len1 int32) (r int32) {
	...
	first = int32(1)
	for len1 != 0 {
		if libc.Bool(uint64(4) == uint64(4)) && (*Tgz_state)(unsafe.Pointer(state)).Fsize > Xgz_intmax(tls) || libc.Int32FromUint32((*Tgz_state)(unsafe.Pointer(state)).Fsize) > len1 {
			v1 = libc.Uint32FromInt32(len1)
		} else {
...
func XinflateBackInit_(tls *libc.TLS, strm Tz_streamp, windowBits int32, window uintptr, version uintptr, stream_size int32) (r int32) {
	var state uintptr
	_ = state
	if version == uintptr(m_Z_NULL) || int32(*(*int8)(unsafe.Pointer(version))) != int32(*(*int8)(unsafe.Pointer(__ccgo_ts))) || stream_size != libc.Int32FromUint64(libc.Uint64FromInt64(88)) {
		return -int32(6)
	}
