...
const m__POSIX_V6_ILP32_OFF32 = 1
const m__POSIX_V6_ILP32_OFFBIG = 1
const m__POSIX_V7_ILP32_OFF32 = 1
...
const m__UNISTD_H = 1
const m__XBS5_ILP32_OFF32 = 1
const m__XBS5_ILP32_OFFBIG = 1
...
const m___ILP32_OFFBIG_CFLAGS = "-D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64"
...
func x_crc32_z(tls *libc.TLS, crc uint32, buf uintptr, len1 Tz_size_t) (r uint32) {
	...
	if len1 >= uint32(libc.Int32FromInt32(m_N)*libc.Int32FromInt32(m_W)+libc.Int32FromInt32(m_W)-libc.Int32FromInt32(1)) {
		/* Compute the CRC up to a z_word_t boundary. */
		for len1 != 0 && uint32(buf)&uint32(libc.Int32FromInt32(m_W)-libc.Int32FromInt32(1)) != uint32(0) {
			len1--
			v1 = buf
			buf++
		...
		blks = len1 / uint32(libc.Int32FromInt32(m_N)*libc.Int32FromInt32(m_W))
		len1 -= blks * uint32(m_N) * uint32(m_W)
		words = buf
...
func x_deflateInit2_(tls *libc.TLS, strm Tz_streamp, level int32, method int32, windowBits int32, memLevel int32, strategy int32, version uintptr, stream_size int32) (r int32) {
	...
	_, _ = s, wrap
	wrap = int32(1)
	if version == uintptr(m_Z_NULL) || int32(*(*uint8)(unsafe.Pointer(version))) != int32(_my_version[0]) || uint32(stream_size) != uint32(56) {
		return -int32(6)
	}
...
func x_inflateBackInit_(tls *libc.TLS, strm Tz_streamp, windowBits int32, window uintptr, version uintptr, stream_size int32) (r int32) {
	var state uintptr
	_ = state
	if version == uintptr(m_Z_NULL) || int32(*(*uint8)(unsafe.Pointer(version))) != int32(*(*uint8)(unsafe.Pointer(__ccgo_ts + 192))) || stream_size != int32(libc.Uint32FromInt64(56)) {
		return -int32(6)
	}
...
func x_compress2(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen TuLong, level int32) (r int32) {
	...
	*(*TuLongf)(unsafe.Pointer(destLen)) = uint32(0)
	...
	err = x_deflateInit_(tls, bp, level, __ccgo_ts+192, libc.Int32FromInt64(56))
	if err != m_Z_OK {
		return err
	}
...
func x_uncompress2(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen uintptr) (r int32) {
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fzfree = libc.UintptrFromInt32(0)
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fopaque = libc.UintptrFromInt32(0)
	err = x_inflateInit_(tls, bp, __ccgo_ts+192, libc.Int32FromInt64(56))
	if err != m_Z_OK {
		return err
	}
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fnext_out = dest
...
type Tblkcnt_t1 = int32

type Tfsblkcnt_t1 = uint32

type Tfsfilcnt_t1 = uint32
...
type Tstat1 = struct {
	...
	Fst_mtim           Ttimespec
	Fst_ctim           Ttimespec
	F__glibc_reserved4 uint32
	F__glibc_reserved5 uint32
}
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	oflag = int32(m___O_LARGEFILE1) | v1 | v2
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, path, libc.Uint32FromInt32(7)+libc.Uint32FromInt32(3)*libc.Uint32FromInt64(4), __ccgo_ts+774, libc.VaList(bp+8, fd))
...
func x_gzseek64(tls *libc.TLS, file TgzFile, offset Toff64_t, whence int32) (r Toff64_t) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fmode == int32(m_GZ_READ) {
		if libc.Bool(libc.Bool(uint32(4) == uint32(8)) && (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave > uint32(m___INT_MAX__1)) || int64((*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave) > offset {
			v1 = uint32(offset)
		} else {
...
//
//	/* -- see zlib.h -- */
func x_gzseek(tls *libc.TLS, file TgzFile, offset Toff_t1, whence int32) (r Toff_t1) {
	var ret Toff64_t
	var v1 int32
	_, _ = ret, v1
	ret = x_gzseek64(tls, file, int64(offset), whence)
...
//
//	/* -- see zlib.h -- */
func x_gztell(tls *libc.TLS, file TgzFile) (r Toff_t1) {
	var ret Toff64_t
	var v1 int32
	_, _ = ret, v1
...
//
//	/* -- see zlib.h -- */
func x_gzoffset(tls *libc.TLS, file TgzFile) (r Toff_t1) {
	var ret Toff64_t
	var v1 int32
	_, _ = ret, v1
...
func x_gz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint32(3), __ccgo_ts+796, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, __ccgo_ts+803, msg))
}
...
const m___O_LARGEFILE2 = 0400000
...
func _gz_skip(tls *libc.TLS, state Tgz_statep, len1 Toff64_t) (r int32) {
	...
	for len1 != 0 {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave != 0 {
			if libc.Bool(libc.Bool(uint32(4) == uint32(8)) && (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave > uint32(m___INT_MAX__1)) || int64((*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave) > len1 {
				v1 = uint32(len1)
			} else {
				v1 = (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave
			}
...
func _gz_zero(tls *libc.TLS, state Tgz_statep, len1 Toff64_t) (r int32) {
	...
	first = int32(1)
	for len1 != 0 {
		if libc.Bool(libc.Bool(uint32(4) == uint32(8)) && (*Tgz_state)(unsafe.Pointer(state)).Fsize > uint32(m___INT_MAX__1)) || int64((*Tgz_state)(unsafe.Pointer(state)).Fsize) > len1 {
			v1 = uint32(len1)
		} else {
