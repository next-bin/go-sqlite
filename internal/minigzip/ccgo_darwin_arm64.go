...
func _file_compress(tls *libc.TLS, file uintptr, mode uintptr) {
	...
	libc.X__builtin___snprintf_chk(tls, bp, uint64(1024), 0, ^T__predefined_size_t(0), __ccgo_ts+84, libc.VaList(bp+1032, file, __ccgo_ts+57))
...
func _file_uncompress(tls *libc.TLS, file uintptr) {
	...
	libc.X__builtin___snprintf_chk(tls, bp, uint64(1024), 0, ^T__predefined_size_t(0), __ccgo_ts+113, libc.VaList(bp+1032, file))
	if len1 > libc.Uint64FromInt64(4)-libc.Uint64FromInt32(1) && libc.Xstrcmp(tls, file+uintptr(len1)-uintptr(libc.Uint64FromInt64(4)-libc.Uint64FromInt32(1)), __ccgo_ts+57) == 0 {
		...
		*(*int8)(unsafe.Pointer(outfile + uintptr(len1-uint64(3)))) = int8('\000')
		...
		outfile = file
		infile = bp
		libc.X__builtin___snprintf_chk(tls, bp+uintptr(len1), uint64(1024)-len1, 0, ^T__predefined_size_t(0), __ccgo_ts+113, libc.VaList(bp+1032, __ccgo_ts+57))
	}
...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	copyout = 0
	uncompr = 0
	libc.X__builtin___snprintf_chk(tls, bp, uint64(20), 0, ^T__predefined_size_t(0), __ccgo_ts+113, libc.VaList(bp+32, __ccgo_ts+119))
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin___snprintf_chk(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint64(1), 0, ^T__predefined_size_t(0), __ccgo_ts+113, libc.VaList(bp+8, path))
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin___snprintf_chk(tls, path, libc.Uint64FromInt32(7)+libc.Uint64FromInt32(3)*libc.Uint64FromInt64(4), 0, ^T__predefined_size_t(0), __ccgo_ts+776, libc.VaList(bp+8, fd))
...
func x_gz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	libc.X__builtin___snprintf_chk(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint64(3), 0, ^T__predefined_size_t(0), __ccgo_ts+798, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, __ccgo_ts+805, msg))
}
