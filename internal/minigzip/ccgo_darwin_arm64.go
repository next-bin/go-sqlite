// Code generated for darwin/arm64 by 'gcc --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -extended-errors --package-name=main -DNDEBUG -U__ARM_FEATURE_CRC32 -DHAVE_HIDDEN -o minigzip64.go minigzip64.o.go -L. libz.a', DO NOT EDIT.
...
func x_file_compress(tls *libc.TLS, file uintptr, mode uintptr) {
	...
	libc.X__builtin___snprintf_chk(tls, bp, uint64(1024), 0, libc.X__builtin_object_size(tls, bp, int32(1)), __ccgo_ts+84, libc.VaList(bp+1032, file, __ccgo_ts+57))
...
func x_file_uncompress(tls *libc.TLS, file uintptr) {
	...
	libc.X__builtin___snprintf_chk(tls, bp, uint64(1024), 0, libc.X__builtin_object_size(tls, bp, int32(1)), __ccgo_ts+113, libc.VaList(bp+1032, file))
	if len1 > libc.Uint64FromInt64(4)-libc.Uint64FromInt32(1) && libc.Xstrcmp(tls, file+uintptr(len1)-uintptr(libc.Uint64FromInt64(4)-libc.Uint64FromInt32(1)), __ccgo_ts+57) == 0 {
		...
		*(*int8)(unsafe.Pointer(outfile + uintptr(len1-uint64(3)))) = int8('\000')
		...
		outfile = file
		infile = bp
		libc.X__builtin___snprintf_chk(tls, bp+uintptr(len1), uint64(1024)-len1, 0, libc.X__builtin_object_size(tls, bp+uintptr(len1), int32(1)), __ccgo_ts+113, libc.VaList(bp+1032, __ccgo_ts+57))
	}
...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	copyout = 0
	uncompr = 0
	libc.X__builtin___snprintf_chk(tls, bp, uint64(20), 0, libc.X__builtin_object_size(tls, bp, int32(1)), __ccgo_ts+113, libc.VaList(bp+32, __ccgo_ts+119))
...
func x_inflateBackInit_(tls *libc.TLS, strm Tz_streamp, windowBits int32, window uintptr, version uintptr, stream_size int32) (r int32) {
	var state uintptr
	_ = state
	if version == uintptr(m_Z_NULL) || int32(*(*int8)(unsafe.Pointer(version))) != int32(*(*int8)(unsafe.Pointer(__ccgo_ts + 192))) || stream_size != int32(libc.Uint64FromInt64(112)) {
		return -int32(6)
	}
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin___snprintf_chk(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint64(1), 0, libc.X__builtin_object_size(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, int32(1)), __ccgo_ts+113, libc.VaList(bp+8, path))
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin___snprintf_chk(tls, path, libc.Uint64FromInt32(7)+libc.Uint64FromInt32(3)*libc.Uint64FromInt64(4), 0, libc.X__builtin_object_size(tls, path, int32(1)), __ccgo_ts+774, libc.VaList(bp+8, fd))
