...
const m___ILP32_OFF32_CFLAGS = "-m32"
const m___ILP32_OFF32_LDFLAGS = "-m32"
const m___ILP32_OFFBIG_CFLAGS = "-m32 -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64"
const m___ILP32_OFFBIG_LDFLAGS = "-m32"
...
const m_F_GETFL = 3
const m_F_GETLK = 5
const m_F_GETLK64 = 12
const m_F_GETOWN = "__F_GETOWN"
const m_F_RDLCK = 0
const m_F_SETFD = 2
const m_F_SETFL = 4
const m_F_SETLK = 6
const m_F_SETLK64 = 13
const m_F_SETLKW = 7
const m_F_SETLKW64 = 14
...
const m__MKNOD_VER = "_MKNOD_VER_LINUX"
const m__MKNOD_VER_LINUX = 1
const m__MKNOD_VER_SVR4 = 2
const m__STAT_VER = "_STAT_VER_KERNEL"
const m__STAT_VER_KERNEL = 1
const m__STAT_VER_LINUX = 3
const m__STAT_VER_LINUX_OLD = 1
const m__STAT_VER_SVR4 = 2
