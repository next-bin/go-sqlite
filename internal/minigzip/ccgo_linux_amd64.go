...
func x_error(tls *libc.TLS, msg uintptr) {
	...
	defer tls.Free(32)
	libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+8, _prog, msg))
...
func x_gz_compress(tls *libc.TLS, in uintptr, out uintptr) {
...
//	 */
func x_gz_uncompress(tls *libc.TLS, in uintptr, out uintptr) {
	bp := tls.Alloc(16400) /* tlsAllocs 16392 maxVaListSize 0 */
	defer tls.Free(16400)
	var len1 int32
	var _ /* buf at bp+0 */ [16384]int8
...
func x_file_compress(tls *libc.TLS, file uintptr, mode uintptr) {
	...
	if libc.Xstrlen(tls, file)+libc.Xstrlen(tls, ts+57) >= uint64(1024) {
		libc.Xfprintf(tls, libc.Xstderr, ts+61, libc.VaList(bp+1032, _prog))
		libc.Xexit(tls, int32(1))
	}
	...
	if out == libc.UintptrFromInt32(0) {
		libc.Xfprintf(tls, libc.Xstderr, ts+92, libc.VaList(bp+1032, _prog, bp))
		libc.Xexit(tls, int32(1))
	}
...
func x_file_uncompress(tls *libc.TLS, file uintptr) {
	...
	in = x_gzopen(tls, infile, ts+89)
	if in == libc.UintptrFromInt32(0) {
		libc.Xfprintf(tls, libc.Xstderr, ts+92, libc.VaList(bp+1032, _prog, infile))
		libc.Xexit(tls, int32(1))
	}
...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	if !(libc.Xstrcmp(tls, bname, ts+124) != 0) {
		...
		if !(libc.Xstrcmp(tls, bname, ts+131) != 0) {
	...
	if argc == 0 {
		if uncompr != 0 {
			file = x_gzdopen(tls, libc.Xfileno(tls, libc.Xstdin), ts+89)
		...
		for first := true; ; first = false {
			...
			if uncompr != 0 {
				if copyout != 0 {
					file = x_gzopen(tls, *(*uintptr)(unsafe.Pointer(argv)), ts+89)
					if file == libc.UintptrFromInt32(0) {
						libc.Xfprintf(tls, libc.Xstderr, ts+92, libc.VaList(bp+32, _prog, *(*uintptr)(unsafe.Pointer(argv))))
					} else {
						x_gz_uncompress(tls, file, libc.Xstdout)
					}
				} else {
...
func x_inflateBackInit_(tls *libc.TLS, strm uintptr, windowBits int32, window uintptr, version uintptr, stream_size int32) (r int32) {
	var state uintptr
	if version == uintptr(m_Z_NULL) || int32(*(*int8)(unsafe.Pointer(version))) != int32(*(*int8)(unsafe.Pointer(ts + 192))) || stream_size != int32(libc.Uint64FromInt64(112)) {
		return -int32(6)
	}
...
func x_inflateBack(tls *libc.TLS, strm uintptr, in uintptr, in_desc uintptr, out uintptr, out_desc uintptr) (r int32) {
	...
	*(*uintptr)(unsafe.Pointer(bp)) = (*Tz_stream)(unsafe.Pointer(strm)).Fnext_in
	...
	_3:
		...
		case uint32(3):
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 196
	...
	_12: /* go to byte boundary */
		...
		if hold&uint64(0xffff) != hold>>int32(16)^uint64(0xffff) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 215
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
	...
	_5:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fnlen > uint32(286) || (*Tinflate_state)(unsafe.Pointer(state)).Fndist > uint32(30) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 244
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 280
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
				...
				*(*uint16)(unsafe.Pointer(state + 152 + uintptr(v23)*2)) = here.Fval
				...
				if int32(here.Fval) == int32(16) {
					...
					if (*Tinflate_state)(unsafe.Pointer(state)).Fhave == uint32(0) {
						(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 305
						(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
						break
					}
		...
		if int32(*(*uint16)(unsafe.Pointer(state + 152 + 256*2))) == 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 331
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 368
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 396
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
	...
	_6:
		...
		if int32(here.Fop)&int32(64) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 418
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
		...
		bits -= uint32(here.Fbits)
		if int32(here.Fop)&int32(64) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 446
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Foffset > (*Tinflate_state)(unsafe.Pointer(state)).Fwsize-v42 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 468
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
...
func x_inflate(tls *libc.TLS, strm uintptr, flush int32) (r int32) {
	...
	_2:
		...
		if len1 > uint32(15) || len1 > (*Tinflate_state)(unsafe.Pointer(state)).Fwbits {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 548
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
	...
	_39:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0xe000) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 568
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		if (*Tinflate_state)(unsafe.Pointer(state)).Fhead != uintptr(m_Z_NULL) {
	...
	_10:
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0x0200) != 0 {
			...
			if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && hold != (*Tinflate_state)(unsafe.Pointer(state)).Fcheck&uint64(0xffff) {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 593
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint64(0)
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 {
			...
			*(*uint64)(unsafe.Pointer(state + 40)) += uint64(out)
			...
			if v97 && v96 != (*Tinflate_state)(unsafe.Pointer(state)).Fcheck {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 613
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint64(0)
	...
	_29:
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 && (*Tinflate_state)(unsafe.Pointer(state)).Fflags != 0 {
			...
			if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && hold != (*Tinflate_state)(unsafe.Pointer(state)).Ftotal&uint64(0xffffffff) {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 634
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint64(0)
...
func x_compress2(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen uint64, level int32) (r int32) {
	...
	*(*uint64)(unsafe.Pointer(destLen)) = uint64(0)
	...
	err = x_deflateInit_(tls, bp, level, ts+192, libc.Int32FromInt64(112))
	if err != m_Z_OK {
		return err
	}
...
func x_uncompress2(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen uintptr) (r int32) {
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fzfree = libc.UintptrFromInt32(0)
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fopaque = libc.UintptrFromInt32(0)
	err = x_inflateInit_(tls, bp, ts+192, libc.Int32FromInt64(112))
	if err != m_Z_OK {
		return err
	}
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fnext_out = dest
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint64(1), ts+113, libc.VaList(bp+8, path))
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r uintptr) {
	...
	libc.X__builtin_snprintf(tls, path, libc.Uint64FromInt32(7)+libc.Uint64FromInt32(3)*libc.Uint64FromInt64(4), ts+774, libc.VaList(bp+8, fd))
...
func x_gz_error(tls *libc.TLS, state uintptr, err int32, msg uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint64(3), ts+796, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, ts+803, msg))
}
...
func _gz_look(tls *libc.TLS, state uintptr) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fsize == uint32(0) {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fin == libc.UintptrFromInt32(0) || (*Tgz_state)(unsafe.Pointer(state)).Fout == libc.UintptrFromInt32(0) {
			...
			x_gz_error(tls, state, -int32(4), ts+782)
			return -int32(1)
		}
		...
		if x_inflateInit2_(tls, state+128, libc.Int32FromInt32(15)+libc.Int32FromInt32(16), ts+192, libc.Int32FromInt64(112)) != m_Z_OK { /* gunzip */
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
...
func x_gzread(tls *libc.TLS, file uintptr, buf uintptr, len1 uint32) (r int32) {
	...
	if int32(len1) < 0 {
		x_gz_error(tls, state, -int32(2), ts+890)
		return -int32(1)
	}
...
func x_gzfread(tls *libc.TLS, buf uintptr, size uint64, nitems uint64, file uintptr) (r uint64) {
	...
	if size != 0 && len1/size != nitems {
		x_gz_error(tls, state, -int32(2), ts+921)
		return uint64(0)
	}
...
func x_gzungetc(tls *libc.TLS, c int32, file uintptr) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave == (*Tgz_state)(unsafe.Pointer(state)).Fsize<<int32(1) {
		x_gz_error(tls, state, -int32(3), ts+954)
		return -int32(1)
	}
...
func _gz_init(tls *libc.TLS, state uintptr) (r int32) {
	...
	if !((*Tgz_state)(unsafe.Pointer(state)).Fdirect != 0) {
		...
		ret = x_deflateInit2_(tls, strm, (*Tgz_state)(unsafe.Pointer(state)).Flevel, int32(m_Z_DEFLATED), libc.Int32FromInt32(m_MAX_WBITS)+libc.Int32FromInt32(16), int32(m_DEF_MEM_LEVEL), (*Tgz_state)(unsafe.Pointer(state)).Fstrategy, ts+192, libc.Int32FromInt64(112))
		if ret != m_Z_OK {
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
			x_gz_error(tls, state, -int32(4), ts+782)
...
func _gz_comp(tls *libc.TLS, state uintptr, flush int32) (r int32) {
	...
	for cond := true; cond; cond = have != 0 {
		...
		if ret == -int32(2) {
			x_gz_error(tls, state, -int32(2), ts+985)
			return -int32(1)
		}
		have -= (*Tz_stream)(unsafe.Pointer(strm)).Favail_out
	}
...
func x_gzwrite(tls *libc.TLS, file uintptr, buf uintptr, len1 uint32) (r int32) {
	...
	/* since an int is returned, make sure len fits in one, otherwise return
	   with an error (this avoids a flaw in the interface) */
	if int32(len1) < 0 {
		x_gz_error(tls, state, -int32(3), ts+1024)
		return 0
	}
...
func x_gzputs(tls *libc.TLS, file uintptr, s uintptr) (r int32) {
	...
	if int32(len1) < 0 || uint64(uint32(len1)) != len1 {
		x_gz_error(tls, state, -int32(2), ts+1061)
		return -int32(1)
	}
