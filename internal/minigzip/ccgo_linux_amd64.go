...
func x_file_uncompress(tls *libc.TLS, file uintptr) {
	...
	len1 = uint32(libc.Xstrlen(tls, file))
	if uint64(uint64(len1))+libc.Xstrlen(tls, __ccgo_ts+57) >= uint64(1024) {
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+61, libc.VaList(bp+1032, _prog))
		libc.Xexit(tls, int32(1))
	}
	libc.X__builtin_snprintf(tls, bp, uint64(1024), __ccgo_ts+113, libc.VaList(bp+1032, file))
	if uint64(uint64(len1)) > libc.Uint64FromInt64(4)-libc.Uint64FromInt32(1) && libc.Xstrcmp(tls, file+uintptr(len1)-uintptr(libc.Uint64FromInt64(4)-libc.Uint64FromInt32(1)), __ccgo_ts+57) == 0 {
		infile = file
		outfile = bp
		*(*int8)(unsafe.Pointer(outfile + uintptr(len1-uint32(3)))) = int8('\000')
		...
		outfile = file
		infile = bp
		libc.X__builtin_snprintf(tls, bp+uintptr(len1), uint64(1024)-uint64(uint64(len1)), __ccgo_ts+113, libc.VaList(bp+1032, __ccgo_ts+57))
	}
...
func x_crc32_z(tls *libc.TLS, crc uint64, buf uintptr, len1 Tz_size_t) (r uint64) {
	...
	for len1 >= uint64(8) {
		v1 = buf
		buf++
		crc = uint64(*(*Tz_crc_t)(unsafe.Pointer(uintptr(unsafe.Pointer(&_crc_table)) + uintptr((int32(int32(crc))^int32(*(*uint8)(unsafe.Pointer(v1))))&int32(0xff))*4))) ^ crc>>int32(8)
		v2 = buf
		buf++
		crc = uint64(*(*Tz_crc_t)(unsafe.Pointer(uintptr(unsafe.Pointer(&_crc_table)) + uintptr((int32(int32(crc))^int32(*(*uint8)(unsafe.Pointer(v2))))&int32(0xff))*4))) ^ crc>>int32(8)
		v3 = buf
		buf++
		crc = uint64(*(*Tz_crc_t)(unsafe.Pointer(uintptr(unsafe.Pointer(&_crc_table)) + uintptr((int32(int32(crc))^int32(*(*uint8)(unsafe.Pointer(v3))))&int32(0xff))*4))) ^ crc>>int32(8)
		v4 = buf
		buf++
		crc = uint64(*(*Tz_crc_t)(unsafe.Pointer(uintptr(unsafe.Pointer(&_crc_table)) + uintptr((int32(int32(crc))^int32(*(*uint8)(unsafe.Pointer(v4))))&int32(0xff))*4))) ^ crc>>int32(8)
		v5 = buf
		buf++
		crc = uint64(*(*Tz_crc_t)(unsafe.Pointer(uintptr(unsafe.Pointer(&_crc_table)) + uintptr((int32(int32(crc))^int32(*(*uint8)(unsafe.Pointer(v5))))&int32(0xff))*4))) ^ crc>>int32(8)
		v6 = buf
		buf++
		crc = uint64(*(*Tz_crc_t)(unsafe.Pointer(uintptr(unsafe.Pointer(&_crc_table)) + uintptr((int32(int32(crc))^int32(*(*uint8)(unsafe.Pointer(v6))))&int32(0xff))*4))) ^ crc>>int32(8)
		v7 = buf
		buf++
		crc = uint64(*(*Tz_crc_t)(unsafe.Pointer(uintptr(unsafe.Pointer(&_crc_table)) + uintptr((int32(int32(crc))^int32(*(*uint8)(unsafe.Pointer(v7))))&int32(0xff))*4))) ^ crc>>int32(8)
		v8 = buf
		buf++
		crc = uint64(*(*Tz_crc_t)(unsafe.Pointer(uintptr(unsafe.Pointer(&_crc_table)) + uintptr((int32(int32(crc))^int32(*(*uint8)(unsafe.Pointer(v8))))&int32(0xff))*4))) ^ crc>>int32(8)
		len1 -= uint64(8)
	}
	if len1 != 0 {
		for {
			v11 = buf
			buf++
			crc = uint64(*(*Tz_crc_t)(unsafe.Pointer(uintptr(unsafe.Pointer(&_crc_table)) + uintptr((int32(int32(crc))^int32(*(*uint8)(unsafe.Pointer(v11))))&int32(0xff))*4))) ^ crc>>int32(8)
			goto _10
		_10:
			len1--
			v9 = len1
...
//
//	/* ========================================================================= */
func _crc32_little(tls *libc.TLS, crc uint64, buf uintptr, len1 Tz_size_t) (r uint64) {
	...
	c = uint32(uint32(crc))
	c = ^c
	for len1 != 0 && int64(int64(buf))&int64(3) != 0 {
		v1 = buf
		buf++
...
//
//	/* ========================================================================= */
func _crc32_big(tls *libc.TLS, crc uint64, buf uintptr, len1 Tz_size_t) (r uint64) {
	var buf4, v1, v10, v13, v2, v3, v4, v5, v6, v7, v8, v9 uintptr
	var c Tz_crc_t
	var v11 Tz_size_t
	_, _, _, _, _, _, _, _, _, _, _, _, _, _ = buf4, c, v1, v10, v11, v13, v2, v3, v4, v5, v6, v7, v8, v9
	c = uint32(uint32(crc))>>libc.Int32FromInt32(24)&libc.Uint32FromInt32(0xff) + uint32(uint32(crc))>>libc.Int32FromInt32(8)&libc.Uint32FromInt32(0xff00) + uint32(uint32(crc))&libc.Uint32FromInt32(0xff00)<<libc.Int32FromInt32(8) + uint32(uint32(crc))&libc.Uint32FromInt32(0xff)<<libc.Int32FromInt32(24)
	c = ^c
	for len1 != 0 && int64(int64(buf))&int64(3) != 0 {
		v1 = buf
		buf++
	...
	c = ^c
	return uint64(c>>libc.Int32FromInt32(24)&libc.Uint32FromInt32(0xff) + c>>libc.Int32FromInt32(8)&libc.Uint32FromInt32(0xff00) + c&libc.Uint32FromInt32(0xff00)<<libc.Int32FromInt32(8) + c&libc.Uint32FromInt32(0xff)<<libc.Int32FromInt32(24))
}

// C documentation
//
//	/* ========================================================================= */
func _gf2_matrix_times(tls *libc.TLS, mat uintptr, vec uint64) (r uint64) {
	var sum uint64
	_ = sum
	sum = uint64(0)
	for vec != 0 {
		if vec&uint64(1) != 0 {
			sum ^= *(*uint64)(unsafe.Pointer(mat))
		}
		vec >>= uint64(1)
		mat += 8
	}
...
func _gf2_matrix_square(tls *libc.TLS, square uintptr, mat uintptr) {
	...
	for {
		...
		*(*uint64)(unsafe.Pointer(square + uintptr(n)*8)) = _gf2_matrix_times(tls, mat, *(*uint64)(unsafe.Pointer(mat + uintptr(n)*8)))
		goto _1
	_1:
		n++
	}
...
func _crc32_combine_(tls *libc.TLS, crc1 TuLong, crc2 TuLong, len2 Toff_t) (r TuLong) {
	...
	var n int32
	var row uint64
	var _ /* even at bp+0 */ [32]uint64
	var _ /* odd at bp+256 */ [32]uint64
	...
	(*(*[32]uint64)(unsafe.Pointer(bp + 256)))[0] = uint64(0xedb88320) /* CRC-32 polynomial */
	row = uint64(1)
	n = int32(1)
	for {
		if !(n < int32(m_GF2_DIM)) {
		...
		(*(*[32]uint64)(unsafe.Pointer(bp + 256)))[n] = row
		row <<= uint64(1)
		goto _1
	_1:
		n++
	...
	_gf2_matrix_square(tls, bp, bp+256)
	/* put operator for four zero bits in odd */
	_gf2_matrix_square(tls, bp+256, bp)
	...
	for cond := true; cond; cond = len2 != 0 {
		...
		_gf2_matrix_square(tls, bp+256, bp)
		if len2&int64(1) != 0 {
			crc1 = _gf2_matrix_times(tls, bp+256, crc1)
		}
		len2 >>= int64(1)
		/* if no more bits set, then done */
	}
...
func x_deflateInit2_(tls *libc.TLS, strm Tz_streamp, level int32, method int32, windowBits int32, memLevel int32, strategy int32, version uintptr, stream_size int32) (r int32) {
	...
	overlay = (*(*func(*libc.TLS, Tvoidpf, TuInt, TuInt) Tvoidpf)(unsafe.Pointer(&struct{ uintptr }{(*Tz_stream)(unsafe.Pointer(strm)).Fzalloc})))(tls, (*Tz_stream)(unsafe.Pointer(strm)).Fopaque, (*Tdeflate_state)(unsafe.Pointer(s)).Flit_bufsize, uint32(libc.Uint64FromInt64(2)+libc.Uint64FromInt32(2)))
	(*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf = overlay
	(*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf_size = uint64((*Tdeflate_state)(unsafe.Pointer(s)).Flit_bufsize) * (libc.Uint64FromInt64(2) + libc.Uint64FromInt64(2))
	...
	(*Tdeflate_state)(unsafe.Pointer(s)).Fd_buf = overlay + uintptr(uint64((*Tdeflate_state)(unsafe.Pointer(s)).Flit_bufsize)/uint64(2))*2
	(*Tdeflate_state)(unsafe.Pointer(s)).Fl_buf = (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr((libc.Uint64FromInt32(1)+libc.Uint64FromInt64(2))*uint64((*Tdeflate_state)(unsafe.Pointer(s)).Flit_bufsize))
...
func x_deflateResetKeep(tls *libc.TLS, strm Tz_streamp) (r int32) {
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fwrap == int32(2) {
		v4 = x_crc32(tls, uint64(0), uintptr(m_Z_NULL), uint32(0))
	} else {
		v4 = x_adler32(tls, uint64(0), uintptr(m_Z_NULL), uint32(0))
	}
...
func x_deflateBound(tls *libc.TLS, strm Tz_streamp, sourceLen TuLong) (r TuLong) {
	...
	complen = sourceLen + (sourceLen+uint64(7))>>int32(3) + (sourceLen+uint64(63))>>int32(6) + uint64(5)
...
func x_deflateCopy(tls *libc.TLS, dest Tz_streamp, source Tz_streamp) (r int32) {
	...
	overlay = (*(*func(*libc.TLS, Tvoidpf, TuInt, TuInt) Tvoidpf)(unsafe.Pointer(&struct{ uintptr }{(*Tz_stream)(unsafe.Pointer(dest)).Fzalloc})))(tls, (*Tz_stream)(unsafe.Pointer(dest)).Fopaque, (*Tdeflate_state)(unsafe.Pointer(ds)).Flit_bufsize, uint32(libc.Uint64FromInt64(2)+libc.Uint64FromInt32(2)))
	...
	(*Tdeflate_state)(unsafe.Pointer(ds)).Fd_buf = overlay + uintptr(uint64((*Tdeflate_state)(unsafe.Pointer(ds)).Flit_bufsize)/uint64(2))*2
	(*Tdeflate_state)(unsafe.Pointer(ds)).Fl_buf = (*Tdeflate_state)(unsafe.Pointer(ds)).Fpending_buf + uintptr((libc.Uint64FromInt32(1)+libc.Uint64FromInt64(2))*uint64((*Tdeflate_state)(unsafe.Pointer(ds)).Flit_bufsize))
...
func _deflate_stored(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
	var have, last, left, len1, min_block, used, v3, v5, v6 uint32
	var v1, v4 uint64
	var v2, v7, v8 int32
	_, _, _, _, _, _, _, _, _, _, _, _, _, _ = have, last, left, len1, min_block, used, v1, v2, v3, v4, v5, v6, v7, v8
	...
	have = uint32((*Tdeflate_state)(unsafe.Pointer(s)).Fwindow_size - uint64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart) - uint64(1))
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf_size-uint64(uint64(have)) > uint64(libc.Int32FromInt32(m_MAX_STORED)) {
		v4 = uint64(libc.Int32FromInt32(m_MAX_STORED))
	} else {
		v4 = (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf_size - uint64(uint64(have))
	}
	have = uint32(v4)
	if have > (*Tdeflate_state)(unsafe.Pointer(s)).Fw_size {
		v5 = (*Tdeflate_state)(unsafe.Pointer(s)).Fw_size
	} else {
		v5 = have
	}
	min_block = v5
...
func _deflate_fast(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
	...
	for {
		...
		if (*Tdeflate_state)(unsafe.Pointer(s)).Fmatch_length >= uint32(m_MIN_MATCH) {
			...
			*(*Tush)(unsafe.Pointer(s + 2504 + uintptr(v5)*4))++
		...
		if bflush != 0 {
			...
			x__tr_flush_block(tls, s, v12, uint64(int64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), 0)
			(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
			_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
	...
	if flush == int32(m_Z_FINISH) {
		...
		x__tr_flush_block(tls, s, v14, uint64(int64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), int32(1))
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
...
func _deflate_slow(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
	...
	if flush == int32(m_Z_FINISH) {
		...
		x__tr_flush_block(tls, s, v19, uint64(int64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), int32(1))
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
			return int32(_finish_started)
...
func _deflate_rle(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
	...
	for {
		...
		if (*Tdeflate_state)(unsafe.Pointer(s)).Fmatch_length >= uint32(m_MIN_MATCH) {
			...
			*(*Tush)(unsafe.Pointer(s + 2504 + uintptr(v25)*4))++
			bflush = libc.BoolInt32((*Tdeflate_state)(unsafe.Pointer(s)).Flast_lit == (*Tdeflate_state)(unsafe.Pointer(s)).Flit_bufsize-uint32(1))
			*(*TuInt)(unsafe.Pointer(s + 180)) -= (*Tdeflate_state)(unsafe.Pointer(s)).Fmatch_length
			*(*TuInt)(unsafe.Pointer(s + 172)) += (*Tdeflate_state)(unsafe.Pointer(s)).Fmatch_length
			(*Tdeflate_state)(unsafe.Pointer(s)).Fmatch_length = uint32(0)
		...
		if bflush != 0 {
			...
			x__tr_flush_block(tls, s, v28, uint64(int64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), 0)
			(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
			_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
			if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
				return int32(_need_more)
...
func _deflate_huff(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
	...
	for {
		...
		*(*Tush)(unsafe.Pointer(s + 212 + uintptr(cc)*4))++
		...
		if bflush != 0 {
			...
			x__tr_flush_block(tls, s, v4, uint64(int64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), 0)
			(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
			_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
			if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
				return int32(_need_more)
	...
	if flush == int32(m_Z_FINISH) {
		...
		x__tr_flush_block(tls, s, v5, uint64(int64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), int32(1))
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
			return int32(_finish_started)
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Flast_lit != 0 {
		...
		x__tr_flush_block(tls, s, v6, uint64(int64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), 0)
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int64((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
			return int32(_need_more)
...
func x_inflateBack(tls *libc.TLS, strm Tz_streamp, in Tin_func, in_desc uintptr, out Tout_func, out_desc uintptr) (r int32) {
	...
	*(*uintptr)(unsafe.Pointer(bp)) = (*Tz_stream)(unsafe.Pointer(strm)).Fnext_in
	...
	_3:
		...
		case uint32(3):
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 199
	...
	_12: /* go to byte boundary */
		...
		if hold&uint64(0xffff) != hold>>int32(16)^uint64(0xffff) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 218
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
	...
	_5:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fnlen > uint32(286) || (*Tinflate_state)(unsafe.Pointer(state)).Fndist > uint32(30) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 247
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 283
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
		...
		if int32(*(*uint16)(unsafe.Pointer(state + 152 + 256*2))) == 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 334
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 399
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
	...
	_6:
		...
		bits -= uint32(here.Fbits)
		if int32(here.Fop)&int32(64) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 449
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Foffset > (*Tinflate_state)(unsafe.Pointer(state)).Fwsize-v43 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 471
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
...
func x_inflate_fast(tls *libc.TLS, strm Tz_streamp, start uint32) {
	...
	for cond := true; cond; cond = in < last && out < end {
		...
		here = *(*Tcode)(unsafe.Pointer(lcode + uintptr(hold&uint64(uint64(lmask)))*4))
	dolen:
		...
		if op == uint32(0) { /* literal */
			...
			*(*uint8)(unsafe.Pointer(v3)) = uint8(here.Fval)
			...
			if op&uint32(16) != 0 { /* length base */
				...
				here = *(*Tcode)(unsafe.Pointer(dcode + uintptr(hold&uint64(uint64(dmask)))*4))
			dodist:
				op = uint32(here.Fbits)
				hold >>= uint64(uint64(op))
				bits -= op
				...
				if op&uint32(16) != 0 { /* distance base */
					...
					if op&uint32(64) == uint32(0) { /* 2nd level distance code */
						here = *(*Tcode)(unsafe.Pointer(dcode + uintptr(uint64(here.Fval)+hold&uint64(libc.Uint32FromUint32(1)<<op-libc.Uint32FromInt32(1)))*4))
						goto dodist
					} else {
						(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 449
						(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				...
				if op&uint32(64) == uint32(0) { /* 2nd level length code */
					here = *(*Tcode)(unsafe.Pointer(lcode + uintptr(uint64(here.Fval)+hold&uint64(libc.Uint32FromUint32(1)<<op-libc.Uint32FromInt32(1)))*4))
					goto dolen
				} else {
...
func x_inflate(tls *libc.TLS, strm Tz_streamp, flush int32) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	var bits, copy1, have, in, left, len1, out, v46, v47, v48, v50, v51, v62, v64, v68, v73, v74, v88 uint32
	var from, next, put, state, v36, v42, v43, v44, v45, v49, v52, v53, v55, v58, v59, v60, v61, v63, v65, v67, v69, v70, v71, v72, v75, v77, v79, v80, v83, v85, v86, v90, v91, v92, v93, v98, p81, p87 uintptr
	var here, last Tcode
	var hold, v100, v37, v54, v56, v57, v94, v95, v96, v99 uint64
	var ret, v101, v102, v103, v38 int32
	var v97 bool
	var _ /* hbuf at bp+0 */ [4]uint8
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = bits, copy1, from, have, here, hold, in, last, left, len1, next, out, put, ret, state, v100, v101, v102, v103, v36, v37, v38, v42, v43, v44, v45, v46, v47, v48, v49, v50, v51, v52, v53, v54, v55, v56, v57, v58, v59, v60, v61, v62, v63, v64, v65, v67, v68, v69, v70, v71, v72, v73, v74, v75, v77, v79, v80, v83, v85, v86, v88, v90, v91, v92, v93, v94, v95, v96, v97, v98, v99, p81, p87 /* buffer for gzip header crc calculation */
	...
	_2:
		...
		if len1 > uint32(15) || len1 > (*Tinflate_state)(unsafe.Pointer(state)).Fwbits {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 551
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0x0800) != 0 {
			...
			for cond := true; cond; cond = len1 != 0 && copy1 < have {
				...
				if (*Tinflate_state)(unsafe.Pointer(state)).Fhead != uintptr(m_Z_NULL) && (*Tgz_header)(unsafe.Pointer((*Tinflate_state)(unsafe.Pointer(state)).Fhead)).Fname != uintptr(m_Z_NULL) && (*Tinflate_state)(unsafe.Pointer(state)).Flength < (*Tgz_header)(unsafe.Pointer((*Tinflate_state)(unsafe.Pointer(state)).Fhead)).Fname_max {
					...
					*(*TBytef)(unsafe.Pointer((*Tgz_header)(unsafe.Pointer((*Tinflate_state)(unsafe.Pointer(state)).Fhead)).Fname + uintptr(v48))) = uint8(uint8(len1))
				}
			}
			if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0x0200) != 0 && (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 {
				(*Tinflate_state)(unsafe.Pointer(state)).Fcheck = x_crc32(tls, (*Tinflate_state)(unsafe.Pointer(state)).Fcheck, next, copy1)
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0x1000) != 0 {
			...
			for cond := true; cond; cond = len1 != 0 && copy1 < have {
				...
				if (*Tinflate_state)(unsafe.Pointer(state)).Fhead != uintptr(m_Z_NULL) && (*Tgz_header)(unsafe.Pointer((*Tinflate_state)(unsafe.Pointer(state)).Fhead)).Fcomment != uintptr(m_Z_NULL) && (*Tinflate_state)(unsafe.Pointer(state)).Flength < (*Tgz_header)(unsafe.Pointer((*Tinflate_state)(unsafe.Pointer(state)).Fhead)).Fcomm_max {
					...
					*(*TBytef)(unsafe.Pointer((*Tgz_header)(unsafe.Pointer((*Tinflate_state)(unsafe.Pointer(state)).Fhead)).Fcomment + uintptr(v51))) = uint8(uint8(len1))
				}
			}
			if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0x0200) != 0 && (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 {
				(*Tinflate_state)(unsafe.Pointer(state)).Fcheck = x_crc32(tls, (*Tinflate_state)(unsafe.Pointer(state)).Fcheck, next, copy1)
	...
	_10:
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0x0200) != 0 {
			...
			if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && hold != (*Tinflate_state)(unsafe.Pointer(state)).Fcheck&uint64(0xffff) {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 596
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint64(0)
	...
	_19:
		for (*Tinflate_state)(unsafe.Pointer(state)).Fhave < (*Tinflate_state)(unsafe.Pointer(state)).Fncode {
			...
			*(*uint16)(unsafe.Pointer(state + 152 + uintptr(_order1[v62])*2)) = uint16(uint32(uint32(hold)) & (libc.Uint32FromUint32(1)<<libc.Int32FromInt32(3) - libc.Uint32FromInt32(1)))
			hold >>= uint64(libc.Int32FromInt32(3))
			bits -= uint32(libc.Int32FromInt32(3))
		}
		for (*Tinflate_state)(unsafe.Pointer(state)).Fhave < uint32(19) {
	...
	_20:
		for (*Tinflate_state)(unsafe.Pointer(state)).Fhave < (*Tinflate_state)(unsafe.Pointer(state)).Fnlen+(*Tinflate_state)(unsafe.Pointer(state)).Fndist {
			for {
				...
				v67 = next
				next++
				hold += uint64(*(*uint8)(unsafe.Pointer(v67))) << bits
				bits += uint32(8)
				goto _66
			_66:
			}
			if int32(here.Fval) < int32(16) {
				...
				bits -= uint32(here.Fbits)
				v69 = state + 140
				v68 = *(*uint32)(unsafe.Pointer(v69))
				*(*uint32)(unsafe.Pointer(v69))++
				*(*uint16)(unsafe.Pointer(state + 152 + uintptr(v68)*2)) = here.Fval
			} else {
				if int32(here.Fval) == int32(16) {
					for bits < uint32(int32(here.Fbits)+libc.Int32FromInt32(2)) {
						if have == uint32(0) {
				...
				for {
					...
					v75 = state + 140
					v74 = *(*uint32)(unsafe.Pointer(v75))
					*(*uint32)(unsafe.Pointer(v75))++
					*(*uint16)(unsafe.Pointer(state + 152 + uintptr(v74)*2)) = uint16(uint16(len1))
				}
			}
		}
		/* handle error breaks in while */
	...
	_23:
		if (*Tinflate_state)(unsafe.Pointer(state)).Fextra != 0 {
			...
			*(*uint32)(unsafe.Pointer(state + 92)) += uint32(uint32(hold)) & (uint32(1)<<(*Tinflate_state)(unsafe.Pointer(state)).Fextra - uint32(1))
			...
			bits -= (*Tinflate_state)(unsafe.Pointer(state)).Fextra
			p81 = state + 7148
			*(*int32)(unsafe.Pointer(p81)) = int32(uint32(*(*int32)(unsafe.Pointer(p81))) + (*Tinflate_state)(unsafe.Pointer(state)).Fextra)
		}
	...
	_24:
		for {
			...
			v83 = next
			next++
			hold += uint64(*(*uint8)(unsafe.Pointer(v83))) << bits
			bits += uint32(8)
			goto _82
		_82:
		}
	...
	_25:
		if (*Tinflate_state)(unsafe.Pointer(state)).Fextra != 0 {
			...
			*(*uint32)(unsafe.Pointer(state + 96)) += uint32(uint32(hold)) & (uint32(1)<<(*Tinflate_state)(unsafe.Pointer(state)).Fextra - uint32(1))
			...
			bits -= (*Tinflate_state)(unsafe.Pointer(state)).Fextra
			p87 = state + 7148
			*(*int32)(unsafe.Pointer(p87)) = int32(uint32(*(*int32)(unsafe.Pointer(p87))) + (*Tinflate_state)(unsafe.Pointer(state)).Fextra)
		}
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 {
			...
			*(*uint64)(unsafe.Pointer(state + 40)) += uint64(uint64(out))
			...
			if v97 && v96 != (*Tinflate_state)(unsafe.Pointer(state)).Fcheck {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 616
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint64(0)
	...
	_29:
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 && (*Tinflate_state)(unsafe.Pointer(state)).Fflags != 0 {
			...
			if hold != (*Tinflate_state)(unsafe.Pointer(state)).Ftotal&uint64(0xffffffff) {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 637
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint64(0)
...
func x__tr_tally(tls *libc.TLS, s uintptr, dist uint32, lc uint32) (r int32) {
	...
	var v3 int32
	_, _, _ = v1, v2, v3
	*(*Tushf)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fd_buf + uintptr((*Tdeflate_state)(unsafe.Pointer(s)).Flast_lit)*2)) = uint16(uint16(dist))
	v2 = s + 5900
	v1 = *(*TuInt)(unsafe.Pointer(v2))
	*(*TuInt)(unsafe.Pointer(v2))++
	*(*Tuchf)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fl_buf + uintptr(v1))) = uint8(uint8(lc))
	if dist == uint32(0) {
		...
		*(*Tush)(unsafe.Pointer(s + 2504 + uintptr(v3)*4))++
	}
...
func _compress_block(tls *libc.TLS, s uintptr, ltree uintptr, dtree uintptr) {
			...
			if dist == uint32(0) {
				...
				if extra != 0 {
					...
					if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len2 {
						val2 = lc
						p14 = s + 5936
						*(*Tush)(unsafe.Pointer(p14)) = Tush(int32(*(*Tush)(unsafe.Pointer(p14))) | int32(uint16(uint16(val2)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
						v16 = s + 40
				...
				if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len3 {
					...
					p21 = s + 5936
					*(*Tush)(unsafe.Pointer(p21)) = Tush(int32(*(*Tush)(unsafe.Pointer(p21))) | int32(uint16(uint16(val3)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
					v23 = s + 40
				...
				if extra != 0 {
					...
					if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len4 {
						...
						p27 = s + 5936
						*(*Tush)(unsafe.Pointer(p27)) = Tush(int32(*(*Tush)(unsafe.Pointer(p27))) | int32(uint16(uint16(val4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
						v29 = s + 40
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len5 {
		...
		p33 = s + 5936
		*(*Tush)(unsafe.Pointer(p33)) = Tush(int32(*(*Tush)(unsafe.Pointer(p33))) | int32(uint16(uint16(val5)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
		v35 = s + 40
...
func _detect_data_type(tls *libc.TLS, s uintptr) (r int32) {
	...
	for {
		...
		if black_mask&uint64(1) != 0 && int32(*(*Tush)(unsafe.Pointer(s + 212 + uintptr(n)*4))) != 0 {
			return m_Z_BINARY
		}
		goto _1
	_1:
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	state = libc.Xmalloc(tls, uint64(232))
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, path, libc.Uint64FromInt32(7)+libc.Uint64FromInt32(3)*libc.Uint64FromInt64(4), __ccgo_ts+777, libc.VaList(bp+8, fd))
...
func x_gz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint64(3), __ccgo_ts+799, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, __ccgo_ts+806, msg))
}
...
func _gz_look(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fsize == uint32(0) {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fin == libc.UintptrFromInt32(0) || (*Tgz_state)(unsafe.Pointer(state)).Fout == libc.UintptrFromInt32(0) {
			...
			x_gz_error(tls, state, -int32(4), __ccgo_ts+785)
			return -int32(1)
		}
		...
		if x_inflateInit2_(tls, state+120, libc.Int32FromInt32(15)+libc.Int32FromInt32(16), __ccgo_ts+192, libc.Int32FromInt64(112)) != m_Z_OK { /* gunzip */
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
...
func _gz_decomp(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	for cond := true; cond; cond = (*Tz_stream)(unsafe.Pointer(strm)).Favail_out != 0 && ret != int32(m_Z_STREAM_END) {
		...
		if (*Tz_stream)(unsafe.Pointer(strm)).Favail_in == uint32(0) {
			x_gz_error(tls, state, -int32(5), __ccgo_ts+809)
			break
		}
		/* decompress and handle errors */
		ret = x_inflate(tls, strm, m_Z_NO_FLUSH)
		if ret == -int32(2) || ret == int32(m_Z_NEED_DICT) {
			x_gz_error(tls, state, -int32(2), __ccgo_ts+832)
			return -int32(1)
		}
		if ret == -int32(4) {
			x_gz_error(tls, state, -int32(4), __ccgo_ts+785)
...
func x_gzread(tls *libc.TLS, file TgzFile, buf Tvoidp, len1 uint32) (r int32) {
	...
	if int32(int32(len1)) < 0 {
		x_gz_error(tls, state, -int32(2), __ccgo_ts+893)
		return -int32(1)
	}
...
func x_gzfread(tls *libc.TLS, buf Tvoidp, size Tz_size_t, nitems Tz_size_t, file TgzFile) (r Tz_size_t) {
	...
	if size != 0 && len1/size != nitems {
		x_gz_error(tls, state, -int32(2), __ccgo_ts+924)
		return uint64(0)
	}
...
func x_gzgetc(tls *libc.TLS, file TgzFile) (r int32) {
	...
	ret = int32(_gz_read(tls, state, bp, uint64(1)))
	if ret < int32(1) {
		v3 = -int32(1)
	} else {
...
func x_gzungetc(tls *libc.TLS, c int32, file TgzFile) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave == (*Tgz_state)(unsafe.Pointer(state)).Fsize<<int32(1) {
		x_gz_error(tls, state, -int32(3), __ccgo_ts+957)
		return -int32(1)
	}
...
func _gz_comp(tls *libc.TLS, state Tgz_statep, flush int32) (r int32) {
	...
	for cond := true; cond; cond = have != 0 {
		...
		if ret == -int32(2) {
			x_gz_error(tls, state, -int32(2), __ccgo_ts+988)
			return -int32(1)
		}
		have -= (*Tz_stream)(unsafe.Pointer(strm)).Favail_out
	}
...
func x_gzwrite(tls *libc.TLS, file TgzFile, buf Tvoidpc, len1 uint32) (r int32) {
	...
	/* since an int is returned, make sure len fits in one, otherwise return
	   with an error (this avoids a flaw in the interface) */
	if int32(int32(len1)) < 0 {
		x_gz_error(tls, state, -int32(3), __ccgo_ts+1027)
		return 0
	}
...
func x_gzvprintf(tls *libc.TLS, file TgzFile, format uintptr, va Tva_list) (r int32) {
	...
	*(*TuInt)(unsafe.Pointer(strm + 8)) += uint32(uint32(len1))
	...
	if (*Tz_stream)(unsafe.Pointer(strm)).Favail_in >= (*Tgz_state)(unsafe.Pointer(state)).Fsize {
		...
		libc.Xmemcpy(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin, (*Tgz_state)(unsafe.Pointer(state)).Fin+uintptr((*Tgz_state)(unsafe.Pointer(state)).Fsize), uint64(uint64(left)))
		(*Tz_stream)(unsafe.Pointer(strm)).Fnext_in = (*Tgz_state)(unsafe.Pointer(state)).Fin
