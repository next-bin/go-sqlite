...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	if argc == 0 {
		if uncompr != 0 {
			if !(libc.X__isthreaded != 0) {
				v2 = int32((*TFILE)(unsafe.Pointer(uintptr(unsafe.Pointer(&libc.X__sF)))).F_file)
			} else {
				v2 = libc.Xfileno(tls, uintptr(unsafe.Pointer(&libc.X__sF)))
			}
			...
			if !(libc.X__isthreaded != 0) {
				v3 = int32((*TFILE)(unsafe.Pointer(uintptr(unsafe.Pointer(&libc.X__sF)) + 1*152)).F_file)
			} else {
				v3 = libc.Xfileno(tls, uintptr(unsafe.Pointer(&libc.X__sF))+1*152)
			}
			...
			if uncompr != 0 {
				...
				if copyout != 0 {
					...
					if in == libc.UintptrFromInt32(0) {
						...
						if !(libc.X__isthreaded != 0) {
							v6 = int32((*TFILE)(unsafe.Pointer(uintptr(unsafe.Pointer(&libc.X__sF)) + 1*152)).F_file)
						} else {
							v6 = libc.Xfileno(tls, uintptr(unsafe.Pointer(&libc.X__sF))+1*152)
						}
