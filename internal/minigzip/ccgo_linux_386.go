...
func x_file_compress(tls *libc.TLS, file uintptr, mode uintptr) {
	...
	_, _ = in, out
	if libc.Xstrlen(tls, file)+libc.Xstrlen(tls, ts+57) >= uint32(1024) {
		libc.Xfprintf(tls, libc.Xstderr, ts+61, libc.VaList(bp+1032, _prog))
		libc.Xexit(tls, int32(1))
	}
	libc.X__builtin_snprintf(tls, bp, uint32(1024), ts+84, libc.VaList(bp+1032, file, ts+57))
...
func x_file_uncompress(tls *libc.TLS, file uintptr) {
	...
	if len1+libc.Xstrlen(tls, ts+57) >= uint32(1024) {
		libc.Xfprintf(tls, libc.Xstderr, ts+61, libc.VaList(bp+1032, _prog))
		libc.Xexit(tls, int32(1))
	}
	libc.X__builtin_snprintf(tls, bp, uint32(1024), ts+113, libc.VaList(bp+1032, file))
	if len1 > libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1) && libc.Xstrcmp(tls, file+uintptr(len1)-uintptr(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)), ts+57) == 0 {
		infile = file
		outfile = bp
		*(*int8)(unsafe.Pointer(outfile + uintptr(len1-uint32(3)))) = int8('\000')
		...
		outfile = file
		infile = bp
		libc.X__builtin_snprintf(tls, bp+uintptr(len1), uint32(1024)-len1, ts+113, libc.VaList(bp+1032, ts+57))
	}
...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	copyout = 0
	uncompr = 0
	libc.X__builtin_snprintf(tls, bp, uint32(20), ts+113, libc.VaList(bp+32, ts+119))
...
func x_inflateBackInit_(tls *libc.TLS, strm Tz_streamp, windowBits int32, window uintptr, version uintptr, stream_size int32) (r int32) {
	var state uintptr
	_ = state
	if version == uintptr(m_Z_NULL) || int32(*(*int8)(unsafe.Pointer(version))) != int32(*(*int8)(unsafe.Pointer(ts + 192))) || stream_size != int32(libc.Uint32FromInt64(56)) {
		return -int32(6)
	}
...
func x_inflate(tls *libc.TLS, strm Tz_streamp, flush int32) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	var bits, copy1, have, hold, in, left, len1, out, v100, v101, v37, v45, v47, v48, v49, v51, v52, v55, v57, v58, v63, v65, v69, v74, v75, v89, v95, v96, v97 uint32
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0x0400) != 0 {
			...
			if copy1 != 0 {
				...
				if v46 && v45 < (*Tgz_header)(unsafe.Pointer((*Tinflate_state)(unsafe.Pointer(state)).Fhead)).Fextra_max {
					...
					libc.Xmemcpy(tls, (*Tgz_header)(unsafe.Pointer((*Tinflate_state)(unsafe.Pointer(state)).Fhead)).Fextra+uintptr(len1), next, v47)
				}
				if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0x0200) != 0 && (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 {
	...
	_10:
		...
		v55 = x_crc32(tls, uint32(0), uintptr(m_Z_NULL), uint32(0))
	...
	_11:
		for bits < uint32(libc.Int32FromInt32(32)) {
			...
			v56 = next
			next++
			hold += uint32(*(*uint8)(unsafe.Pointer(v56))) << bits
			bits += uint32(8)
		}
		v57 = hold>>libc.Int32FromInt32(24)&libc.Uint32FromInt32(0xff) + hold>>libc.Int32FromInt32(8)&libc.Uint32FromInt32(0xff00) + hold&libc.Uint32FromInt32(0xff00)<<libc.Int32FromInt32(8) + hold&libc.Uint32FromInt32(0xff)<<libc.Int32FromInt32(24)
	...
	_12:
		...
		v58 = x_adler32(tls, uint32(0), uintptr(m_Z_NULL), uint32(0))
	...
	_19:
		for (*Tinflate_state)(unsafe.Pointer(state)).Fhave < (*Tinflate_state)(unsafe.Pointer(state)).Fncode {
			...
			*(*uint16)(unsafe.Pointer(state + 116 + uintptr(_order1[v63])*2)) = uint16(hold & (libc.Uint32FromUint32(1)<<libc.Int32FromInt32(3) - libc.Uint32FromInt32(1)))
			hold >>= uint32(libc.Int32FromInt32(3))
			bits -= uint32(libc.Int32FromInt32(3))
		}
		for (*Tinflate_state)(unsafe.Pointer(state)).Fhave < uint32(19) {
			...
			*(*uint16)(unsafe.Pointer(state + 116 + uintptr(_order1[v65])*2)) = uint16(0)
		}
		(*Tinflate_state)(unsafe.Pointer(state)).Fnext = state + 1332
		(*Tinflate_state)(unsafe.Pointer(state)).Flencode = (*Tinflate_state)(unsafe.Pointer(state)).Fnext
		(*Tinflate_state)(unsafe.Pointer(state)).Flenbits = uint32(7)
	...
	_20:
		for (*Tinflate_state)(unsafe.Pointer(state)).Fhave < (*Tinflate_state)(unsafe.Pointer(state)).Fnlen+(*Tinflate_state)(unsafe.Pointer(state)).Fndist {
			for {
				...
				v68 = next
				next++
				hold += uint32(*(*uint8)(unsafe.Pointer(v68))) << bits
				bits += uint32(8)
				goto _67
			_67:
			}
			if int32(here.Fval) < int32(16) {
				...
				*(*uint16)(unsafe.Pointer(state + 116 + uintptr(v69)*2)) = here.Fval
			} else {
				if int32(here.Fval) == int32(16) {
					for bits < uint32(int32(here.Fbits)+libc.Int32FromInt32(2)) {
						if have == uint32(0) {
				...
				for {
					...
					*(*uint16)(unsafe.Pointer(state + 116 + uintptr(v75)*2)) = uint16(len1)
				}
			}
		}
		/* handle error breaks in while */
	...
	_22:
		...
		if here.Fop != 0 && int32(here.Fop)&int32(0xf0) == 0 {
			...
			for {
				...
				v80 = next
				next++
				hold += uint32(*(*uint8)(unsafe.Pointer(v80))) << bits
				bits += uint32(8)
				goto _79
			_79:
			}
	...
	_24:
		...
		if int32(here.Fop)&int32(0xf0) == 0 {
			...
			for {
				...
				v86 = next
				next++
				hold += uint32(*(*uint8)(unsafe.Pointer(v86))) << bits
				bits += uint32(8)
				goto _85
			_85:
			}
	...
	_28:
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 {
			for bits < uint32(libc.Int32FromInt32(32)) {
				...
				v94 = next
				next++
				hold += uint32(*(*uint8)(unsafe.Pointer(v94))) << bits
				bits += uint32(8)
			}
			out -= left
			...
			*(*uint32)(unsafe.Pointer(state + 32)) += out
			...
			if v98 = (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0; v98 {
				if (*Tinflate_state)(unsafe.Pointer(state)).Fflags != 0 {
					...
					v97 = hold>>int32(24)&uint32(0xff) + hold>>int32(8)&uint32(0xff00) + hold&uint32(0xff00)<<int32(8) + hold&uint32(0xff)<<int32(24)
				}
			}
	...
	_29:
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 && (*Tinflate_state)(unsafe.Pointer(state)).Fflags != 0 {
			for bits < uint32(libc.Int32FromInt32(32)) {
				...
				v99 = next
				next++
				hold += uint32(*(*uint8)(unsafe.Pointer(v99))) << bits
				bits += uint32(8)
			}
...
func x_compress2(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen TuLong, level int32) (r int32) {
	...
	*(*TuLongf)(unsafe.Pointer(destLen)) = uint32(0)
	...
	err = x_deflateInit_(tls, bp, level, ts+192, libc.Int32FromInt64(56))
	if err != m_Z_OK {
		return err
	}
...
func x_uncompress2(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen uintptr) (r int32) {
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fzfree = libc.UintptrFromInt32(0)
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fopaque = libc.UintptrFromInt32(0)
	err = x_inflateInit_(tls, bp, ts+192, libc.Int32FromInt64(56))
	if err != m_Z_OK {
		return err
	}
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fnext_out = dest
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint32(1), ts+113, libc.VaList(bp+8, path))
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, path, libc.Uint32FromInt32(7)+libc.Uint32FromInt32(3)*libc.Uint32FromInt64(4), ts+774, libc.VaList(bp+8, fd))
...
func x_gz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint32(3), ts+796, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, ts+803, msg))
}
...
func _gz_look(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fsize == uint32(0) {
		...
		if x_inflateInit2_(tls, state+100, libc.Int32FromInt32(15)+libc.Int32FromInt32(16), ts+192, libc.Int32FromInt64(56)) != m_Z_OK { /* gunzip */
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
...
func _gz_init(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if !((*Tgz_state)(unsafe.Pointer(state)).Fdirect != 0) {
		...
		ret = x_deflateInit2_(tls, strm, (*Tgz_state)(unsafe.Pointer(state)).Flevel, int32(m_Z_DEFLATED), libc.Int32FromInt32(m_MAX_WBITS)+libc.Int32FromInt32(16), int32(m_DEF_MEM_LEVEL), (*Tgz_state)(unsafe.Pointer(state)).Fstrategy, ts+192, libc.Int32FromInt64(56))
		if ret != m_Z_OK {
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
			x_gz_error(tls, state, -int32(4), ts+782)
