...
func _file_compress(tls *libc.TLS, file uintptr, mode uintptr) {
	...
	var in uintptr
	var out TgzFile
	var _ /* outfile at bp+0 */ [1024]uint8
	_, _ = in, out
	if libc.Xstrlen(tls, file)+libc.Xstrlen(tls, __ccgo_ts+57) >= uint64(1024) {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+61, libc.VaList(bp+1032, _prog))
		libc.Xexit(tls, int32(1))
	}
	...
	if out == libc.UintptrFromInt32(0) {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+92, libc.VaList(bp+1032, _prog, bp))
		libc.Xexit(tls, int32(1))
	}
...
func _file_uncompress(tls *libc.TLS, file uintptr) {
	...
	if in == libc.UintptrFromInt32(0) {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+92, libc.VaList(bp+1032, _prog, infile))
		libc.Xexit(tls, int32(1))
	}
...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
		...
		if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+136) == 0 {
			...
			if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+139) == 0 {
				...
				if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+142) == 0 {
					(*(*[20]uint8)(unsafe.Pointer(bp)))[int32(3)] = uint8('f')
				} else {
					if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+145) == 0 {
						(*(*[20]uint8)(unsafe.Pointer(bp)))[int32(3)] = uint8('h')
					} else {
						if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+148) == 0 {
							(*(*[20]uint8)(unsafe.Pointer(bp)))[int32(3)] = uint8('R')
						} else {
							if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv))))) == int32('-') && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 1))) >= int32('1') && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 1))) <= int32('9') && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 2))) == 0 {
								(*(*[20]uint8)(unsafe.Pointer(bp)))[int32(2)] = *(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 1))
							} else {
								break
							}
						}
	...
	if libc.Int32FromUint8((*(*[20]uint8)(unsafe.Pointer(bp)))[int32(3)]) == int32(' ') {
		(*(*[20]uint8)(unsafe.Pointer(bp)))[int32(3)] = uint8(0)
	}
	if argc == 0 {
		if uncompr != 0 {
		...
		for {
			if uncompr != 0 {
				if copyout != 0 {
					...
					if file == libc.UintptrFromInt32(0) {
						libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+92, libc.VaList(bp+32, _prog, *(*uintptr)(unsafe.Pointer(argv))))
					} else {
						_gz_uncompress(tls, file, libc.X__stdoutp)
					}
				} else {
...
func x_inflateInit2_(tls *libc.TLS, strm Tz_streamp, windowBits int32, version uintptr, stream_size int32) (r int32) {
	...
	var state uintptr
	_, _ = ret, state
	if version == uintptr(m_Z_NULL) || libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(version))) != libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(__ccgo_ts + 192))) || stream_size != libc.Int32FromUint64(libc.Uint64FromInt64(112)) {
		return -int32(6)
	}
	if strm == uintptr(m_Z_NULL) {
		return -int32(2)
