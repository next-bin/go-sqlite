...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	if fd == -int32(2) {
		...
		if len1 == libc.Uint32FromInt32(-libc.Int32FromInt32(1)) {
			len1 = uint32(0)
		}
	} else {
...
func x_gzseek64(tls *libc.TLS, file TgzFile, offset int32, whence int32) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fmode == int32(m_GZ_READ) {
		if libc.Bool(uint32(4) == uint32(4)) && (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave > x_gz_intmax(tls) || libc.Int32FromUint32((*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave) > offset {
...
func _gz_skip(tls *libc.TLS, state Tgz_statep, len1 int32) (r int32) {
	...
	for len1 != 0 {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave != 0 {
			if libc.Bool(uint32(4) == uint32(4)) && (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave > x_gz_intmax(tls) || libc.Int32FromUint32((*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave) > len1 {
...
func _gz_zero(tls *libc.TLS, state Tgz_statep, len1 int32) (r int32) {
	...
	first = int32(1)
	for len1 != 0 {
		if libc.Bool(uint32(4) == uint32(4)) && (*Tgz_state)(unsafe.Pointer(state)).Fsize > x_gz_intmax(tls) || libc.Int32FromUint32((*Tgz_state)(unsafe.Pointer(state)).Fsize) > len1 {
			v1 = libc.Uint32FromInt32(len1)
		} else {
