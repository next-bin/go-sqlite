// Code generated for windows/386 by 'i686-w64-mingw32-gcc --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -extended-errors --libc modernc.org/libc -D_UCRT --cpp /home/jnml/bin/llvm-mingw-20251216-ucrt-ubuntu-22.04-x86_64/bin/i686-w64-mingw32-gcc --goarch 386 --goos windows --package-name=main -map ar=i686-w64-mingw32-ar,gcc=i686-w64-mingw32-gcc -o minigzip.exe.go minigzip.o.go libz.a', DO NOT EDIT.
...
func _gz_compress(tls *libc.TLS, in uintptr, out TgzFile) {
	...
	_ = len1
	for {
		len1 = int32(libc.Xfread(tls, bp, uint32(1), uint32(16384), in))
...
func _gz_uncompress(tls *libc.TLS, in TgzFile, out uintptr) {
	...
	for {
		...
		if int32(libc.Xfwrite(tls, bp, uint32(1), uint32(len1), out)) != len1 {
...
func _file_compress(tls *libc.TLS, file uintptr, mode uintptr) {
	...
	_string_copy(tls, end, __ccgo_ts+57, uint32(1025)-uint32(int32(end)-T__predefined_ptrdiff_t(bp)))
...
func x_crc32_z(tls *libc.TLS, crc TuLong, buf uintptr, len1 Tz_size_t) (r TuLong) {
	...
	if len1 >= uint32(libc.Int32FromInt32(m_N)*libc.Int32FromInt32(4)+libc.Int32FromInt32(4)-libc.Int32FromInt32(1)) {
		...
		for len1 != 0 && uint32(buf)&uint32(libc.Int32FromInt32(4)-libc.Int32FromInt32(1)) != uint32(0) {
			len1 = len1 - 1
			v1 = buf
			buf = buf + 1
	...
	for {
		...
		if (*Tdeflate_state)(unsafe.Pointer(s)).Fmatch_length >= uint32(m_MIN_MATCH) {
			...
			*(*Tuchf)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fsym_buf + uintptr(v3))) = len1
			dist = dist - 1
			*(*Tush)(unsafe.Pointer(s + 148 + uintptr(int32(x__length_code[len1])+int32(m_LITERALS)+int32(1))*4)) = *(*Tush)(unsafe.Pointer(s + 148 + uintptr(int32(x__length_code[len1])+int32(m_LITERALS)+int32(1))*4)) + 1
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	if fd == -int32(2) {
		...
		libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint32(1), __ccgo_ts+190, libc.VaList(bp+8, path))
	}
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, path, libc.Uint32FromInt32(7)+libc.Uint32FromInt32(3)*libc.Uint32FromInt64(4), __ccgo_ts+193, libc.VaList(bp+8, fd))
...
func x_gz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint32(3), __ccgo_ts+216, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, __ccgo_ts+223, msg))
}
...
func _gz_skip(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	for cond := true; cond; cond = (*Tgz_state)(unsafe.Pointer(state)).Fskip != 0 {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave != 0 {
			if libc.Bool(libc.Bool(uint32(4) == uint32(8)) && (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave > x_gz_intmax(tls)) || int64((*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave) > (*Tgz_state)(unsafe.Pointer(state)).Fskip {
			...
			for (*Tz_stream)(unsafe.Pointer(strm)).Fnext_out > (*Tgz_state)(unsafe.Pointer(state)).Fx.Fnext {
				*(*int32)(unsafe.Pointer(libc.X_errno(tls))) = 0
				...
				if int32((*Tz_stream)(unsafe.Pointer(strm)).Fnext_out)-int32((*Tgz_state)(unsafe.Pointer(state)).Fx.Fnext) > int32(max) {
					...
					v1 = uint32(int32((*Tz_stream)(unsafe.Pointer(strm)).Fnext_out) - int32((*Tgz_state)(unsafe.Pointer(state)).Fx.Fnext))
				}
				put = v1
...
func _gz_zero(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	first = int32(1)
	for cond := true; cond; cond = (*Tgz_state)(unsafe.Pointer(state)).Fskip != 0 {
		if libc.Bool(libc.Bool(uint32(4) == uint32(8)) && (*Tgz_state)(unsafe.Pointer(state)).Fsize > x_gz_intmax(tls)) || int64((*Tgz_state)(unsafe.Pointer(state)).Fsize) > (*Tgz_state)(unsafe.Pointer(state)).Fskip {
			v1 = uint32((*Tgz_state)(unsafe.Pointer(state)).Fskip)
		} else {
...
func x_inflateInit2_(tls *libc.TLS, strm Tz_streamp, windowBits int32, version uintptr, stream_size int32) (r int32) {
	...
	var state uintptr
	_, _ = ret, state
	if version == uintptr(m_Z_NULL) || int32(*(*int8)(unsafe.Pointer(version))) != int32(*(*int8)(unsafe.Pointer(__ccgo_ts + 184))) || stream_size != int32(libc.Uint32FromInt64(56)) {
		return -int32(6)
	}
	if strm == uintptr(m_Z_NULL) {
		return -int32(2)
	...
	for cond := true; cond; cond = (*Tdeflate_state)(unsafe.Pointer(s)).Fheap_len >= int32(2) {
		...
		*(*Tush)(unsafe.Pointer(tree + uintptr(node)*4)) = uint16(int32(*(*Tush)(unsafe.Pointer(tree + uintptr(n)*4))) + int32(*(*Tush)(unsafe.Pointer(tree + uintptr(m)*4))))
		if int32(*(*Tuch)(unsafe.Pointer(s + 5208 + uintptr(n)))) >= int32(*(*Tuch)(unsafe.Pointer(s + 5208 + uintptr(m)))) {
			v2 = int32(*(*Tuch)(unsafe.Pointer(s + 5208 + uintptr(n))))
		} else {
			v2 = int32(*(*Tuch)(unsafe.Pointer(s + 5208 + uintptr(m))))
		}
		*(*Tuch)(unsafe.Pointer(s + 5208 + uintptr(node))) = uint8(v2 + libc.Int32FromInt32(1))
		v18 = uint16(node)
				...
				for {
					...
					if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len1 {
						...
						*(*int32)(unsafe.Pointer(s + 5820)) += len1 - int32(m_Buf_size)
						...
						v5 = s + 5816
						*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(*(*Tush)(unsafe.Pointer(s + 2684 + uintptr(curlen)*4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
				...
				if curlen != 0 {
					...
					if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len2 {
						...
						*(*int32)(unsafe.Pointer(s + 5820)) += len2 - int32(m_Buf_size)
						...
						v5 = s + 5816
						*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(*(*Tush)(unsafe.Pointer(s + 2684 + 16*4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
					...
					if count <= int32(10) {
						...
						if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len4 {
							...
							*(*int32)(unsafe.Pointer(s + 5820)) += len4 - int32(m_Buf_size)
							...
							v5 = s + 5816
							*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(*(*Tush)(unsafe.Pointer(s + 2684 + 17*4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
						...
						if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len6 {
							...
							*(*int32)(unsafe.Pointer(s + 5820)) += len6 - int32(m_Buf_size)
							...
							v5 = s + 5816
							*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(*(*Tush)(unsafe.Pointer(s + 2684 + 18*4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
	...
	for {
		...
		if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len3 {
			...
			*(*int32)(unsafe.Pointer(s + 5820)) += len3 - int32(m_Buf_size)
			...
			v1 = s + 5816
			*(*Tush)(unsafe.Pointer(v1)) = Tush(int32(*(*Tush)(unsafe.Pointer(v1))) | int32(*(*Tush)(unsafe.Pointer(s + 2684 + uintptr(_bl_order[rank])*4 + 2)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
			*(*int32)(unsafe.Pointer(s + 5820)) += len3
		}
		goto _19
	_19:
