// Code generated for linux/amd64 by 'gcc --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -extended-errors --package-name=main -mlong-double-64 -D_LARGEFILE64_SOURCE=1 -DHAVE_HIDDEN -o example64.go example64.o.go -L. libz.a', DO NOT EDIT.
...
var _dictId uint64 /* Adler32 value of the dictionary */
...
//	 */
func x_test_compress(tls *libc.TLS, compr uintptr, _comprLen uint64, uncompr uintptr, _uncomprLen uint64) {
	...
	*(*uint64)(unsafe.Pointer(bp + 8)) = _uncomprLen
	...
	err = x_uncompress(tls, uncompr, bp+8, compr, *(*uint64)(unsafe.Pointer(bp)))
	if err != m_Z_OK {
...
//	 */
func x_test_gzio(tls *libc.TLS, fname uintptr, uncompr uintptr, uncomprLen uint64) {
	...
	file = x_gzopen(tls, fname, ts+76)
	if file == libc.UintptrFromInt32(0) {
		libc.Xfprintf(tls, libc.Xstderr, ts+79, 0)
		libc.Xexit(tls, int32(1))
	}
	x_gzputc(tls, file, int32('h'))
	if x_gzputs(tls, file, ts+93) != int32(4) {
		libc.Xfprintf(tls, libc.Xstderr, ts+98, libc.VaList(bp+16, x_gzerror(tls, file, bp)))
		libc.Xexit(tls, int32(1))
	}
	if x_gzprintf(tls, file, ts+114, libc.VaList(bp+16, ts+120)) != int32(8) {
		libc.Xfprintf(tls, libc.Xstderr, ts+126, libc.VaList(bp+16, x_gzerror(tls, file, bp)))
		libc.Xexit(tls, int32(1))
	}
	x_gzseek(tls, file, int64(1), int32(m_SEEK_CUR)) /* add one zero byte */
	x_gzclose(tls, file)
	file = x_gzopen(tls, fname, ts+144)
	if file == libc.UintptrFromInt32(0) {
		libc.Xfprintf(tls, libc.Xstderr, ts+79, 0)
		libc.Xexit(tls, int32(1))
	}
	...
	if x_gzread(tls, file, uncompr, uint32(uncomprLen)) != len1 {
		libc.Xfprintf(tls, libc.Xstderr, ts+147, libc.VaList(bp+16, x_gzerror(tls, file, bp)))
		libc.Xexit(tls, int32(1))
	}
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&_hello))) != 0 {
	...
	if pos != int64(6) || x_gztell(tls, file) != pos {
		libc.Xfprintf(tls, libc.Xstderr, ts+193, libc.VaList(bp+16, pos, x_gztell(tls, file)))
		libc.Xexit(tls, int32(1))
	}
	...
	if libc.Xstrlen(tls, uncompr) != uint64(7) { /* " hello!" */
		libc.Xfprintf(tls, libc.Xstderr, ts+258, libc.VaList(bp+16, x_gzerror(tls, file, bp)))
		libc.Xexit(tls, int32(1))
	}
...
//	 */
func x_test_deflate(tls *libc.TLS, compr uintptr, comprLen uint64) {
	...
	err = x_deflateInit_(tls, bp, -int32(1), ts+339, libc.Int32FromInt64(112))
	if err != m_Z_OK {
...
//	 */
func x_test_inflate(tls *libc.TLS, compr uintptr, comprLen uint64, uncompr uintptr, uncomprLen uint64) {
	bp := tls.Alloc(144) /* tlsAllocs 112 maxVaListSize 16 */
	defer tls.Free(144)
	var err int32
	var v1 uint32
	var _ /* d_stream at bp+0 */ Tz_stream /* decompression stream */
	libc.Xstrcpy(tls, uncompr, ts+23)
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fzalloc = _zalloc
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fopaque = libc.UintptrFromInt32(0)
	...
	err = x_inflateInit_(tls, bp, ts+339, libc.Int32FromInt64(112))
	if err != m_Z_OK {
...
//	 */
func x_test_large_deflate(tls *libc.TLS, compr uintptr, comprLen uint64, uncompr uintptr, uncomprLen uint64) {
	bp := tls.Alloc(144) /* tlsAllocs 112 maxVaListSize 16 */
	defer tls.Free(144)
	var err int32
	var _ /* c_stream at bp+0 */ Tz_stream
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fopaque = libc.UintptrFromInt32(0)
	err = x_deflateInit_(tls, bp, int32(m_Z_BEST_SPEED), ts+339, libc.Int32FromInt64(112))
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+120, ts+343, err))
		libc.Xexit(tls, int32(1))
	}
...
//	 */
func x_test_large_inflate(tls *libc.TLS, compr uintptr, comprLen uint64, uncompr uintptr, uncomprLen uint64) {
	bp := tls.Alloc(144) /* tlsAllocs 112 maxVaListSize 16 */
	defer tls.Free(144)
	var err int32
	var _ /* d_stream at bp+0 */ Tz_stream /* decompression stream */
	...
	if (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out != uint64(2)*uncomprLen+uncomprLen/uint64(2) {
		libc.Xfprintf(tls, libc.Xstderr, ts+503, libc.VaList(bp+120, (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out))
		libc.Xexit(tls, int32(1))
	} else {
...
func x_test_flush(tls *libc.TLS, compr uintptr, comprLen uintptr) {
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Favail_out = uint32(*(*uint64)(unsafe.Pointer(comprLen)))
	...
	*(*uint64)(unsafe.Pointer(comprLen)) = (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out
}
...
//	 * Test inflateSync()
//	 */
func x_test_sync(tls *libc.TLS, compr uintptr, comprLen uint64, uncompr uintptr, uncomprLen uint64) {
	bp := tls.Alloc(144) /* tlsAllocs 112 maxVaListSize 16 */
	defer tls.Free(144)
	var err int32
	var _ /* d_stream at bp+0 */ Tz_stream /* decompression stream */
...
//	 */
func x_test_dict_deflate(tls *libc.TLS, compr uintptr, comprLen uint64) {
	bp := tls.Alloc(144) /* tlsAllocs 112 maxVaListSize 16 */
	defer tls.Free(144)
	var err int32
	var _ /* c_stream at bp+0 */ Tz_stream
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fopaque = libc.UintptrFromInt32(0)
	err = x_deflateInit_(tls, bp, int32(m_Z_BEST_COMPRESSION), ts+339, libc.Int32FromInt64(112))
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+120, ts+343, err))
		libc.Xexit(tls, int32(1))
	}
...
//	 */
func x_test_dict_inflate(tls *libc.TLS, compr uintptr, comprLen uint64, uncompr uintptr, uncomprLen uint64) {
	bp := tls.Alloc(144) /* tlsAllocs 112 maxVaListSize 16 */
	defer tls.Free(144)
	var err int32
	var _ /* d_stream at bp+0 */ Tz_stream /* decompression stream */
...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	*(*uint64)(unsafe.Pointer(bp)) = uint64(3) * uncomprLen
	if int32(*(*int8)(unsafe.Pointer(x_zlibVersion(tls)))) != int32(*(*int8)(unsafe.Pointer(_myVersion))) {
		...
		if libc.Xstrcmp(tls, x_zlibVersion(tls), ts+339) != 0 {
			libc.Xfprintf(tls, libc.Xstderr, ts+764, libc.VaList(bp+16, x_zlibVersion(tls)))
		}
	}
	libc.Xprintf(tls, ts+808, libc.VaList(bp+16, ts+339, int32(m_ZLIB_VERNUM), x_zlibCompileFlags(tls)))
	...
	x_test_compress(tls, compr, *(*uint64)(unsafe.Pointer(bp)), uncompr, uncomprLen)
	if argc > int32(1) {
	...
	x_test_deflate(tls, compr, *(*uint64)(unsafe.Pointer(bp)))
	x_test_inflate(tls, compr, *(*uint64)(unsafe.Pointer(bp)), uncompr, uncomprLen)
	x_test_large_deflate(tls, compr, *(*uint64)(unsafe.Pointer(bp)), uncompr, uncomprLen)
	x_test_large_inflate(tls, compr, *(*uint64)(unsafe.Pointer(bp)), uncompr, uncomprLen)
	x_test_flush(tls, compr, bp)
	x_test_sync(tls, compr, *(*uint64)(unsafe.Pointer(bp)), uncompr, uncomprLen)
	*(*uint64)(unsafe.Pointer(bp)) = uint64(3) * uncomprLen
	x_test_dict_deflate(tls, compr, *(*uint64)(unsafe.Pointer(bp)))
	x_test_dict_inflate(tls, compr, *(*uint64)(unsafe.Pointer(bp)), uncompr, uncomprLen)
	libc.Xfree(tls, compr)
	libc.Xfree(tls, uncompr)
	return 0
}

var _myVersion = ts + 339
...
func x_inflateBackInit_(tls *libc.TLS, strm uintptr, windowBits int32, window uintptr, version uintptr, stream_size int32) (r int32) {
	var state uintptr
	if version == uintptr(m_Z_NULL) || int32(*(*int8)(unsafe.Pointer(version))) != int32(*(*int8)(unsafe.Pointer(ts + 339))) || stream_size != int32(libc.Uint64FromInt64(112)) {
		return -int32(6)
	}
...
func x_inflateBack(tls *libc.TLS, strm uintptr, in uintptr, in_desc uintptr, out uintptr, out_desc uintptr) (r int32) {
	...
	*(*uintptr)(unsafe.Pointer(bp)) = (*Tz_stream)(unsafe.Pointer(strm)).Fnext_in
	...
	_3:
		...
		case uint32(3):
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 879
	...
	_12: /* go to byte boundary */
		...
		if hold&uint64(0xffff) != hold>>int32(16)^uint64(0xffff) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 898
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
	...
	_5:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fnlen > uint32(286) || (*Tinflate_state)(unsafe.Pointer(state)).Fndist > uint32(30) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 927
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 963
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
				...
				*(*uint16)(unsafe.Pointer(state + 152 + uintptr(v23)*2)) = here.Fval
				...
				if int32(here.Fval) == int32(16) {
					...
					if (*Tinflate_state)(unsafe.Pointer(state)).Fhave == uint32(0) {
						(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 988
						(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
						break
					}
		...
		if int32(*(*uint16)(unsafe.Pointer(state + 152 + 256*2))) == 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 1014
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 1051
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 1079
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
	...
	_6:
		...
		if int32(here.Fop)&int32(64) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 1101
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
		...
		bits -= uint32(here.Fbits)
		if int32(here.Fop)&int32(64) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 1129
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Foffset > (*Tinflate_state)(unsafe.Pointer(state)).Fwsize-v42 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 1151
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _10
		}
...
func x_inflate(tls *libc.TLS, strm uintptr, flush int32) (r int32) {
	...
	_2:
		...
		if len1 > uint32(15) || len1 > (*Tinflate_state)(unsafe.Pointer(state)).Fwbits {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 1231
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
	...
	_39:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0xe000) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 1251
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		if (*Tinflate_state)(unsafe.Pointer(state)).Fhead != uintptr(m_Z_NULL) {
	...
	_10:
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0x0200) != 0 {
			...
			if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && hold != (*Tinflate_state)(unsafe.Pointer(state)).Fcheck&uint64(0xffff) {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 1276
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint64(0)
		...
		v55 = x_crc32(tls, uint64(0), uintptr(m_Z_NULL), uint32(0))
	...
	_12:
		...
		v58 = x_adler32(tls, uint64(0), uintptr(m_Z_NULL), uint32(0))
			...
			*(*uint64)(unsafe.Pointer(state + 40)) += uint64(out)
			if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && out != 0 {
				if (*Tinflate_state)(unsafe.Pointer(state)).Fflags != 0 {
					v95 = x_crc32(tls, (*Tinflate_state)(unsafe.Pointer(state)).Fcheck, put-uintptr(out), out)
				} else {
					v95 = x_adler32(tls, (*Tinflate_state)(unsafe.Pointer(state)).Fcheck, put-uintptr(out), out)
				}
				v94 = v95
			...
			if v97 && v96 != (*Tinflate_state)(unsafe.Pointer(state)).Fcheck {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 1296
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint64(0)
	...
	_29:
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 && (*Tinflate_state)(unsafe.Pointer(state)).Fflags != 0 {
			...
			if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && hold != (*Tinflate_state)(unsafe.Pointer(state)).Ftotal&uint64(0xffffffff) {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = ts + 1317
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint64(0)
...
inf_leave:
	...
	*(*uint64)(unsafe.Pointer(state + 40)) += uint64(out)
	if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && out != 0 {
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags != 0 {
			v100 = x_crc32(tls, (*Tinflate_state)(unsafe.Pointer(state)).Fcheck, (*Tz_stream)(unsafe.Pointer(strm)).Fnext_out-uintptr(out), out)
		} else {
			v100 = x_adler32(tls, (*Tinflate_state)(unsafe.Pointer(state)).Fcheck, (*Tz_stream)(unsafe.Pointer(strm)).Fnext_out-uintptr(out), out)
		}
		v99 = v100
...
func x_compress2(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen uint64, level int32) (r int32) {
	...
	*(*uint64)(unsafe.Pointer(destLen)) = uint64(0)
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fopaque = libc.UintptrFromInt32(0)
	err = x_deflateInit_(tls, bp, level, ts+339, libc.Int32FromInt64(112))
	if err != m_Z_OK {
		return err
	}
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint64(1), ts+1457, libc.VaList(bp+8, path))
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r uintptr) {
	...
	libc.X__builtin_snprintf(tls, path, libc.Uint64FromInt32(7)+libc.Uint64FromInt32(3)*libc.Uint64FromInt64(4), ts+1460, libc.VaList(bp+8, fd))
...
func x_gz_error(tls *libc.TLS, state uintptr, err int32, msg uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint64(3), ts+1482, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, ts+1489, msg))
}
...
func _gz_look(tls *libc.TLS, state uintptr) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fsize == uint32(0) {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fin == libc.UintptrFromInt32(0) || (*Tgz_state)(unsafe.Pointer(state)).Fout == libc.UintptrFromInt32(0) {
			...
			x_gz_error(tls, state, -int32(4), ts+1468)
			return -int32(1)
		}
		...
		if x_inflateInit2_(tls, state+128, libc.Int32FromInt32(15)+libc.Int32FromInt32(16), ts+339, libc.Int32FromInt64(112)) != m_Z_OK { /* gunzip */
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
...
func x_gzread(tls *libc.TLS, file uintptr, buf uintptr, len1 uint32) (r int32) {
	...
	if int32(len1) < 0 {
		x_gz_error(tls, state, -int32(2), ts+1576)
		return -int32(1)
	}
...
func x_gzfread(tls *libc.TLS, buf uintptr, size uint64, nitems uint64, file uintptr) (r uint64) {
	...
	if size != 0 && len1/size != nitems {
		x_gz_error(tls, state, -int32(2), ts+1607)
		return uint64(0)
	}
...
func x_gzungetc(tls *libc.TLS, c int32, file uintptr) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave == (*Tgz_state)(unsafe.Pointer(state)).Fsize<<int32(1) {
		x_gz_error(tls, state, -int32(3), ts+1640)
		return -int32(1)
	}
...
func _gz_init(tls *libc.TLS, state uintptr) (r int32) {
	...
	if !((*Tgz_state)(unsafe.Pointer(state)).Fdirect != 0) {
		...
		ret = x_deflateInit2_(tls, strm, (*Tgz_state)(unsafe.Pointer(state)).Flevel, int32(m_Z_DEFLATED), libc.Int32FromInt32(m_MAX_WBITS)+libc.Int32FromInt32(16), int32(m_DEF_MEM_LEVEL), (*Tgz_state)(unsafe.Pointer(state)).Fstrategy, ts+339, libc.Int32FromInt64(112))
		if ret != m_Z_OK {
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
			x_gz_error(tls, state, -int32(4), ts+1468)
...
func _gz_comp(tls *libc.TLS, state uintptr, flush int32) (r int32) {
	...
	for cond := true; cond; cond = have != 0 {
		...
		if ret == -int32(2) {
			x_gz_error(tls, state, -int32(2), ts+1671)
			return -int32(1)
		}
		have -= (*Tz_stream)(unsafe.Pointer(strm)).Favail_out
	}
...
func x_gzwrite(tls *libc.TLS, file uintptr, buf uintptr, len1 uint32) (r int32) {
	...
	/* since an int is returned, make sure len fits in one, otherwise return
	   with an error (this avoids a flaw in the interface) */
	if int32(len1) < 0 {
		x_gz_error(tls, state, -int32(3), ts+1710)
		return 0
	}
...
func x_gzputs(tls *libc.TLS, file uintptr, s uintptr) (r int32) {
	...
	if int32(len1) < 0 || uint64(uint32(len1)) != len1 {
		x_gz_error(tls, state, -int32(2), ts+1747)
		return -int32(1)
	}
