...
func x_test_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong) {
	...
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts, libc.VaList(bp+120, __ccgo_ts+346, err))
		libc.Xexit(tls, int32(1))
	}
	...
	for (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_in != len1 && (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out < comprLen {
		...
		if err != m_Z_OK {
			libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts, libc.VaList(bp+120, __ccgo_ts+358, err))
			libc.Xexit(tls, int32(1))
		}
	}
	...
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts, libc.VaList(bp+120, __ccgo_ts+366, err))
		libc.Xexit(tls, int32(1))
	}
}
...
func x_test_inflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts, libc.VaList(bp+120, __ccgo_ts+377, err))
		libc.Xexit(tls, int32(1))
	}
	for (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out < uncomprLen && (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_in < comprLen {
		...
		if err != m_Z_OK {
			libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts, libc.VaList(bp+120, __ccgo_ts+389, err))
			libc.Xexit(tls, int32(1))
		}
	}
	err = x_inflateEnd(tls, bp)
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts, libc.VaList(bp+120, __ccgo_ts+397, err))
		libc.Xexit(tls, int32(1))
	}
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&_hello))) != 0 {
		...
		libc.Xprintf(tls, __ccgo_ts+421, libc.VaList(bp+120, uncompr))
	}
}
...
func x_test_large_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fnext_in = compr
	(*(*Tz_stream)(unsafe.Pointer(bp))).Favail_in = uint32(uint32(comprLen)) / uint32(2)
	err = x_deflate(tls, bp, m_Z_NO_FLUSH)
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts, libc.VaList(bp+120, __ccgo_ts+358, err))
		libc.Xexit(tls, int32(1))
...
func x_test_large_inflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	for {
		...
		if err != m_Z_OK {
			libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts, libc.VaList(bp+120, __ccgo_ts+492, err))
			libc.Xexit(tls, int32(1))
		}
		goto _1
	_1:
	...
	if (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out != uint64(2)*uncomprLen+comprLen/uint64(2) {
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+506, libc.VaList(bp+120, (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out))
		libc.Xexit(tls, int32(1))
	} else {
...
func x_test_sync(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts, libc.VaList(bp+120, __ccgo_ts+551, err))
		libc.Xexit(tls, int32(1))
	}
	...
	libc.Xprintf(tls, __ccgo_ts+597, libc.VaList(bp+120, uncompr))
}
...
func x_test_dict_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong) {
	...
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts, libc.VaList(bp+120, __ccgo_ts+625, err))
		libc.Xexit(tls, int32(1))
	}
...
func x_test_dict_inflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	for {
		...
		if err != m_Z_OK {
			libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts, libc.VaList(bp+120, __ccgo_ts+668, err))
			libc.Xexit(tls, int32(1))
		}
		goto _1
	_1:
	...
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&_hello))) != 0 {
		...
		libc.Xprintf(tls, __ccgo_ts+709, libc.VaList(bp+120, uncompr))
	}
}
...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	*(*TuLong)(unsafe.Pointer(bp)) = libc.Uint64FromInt32(10000) * libc.Uint64FromInt64(4) /* don't overflow on MSDOS */
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint64(1), __ccgo_ts+1447, libc.VaList(bp+8, path))
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, path, libc.Uint64FromInt32(7)+libc.Uint64FromInt32(3)*libc.Uint64FromInt64(4), __ccgo_ts+1450, libc.VaList(bp+8, fd))
...
func x_gz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint64(3), __ccgo_ts+1472, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, __ccgo_ts+1479, msg))
}
...
func _gz_look(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fsize == uint32(0) {
		...
		if x_inflateInit2_(tls, state+120, libc.Int32FromInt32(15)+libc.Int32FromInt32(16), __ccgo_ts+339, libc.Int32FromInt64(112)) != m_Z_OK { /* gunzip */
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
