...
func x_test_compress(tls *libc.TLS, compr uintptr, _comprLen TuLong, uncompr uintptr, _uncomprLen TuLong) {
	...
	*(*TuLong)(unsafe.Pointer(bp + 4)) = _uncomprLen
	...
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+16, ts+14, err))
		libc.Xexit(tls, int32(1))
	}
	libc.Xstrcpy(tls, uncompr, ts+23)
	err = x_uncompress(tls, uncompr, bp+4, compr, *(*TuLong)(unsafe.Pointer(bp)))
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+16, ts+31, err))
		libc.Xexit(tls, int32(1))
	}
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&_hello))) != 0 {
		...
		libc.Xprintf(tls, ts+58, libc.VaList(bp+16, uncompr))
	}
}
...
func x_test_gzio(tls *libc.TLS, fname uintptr, uncompr uintptr, uncomprLen TuLong) {
	...
	if pos != int64(6) || x_gztell(tls, file) != pos {
		libc.Xfprintf(tls, libc.Xstderr, ts+193, libc.VaList(bp+16, int32(pos), int32(x_gztell(tls, file))))
		libc.Xexit(tls, int32(1))
	}
...
func x_test_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong) {
	...
	err = x_deflateInit_(tls, bp, -int32(1), ts+339, libc.Int32FromInt64(56))
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+64, ts+343, err))
		libc.Xexit(tls, int32(1))
	}
	...
	for (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_in != len1 && (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out < comprLen {
		...
		if err != m_Z_OK {
			libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+64, ts+355, err))
			libc.Xexit(tls, int32(1))
		}
	}
	...
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+64, ts+363, err))
		libc.Xexit(tls, int32(1))
	}
}
...
func x_test_inflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	err = x_inflateInit_(tls, bp, ts+339, libc.Int32FromInt64(56))
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+64, ts+374, err))
		libc.Xexit(tls, int32(1))
	}
	for (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out < uncomprLen && (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_in < comprLen {
		...
		if err != m_Z_OK {
			libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+64, ts+386, err))
			libc.Xexit(tls, int32(1))
		}
	}
	err = x_inflateEnd(tls, bp)
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+64, ts+394, err))
		libc.Xexit(tls, int32(1))
	}
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&_hello))) != 0 {
		...
		libc.Xprintf(tls, ts+418, libc.VaList(bp+64, uncompr))
	}
}
...
func x_test_large_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fopaque = libc.UintptrFromInt32(0)
	err = x_deflateInit_(tls, bp, int32(m_Z_BEST_SPEED), ts+339, libc.Int32FromInt64(56))
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+64, ts+343, err))
		libc.Xexit(tls, int32(1))
	}
...
func x_test_large_inflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	for {
		...
		if err != m_Z_OK {
			libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+64, ts+489, err))
			libc.Xexit(tls, int32(1))
		}
		goto _1
	_1:
	...
	if (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out != uint32(2)*uncomprLen+uncomprLen/uint32(2) {
		libc.Xfprintf(tls, libc.Xstderr, ts+503, libc.VaList(bp+64, (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out))
		libc.Xexit(tls, int32(1))
	} else {
...
func x_test_sync(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+64, ts+548, err))
		libc.Xexit(tls, int32(1))
	}
	...
	libc.Xprintf(tls, ts+596, libc.VaList(bp+64, uncompr))
}
...
func x_test_dict_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong) {
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fopaque = libc.UintptrFromInt32(0)
	err = x_deflateInit_(tls, bp, int32(m_Z_BEST_COMPRESSION), ts+339, libc.Int32FromInt64(56))
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+64, ts+343, err))
		libc.Xexit(tls, int32(1))
	}
	...
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+64, ts+624, err))
		libc.Xexit(tls, int32(1))
	}
...
func x_test_dict_inflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	for {
		...
		if err != m_Z_OK {
			libc.Xfprintf(tls, libc.Xstderr, ts, libc.VaList(bp+64, ts+667, err))
			libc.Xexit(tls, int32(1))
		}
		goto _1
	_1:
	...
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&_hello))) != 0 {
		...
		libc.Xprintf(tls, ts+708, libc.VaList(bp+64, uncompr))
	}
}
...
func x_inflateBackInit_(tls *libc.TLS, strm Tz_streamp, windowBits int32, window uintptr, version uintptr, stream_size int32) (r int32) {
	var state uintptr
	_ = state
	if version == uintptr(m_Z_NULL) || int32(*(*int8)(unsafe.Pointer(version))) != int32(*(*int8)(unsafe.Pointer(ts + 339))) || stream_size != int32(libc.Uint32FromInt64(56)) {
		return -int32(6)
	}
...
func x_compress2(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen TuLong, level int32) (r int32) {
	...
	*(*TuLongf)(unsafe.Pointer(destLen)) = uint32(0)
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fopaque = libc.UintptrFromInt32(0)
	err = x_deflateInit_(tls, bp, level, ts+339, libc.Int32FromInt64(56))
	if err != m_Z_OK {
		return err
	}
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint32(1), ts+1457, libc.VaList(bp+8, path))
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, path, libc.Uint32FromInt32(7)+libc.Uint32FromInt32(3)*libc.Uint32FromInt64(4), ts+1460, libc.VaList(bp+8, fd))
...
func x_gz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint32(3), ts+1482, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, ts+1489, msg))
}
...
func _gz_look(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fsize == uint32(0) {
		...
		if x_inflateInit2_(tls, state+100, libc.Int32FromInt32(15)+libc.Int32FromInt32(16), ts+339, libc.Int32FromInt64(56)) != m_Z_OK { /* gunzip */
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
...
func _gz_init(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if !((*Tgz_state)(unsafe.Pointer(state)).Fdirect != 0) {
		...
		ret = x_deflateInit2_(tls, strm, (*Tgz_state)(unsafe.Pointer(state)).Flevel, int32(m_Z_DEFLATED), libc.Int32FromInt32(m_MAX_WBITS)+libc.Int32FromInt32(16), int32(m_DEF_MEM_LEVEL), (*Tgz_state)(unsafe.Pointer(state)).Fstrategy, ts+339, libc.Int32FromInt64(56))
		if ret != m_Z_OK {
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
			x_gz_error(tls, state, -int32(4), ts+1468)
