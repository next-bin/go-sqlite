// Code generated for windows/arm64 by 'generator.exe --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -DNDEBUG -extended-errors -I . -o example.go test\example.c adler32.o.go compress.o.go crc32.o.go deflate.o.go gzclose.o.go gzlib.o.go gzread.o.go gzwrite.o.go infback.o.go inffast.o.go inflate.o.go inftrees.o.go trees.o.go uncompr.o.go zutil.o.go', DO NOT EDIT.
...
func x_test_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong) {
	...
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts, libc.VaList(bp+96, __ccgo_ts+343, err))
		libc.Xexit(tls, int32(1))
	}
	...
	for (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_in != len1 && (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out < comprLen {
		...
		if err != m_Z_OK {
			libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts, libc.VaList(bp+96, __ccgo_ts+355, err))
			libc.Xexit(tls, int32(1))
		}
	}
	...
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts, libc.VaList(bp+96, __ccgo_ts+363, err))
		libc.Xexit(tls, int32(1))
	}
}
...
func x_test_inflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts, libc.VaList(bp+96, __ccgo_ts+374, err))
		libc.Xexit(tls, int32(1))
	}
	for (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out < uncomprLen && (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_in < comprLen {
		...
		if err != m_Z_OK {
			libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts, libc.VaList(bp+96, __ccgo_ts+386, err))
			libc.Xexit(tls, int32(1))
		}
	}
	err = x_inflateEnd(tls, bp)
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts, libc.VaList(bp+96, __ccgo_ts+394, err))
		libc.Xexit(tls, int32(1))
	}
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&_hello))) != 0 {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts+405, 0)
		libc.Xexit(tls, int32(1))
	} else {
		libc.Xprintf(tls, __ccgo_ts+418, libc.VaList(bp+96, uncompr))
	}
}
...
func x_test_large_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	if (*(*Tz_stream)(unsafe.Pointer(bp))).Favail_in != uint32(0) {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts+433, 0)
		libc.Xexit(tls, int32(1))
	}
	...
	err = x_deflate(tls, bp, int32(m_Z_FINISH))
	if err != int32(m_Z_STREAM_END) {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts+453, 0)
		libc.Xexit(tls, int32(1))
	}
	err = x_deflateEnd(tls, bp)
	if err != m_Z_OK {
...
func x_test_large_inflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	for {
		...
		if err != m_Z_OK {
			libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts, libc.VaList(bp+96, __ccgo_ts+489, err))
			libc.Xexit(tls, int32(1))
		}
		goto _1
	_1:
	...
	if (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out != uint32(2)*uncomprLen+uncomprLen/uint32(2) {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts+503, libc.VaList(bp+96, (*(*Tz_stream)(unsafe.Pointer(bp))).Ftotal_out))
		libc.Xexit(tls, int32(1))
	} else {
...
func x_test_sync(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts, libc.VaList(bp+96, __ccgo_ts+548, err))
		libc.Xexit(tls, int32(1))
	}
	err = x_inflate(tls, bp, int32(m_Z_FINISH))
	if err != int32(m_Z_STREAM_END) {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts+560, 0)
		libc.Xexit(tls, int32(1))
	}
	err = x_inflateEnd(tls, bp)
	if err != m_Z_OK {
	...
	libc.Xprintf(tls, __ccgo_ts+596, libc.VaList(bp+96, uncompr))
}
...
func x_test_dict_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong) {
	...
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts, libc.VaList(bp+96, __ccgo_ts+624, err))
		libc.Xexit(tls, int32(1))
	}
...
func x_test_dict_inflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	for {
		...
		if err == int32(m_Z_NEED_DICT) {
			if (*(*Tz_stream)(unsafe.Pointer(bp))).Fadler != _dictId {
				libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts+645, 0)
				libc.Xexit(tls, int32(1))
			}
			err = x_inflateSetDictionary(tls, bp, uintptr(unsafe.Pointer(&_dictionary)), uint32(libc.Int32FromInt64(6)))
		}
		if err != m_Z_OK {
			libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts, libc.VaList(bp+96, __ccgo_ts+667, err))
			libc.Xexit(tls, int32(1))
		}
		goto _1
	_1:
	...
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&_hello))) != 0 {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts+685, 0)
		libc.Xexit(tls, int32(1))
	} else {
		libc.Xprintf(tls, __ccgo_ts+708, libc.VaList(bp+96, uncompr))
	}
}
...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	*(*TuLong)(unsafe.Pointer(bp)) = uint32(3) * uncomprLen
	if int32(*(*int8)(unsafe.Pointer(x_zlibVersion(tls)))) != int32(*(*int8)(unsafe.Pointer(_myVersion))) {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts+737, 0)
		libc.Xexit(tls, int32(1))
	} else {
		if libc.Xstrcmp(tls, x_zlibVersion(tls), __ccgo_ts+339) != 0 {
			libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts+764, libc.VaList(bp+16, x_zlibVersion(tls)))
		}
	}
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	if fd == -int32(2) {
		...
		libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint64(1), __ccgo_ts+879, libc.VaList(bp+8, path))
	}
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fmode == int32(m_GZ_READ) {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fmode == int32(m_GZ_WRITE) {
			...
			v3 = int32(m__O_APPEND)
		}
		v1 = libc.Int32FromInt32(m__O_WRONLY) | libc.Int32FromInt32(m__O_CREAT) | v2 | v3
	}
	oflag = int32(m__O_BINARY) | v1
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, path, libc.Uint64FromInt32(7)+libc.Uint64FromInt32(3)*libc.Uint64FromInt64(4), __ccgo_ts+882, libc.VaList(bp+8, fd))
...
func x_gz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint64(3), __ccgo_ts+905, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, __ccgo_ts+912, msg))
}
