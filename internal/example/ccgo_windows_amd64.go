// Code generated for windows/amd64 by 'gcc --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -extended-errors --package-name=main example64.o.go -o example64.go', DO NOT EDIT.
	...
	*(*TuLong)(unsafe.Pointer(bp)) = uint32(3) * uncomprLen
	if int32(*(*int8)(unsafe.Pointer(_zlibVersion(tls)))) != int32(*(*int8)(unsafe.Pointer(_myVersion))) {
		...
		if libc.Xstrcmp(tls, _zlibVersion(tls), __ccgo_ts+339) != 0 {
			libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts+764, libc.VaList(bp+16, _zlibVersion(tls)))
		}
	}
	libc.Xprintf(tls, __ccgo_ts+808, libc.VaList(bp+16, __ccgo_ts+339, int32(m_ZLIB_VERNUM), _zlibCompileFlags(tls)))
