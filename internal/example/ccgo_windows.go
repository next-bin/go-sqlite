// Code generated for windows/amd64 by 'x86_64-w64-mingw32-gcc --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -extended-errors -build-lines \/\/go:build windows && (amd64 || arm64)\n\/\/ \x2bbuild windows\n\/\/ \x2bbuild amd64 arm64 --cpp /usr/bin/x86_64-w64-mingw32-gcc --goarch amd64 --goos windows --package-name=main -map ar=x86_64-w64-mingw32-ar,gcc=x86_64-w64-mingw32-gcc -o example.exe.go example.o.go libz.a', DO NOT EDIT.
...
func x_test_compress(tls *libc.TLS, compr uintptr, _comprLen TuLong, uncompr uintptr, _uncomprLen TuLong) {
	bp := tls.Alloc(112)
	defer tls.Free(112)
	*(*TuLong)(unsafe.Pointer(bp + 104)) = _comprLen
	*(*TuLong)(unsafe.Pointer(bp + 108)) = _uncomprLen
	var __local_argv, __local_argv1 T__builtin_va_list
	var __retval, __retval1, err int32
	var len1 TuLong
	var v1, v3, v5, v7 uintptr
	_, _, _, _, _, _, _, _, _, _ = __local_argv, __local_argv1, __retval, __retval1, err, len1, v1, v3, v5, v7
	len1 = uint32(libc.Xstrlen(tls, uintptr(unsafe.Pointer(&_hello)))) + uint32(1)
	err = x_compress(tls, compr, bp+104, uintptr(unsafe.Pointer(&_hello)), len1)
	if err != m_Z_OK {
		v1 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+14, err)
		__local_argv = bp
	...
	err = x_uncompress(tls, uncompr, bp+108, compr, *(*TuLong)(unsafe.Pointer(bp + 104)))
	if err != m_Z_OK {
		v3 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+31, err)
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v3, __local_argv)
		_ = __local_argv
		_ = __retval
		goto _4
	_4:
	...
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&_hello))) != 0 {
		v5 = __ccgo_ts + 42
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v5, __local_argv)
		_ = __local_argv
		_ = __retval
		goto _6
	_6:
		...
		v7 = __ccgo_ts + 58
		libc.VaList(bp, uncompr)
		__local_argv1 = bp
		__retval1 = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(1)), v7, __local_argv1)
		_ = __local_argv1
		_ = __retval1
		goto _8
	_8:
...
func x_test_gzio(tls *libc.TLS, fname uintptr, uncompr uintptr, uncomprLen TuLong) {
	...
	defer tls.Free(304)
	var __local_argv, __local_argv1 T__builtin_va_list
	var __retval, __retval1, len1, pos, v17 int32
	var file TgzFile
	var v1, v11, v13, v15, v18, v19, v20, v22, v24, v26, v28, v3, v5, v7, v9 uintptr
	var _ /* err at bp+280 */ int32
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = __local_argv, __local_argv1, __retval, __retval1, file, len1, pos, v1, v11, v13, v15, v17, v18, v19, v20, v22, v24, v26, v28, v3, v5, v7, v9
	...
	if x_gzputs(tls, file, __ccgo_ts+93) != int32(4) {
		v3 = __ccgo_ts + 98
		libc.VaList(bp, x_gzerror(tls, file, bp+280))
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v3, __local_argv)
		_ = __local_argv
		_ = __retval
	...
	if x_gzprintf(tls, file, __ccgo_ts+114, libc.VaList(bp+296, __ccgo_ts+120)) != int32(8) {
		v5 = __ccgo_ts + 126
		libc.VaList(bp, x_gzerror(tls, file, bp+280))
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v5, __local_argv)
	...
	if file == libc.UintptrFromInt32(0) {
		v7 = __ccgo_ts + 79
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v7, __local_argv)
		_ = __local_argv
		_ = __retval
		goto _8
	_8:
	...
	if x_gzread(tls, file, uncompr, uint32(uint32(uncomprLen))) != len1 {
		...
		libc.VaList(bp, x_gzerror(tls, file, bp+280))
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v9, __local_argv)
		_ = __local_argv
		_ = __retval
		goto _10
	_10:
	...
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&_hello))) != 0 {
		...
		libc.VaList(bp, uncompr)
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v11, __local_argv)
		_ = __local_argv
		_ = __retval
		goto _12
	_12:
		...
		libc.VaList(bp, uncompr)
		__local_argv1 = bp
		__retval1 = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(1)), v13, __local_argv1)
		_ = __local_argv1
		_ = __retval1
		goto _14
	_14:
	...
	if pos != int32(6) || x_gztell(tls, file) != pos {
		v15 = __ccgo_ts + 193
		libc.VaList(bp, pos, x_gztell(tls, file))
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v15, __local_argv)
		_ = __local_argv
		_ = __retval
		goto _16
	_16:
	...
	if (*TgzFile_s)(unsafe.Pointer(file)).Fhave != 0 {
		...
		*(*uintptr)(unsafe.Pointer(v19))++
		...
		v17 = x_gzgetc(tls, file)
	}
	if v17 != int32(' ') {
		v20 = __ccgo_ts + 228
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v20, __local_argv)
		_ = __local_argv
		_ = __retval
		goto _21
	_21:
	...
	if x_gzungetc(tls, int32(' '), file) != int32(' ') {
		v22 = __ccgo_ts + 242
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v22, __local_argv)
		_ = __local_argv
		_ = __retval
		goto _23
	_23:
	...
	if libc.Xstrlen(tls, uncompr) != uint64(7) { /* " hello!" */
		...
		libc.VaList(bp, x_gzerror(tls, file, bp+280))
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v24, __local_argv)
		_ = __local_argv
		_ = __retval
		goto _25
	_25:
	...
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&_hello))+uintptr(6)) != 0 {
		v26 = __ccgo_ts + 287
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v26, __local_argv)
		_ = __local_argv
		_ = __retval
		goto _27
	_27:
		...
		libc.VaList(bp, uncompr)
		__local_argv1 = bp
		__retval1 = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(1)), v28, __local_argv1)
		_ = __local_argv1
		_ = __retval1
		goto _29
	_29:
...
func x_test_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong) {
	...
	defer tls.Free(224)
	var __local_argv T__builtin_va_list
	var __retval, err int32
	var len1 TuLong
	var v1, v4, v7, v9 uintptr
	var v3 TuInt
	var _ /* c_stream at bp+128 */ Tz_stream
	_, _, _, _, _, _, _, _, _ = __local_argv, __retval, err, len1, v1, v3, v4, v7, v9
	len1 = uint32(libc.Xstrlen(tls, uintptr(unsafe.Pointer(&_hello)))) + uint32(1)
	(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Fzalloc = _zalloc
	(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Fopaque = libc.UintptrFromInt32(0)
	err = x_deflateInit_(tls, bp+128, -int32(1), __ccgo_ts+339, libc.Int32FromInt64(88))
	if err != m_Z_OK {
		v1 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+343, err)
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v1, __local_argv)
		_ = __local_argv
		_ = __retval
	...
	(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Fnext_in = uintptr(unsafe.Pointer(&_hello))
	(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Fnext_out = compr
	for (*(*Tz_stream)(unsafe.Pointer(bp + 128))).Ftotal_in != len1 && (*(*Tz_stream)(unsafe.Pointer(bp + 128))).Ftotal_out < comprLen {
		v3 = libc.Uint32FromInt32(1)
		(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Favail_out = v3
		(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Favail_in = v3 /* force small buffers */
		err = x_deflate(tls, bp+128, m_Z_NO_FLUSH)
		if err != m_Z_OK {
			v4 = __ccgo_ts
			libc.VaList(bp, __ccgo_ts+355, err)
			__local_argv = bp
	...
	for {
		(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Favail_out = uint32(1)
		err = x_deflate(tls, bp+128, int32(m_Z_FINISH))
	...
	err = x_deflateEnd(tls, bp+128)
	if err != m_Z_OK {
		v9 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+363, err)
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v9, __local_argv)
		_ = __local_argv
		_ = __retval
...
func x_test_inflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	var __local_argv, __local_argv1 T__builtin_va_list
	var __retval, __retval1, err int32
	var v1, v10, v4, v6, v8 uintptr
	var v3 TuInt
	var _ /* d_stream at bp+136 */ Tz_stream
	_, _, _, _, _, _, _, _, _, _, _ = __local_argv, __local_argv1, __retval, __retval1, err, v1, v10, v3, v4, v6, v8 /* decompression stream */
	libc.Xstrcpy(tls, uncompr, __ccgo_ts+23)
	(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Fzalloc = _zalloc
	(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Fopaque = libc.UintptrFromInt32(0)
	(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Fnext_in = compr
	(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Favail_in = uint32(0)
	(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Fnext_out = uncompr
	err = x_inflateInit_(tls, bp+136, __ccgo_ts+339, libc.Int32FromInt64(88))
	if err != m_Z_OK {
		v1 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+374, err)
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v1, __local_argv)
		_ = __local_argv
		_ = __retval
	...
	for (*(*Tz_stream)(unsafe.Pointer(bp + 136))).Ftotal_out < uncomprLen && (*(*Tz_stream)(unsafe.Pointer(bp + 136))).Ftotal_in < comprLen {
		v3 = libc.Uint32FromInt32(1)
		(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Favail_out = v3
		(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Favail_in = v3 /* force small buffers */
		err = x_inflate(tls, bp+136, m_Z_NO_FLUSH)
		if err == int32(m_Z_STREAM_END) {
			break
		}
		if err != m_Z_OK {
			v4 = __ccgo_ts
			libc.VaList(bp, __ccgo_ts+386, err)
			__local_argv = bp
			__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v4, __local_argv)
			_ = __local_argv
			_ = __retval
	...
	err = x_inflateEnd(tls, bp+136)
	if err != m_Z_OK {
		v6 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+394, err)
		__local_argv = bp
	...
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&_hello))) != 0 {
		v8 = __ccgo_ts + 405
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v8, __local_argv)
		_ = __local_argv
		_ = __retval
		goto _9
	_9:
...
func x_test_large_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	var __local_argv T__builtin_va_list
	var __retval, err int32
	var v1, v11, v13, v3, v5, v7, v9 uintptr
	var _ /* c_stream at bp+192 */ Tz_stream
	_, _, _, _, _, _, _, _, _, _ = __local_argv, __retval, err, v1, v11, v13, v3, v5, v7, v9
	(*(*Tz_stream)(unsafe.Pointer(bp + 192))).Fzalloc = _zalloc
	(*(*Tz_stream)(unsafe.Pointer(bp + 192))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp + 192))).Fopaque = libc.UintptrFromInt32(0)
	err = x_deflateInit_(tls, bp+192, int32(m_Z_BEST_SPEED), __ccgo_ts+339, libc.Int32FromInt64(88))
	if err != m_Z_OK {
		v1 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+343, err)
		__local_argv = bp
	...
	(*(*Tz_stream)(unsafe.Pointer(bp + 192))).Fnext_out = compr
	(*(*Tz_stream)(unsafe.Pointer(bp + 192))).Favail_out = uint32(uint32(comprLen))
	/* At this point, uncompr is still mostly zeroes, so it should compress
	 * very well:
	 */
	(*(*Tz_stream)(unsafe.Pointer(bp + 192))).Fnext_in = uncompr
	(*(*Tz_stream)(unsafe.Pointer(bp + 192))).Favail_in = uint32(uint32(uncomprLen))
	err = x_deflate(tls, bp+192, m_Z_NO_FLUSH)
	if err != m_Z_OK {
		v3 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+355, err)
		__local_argv = bp
	...
	if (*(*Tz_stream)(unsafe.Pointer(bp + 192))).Favail_in != uint32(0) {
		v5 = __ccgo_ts + 433
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v5, __local_argv)
		_ = __local_argv
	...
	x_deflateParams(tls, bp+192, m_Z_NO_COMPRESSION, m_Z_DEFAULT_STRATEGY)
	(*(*Tz_stream)(unsafe.Pointer(bp + 192))).Fnext_in = compr
	(*(*Tz_stream)(unsafe.Pointer(bp + 192))).Favail_in = uint32(uint32(uncomprLen)) / uint32(2)
	err = x_deflate(tls, bp+192, m_Z_NO_FLUSH)
	if err != m_Z_OK {
		v7 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+355, err)
	...
	x_deflateParams(tls, bp+192, int32(m_Z_BEST_COMPRESSION), int32(m_Z_FILTERED))
	(*(*Tz_stream)(unsafe.Pointer(bp + 192))).Fnext_in = uncompr
	(*(*Tz_stream)(unsafe.Pointer(bp + 192))).Favail_in = uint32(uint32(uncomprLen))
	err = x_deflate(tls, bp+192, m_Z_NO_FLUSH)
	if err != m_Z_OK {
	...
	err = x_deflate(tls, bp+192, int32(m_Z_FINISH))
	if err != int32(m_Z_STREAM_END) {
		v11 = __ccgo_ts + 453
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v11, __local_argv)
	...
	err = x_deflateEnd(tls, bp+192)
	if err != m_Z_OK {
		v13 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+363, err)
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v13, __local_argv)
		_ = __local_argv
		_ = __retval
		goto _14
	_14:
...
func x_test_large_inflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	var v1, v10, v4, v6, v8 uintptr
	var _ /* d_stream at bp+136 */ Tz_stream
	_, _, _, _, _, _, _, _, _, _ = __local_argv, __local_argv1, __retval, __retval1, err, v1, v10, v4, v6, v8 /* decompression stream */
	libc.Xstrcpy(tls, uncompr, __ccgo_ts+23)
	(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Fzalloc = _zalloc
	(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Fopaque = libc.UintptrFromInt32(0)
	(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Fnext_in = compr
	(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Favail_in = uint32(uint32(comprLen))
	err = x_inflateInit_(tls, bp+136, __ccgo_ts+339, libc.Int32FromInt64(88))
	if err != m_Z_OK {
		v1 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+374, err)
	...
	for {
		(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Fnext_out = uncompr /* discard the output */
		(*(*Tz_stream)(unsafe.Pointer(bp + 136))).Favail_out = uint32(uint32(uncomprLen))
		err = x_inflate(tls, bp+136, m_Z_NO_FLUSH)
		if err == int32(m_Z_STREAM_END) {
			break
		}
		if err != m_Z_OK {
			v4 = __ccgo_ts
			libc.VaList(bp, __ccgo_ts+489, err)
			__local_argv = bp
			__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v4, __local_argv)
			_ = __local_argv
			_ = __retval
	...
	if (*(*Tz_stream)(unsafe.Pointer(bp + 136))).Ftotal_out != uint32(2)*uncomprLen+uncomprLen/uint32(2) {
		v8 = __ccgo_ts + 503
		libc.VaList(bp, (*(*Tz_stream)(unsafe.Pointer(bp + 136))).Ftotal_out)
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v8, __local_argv)
		_ = __local_argv
		_ = __retval
...
func x_test_flush(tls *libc.TLS, compr uintptr, comprLen uintptr) {
	...
	var v1, v3, v5, v7 uintptr
	var _ /* c_stream at bp+128 */ Tz_stream
	_, _, _, _, _, _, _, _ = __local_argv, __retval, err, len1, v1, v3, v5, v7
	len1 = uint32(libc.Xstrlen(tls, uintptr(unsafe.Pointer(&_hello)))) + uint32(1)
	(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Fzalloc = _zalloc
	(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Fopaque = libc.UintptrFromInt32(0)
	...
	(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Fnext_in = uintptr(unsafe.Pointer(&_hello))
	(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Fnext_out = compr
	(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Favail_in = uint32(3)
	(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Favail_out = uint32(*(*TuLong)(unsafe.Pointer(comprLen)))
	err = x_deflate(tls, bp+128, int32(m_Z_FULL_FLUSH))
	if err != m_Z_OK {
		v3 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+355, err)
		__local_argv = bp
	...
	*(*TByte)(unsafe.Pointer(compr + 3))++ /* force an error in first compressed block */
	(*(*Tz_stream)(unsafe.Pointer(bp + 128))).Favail_in = len1 - uint32(3)
	err = x_deflate(tls, bp+128, int32(m_Z_FINISH))
	if err != int32(m_Z_STREAM_END) {
		if err != m_Z_OK {
			v5 = __ccgo_ts
	...
	*(*TuLong)(unsafe.Pointer(comprLen)) = (*(*Tz_stream)(unsafe.Pointer(bp + 128))).Ftotal_out
}
...
func x_test_sync(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	var __local_argv, __local_argv1 T__builtin_va_list
	var __retval, __retval1, err int32
	var v1, v11, v3, v5, v7, v9 uintptr
	var _ /* d_stream at bp+168 */ Tz_stream
	_, _, _, _, _, _, _, _, _, _, _ = __local_argv, __local_argv1, __retval, __retval1, err, v1, v11, v3, v5, v7, v9 /* decompression stream */
	libc.Xstrcpy(tls, uncompr, __ccgo_ts+23)
	(*(*Tz_stream)(unsafe.Pointer(bp + 168))).Fzalloc = _zalloc
	(*(*Tz_stream)(unsafe.Pointer(bp + 168))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp + 168))).Fopaque = libc.UintptrFromInt32(0)
	(*(*Tz_stream)(unsafe.Pointer(bp + 168))).Fnext_in = compr
	(*(*Tz_stream)(unsafe.Pointer(bp + 168))).Favail_in = uint32(2) /* just read the zlib header */
	err = x_inflateInit_(tls, bp+168, __ccgo_ts+339, libc.Int32FromInt64(88))
	if err != m_Z_OK {
		v1 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+374, err)
		__local_argv = bp
	...
	(*(*Tz_stream)(unsafe.Pointer(bp + 168))).Fnext_out = uncompr
	(*(*Tz_stream)(unsafe.Pointer(bp + 168))).Favail_out = uint32(uint32(uncomprLen))
	err = x_inflate(tls, bp+168, m_Z_NO_FLUSH)
	if err != m_Z_OK {
		v3 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+386, err)
		__local_argv = bp
	...
	(*(*Tz_stream)(unsafe.Pointer(bp + 168))).Favail_in = uint32(uint32(comprLen)) - uint32(2) /* read all compressed data */
	err = x_inflateSync(tls, bp+168)                                                           /* but skip the damaged part */
	if err != m_Z_OK {
		v5 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+548, err)
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v5, __local_argv)
		_ = __local_argv
		_ = __retval
	...
	err = x_inflate(tls, bp+168, int32(m_Z_FINISH))
	if err != int32(m_Z_STREAM_END) {
		v7 = __ccgo_ts + 560
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v7, __local_argv)
	...
	libc.VaList(bp, uncompr)
	__local_argv1 = bp
	__retval1 = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(1)), v11, __local_argv1)
	_ = __local_argv1
	_ = __retval1
	goto _12
_12:
...
func x_test_dict_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong) {
	...
	var __retval, err int32
	var v1, v3, v5, v7 uintptr
	var _ /* c_stream at bp+112 */ Tz_stream
	_, _, _, _, _, _, _ = __local_argv, __retval, err, v1, v3, v5, v7
	(*(*Tz_stream)(unsafe.Pointer(bp + 112))).Fzalloc = _zalloc
	(*(*Tz_stream)(unsafe.Pointer(bp + 112))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp + 112))).Fopaque = libc.UintptrFromInt32(0)
	err = x_deflateInit_(tls, bp+112, int32(m_Z_BEST_COMPRESSION), __ccgo_ts+339, libc.Int32FromInt64(88))
	if err != m_Z_OK {
		v1 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+343, err)
		__local_argv = bp
	...
	err = x_deflateSetDictionary(tls, bp+112, uintptr(unsafe.Pointer(&_dictionary)), uint32(libc.Int32FromInt64(6)))
	if err != m_Z_OK {
		v3 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+624, err)
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v3, __local_argv)
		_ = __local_argv
		_ = __retval
	...
	_dictId = (*(*Tz_stream)(unsafe.Pointer(bp + 112))).Fadler
	(*(*Tz_stream)(unsafe.Pointer(bp + 112))).Fnext_out = compr
	(*(*Tz_stream)(unsafe.Pointer(bp + 112))).Favail_out = uint32(uint32(comprLen))
	(*(*Tz_stream)(unsafe.Pointer(bp + 112))).Fnext_in = uintptr(unsafe.Pointer(&_hello))
	(*(*Tz_stream)(unsafe.Pointer(bp + 112))).Favail_in = uint32(libc.Xstrlen(tls, uintptr(unsafe.Pointer(&_hello)))) + uint32(1)
	err = x_deflate(tls, bp+112, int32(m_Z_FINISH))
	if err != int32(m_Z_STREAM_END) {
		v5 = __ccgo_ts + 453
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v5, __local_argv)
...
func x_test_dict_inflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	var __local_argv, __local_argv1 T__builtin_va_list
	var __retval, __retval1, err int32
	var v1, v10, v12, v4, v6, v8 uintptr
	var _ /* d_stream at bp+152 */ Tz_stream
	_, _, _, _, _, _, _, _, _, _, _ = __local_argv, __local_argv1, __retval, __retval1, err, v1, v10, v12, v4, v6, v8 /* decompression stream */
	libc.Xstrcpy(tls, uncompr, __ccgo_ts+23)
	(*(*Tz_stream)(unsafe.Pointer(bp + 152))).Fzalloc = _zalloc
	(*(*Tz_stream)(unsafe.Pointer(bp + 152))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp + 152))).Fopaque = libc.UintptrFromInt32(0)
	(*(*Tz_stream)(unsafe.Pointer(bp + 152))).Fnext_in = compr
	(*(*Tz_stream)(unsafe.Pointer(bp + 152))).Favail_in = uint32(uint32(comprLen))
	err = x_inflateInit_(tls, bp+152, __ccgo_ts+339, libc.Int32FromInt64(88))
	if err != m_Z_OK {
		v1 = __ccgo_ts
		libc.VaList(bp, __ccgo_ts+374, err)
		__local_argv = bp
	...
	(*(*Tz_stream)(unsafe.Pointer(bp + 152))).Fnext_out = uncompr
	(*(*Tz_stream)(unsafe.Pointer(bp + 152))).Favail_out = uint32(uint32(uncomprLen))
	for {
		err = x_inflate(tls, bp+152, m_Z_NO_FLUSH)
		if err == int32(m_Z_STREAM_END) {
			break
		}
		if err == int32(m_Z_NEED_DICT) {
			if (*(*Tz_stream)(unsafe.Pointer(bp + 152))).Fadler != _dictId {
				v4 = __ccgo_ts + 645
				__local_argv = bp
				__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v4, __local_argv)
				_ = __local_argv
			...
			err = x_inflateSetDictionary(tls, bp+152, uintptr(unsafe.Pointer(&_dictionary)), uint32(libc.Int32FromInt64(6)))
		}
		if err != m_Z_OK {
			v6 = __ccgo_ts
			libc.VaList(bp, __ccgo_ts+667, err)
			__local_argv = bp
			__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v6, __local_argv)
			_ = __local_argv
			_ = __retval
	...
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&_hello))) != 0 {
		v10 = __ccgo_ts + 685
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v10, __local_argv)
		_ = __local_argv
		_ = __retval
		goto _11
	_11:
		...
		libc.VaList(bp, uncompr)
		__local_argv1 = bp
		__retval1 = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(1)), v12, __local_argv1)
		_ = __local_argv1
		_ = __retval1
		goto _13
	_13:
...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	var compr, uncompr, v1, v3, v5, v7, v9 uintptr
	var uncomprLen TuLong
	var _ /* comprLen at bp+96 */ TuLong
	_, _, _, _, _, _, _, _, _, _, _, _ = __local_argv, __local_argv1, __retval, __retval1, compr, uncompr, uncomprLen, v1, v3, v5, v7, v9
	uncomprLen = uint32(20000)
	*(*TuLong)(unsafe.Pointer(bp + 96)) = uint32(3) * uncomprLen
	...
	_2:
		...
		if libc.Xstrcmp(tls, x_zlibVersion(tls), __ccgo_ts+339) != 0 {
			v3 = __ccgo_ts + 764
			libc.VaList(bp, x_zlibVersion(tls))
			__local_argv = bp
			__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v3, __local_argv)
			_ = __local_argv
			_ = __retval
	...
	v5 = __ccgo_ts + 808
	libc.VaList(bp, __ccgo_ts+339, int32(m_ZLIB_VERNUM), x_zlibCompileFlags(tls))
	__local_argv1 = bp
	...
	goto _6
_6:
	compr = libc.Xcalloc(tls, uint64(uint32(*(*TuLong)(unsafe.Pointer(bp + 96)))), uint64(1))
	uncompr = libc.Xcalloc(tls, uint64(uint32(uint32(uncomprLen))), uint64(1))
	...
	x_test_compress(tls, compr, *(*TuLong)(unsafe.Pointer(bp + 96)), uncompr, uncomprLen)
	if argc > int32(1) {
		v9 = *(*uintptr)(unsafe.Pointer(argv + 1*8))
	} else {
		v9 = __ccgo_ts + 872
	}
	x_test_gzio(tls, v9, uncompr, uncomprLen)
	x_test_deflate(tls, compr, *(*TuLong)(unsafe.Pointer(bp + 96)))
	x_test_inflate(tls, compr, *(*TuLong)(unsafe.Pointer(bp + 96)), uncompr, uncomprLen)
	x_test_large_deflate(tls, compr, *(*TuLong)(unsafe.Pointer(bp + 96)), uncompr, uncomprLen)
	x_test_large_inflate(tls, compr, *(*TuLong)(unsafe.Pointer(bp + 96)), uncompr, uncomprLen)
	x_test_flush(tls, compr, bp+96)
	x_test_sync(tls, compr, *(*TuLong)(unsafe.Pointer(bp + 96)), uncompr, uncomprLen)
	*(*TuLong)(unsafe.Pointer(bp + 96)) = uint32(3) * uncomprLen
	x_test_dict_deflate(tls, compr, *(*TuLong)(unsafe.Pointer(bp + 96)))
	x_test_dict_inflate(tls, compr, *(*TuLong)(unsafe.Pointer(bp + 96)), uncompr, uncomprLen)
...
func _adler32_combine_(tls *libc.TLS, adler1 TuLong, adler2 TuLong, len2 int32) (r TuLong) {
	...
	sum2 = uint32(uint32(rem)) * sum1
	sum2 %= uint32(65521)
	sum1 += adler2&uint32(0xffff) + uint32(65521) - uint32(1)
	sum2 += adler1>>libc.Int32FromInt32(16)&uint32(0xffff) + adler2>>libc.Int32FromInt32(16)&uint32(0xffff) + uint32(65521) - uint32(uint32(rem))
...
//
//	/* ========================================================================= */
func x_adler32_combine(tls *libc.TLS, adler1 TuLong, adler2 TuLong, len2 int32) (r TuLong) {
...
func x_crc32_z(tls *libc.TLS, crc uint32, buf uintptr, len1 Tz_size_t) (r uint32) {
	...
	for len1 >= uint64(8) {
		...
		v7 = buf
		buf++
		crc = crc>>int32(8) ^ uint32(_crc_table[(crc^uint32(*(*uint8)(unsafe.Pointer(v7))))&uint32(0xff)])
		v8 = buf
		buf++
		crc = crc>>int32(8) ^ uint32(_crc_table[(crc^uint32(*(*uint8)(unsafe.Pointer(v8))))&uint32(0xff)])
		v9 = buf
		buf++
		crc = crc>>int32(8) ^ uint32(_crc_table[(crc^uint32(*(*uint8)(unsafe.Pointer(v9))))&uint32(0xff)])
		v10 = buf
		buf++
		crc = crc>>int32(8) ^ uint32(_crc_table[(crc^uint32(*(*uint8)(unsafe.Pointer(v10))))&uint32(0xff)])
		v11 = buf
		buf++
		crc = crc>>int32(8) ^ uint32(_crc_table[(crc^uint32(*(*uint8)(unsafe.Pointer(v11))))&uint32(0xff)])
		v12 = buf
		buf++
		crc = crc>>int32(8) ^ uint32(_crc_table[(crc^uint32(*(*uint8)(unsafe.Pointer(v12))))&uint32(0xff)])
		v13 = buf
		buf++
		crc = crc>>int32(8) ^ uint32(_crc_table[(crc^uint32(*(*uint8)(unsafe.Pointer(v13))))&uint32(0xff)])
	}
	for len1 != 0 {
		len1--
		v14 = buf
		buf++
		crc = crc>>int32(8) ^ uint32(_crc_table[(crc^uint32(*(*uint8)(unsafe.Pointer(v14))))&uint32(0xff)])
	}
...
//
//	/* ========================================================================= */
func x_crc32_combine64(tls *libc.TLS, crc1 TuLong, crc2 TuLong, len2 int32) (r TuLong) {
	return uint32(_multmodp(tls, _x2nmodp(tls, len2, uint32(3)), uint32(uint32(crc1)))) ^ crc2&uint32(0xffffffff)
}

// C documentation
//
//	/* ========================================================================= */
func x_crc32_combine(tls *libc.TLS, crc1 TuLong, crc2 TuLong, len2 int32) (r TuLong) {
...
//
//	/* ========================================================================= */
func x_crc32_combine_gen64(tls *libc.TLS, len2 int32) (r TuLong) {
	return uint32(_x2nmodp(tls, len2, uint32(3)))
}

// C documentation
//
//	/* ========================================================================= */
func x_crc32_combine_gen(tls *libc.TLS, len2 int32) (r TuLong) {
...
func x_crc32_combine_op(tls *libc.TLS, crc1 TuLong, crc2 TuLong, op TuLong) (r TuLong) {
	return uint32(_multmodp(tls, uint32(uint32(op)), uint32(uint32(crc1)))) ^ crc2&uint32(0xffffffff)
}
...
func _fill_window(tls *libc.TLS, s uintptr) {
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fhigh_water < (*Tdeflate_state)(unsafe.Pointer(s)).Fwindow_size {
		curr = uint32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart) + uint32((*Tdeflate_state)(unsafe.Pointer(s)).Flookahead)
...
func x_deflateInit2_(tls *libc.TLS, strm Tz_streamp, level int32, method int32, windowBits int32, memLevel int32, strategy int32, version uintptr, stream_size int32) (r int32) {
	...
	(*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf_size = uint32((*Tdeflate_state)(unsafe.Pointer(s)).Flit_bufsize) * uint32(4)
...
func x_deflateParams(tls *libc.TLS, strm Tz_streamp, level int32, strategy int32) (r int32) {
	...
	if (strategy != (*Tdeflate_state)(unsafe.Pointer(s)).Fstrategy || func1 != _configuration_table[level].Ffunc1) && (*Tdeflate_state)(unsafe.Pointer(s)).Flast_flush != -int32(2) {
		...
		if (*Tz_stream)(unsafe.Pointer(strm)).Favail_in != 0 || uint32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-uint32((*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start)+uint32((*Tdeflate_state)(unsafe.Pointer(s)).Flookahead) != 0 {
			return -int32(5)
		}
	}
	...
	case int32(2):
		...
		if (*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead != uintptr(m_Z_NULL) {
			if (*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fextra != uintptr(m_Z_NULL) {
				wraplen += uint32(uint32(2) + (*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fextra_len)
			}
...
func x_deflate(tls *libc.TLS, strm Tz_streamp, flush int32) (r int32) {
	...
	if (*Tz_stream)(unsafe.Pointer(strm)).Favail_in != uint32(0) || (*Tdeflate_state)(unsafe.Pointer(s)).Flookahead != uint32(0) || flush != m_Z_NO_FLUSH && (*Tdeflate_state)(unsafe.Pointer(s)).Fstatus != int32(m_FINISH_STATE) {
		...
		bstate = v63
		if int32(bstate) == _finish_started || int32(bstate) == _finish_done {
			(*Tdeflate_state)(unsafe.Pointer(s)).Fstatus = int32(m_FINISH_STATE)
		}
		if int32(bstate) == _need_more || int32(bstate) == _finish_started {
			if (*Tz_stream)(unsafe.Pointer(strm)).Favail_out == uint32(0) {
...
func _deflate_stored(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf_size-uint32(5) > uint32((*Tdeflate_state)(unsafe.Pointer(s)).Fw_size) {
		v1 = uint32((*Tdeflate_state)(unsafe.Pointer(s)).Fw_size)
	} else {
	...
	for cond := true; cond; cond = last == uint32(0) {
		...
		left = uint32(uint32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart) - uint32((*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start)) /* bytes left in window */
		if uint32(uint32(len1)) > uint32(uint32(left))+uint32((*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_in) {
		...
		last = uint32(v2)
		x__tr_stored_block(tls, s, libc.UintptrFromInt32(0), uint32(0), int32(int32(last)))
		/* Replace the lengths in the dummy stored block with len. */
		*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr((*Tdeflate_state)(unsafe.Pointer(s)).Fpending-uint32(4)))) = uint8(uint8(len1))
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf_size-uint32(uint32(have)) > uint32(libc.Int32FromInt32(m_MAX_STORED)) {
		v7 = uint32(libc.Int32FromInt32(m_MAX_STORED))
	} else {
		v7 = (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf_size - uint32(uint32(have))
	}
	have = uint32(v7)
	...
	min_block = v8
	left = uint32(uint32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart) - uint32((*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start))
...
func _deflate_fast(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
	...
	if flush == int32(m_Z_FINISH) {
		...
		x__tr_flush_block(tls, s, v22, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), int32(1))
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fsym_next != 0 {
		...
		x__tr_flush_block(tls, s, v23, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), 0)
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
			return _need_more
...
func _deflate_slow(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
		...
		if (*Tdeflate_state)(unsafe.Pointer(s)).Fprev_length >= uint32(m_MIN_MATCH) && (*Tdeflate_state)(unsafe.Pointer(s)).Fmatch_length <= (*Tdeflate_state)(unsafe.Pointer(s)).Fprev_length {
			...
			*(*TuInt)(unsafe.Pointer(s + 160)) -= uint32(2)
			...
			if bflush != 0 {
				...
				x__tr_flush_block(tls, s, v16, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), 0)
				(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
				_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
				if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
					return _need_more
	...
	if flush == int32(m_Z_FINISH) {
		...
		x__tr_flush_block(tls, s, v31, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), int32(1))
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
			return _finish_started
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fsym_next != 0 {
		...
		x__tr_flush_block(tls, s, v32, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), 0)
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
			return _need_more
...
func _deflate_rle(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
	...
	for {
		...
		if bflush != 0 {
			...
			x__tr_flush_block(tls, s, v36, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), 0)
			(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
			_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
			if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
				return _need_more
	...
	if flush == int32(m_Z_FINISH) {
		...
		x__tr_flush_block(tls, s, v37, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), int32(1))
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
			return _finish_started
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fsym_next != 0 {
		...
		x__tr_flush_block(tls, s, v38, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), 0)
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
			return _need_more
...
func _deflate_huff(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
	...
	for {
		...
		*(*Tush)(unsafe.Pointer(s + 188 + uintptr(cc)*4))++
		...
		if bflush != 0 {
			...
			x__tr_flush_block(tls, s, v8, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), 0)
			(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
			_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
			if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
				return _need_more
	...
	if flush == int32(m_Z_FINISH) {
		...
		x__tr_flush_block(tls, s, v9, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), int32(1))
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
			return _finish_started
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fsym_next != 0 {
		...
		x__tr_flush_block(tls, s, v10, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), 0)
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
			return _need_more
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fmode == int32(m_GZ_READ) {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fstart == int32(-int32(1)) {
...
//
//	/* -- see zlib.h -- */
func x_gzopen_w(tls *libc.TLS, path uintptr, mode uintptr) (r TgzFile) {
...
//
//	/* -- see zlib.h -- */
func x_gzoffset64(tls *libc.TLS, file TgzFile) (r int32) {
	var offset int32
	var state Tgz_statep
	_, _ = offset, state
	/* get internal structure and check integrity */
	...
	if offset == int32(-int32(1)) {
		return int32(-int32(1))
	}
	if (*Tgz_state)(unsafe.Pointer(state)).Fmode == int32(m_GZ_READ) { /* reading */
		offset = int32(uint32(offset) - uint32((*Tgz_state)(unsafe.Pointer(state)).Fstrm.Favail_in))
...
//
//	/* -- see zlib.h -- */
func x_gzoffset(tls *libc.TLS, file TgzFile) (r int32) {
	var ret, v1 int32
	_, _ = ret, v1
...
func x_gz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	v2 = __ccgo_ts + 905
	libc.VaList(bp, (*Tgz_state)(unsafe.Pointer(state)).Fpath, __ccgo_ts+912, msg)
	__local_argv = bp
...
func _gz_look(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fsize == uint32(0) {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fin == libc.UintptrFromInt32(0) || (*Tgz_state)(unsafe.Pointer(state)).Fout == libc.UintptrFromInt32(0) {
			...
			x_gz_error(tls, state, -int32(4), __ccgo_ts+890)
			return -int32(1)
		}
...
func _gz_decomp(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	for cond := true; cond; cond = (*Tz_stream)(unsafe.Pointer(strm)).Favail_out != 0 && ret != int32(m_Z_STREAM_END) {
		...
		if (*Tz_stream)(unsafe.Pointer(strm)).Favail_in == uint32(0) {
			x_gz_error(tls, state, -int32(5), __ccgo_ts+915)
			break
		}
		/* decompress and handle errors */
		ret = x_inflate(tls, strm, m_Z_NO_FLUSH)
		if ret == -int32(2) || ret == int32(m_Z_NEED_DICT) {
			x_gz_error(tls, state, -int32(2), __ccgo_ts+938)
			return -int32(1)
		}
		if ret == -int32(4) {
			x_gz_error(tls, state, -int32(4), __ccgo_ts+890)
...
func x_gzread(tls *libc.TLS, file TgzFile, buf Tvoidp, len1 uint32) (r int32) {
	...
	if int32(int32(len1)) < 0 {
		x_gz_error(tls, state, -int32(2), __ccgo_ts+999)
		return -int32(1)
	}
...
func x_gzfread(tls *libc.TLS, buf Tvoidp, size Tz_size_t, nitems Tz_size_t, file TgzFile) (r Tz_size_t) {
	...
	if size != 0 && len1/size != nitems {
		x_gz_error(tls, state, -int32(2), __ccgo_ts+1030)
		return uint64(0)
	}
...
func x_gzungetc(tls *libc.TLS, c int32, file TgzFile) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave == (*Tgz_state)(unsafe.Pointer(state)).Fsize<<int32(1) {
		x_gz_error(tls, state, -int32(3), __ccgo_ts+1063)
		return -int32(1)
	}
...
func x_gzgets(tls *libc.TLS, file TgzFile, buf uintptr, len1 int32) (r uintptr) {
	var eol, str, p2 uintptr
	var left, n, v1 uint32
	var state Tgz_statep
	_, _, _, _, _, _, _ = eol, left, n, state, str, v1, p2
...
func _gz_comp(tls *libc.TLS, state Tgz_statep, flush int32) (r int32) {
	...
	for cond := true; cond; cond = have != 0 {
		...
		if ret == -int32(2) {
			x_gz_error(tls, state, -int32(2), __ccgo_ts+1094)
			return -int32(1)
		}
		have -= (*Tz_stream)(unsafe.Pointer(strm)).Favail_out
	}
...
func x_gzwrite(tls *libc.TLS, file TgzFile, buf Tvoidpc, len1 uint32) (r int32) {
	...
	/* since an int is returned, make sure len fits in one, otherwise return
	   with an error (this avoids a flaw in the interface) */
	if int32(int32(len1)) < 0 {
		x_gz_error(tls, state, -int32(3), __ccgo_ts+1133)
		return 0
	}
...
func x_gzputs(tls *libc.TLS, file TgzFile, s uintptr) (r int32) {
	...
	if int32(int32(len1)) < 0 || uint64(uint32(uint32(len1))) != len1 {
		x_gz_error(tls, state, -int32(2), __ccgo_ts+1170)
		return -int32(1)
	}
	...
	*(*uintptr)(unsafe.Pointer(bp)) = (*Tz_stream)(unsafe.Pointer(strm)).Fnext_in
	...
	_12: /* go to byte boundary */
		...
		if hold&uint32(0xffff) != hold>>int32(16)^uint32(0xffff) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1223
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
			goto _10
		}
	...
	_5:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fnlen > uint32(286) || (*Tinflate_state)(unsafe.Pointer(state)).Fndist > uint32(30) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1252
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
			goto _10
		}
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1288
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
			goto _10
		}
				...
				*(*uint16)(unsafe.Pointer(state + 144 + uintptr(v24)*2)) = here.Fval
				...
				if int32(here.Fval) == int32(16) {
					...
					if (*Tinflate_state)(unsafe.Pointer(state)).Fhave == uint32(0) {
						(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1313
						(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
						break
					}
		...
		if int32(*(*uint16)(unsafe.Pointer(state + 144 + 256*2))) == 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1339
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
			goto _10
		}
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1376
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
			goto _10
		}
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1404
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
			goto _10
		}
	...
	_6:
		...
		if int32(here.Fop)&int32(64) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1426
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
			goto _10
		}
		...
		bits -= uint32(here.Fbits)
		if int32(here.Fop)&int32(64) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1454
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
			goto _10
		}
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Foffset > (*Tinflate_state)(unsafe.Pointer(state)).Fwsize-v43 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1476
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
			goto _10
		}
...
func x_inflate_fast(tls *libc.TLS, strm Tz_streamp, start uint32) {
	...
	for cond := true; cond; cond = in < last && out < end {
		...
		here = lcode + uintptr(hold&uint32(uint32(lmask)))*4
	dolen:
		...
		if op == uint32(0) { /* literal */
			...
			*(*uint8)(unsafe.Pointer(v3)) = uint8((*Tcode)(unsafe.Pointer(here)).Fval)
			...
			if op&uint32(16) != 0 { /* length base */
				...
				here = dcode + uintptr(hold&uint32(uint32(dmask)))*4
			dodist:
				op = uint32((*Tcode)(unsafe.Pointer(here)).Fbits)
				hold >>= uint32(uint32(op))
				bits -= op
...
func x_inflate(tls *libc.TLS, strm Tz_streamp, flush int32) (r int32) {
	...
	_2:
		...
		if len1 > uint32(15) || len1 > (*Tinflate_state)(unsafe.Pointer(state)).Fwbits {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1556
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
			goto _35
		}
	...
	_39:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0xe000) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1576
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
			goto _35
		}
		if (*Tinflate_state)(unsafe.Pointer(state)).Fhead != uintptr(m_Z_NULL) {
	...
	_10:
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0x0200) != 0 {
			...
			if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && hold != (*Tinflate_state)(unsafe.Pointer(state)).Fcheck&uint32(0xffff) {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1601
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
				goto _35
			}
			hold = uint32(0)
		...
		v56 = x_crc32(tls, uint32(0), uintptr(m_Z_NULL), uint32(0))
	...
	_12:
		...
		v59 = x_adler32(tls, uint32(0), uintptr(m_Z_NULL), uint32(0))
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 {
			...
			*(*uint32)(unsafe.Pointer(state + 36)) += uint32(uint32(out))
			...
			if v99 && v98 != (*Tinflate_state)(unsafe.Pointer(state)).Fcheck {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1621
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
				goto _35
			}
			hold = uint32(0)
	...
	_29:
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 && (*Tinflate_state)(unsafe.Pointer(state)).Fflags != 0 {
			...
			if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && hold != (*Tinflate_state)(unsafe.Pointer(state)).Ftotal&uint32(0xffffffff) {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1642
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = _BAD
				goto _35
			}
			hold = uint32(0)
...
func x_inflateMark(tls *libc.TLS, strm Tz_streamp) (r int32) {
	...
	return int32(uint32(int32(uint32(int32((*Tinflate_state)(unsafe.Pointer(state)).Fback))<<libc.Int32FromInt32(16))) + uint32(v1))
}
...
func x_inflate_table(tls *libc.TLS, type1 Tcodetype, lens uintptr, codes uint32, table uintptr, bits uintptr, work uintptr) (r int32) {
	...
	*/
	...
	if left > 0 && (int32(type1) == _CODES || max != uint32(1)) {
		return -int32(1)
	} /* incomplete set */
	...
	*/
	...
	if int32(type1) == _LENS && used > uint32(m_ENOUGH_LENS) || int32(type1) == _DISTS && used > uint32(m_ENOUGH_DISTS) {
		return int32(1)
	}
...
func x_uncompress2(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen uintptr) (r int32) {
	...
	for cond := true; cond; cond = err == m_Z_OK {
		...
		if (*(*Tz_stream)(unsafe.Pointer(bp))).Favail_in == uint32(0) {
			if len1 > uint32(uint32(max)) {
				v2 = max
			} else {
				v2 = uint32(uint32(len1))
			}
			(*(*Tz_stream)(unsafe.Pointer(bp))).Favail_in = v2
			len1 -= uint32((*(*Tz_stream)(unsafe.Pointer(bp))).Favail_in)
		}
	...
	*(*TuLong)(unsafe.Pointer(sourceLen)) -= len1 + uint32((*(*Tz_stream)(unsafe.Pointer(bp))).Favail_in)
	...
	if err == int32(m_Z_STREAM_END) {
		...
		if err == int32(m_Z_NEED_DICT) {
			...
			if err == -int32(5) && left+uint32((*(*Tz_stream)(unsafe.Pointer(bp))).Favail_out) != 0 {
				v5 = -int32(3)
			} else {
				v5 = err
			}
