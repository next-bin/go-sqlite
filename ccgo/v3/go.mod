module github.com/next-bin/go-sqlite/ccgo/v3
...
require (
	...
	github.com/next-bin/go-sqlite/cc/v3 v3.41.0
	github.com/next-bin/go-sqlite/ccgo/v4 v4.0.0-20230827202736-8661c3d9955b
	github.com/next-bin/go-sqlite/ccorpus v1.11.6
	github.com/next-bin/go-sqlite/libc v1.24.1
...
require (
	...
	github.com/next-bin/go-sqlite/cc/v4 v4.13.2 // indirect
	github.com/next-bin/go-sqlite/gc/v2 v2.3.0 // indirect
	github.com/next-bin/go-sqlite/httpfs v1.0.6 // indirect
	github.com/next-bin/go-sqlite/memory v1.7.0 // indirect
...
replace (
	...
	github.com/next-bin/go-sqlite/ccorpus => ../../ccorpus
	github.com/next-bin/go-sqlite/gc/v2 => ../../gc/v2
	github.com/next-bin/go-sqlite/httpfs => ../../httpfs
