...
To install or update ccgo and its accompanying tools
     ...
     $ go get [-u] github.com/next-bin/go-sqlite/ccgo/v2/...

Online documentation: [pkg.go.dev/github.com/next-bin/go-sqlite/ccgo/v2/ccgo](https://pkg.go.dev/github.com/next-bin/go-sqlite/ccgo/v2/ccgo)
