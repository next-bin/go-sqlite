// Code generated for windows/amd64 by 'generator --cpp /usr/bin/x86_64-w64-mingw32-gcc --goarch amd64 --goos windows -DNDEBUG -DSQLITE_OMIT_SEH -DSQLITE_OS_WIN=1 -I /tmp/libsqlite3/sqlite-src-3450200 -build-lines \/\/go:build windows && (amd64 || arm64)\n\/\/ \x2bbuild windows\n\/\/ \x2bbuild amd64 arm64 -map gcc=x86_64-w64-mingw32-gcc -o speedtest1/ccgo_windows.go /tmp/libsqlite3/sqlite-src-3450200/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func speedtest1_exec(tls *libc.TLS, zFormat uintptr, va uintptr) {
	...
	if g.bSqlOnly != 0 {
		...
		*(*uintptr)(unsafe.Pointer(bp + 24)) = uintptr(0)
		...
		if rc != SQLITE_OK {
			fatal_error(tls, __ccgo_ts+527, libc.VaList(bp+40, libsqlite3.Xsqlite3_errmsg(tls, g.db)))
		}
	}
...
func speedtest1_once(tls *libc.TLS, zFormat uintptr, va uintptr) (r uintptr) {
	...
	if g.bSqlOnly != 0 {
		...
		if rc != 0 {
			fatal_error(tls, __ccgo_ts+543, libc.VaList(bp+40, libsqlite3.Xsqlite3_errmsg(tls, g.db)))
		}
		if g.pScript != 0 {
																													...
																													if libc.Xstrcmp(tls, z, __ccgo_ts+19445) == 0 {
																														...
																														if libc.Xstrcmp(tls, z, __ccgo_ts+19456) == 0 {
																															...
																															if libc.Xstrcmp(tls, z, __ccgo_ts+19469) == 0 {
																																...
																																i++
																																v10 = i
																																g.pScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v10)*8)), __ccgo_ts+19356)
