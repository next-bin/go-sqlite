// Code generated for windows/amd64 by 'generator --cpp /usr/bin/x86_64-w64-mingw32-gcc --goarch amd64 --goos windows -DNDEBUG -DSQLITE_OMIT_SEH -DSQLITE_OS_WIN=1 -DSQLITE_ENABLE_RTREE -I /tmp/libsqlite3/sqlite-src-3500400 -build-lines \/\/go:build windows && (amd64 || arm64)\n\/\/ \x2bbuild windows\n\/\/ \x2bbuild amd64 arm64 -map gcc=x86_64-w64-mingw32-gcc -o speedtest1/ccgo_windows.go /tmp/libsqlite3/sqlite-src-3500400/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func speedtest1_run(tls *libc.TLS) {
	...
	if g.FbReprepare != 0 {
		libsqlite3.Xsqlite3_prepare_v2(tls, g.Fdb, libsqlite3.Xsqlite3_sql(tls, g.FpStmt), -int32(1), bp+112, uintptr(0))
		rc = libsqlite3.Xsqlite3_finalize(tls, g.FpStmt)
		if rc != SQLITE_OK {
			v1 = __ccgo_ts + 562
			libc.VaList(bp, libsqlite3.Xsqlite3_sql(tls, *(*uintptr)(unsafe.Pointer(bp + 112))), rc, libsqlite3.Xsqlite3_errmsg(tls, g.Fdb))
			__local_argv = bp
			__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v1, __local_argv)
			_ = __local_argv
			_ = __retval
		...
		g.FpStmt = *(*uintptr)(unsafe.Pointer(bp + 112))
	} else {
