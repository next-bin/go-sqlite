// Code generated for freebsd/arm64 by 'generator -DNDEBUG -DSQLITE_ENABLE_RTREE -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_freebsd_arm64.go -I /tmp/libsqlite3/sqlite-src-3500400 /tmp/libsqlite3/sqlite-src-3500400/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func integerValue(tls *libc.TLS, zArg uintptr) (r int32) {
	var i, isNeg, x, v1, v2 int32
	var v sqlite3_int64
	var v11 int64
	var v4 __ct_rune_t
	var v7 uint64
	var v8 uintptr
	_, _, _, _, _, _, _, _, _, _ = i, isNeg, v, x, v1, v11, v2, v4, v7, v8
	v = 0
	isNeg = 0
	...
	if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(zArg))) == int32('0') && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(zArg + 1))) == int32('x') {
		...
		for {
			v4 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(zArg)))
...
func printSql(tls *libc.TLS, zSql uintptr) {
	...
	for {
		if v10 = n > 0; v10 {
			if v9 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(zSql + uintptr(n-int32(1))))) == int32(';'); !v9 {
				v3 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(zSql + uintptr(n-int32(1)))))
...
func speedtest1_once(tls *libc.TLS, zFormat uintptr, va uintptr) (r uintptr) {
	...
	if g.FbSqlOnly != 0 {
		...
		if rc1 != SQLITE_OK {
			libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+562, libc.VaList(bp+16, libsqlite3.Xsqlite3_sql(tls, *(*uintptr)(unsafe.Pointer(bp))), rc1, libsqlite3.Xsqlite3_errmsg(tls, g.Fdb)))
			libc.Xexit(tls, int32(1))
		}
...
func speedtest1_run(tls *libc.TLS) {
	...
	if g.FbReprepare != 0 {
		...
		if rc != SQLITE_OK {
			libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+562, libc.VaList(bp+24, libsqlite3.Xsqlite3_sql(tls, *(*uintptr)(unsafe.Pointer(bp + 8))), rc, libsqlite3.Xsqlite3_errmsg(tls, g.Fdb)))
			libc.Xexit(tls, int32(1))
		}
		...
		if rc != SQLITE_OK {
			libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+562, libc.VaList(bp+24, libsqlite3.Xsqlite3_sql(tls, g.FpStmt), rc, libsqlite3.Xsqlite3_errmsg(tls, g.Fdb)))
			libc.Xexit(tls, int32(1))
		}
	}
	speedtest1_shrink_memory(tls)
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	for cond := true; cond; cond = *(*uint8)(unsafe.Pointer(zTSet)) != 0 {
		...
		if zSep != 0 {
			kk = int32(1)
			for {
				if v25 = *(*uint8)(unsafe.Pointer(zSep + uintptr(kk))) != 0; v25 {
					v19 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(zSep + uintptr(kk))))
					if v19 < 0 || v19 >= libc.X__mb_sb_limit {
						v22 = uint64(0)
					} else {
						if libc.X_ThreadRuneLocale != 0 {
							v15 = libc.X_ThreadRuneLocale
							goto _24
						}
						v15 = libc.X_CurrentRuneLocale
						goto _24
					_24:
						v22 = *(*uint64)(unsafe.Pointer(v15 + 64 + uintptr(v19)*8)) & uint64(0x00000400)
					}
					v3 = libc.Int32FromUint64(v22)
					goto _21
				_21:
					v2 = libc.BoolInt32(!!(v3 != 0))
					goto _18
				_18:
				}
				if !(v25 && v2 != 0) {
