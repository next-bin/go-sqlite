// Code generated for freebsd/arm64 by 'generator -DNDEBUG -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_freebsd_arm64.go -I /tmp/libsqlite3/sqlite-src-3500000 /tmp/libsqlite3/sqlite-src-3500000/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	var cacheSize, doAutovac, doExclusive, doFullFSync, doIncrvac, doPCache, doTrace, i, kk, memDb, mmapSize, mnHeap, nHardHeapLmt, nHeap, nLook, nPCache, nSoftHeapLmt, nThread, noSync, openFlags, pageSize, rc, showStats, szLook, szPCache, v10, v11, v12, v13, v14, v17, v2, v20, v3, v4, v5, v6, v7, v8, v9 int32
	var pHeap, pLook, pPCache, pVfs, z, zComma, zEncoding, zJMode, zKey, zObj, zSep, zSql, zTSet, zThisTest, v15, v23 uintptr
	var v19 __ct_rune_t
	var v22 uint64
	var v25 bool
																													...
																													if libc.Xstrcmp(tls, z, __ccgo_ts+35512) == 0 {
																														...
																														if libc.Xstrcmp(tls, z, __ccgo_ts+35523) == 0 {
																															...
																															if libc.Xstrcmp(tls, z, __ccgo_ts+35536) == 0 {
																																...
																																i++
																																v8 = i
																																g.FpScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v8)*8)), __ccgo_ts+35423)
