// Code generated for freebsd/arm64 by 'generator -DNDEBUG -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_freebsd_arm64.go -I /tmp/libsqlite3/sqlite-src-3510000 /tmp/libsqlite3/sqlite-src-3510000/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func xCompileOptions(tls *libc.TLS, pCtx uintptr, nVal int32, azVal uintptr, azCol uintptr) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	libc.Xprintf(tls, __ccgo_ts+35124, libc.VaList(bp+8, *(*uintptr)(unsafe.Pointer(azVal))))
	return SQLITE_OK
}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	zTSet = __ccgo_ts + 35147                                                                        /* Which --testset torun */
	...
	libc.Xprintf(tls, __ccgo_ts+35152, libc.VaList(bp+16, libsqlite3.Xsqlite3_libversion(tls), libsqlite3.Xsqlite3_sourceid(tls)))
	/* Process command-line arguments */
	g.FzDbName = uintptr(0)
	g.FzVfs = uintptr(0)
	g.FzWR = __ccgo_ts + 6
	g.FzNN = __ccgo_ts + 6
	g.FzPK = __ccgo_ts + 35187
	g.FszTest = int32(100)
	g.FszBase = int32(100)
	g.FnRepeat = int32(1)
	i = int32(1)
	for {
		...
		if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(z))) == int32('-') {
			...
			if libc.Xstrcmp(tls, z, __ccgo_ts+35194) == 0 {
				doAutovac = int32(1)
			} else {
				if libc.Xstrcmp(tls, z, __ccgo_ts+35205) == 0 {
					g.FdoBigTransactions = int32(1)
				} else {
					if libc.Xstrcmp(tls, z, __ccgo_ts+35222) == 0 {
						if i >= argc-int32(1) {
							fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
						}
						i = i + 1
						v2 = i
						cacheSize = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*8)))
					} else {
						if libc.Xstrcmp(tls, z, __ccgo_ts+35256) == 0 {
							doExclusive = int32(1)
						} else {
							if libc.Xstrcmp(tls, z, __ccgo_ts+35266) == 0 {
								doFullFSync = int32(1)
							} else {
								if libc.Xstrcmp(tls, z, __ccgo_ts+35276) == 0 {
									g.FdoCheckpoint = int32(1)
								} else {
									if libc.Xstrcmp(tls, z, __ccgo_ts+35287) == 0 {
										g.FbSqlOnly = int32(1)
										g.FbExplain = int32(1)
									} else {
										if libc.Xstrcmp(tls, z, __ccgo_ts+35295) == 0 {
											if i >= argc-int32(1) {
												fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
											}
											...
											if libc.Xstrcmp(tls, z, __ccgo_ts+35311) == 0 {
												if i >= argc-int32(2) {
													fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
												}
												...
												if libc.Xstrcmp(tls, z, __ccgo_ts+35316) == 0 {
													doIncrvac = int32(1)
												} else {
													if libc.Xstrcmp(tls, z, __ccgo_ts+35327) == 0 {
														if i >= argc-int32(1) {
															fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
														}
														i = i + 1
														...
														if libc.Xstrcmp(tls, z, __ccgo_ts+35335) == 0 {
															if i >= argc-int32(1) {
																fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
															}
															i = i + 1
															...
															if libc.Xstrcmp(tls, z, __ccgo_ts+35339) == 0 {
																if i >= argc-int32(2) {
																	fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																}
																...
																if libc.Xstrcmp(tls, z, __ccgo_ts+35349) == 0 {
																	memDb = int32(1)
																} else {
																	if libc.Xstrcmp(tls, z, __ccgo_ts+35355) == 0 {
																		libsqlite3.Xsqlite3_config(tls, int32(SQLITE_CONFIG_MULTITHREAD), 0)
																	} else {
																		if libc.Xstrcmp(tls, z, __ccgo_ts+35367) == 0 {
																			libsqlite3.Xsqlite3_config(tls, int32(SQLITE_CONFIG_MEMSTATUS), libc.VaList(bp+16, 0))
																		} else {
																			if libc.Xstrcmp(tls, z, __ccgo_ts+35377) == 0 {
																				if i >= argc-int32(1) {
																					fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																				}
																				i = i + 1
																				...
																				if libc.Xstrcmp(tls, z, __ccgo_ts+35382) == 0 {
																					openFlags = openFlags | int32(SQLITE_OPEN_NOMUTEX)
																				} else {
																					if libc.Xstrcmp(tls, z, __ccgo_ts+35390) == 0 {
																						noSync = int32(1)
																					} else {
																						if libc.Xstrcmp(tls, z, __ccgo_ts+35397) == 0 {
																							g.FzNN = __ccgo_ts + 35405
																						} else {
																							if libc.Xstrcmp(tls, z, __ccgo_ts+35414) == 0 {
																								if i >= argc-int32(1) {
																									fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																								}
																								i = i + 1
																								if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), __ccgo_ts+35421) == 0 {
																									g.FhashFile = libc.X__stdoutp
																								} else {
																									g.FhashFile = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), __ccgo_ts+35423)
																									if g.FhashFile == uintptr(0) {
																										fatal_error(tls, __ccgo_ts+35426, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																									}
																								}
																							} else {
																								if libc.Xstrcmp(tls, z, __ccgo_ts+35456) == 0 {
																									if i >= argc-int32(1) {
																										fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																									}
																									i = i + 1
																									...
																									if libc.Xstrcmp(tls, z, __ccgo_ts+35465) == 0 {
																										if i >= argc-int32(2) {
																											fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																										}
																										...
																										if libc.Xstrcmp(tls, z, __ccgo_ts+35472) == 0 {
																											g.FzPK = __ccgo_ts + 35483
																										} else {
																											if libc.Xstrcmp(tls, z, __ccgo_ts+35495) == 0 {
																												...
																												if libc.Xstrcmp(tls, z, __ccgo_ts+35502) == 0 {
																													g.FbReprepare = int32(1)
																												} else {
																													if libc.Xstrcmp(tls, z, __ccgo_ts+35512) == 0 {
																														libsqlite3.Xsqlite3_config(tls, int32(SQLITE_CONFIG_SERIALIZED), 0)
																													} else {
																														if libc.Xstrcmp(tls, z, __ccgo_ts+35523) == 0 {
																															libsqlite3.Xsqlite3_config(tls, int32(SQLITE_CONFIG_SINGLETHREAD), 0)
																														} else {
																															if libc.Xstrcmp(tls, z, __ccgo_ts+35536) == 0 {
																																if i >= argc-int32(1) {
																																	fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																																}
																																if g.FpScript != 0 {
																																...
																																i = i + 1
																																v2 = i
																																g.FpScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*8)), __ccgo_ts+35423)
																																if g.FpScript == uintptr(0) {
																																	fatal_error(tls, __ccgo_ts+35543, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																																}
																															} else {
																																if libc.Xstrcmp(tls, z, __ccgo_ts+35576) == 0 {
																																	g.FbSqlOnly = int32(1)
																																} else {
																																	if libc.Xstrcmp(tls, z, __ccgo_ts+35584) == 0 {
																																		g.FbMemShrink = int32(1)
																																	} else {
																																		if libc.Xstrcmp(tls, z, __ccgo_ts+35598) == 0 {
																																			if i >= argc-int32(1) {
																																				fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																																			}
																																			i = i + 1
																																			...
																																			if libc.Xstrcmp(tls, z, __ccgo_ts+35603) == 0 {
																																				if i >= argc-int32(1) {
																																					fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																																				}
																																				...
																																				if libc.Xstrcmp(tls, z, __ccgo_ts+35619) == 0 {
																																					showStats = int32(1)
																																				} else {
																																					if libc.Xstrcmp(tls, z, __ccgo_ts+35625) == 0 {
																																						if i >= argc-int32(1) {
																																							fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																																						}
																																						i = i + 1
																																						...
																																						if libc.Xstrcmp(tls, z, __ccgo_ts+35683) == 0 {
																																							...
																																							if libc.Xstrcmp(tls, z, __ccgo_ts+35691) == 0 {
																																								doTrace = int32(1)
																																							} else {
																																								if libc.Xstrcmp(tls, z, __ccgo_ts+35697) == 0 {
																																									if i >= argc-int32(1) {
																																										fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																																									}
																																									i = i + 1
																																									...
																																									if libc.Xstrcmp(tls, z, __ccgo_ts+35705) == 0 {
																																										zEncoding = __ccgo_ts + 35705
																																									} else {
																																										if libc.Xstrcmp(tls, z, __ccgo_ts+35713) == 0 {
																																											zEncoding = __ccgo_ts + 35713
																																										} else {
																																											if libc.Xstrcmp(tls, z, __ccgo_ts+35721) == 0 {
																																												g.FbVerify = int32(1)
																																												HashInit(tls)
																																											} else {
																																												if libc.Xstrcmp(tls, z, __ccgo_ts+35728) == 0 {
																																													if i >= argc-int32(1) {
																																														fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																																													}
																																													i = i + 1
																																													...
																																													if libc.Xstrcmp(tls, z, __ccgo_ts+35732) == 0 {
																																														if i >= argc-int32(1) {
																																															fatal_error(tls, __ccgo_ts+35232, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																																														}
																																														i = i + 1
																																														...
																																														if libc.Xstrcmp(tls, z, __ccgo_ts+35740) == 0 {
																																															g.FstmtScanStatus = int32(1)
																																														} else {
																																															if libc.Xstrcmp(tls, z, __ccgo_ts+35755) == 0 {
																																																if libc.Xstrstr(tls, g.FzWR, __ccgo_ts+35769) != uintptr(0) {
																																																	/* no-op */
																																																} else {
																																																	if libc.Xstrstr(tls, g.FzWR, __ccgo_ts+35777) != uintptr(0) {
																																																		g.FzWR = __ccgo_ts + 35784
																																																	} else {
																																																...
																																																if libc.Xstrcmp(tls, z, __ccgo_ts+35805) == 0 {
																																																	if libc.Xstrstr(tls, g.FzWR, __ccgo_ts+35777) != uintptr(0) {
																																																		/* no-op */
																																																	} else {
																																																		if libc.Xstrstr(tls, g.FzWR, __ccgo_ts+35769) != uintptr(0) {
																																																			...
																																																			g.FzWR = __ccgo_ts + 35777
																																																		}
																																																	}
																																																} else {
																																																	if libc.Xstrcmp(tls, z, __ccgo_ts+35812) == 0 || libc.Xstrcmp(tls, z, __ccgo_ts+35817) == 0 {
																																																		libc.Xprintf(tls, uintptr(unsafe.Pointer(&zHelp)), libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv))))
																																																		libc.Xexit(tls, 0)
																																																	} else {
																																																		fatal_error(tls, __ccgo_ts+35819, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), *(*uintptr)(unsafe.Pointer(argv))))
																																																	}
																																																}
																																															}
																																														}
			...
			if g.FzDbName == uintptr(0) {
				...
				fatal_error(tls, __ccgo_ts+35860, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), *(*uintptr)(unsafe.Pointer(argv))))
			}
		}
		goto _1
	_1:
	...
	if nHeap > 0 {
		...
		if pHeap == uintptr(0) {
			fatal_error(tls, __ccgo_ts+35903, libc.VaList(bp+16, nHeap))
		}
		rc = libsqlite3.Xsqlite3_config(tls, int32(SQLITE_CONFIG_HEAP), libc.VaList(bp+16, pHeap, nHeap, mnHeap))
		if rc != 0 {
			fatal_error(tls, __ccgo_ts+35933, libc.VaList(bp+16, rc))
		}
	}
	if doPCache != 0 {
		if nPCache > 0 && szPCache > 0 {
			...
			if pPCache == uintptr(0) {
				fatal_error(tls, __ccgo_ts+35964, libc.VaList(bp+16, int64(nPCache)*int64(szPCache)))
			}
		}
		rc = libsqlite3.Xsqlite3_config(tls, int32(SQLITE_CONFIG_PAGECACHE), libc.VaList(bp+16, pPCache, szPCache, nPCache))
		if rc != 0 {
			fatal_error(tls, __ccgo_ts+35998, libc.VaList(bp+16, rc))
		}
	}
	if nLook >= 0 {
	...
	if nLook > 0 && szLook > 0 {
		...
		if rc != 0 {
			fatal_error(tls, __ccgo_ts+36040, libc.VaList(bp+16, rc))
		}
	}
	if g.FnReserve > 0 {
	...
	libsqlite3.Xsqlite3_create_function(tls, g.Fdb, __ccgo_ts+36076, 0, int32(SQLITE_UTF8), uintptr(0), __ccgo_fp(randomFunc), uintptr(0), uintptr(0))
	if doTrace != 0 {
		libsqlite3.Xsqlite3_trace(tls, g.Fdb, __ccgo_fp(traceCallback), uintptr(0))
	}
	if memDb > 0 {
		speedtest1_exec(tls, __ccgo_ts+36083, 0)
	}
	if mmapSize > 0 {
		speedtest1_exec(tls, __ccgo_ts+36108, libc.VaList(bp+16, mmapSize))
	}
	speedtest1_exec(tls, __ccgo_ts+36128, libc.VaList(bp+16, nThread))
	if zKey != 0 {
		speedtest1_exec(tls, __ccgo_ts+36146, libc.VaList(bp+16, zKey))
	}
	if zEncoding != 0 {
		speedtest1_exec(tls, __ccgo_ts+36163, libc.VaList(bp+16, zEncoding))
	}
	if doAutovac != 0 {
		speedtest1_exec(tls, __ccgo_ts+36182, 0)
	} else {
		if doIncrvac != 0 {
			speedtest1_exec(tls, __ccgo_ts+36206, 0)
		}
	}
	if pageSize != 0 {
		speedtest1_exec(tls, __ccgo_ts+36237, libc.VaList(bp+16, pageSize))
	}
	if cacheSize != 0 {
		speedtest1_exec(tls, __ccgo_ts+36257, libc.VaList(bp+16, cacheSize))
	}
	if noSync != 0 {
		speedtest1_exec(tls, __ccgo_ts+36278, 0)
	} else {
		if doFullFSync != 0 {
			speedtest1_exec(tls, __ccgo_ts+36301, 0)
		}
	}
	if doExclusive != 0 {
		speedtest1_exec(tls, __ccgo_ts+36321, 0)
	}
	if zJMode != 0 {
		speedtest1_exec(tls, __ccgo_ts+36351, libc.VaList(bp+16, zJMode))
	}
	if nHardHeapLmt > 0 {
		speedtest1_exec(tls, __ccgo_ts+36374, libc.VaList(bp+16, nHardHeapLmt))
	}
	if nSoftHeapLmt > 0 {
		speedtest1_exec(tls, __ccgo_ts+36400, libc.VaList(bp+16, nSoftHeapLmt))
	}
	if zJMode != 0 {
		speedtest1_exec(tls, __ccgo_ts+36351, libc.VaList(bp+16, zJMode))
	}
	if g.FbExplain != 0 {
		libc.Xprintf(tls, __ccgo_ts+36426, 0)
	}
	if libc.Xstrcmp(tls, zTSet, __ccgo_ts+35147) == 0 {
	...
	for cond := true; cond; cond = *(*uint8)(unsafe.Pointer(zTSet)) != 0 {
		...
		if zSep != 0 {
			...
			if kk == int32(1) || libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(zSep + uintptr(kk)))) != 0 {
				fatal_error(tls, __ccgo_ts+36445, libc.VaList(bp+16, zThisTest))
			}
		...
		if g.FiTotal > 0 || zComma == uintptr(0) {
			libc.Xprintf(tls, __ccgo_ts+36480, libc.VaList(bp+16, zThisTest))
		}
		if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+36507) == 0 {
			testset_main(tls)
		} else {
			if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+36512) == 0 {
				testset_debug1(tls)
			} else {
				if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+36519) == 0 {
					testset_orm(tls)
				} else {
					if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+36523) == 0 {
						testset_cte(tls)
					} else {
						if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+36527) == 0 {
							testset_star(tls)
						} else {
							if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+36532) == 0 {
								testset_app(tls)
							} else {
								if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+36536) == 0 {
									testset_fp(tls)
								} else {
									if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+36539) == 0 {
										testset_json(tls)
									} else {
										if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+36544) == 0 {
											testset_trigger(tls)
										} else {
											if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+36552) == 0 {
												testset_parsenumber(tls)
											} else {
												if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+36564) == 0 {
													fatal_error(tls, __ccgo_ts+36570, 0)
												} else {
													fatal_error(tls, __ccgo_ts+36633, libc.VaList(bp+16, zThisTest))
												}
											}
										}
									}
		...
		if *(*uint8)(unsafe.Pointer(zTSet)) != 0 {
			speedtest1_begin_test(tls, int32(999), __ccgo_ts+36702, 0)
			for int32(1) != 0 {
				zObj = speedtest1_once(tls, __ccgo_ts+36721, 0)
				if zObj == uintptr(0) {
					break
				}
				zSql = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+36791, libc.VaList(bp+16, zObj))
				speedtest1_exec(tls, zSql, 0)
				libsqlite3.Xsqlite3_free(tls, zSql)
				libsqlite3.Xsqlite3_free(tls, zObj)
			}
			for int32(1) != 0 {
				zObj = speedtest1_once(tls, __ccgo_ts+36812, 0)
				if zObj == uintptr(0) {
					break
				}
				zSql = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+36791, libc.VaList(bp+16, zObj))
	...
	if showStats != 0 {
		...
		libc.Xprintf(tls, __ccgo_ts+37292, libc.VaList(bp+16, *(*int32)(unsafe.Pointer(bp)), *(*int32)(unsafe.Pointer(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_MALLOC_COUNT), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+37337, libc.VaList(bp+16, *(*int32)(unsafe.Pointer(bp)), *(*int32)(unsafe.Pointer(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_PAGECACHE_OVERFLOW), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+37382, libc.VaList(bp+16, *(*int32)(unsafe.Pointer(bp)), *(*int32)(unsafe.Pointer(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_MALLOC_SIZE), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+37427, libc.VaList(bp+16, *(*int32)(unsafe.Pointer(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_PAGECACHE_SIZE), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+37469, libc.VaList(bp+16, *(*int32)(unsafe.Pointer(bp + 4))))
	}
	if g.FpScript != 0 {
		libc.Xfclose(tls, g.FpScript)
	}
