// Code generated for linux/arm by 'generator -DNDEBUG -ignore-unsupported-alignment -o speedtest1/ccgo_linux_arm.go -I /tmp/libsqlite3/sqlite-src-3450300 /tmp/libsqlite3/sqlite-src-3450300/test/speedtest1.c -lsqlite3', DO NOT EDIT.
																																		...
																																		if libc.Xstrcmp(tls, z, __ccgo_ts+19804) == 0 {
																																			...
																																			if libc.Xstrcmp(tls, z, __ccgo_ts+19809) == 0 {
																																				...
																																				if libc.Xstrcmp(tls, z, __ccgo_ts+19815) == 0 {
																																					...
																																					g.FeTemp = int32(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))) - int32('0')
																																				} else {
