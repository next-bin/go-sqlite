// Code generated for linux/arm by 'generator -DNDEBUG -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_linux_arm.go -I /tmp/libsqlite3/sqlite-src-3500000 /tmp/libsqlite3/sqlite-src-3500000/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func HashUpdate(tls *libc.TLS, aData uintptr, nData uint32) {
	...
	for {
		...
		j = uint8(int32(j) + (libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(i)))) + libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(aData + uintptr(k))))))
...
func HashFinal(tls *libc.TLS) {
	...
	for {
		...
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(j))) = t
		t = uint8(int32(t) + libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(i)))))
																													...
																													if libc.Xstrcmp(tls, z, __ccgo_ts+35785) == 0 {
																														...
																														if libc.Xstrcmp(tls, z, __ccgo_ts+35796) == 0 {
																															...
																															if libc.Xstrcmp(tls, z, __ccgo_ts+35809) == 0 {
																																...
																																i++
																																v8 = i
																																g.FpScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v8)*4)), __ccgo_ts+35696)
																																										...
																																										if libc.Xstrcmp(tls, z, __ccgo_ts+35986) == 0 {
																																											...
																																											if libc.Xstrcmp(tls, z, __ccgo_ts+35994) == 0 {
																																												...
																																												if libc.Xstrcmp(tls, z, __ccgo_ts+36001) == 0 {
																																													...
																																													i++
																																													v13 = i
																																													g.FzVfs = *(*uintptr)(unsafe.Pointer(argv + uintptr(v13)*4))
																																												} else {
