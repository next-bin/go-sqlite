// Code generated for linux/arm by 'generator -DNDEBUG -DSQLITE_ENABLE_RTREE -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_linux_arm.go -I /tmp/libsqlite3/sqlite-src-3500400 /tmp/libsqlite3/sqlite-src-3500400/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func speedtest1_run(tls *libc.TLS) {
	...
	if g.FbReprepare != 0 {
		...
		if rc != SQLITE_OK {
			libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+562, libc.VaList(bp+16, libsqlite3.Xsqlite3_sql(tls, *(*uintptr)(unsafe.Pointer(bp + 4))), rc, libsqlite3.Xsqlite3_errmsg(tls, g.Fdb)))
			libc.Xexit(tls, int32(1))
		}
		...
		if rc != SQLITE_OK {
			libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+562, libc.VaList(bp+16, libsqlite3.Xsqlite3_sql(tls, g.FpStmt), rc, libsqlite3.Xsqlite3_errmsg(tls, g.Fdb)))
			libc.Xexit(tls, int32(1))
		}
	}
	speedtest1_shrink_memory(tls)
