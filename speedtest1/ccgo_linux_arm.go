// Code generated for linux/arm by 'generator -DNDEBUG -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_linux_arm.go -I /tmp/libsqlite3/sqlite-src-3510000 /tmp/libsqlite3/sqlite-src-3510000/test/speedtest1.c -lsqlite3', DO NOT EDIT.
	...
	for {
		...
		if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(z))) == int32('-') {
			...
			if libc.Xstrcmp(tls, z, __ccgo_ts+35467) == 0 {
				...
				if libc.Xstrcmp(tls, z, __ccgo_ts+35478) == 0 {
					...
					if libc.Xstrcmp(tls, z, __ccgo_ts+35495) == 0 {
						if i >= argc-int32(1) {
							fatal_error(tls, __ccgo_ts+35505, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
						}
						i = i + 1
						v2 = i
																					...
																					if libc.Xstrcmp(tls, z, __ccgo_ts+35663) == 0 {
																						...
																						if libc.Xstrcmp(tls, z, __ccgo_ts+35670) == 0 {
																							...
																							if libc.Xstrcmp(tls, z, __ccgo_ts+35687) == 0 {
																								...
																								i = i + 1
																								if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), __ccgo_ts+35694) == 0 {
																									g.FhashFile = libc.Xstdout
																								} else {
																									g.FhashFile = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), __ccgo_ts+35696)
																									if g.FhashFile == uintptr(0) {
																										fatal_error(tls, __ccgo_ts+35699, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																									}
																								}
																							} else {
																													...
																													if libc.Xstrcmp(tls, z, __ccgo_ts+35785) == 0 {
																														...
																														if libc.Xstrcmp(tls, z, __ccgo_ts+35796) == 0 {
																															...
																															if libc.Xstrcmp(tls, z, __ccgo_ts+35809) == 0 {
																																...
																																i = i + 1
																																v2 = i
																																g.FpScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*4)), __ccgo_ts+35696)
																																if g.FpScript == uintptr(0) {
																																	fatal_error(tls, __ccgo_ts+35816, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																																}
																															} else {
																																															...
																																															if libc.Xstrcmp(tls, z, __ccgo_ts+36028) == 0 {
																																																...
																																																if libc.Xstrcmp(tls, z, __ccgo_ts+36078) == 0 {
																																																	...
																																																	if libc.Xstrcmp(tls, z, __ccgo_ts+36085) == 0 || libc.Xstrcmp(tls, z, __ccgo_ts+36090) == 0 {
																																																		...
																																																		fatal_error(tls, __ccgo_ts+36092, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), *(*uintptr)(unsafe.Pointer(argv))))
																																																	}
																																																}
																																															}
																																														}
			...
			if g.FzDbName == uintptr(0) {
				...
				fatal_error(tls, __ccgo_ts+36133, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), *(*uintptr)(unsafe.Pointer(argv))))
			}
		}
		goto _1
	_1:
