// Code generated for linux/riscv64 by 'generator -DNDEBUG -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_linux_riscv64.go -I /tmp/libsqlite3/sqlite-src-3510000 /tmp/libsqlite3/sqlite-src-3510000/test/speedtest1.c -lsqlite3', DO NOT EDIT.
																													...
																													if libc.Xstrcmp(tls, z, __ccgo_ts+35785) == 0 {
																														...
																														if libc.Xstrcmp(tls, z, __ccgo_ts+35796) == 0 {
																															...
																															if libc.Xstrcmp(tls, z, __ccgo_ts+35809) == 0 {
																																...
																																i = i + 1
																																v2 = i
																																g.FpScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*8)), __ccgo_ts+35696)
