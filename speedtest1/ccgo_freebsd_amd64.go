// Code generated for freebsd/amd64 by 'generator -ignore-unsupported-alignment -o speedtest1/ccgo_freebsd_amd64.go -I /tmp/libsqlite3/sqlite-src-3450100 /tmp/libsqlite3/sqlite-src-3450100/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func speedtest1_end_test(tls *libc.TLS) {
	...
	if !(iTestNumber > 0) {
		libc.X__assert(tls, uintptr(unsafe.Pointer(&__func__)), __ccgo_ts+377, int32(422), __ccgo_ts+430)
	}
	if g.pScript != 0 {
...
func speedtest1_run(tls *libc.TLS) {
	...
	if !(g.pStmt != 0) {
		libc.X__assert(tls, uintptr(unsafe.Pointer(&__func__1)), __ccgo_ts+377, int32(569), __ccgo_ts+631)
	}
	g.nResult = 0
	if g.pScript != 0 {
