// Code generated for freebsd/amd64 by 'generator -DNDEBUG -DSQLITE_ENABLE_RTREE -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_freebsd_amd64.go -I /tmp/libsqlite3/sqlite-src-3500400 /tmp/libsqlite3/sqlite-src-3500400/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func printSql(tls *libc.TLS, zSql uintptr) {
	...
	for {
		if v10 = n > 0; v10 {
			if v9 = int32(*(*int8)(unsafe.Pointer(zSql + uintptr(n-int32(1))))) == int32(';'); !v9 {
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	for cond := true; cond; cond = *(*int8)(unsafe.Pointer(zTSet)) != 0 {
		...
		if zSep != 0 {
			kk = int32(1)
			for {
				if v25 = *(*int8)(unsafe.Pointer(zSep + uintptr(kk))) != 0; v25 {
