// Code generated for linux/386 by 'generator -DNDEBUG -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_linux_386.go -I /tmp/libsqlite3/sqlite-src-3460100 /tmp/libsqlite3/sqlite-src-3460100/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func HashUpdate(tls *libc.TLS, aData uintptr, nData uint32) {
	...
	for {
		...
		j = uint8(int32(j) + (libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3116 + 3 + uintptr(i)))) + libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(aData + uintptr(k))))))
...
func HashFinal(tls *libc.TLS) {
	...
	for {
		...
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3116 + 3 + uintptr(j))) = t
		t = uint8(int32(t) + libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3116 + 3 + uintptr(i)))))
...
func speedtest1_final(tls *libc.TLS) {
	...
	if g.FbVerify != 0 {
		...
		for {
			...
			libc.Xprintf(tls, __ccgo_ts+459, libc.VaList(bp+8, libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3116 + 259 + uintptr(i))))))
			goto _1
		_1:
			;
			i++
		...
		for {
			...
			if libc.Uint32FromInt32(g.FnResult+len1) < libc.Uint32FromInt64(3000)-libc.Uint32FromInt32(2) {
				if g.FnResult > 0 {
					...
					*(*int8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 108 + uintptr(v3))) = int8(' ')
				}
				libc.Xmemcpy(tls, uintptr(unsafe.Pointer(&g))+108+uintptr(g.FnResult), z1, libc.Uint32FromInt32(len1+int32(1)))
				g.FnResult += len1
			}
			goto _1
		_1:
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	for {
		...
		if int32(*(*int8)(unsafe.Pointer(z))) == int32('-') {
			...
			if libc.Xstrcmp(tls, z, __ccgo_ts+19844) == 0 {
				...
				if libc.Xstrcmp(tls, z, __ccgo_ts+19855) == 0 {
					...
					if libc.Xstrcmp(tls, z, __ccgo_ts+19872) == 0 {
						if i >= argc-int32(1) {
							fatal_error(tls, __ccgo_ts+19882, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
						}
						i++
						v2 = i
																					...
																					if libc.Xstrcmp(tls, z, __ccgo_ts+20037) == 0 {
																						...
																						if libc.Xstrcmp(tls, z, __ccgo_ts+20044) == 0 {
																							...
																							if libc.Xstrcmp(tls, z, __ccgo_ts+20061) == 0 {
																								...
																								i++
																								if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), __ccgo_ts+20068) == 0 {
																									g.FhashFile = libc.Xstdout
																								} else {
																									g.FhashFile = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), __ccgo_ts+20070)
																									if g.FhashFile == uintptr(0) {
																										fatal_error(tls, __ccgo_ts+20073, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																									}
																								}
																							} else {
																													...
																													if libc.Xstrcmp(tls, z, __ccgo_ts+20159) == 0 {
																														...
																														if libc.Xstrcmp(tls, z, __ccgo_ts+20170) == 0 {
																															...
																															if libc.Xstrcmp(tls, z, __ccgo_ts+20183) == 0 {
																																...
																																i++
																																v8 = i
																																g.FpScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v8)*4)), __ccgo_ts+20070)
																																if g.FpScript == uintptr(0) {
																																	fatal_error(tls, __ccgo_ts+20190, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																																}
																															} else {
																																if libc.Xstrcmp(tls, z, __ccgo_ts+20223) == 0 {
																																	...
																																	if libc.Xstrcmp(tls, z, __ccgo_ts+20231) == 0 {
																																		...
																																		if libc.Xstrcmp(tls, z, __ccgo_ts+20245) == 0 {
																																			...
																																			i++
																																			v9 = i
																																			g.FszTest = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v9)*4)))
																																		} else {
																																										...
																																										if libc.Xstrcmp(tls, z, __ccgo_ts+20352) == 0 {
																																											...
																																											if libc.Xstrcmp(tls, z, __ccgo_ts+20359) == 0 {
																																												...
																																												if libc.Xstrcmp(tls, z, __ccgo_ts+20363) == 0 {
																																													...
																																													i++
																																													v13 = i
																																													g.FnReserve = libc.Xatoi(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v13)*4)))
																																												} else {
																																														...
																																														if libc.Xstrcmp(tls, z, __ccgo_ts+20386) == 0 {
																																															...
																																															if libc.Xstrcmp(tls, z, __ccgo_ts+20436) == 0 {
																																																...
																																																if libc.Xstrcmp(tls, z, __ccgo_ts+20443) == 0 || libc.Xstrcmp(tls, z, __ccgo_ts+20448) == 0 {
																																																	...
																																																	fatal_error(tls, __ccgo_ts+20450, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), *(*uintptr)(unsafe.Pointer(argv))))
																																																}
																																															}
																																														}
																																													}
			...
			if zDbName == uintptr(0) {
				...
				fatal_error(tls, __ccgo_ts+20491, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), *(*uintptr)(unsafe.Pointer(argv))))
			}
		}
		goto _1
	_1:
	...
	if g.FnReserve > 0 {
		libsqlite3.Xsqlite3_file_control(tls, g.Fdb, uintptr(0), int32(SQLITE_FCNTL_RESERVE_BYTES), uintptr(unsafe.Pointer(&g))+64)
	}
