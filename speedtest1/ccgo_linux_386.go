// Code generated for linux/386 by 'generator -DNDEBUG -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_linux_386.go -I /tmp/libsqlite3/sqlite-src-3490100 /tmp/libsqlite3/sqlite-src-3490100/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func HashInit(tls *libc.TLS) {
	...
	for {
		...
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3120 + 3 + uintptr(k))) = uint8(k)
		goto _1
	_1:
		;
		k++
...
func HashUpdate(tls *libc.TLS, aData uintptr, nData uint32) {
	...
	for {
		...
		j = uint8(int32(j) + (libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3120 + 3 + uintptr(i)))) + libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(aData + uintptr(k))))))
		t = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3120 + 3 + uintptr(j)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3120 + 3 + uintptr(j))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3120 + 3 + uintptr(i)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3120 + 3 + uintptr(i))) = t
		i++
		goto _1
	_1:
		;
...
func HashFinal(tls *libc.TLS) {
	...
	for {
		...
		i++
		t = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3120 + 3 + uintptr(i)))
		j = uint8(int32(j) + libc.Int32FromUint8(t))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3120 + 3 + uintptr(i))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3120 + 3 + uintptr(j)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3120 + 3 + uintptr(j))) = t
		t = uint8(int32(t) + libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3120 + 3 + uintptr(i)))))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3120 + 259 + uintptr(k))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3120 + 3 + uintptr(t)))
		goto _1
	_1:
		;
		k++
...
func speedtest1_final(tls *libc.TLS) {
	...
	if g.FbVerify != 0 {
		...
		for {
			...
			libc.Xprintf(tls, __ccgo_ts+459, libc.VaList(bp+8, libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3120 + 259 + uintptr(i))))))
			goto _1
		_1:
			;
			i++
	...
	for libsqlite3.Xsqlite3_step(tls, g.FpStmt) == int32(SQLITE_ROW) {
		...
		for {
			...
			if g.FbVerify != 0 {
				...
				(*(*[2]uint8)(unsafe.Pointer(bp)))[int32(1)] = libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(__ccgo_ts + 566 + uintptr(eType))))
				if g.FnResByte != 0 {
				...
				if eType == int32(SQLITE_FLOAT) {
					...
					if eType == int32(SQLITE_BLOB) {
						...
						for {
							...
							(*(*[2]uint8)(unsafe.Pointer(bp + 2)))[0] = libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(__ccgo_ts + 573 + uintptr(libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(aBlob + uintptr(iBlob))))>>int32(4)))))
							(*(*[2]uint8)(unsafe.Pointer(bp + 2)))[int32(1)] = libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(__ccgo_ts + 573 + uintptr(libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(aBlob + uintptr(iBlob))))&int32(15)))))
			...
			if libc.Uint32FromInt32(g.FnResult+len1) < libc.Uint32FromInt64(3000)-libc.Uint32FromInt32(2) {
				if g.FnResult > 0 {
					v4 = uintptr(unsafe.Pointer(&g)) + 108
					v3 = *(*int32)(unsafe.Pointer(v4))
					*(*int32)(unsafe.Pointer(v4))++
					*(*int8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 112 + uintptr(v3))) = int8(' ')
				}
				libc.Xmemcpy(tls, uintptr(unsafe.Pointer(&g))+112+uintptr(g.FnResult), z1, libc.Uint32FromInt32(len1+int32(1)))
				g.FnResult += len1
			}
			goto _1
		_1:
...
var zMix1Tests = [53]int8{'m', 'a', 'i', 'n', ',', 'o', 'r', 'm', '/', '2', '5', ',', 'c', 't', 'e', '/', '2', '0', ',', 'j', 's', 'o', 'n', ',', 'f', 'p', '/', '3', ',', 'p', 'a', 'r', 's', 'e', 'n', 'u', 'm', 'b', 'e', 'r', '/', '2', '5', ',', 'r', 't', 'r', 'e', 'e', '/', '1', '0'}
