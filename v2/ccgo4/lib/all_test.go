...
package ccgo // import "github.com/next-bin/go-sqlite/v2/ccgo4/lib"
...
func TestCSmith(t *testing.T) {
	...
	blacklist := []struct{ target, seed string }{
		...
		{"linux/ppc64le", "3088696074888013"}, // TODO https://gitlab.com/cznic/builder/-/tree/91efcffac0cf3a1618f47d117864b76435ed87a2/logs/github.com/next-bin/go-sqlite/v2/ccgo4/lib
		...
		//
		// https://gitlab.com/cznic/builder/-/blob/a796cec9f649d055ac3e20294c0d577b28315806/logs/github.com/next-bin/go-sqlite/v2/ccgo4/lib/pi64
		//
