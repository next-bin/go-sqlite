// Code generated for linux/amd64 by 'generator -I /tmp/libsqlite3/sqlite-src-3450100 -ignore-unsupported-alignment -o mptest/ccgo_linux_amd64.go /tmp/libsqlite3/sqlite-src-3450100/mptest/mptest.c -lsqlite3', DO NOT EDIT.
		...
		if c == int32('*') {
			...
			if c == int32('?') {
				...
				if c == int32('[') {
					...
					if c == int32('#') {
						if (int32(*(*int8)(unsafe.Pointer(z))) == int32('-') || int32(*(*int8)(unsafe.Pointer(z))) == int32('+')) && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(z + 1)))))*2)))&int32(uint16(_ISdigit)) != 0 {
							z++
						}
						if !(int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(z)))))*2)))&int32(uint16(_ISdigit)) != 0) {
							return 0
						}
						z++
						for int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(z)))))*2)))&int32(uint16(_ISdigit)) != 0 {
							z++
						}
					} else {
						v17 = z
...
func clipLength(tls *libc.TLS, z uintptr) (r int32) {
	...
	for n > 0 && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n-int32(1)))))))*2)))&int32(uint16(_ISspace)) != 0 {
		n--
	}
	return n
}
...
func stringAppendTerm(tls *libc.TLS, p uintptr, z uintptr) {
	...
	i = 0
	for {
		if !(*(*int8)(unsafe.Pointer(z + uintptr(i))) != 0 && !(int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(i))))))*2)))&int32(uint16(_ISspace)) != 0)) {
			break
		}
		goto _1
	_1:
...
func tokenLength(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	n = 0
	if int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(z)))))*2)))&int32(uint16(_ISspace)) != 0 || int32(*(*int8)(unsafe.Pointer(z))) == int32('/') && int32(*(*int8)(unsafe.Pointer(z + 1))) == int32('*') {
		inC = 0
...
func extractToken(tls *libc.TLS, zIn uintptr, nIn int32, zOut uintptr, nOut int32) (r int32) {
	...
	i = 0
	for {
		if !(i < nIn && i < nOut-int32(1) && !(int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(zIn + uintptr(i))))))*2)))&int32(uint16(_ISspace)) != 0)) {
			break
		}
...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	_ = n
	n = 0
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 && (libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+960, uint64(5)) != 0 || !(int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(5)))))))*2)))&int32(uint16(_ISspace)) != 0)) {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	...
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+966, uint64(7)) == 0 && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(7)))))))*2)))&int32(uint16(_ISspace)) != 0 || stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+974, uint64(6)) == 0 && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(6)))))))*2)))&int32(uint16(_ISspace)) != 0 {
			return n + len1
		}
		if libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+981, uint64(4)) == 0 && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(4)))))))*2)))&int32(uint16(_ISspace)) != 0 {
...
func runScript(tls *libc.TLS, iClient int32, taskId int32, zScript uintptr, zFilename uintptr) {
	...
	*(*int32)(unsafe.Pointer(bp)) = int32(1)
	...
	for {
		...
		if int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(c)))*2)))&int32(uint16(_ISspace)) != 0 || c == int32('/') && int32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+int32(1))))) == int32('*') {
			ii += len1
			continue
		}
		if c != int32('-') || int32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+int32(1))))) != int32('-') || !(int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+int32(2))))))*2)))&int32(uint16(_ISalpha)) != 0) {
			ii += len1
			continue
		}
		...
		for {
			...
			for n < len1-int32(2) && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+int32(2)+n))))))*2)))&int32(uint16(_ISspace)) != 0 {
				n++
			}
			if n >= len1-int32(2) {
				break
					...
					if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1291) == 0 && iClient > 0 {
						...
						if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1298) == 0 {
							...
							if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1304) == 0 {
								...
								jj = int32(7)
								for {
									if !(jj < len1-int32(1) && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(zAns + uintptr(jj))))))*2)))&int32(uint16(_ISspace)) != 0) {
										break
									}
									goto _5
								_5:
								...
								if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1355) == 0 || libc.Xstrcmp(tls, bp+24, __ccgo_ts+1360) == 0 {
									...
									for {
										if !(jj1 < len1-int32(1) && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(zAns1 + uintptr(jj1))))))*2)))&int32(uint16(_ISspace)) != 0) {
											break
										}
										goto _6
									_6:
									...
									if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1411) == 0 {
										...
										if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1418) == 0 {
											...
											if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1469) == 0 {
												jj2 = int32(7)
												for {
													if !(jj2 < len1 && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+jj2))))))*2)))&int32(uint16(_ISspace)) != 0) {
														break
													}
													goto _9
												_9:
												...
												if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1475) == 0 {
													jj3 = int32(4)
													for {
														if !(jj3 < len1 && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+jj3))))))*2)))&int32(uint16(_ISspace)) != 0) {
															break
														}
														goto _10
													_10:
