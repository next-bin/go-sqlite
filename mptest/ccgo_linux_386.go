		...
		if c == int32('*') {
			...
			if c == int32('?') {
				...
				if c == int32('[') {
					...
					if c == int32('#') {
						if (int32(*(*int8)(unsafe.Pointer(z))) == int32('-') || int32(*(*int8)(unsafe.Pointer(z))) == int32('+')) && libc.BoolInt32(uint32(uint8(*(*int8)(unsafe.Pointer(z + 1))))-uint32('0') < uint32(10)) != 0 {
							z++
						}
						if !(libc.BoolInt32(uint32(uint8(*(*int8)(unsafe.Pointer(z))))-libc.Uint32FromUint8('0') < libc.Uint32FromInt32(10)) != 0) {
							return 0
						}
						z++
						for libc.BoolInt32(uint32(uint8(*(*int8)(unsafe.Pointer(z))))-uint32('0') < uint32(10)) != 0 {
							z++
						}
					} else {
						v17 = z
	...
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if v9 = v4 && v2 != 0; !v9 {
			if v8 = stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+910, uint32(6)) == 0; v8 {
				v5 = int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(6))))))
		...
		if v13 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+917, uint32(4)) == 0; v13 {
			v10 = int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(4))))))
...
func runScript(tls *libc.TLS, iClient int32, taskId int32, zScript uintptr, zFilename uintptr) {
	...
	*(*int32)(unsafe.Pointer(bp)) = int32(1)
	...
	_4:
		...
		if c != int32('-') || int32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+int32(1))))) != int32('-') || !(libc.BoolInt32(uint32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+int32(2)))))|libc.Uint32FromInt32(32)-libc.Uint32FromUint8('a') < libc.Uint32FromInt32(26)) != 0) {
			ii += len1
			continue
		}
		...
		for {
			...
			for {
				if v9 = n < len1-int32(2); v9 {
					v6 = int32(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+int32(2)+n)))))
					v7 = libc.BoolInt32(v6 == int32(' ') || uint32(v6)-uint32('\t') < uint32(5))
					goto _8
				_8:
				}
							...
							if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1240) == 0 {
								...
								for {
									if v16 = jj < len1-int32(1); v16 {
										v13 = int32(uint8(*(*int8)(unsafe.Pointer(zAns + uintptr(jj)))))
										v14 = libc.BoolInt32(v13 == int32(' ') || uint32(v13)-uint32('\t') < uint32(5))
										goto _15
									_15:
									}
								...
								if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1291) == 0 || libc.Xstrcmp(tls, bp+16, __ccgo_ts+1296) == 0 {
									...
									for {
										if v21 = jj1 < len1-int32(1); v21 {
											v18 = int32(uint8(*(*int8)(unsafe.Pointer(zAns1 + uintptr(jj1)))))
									...
									if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1347) == 0 {
										...
										if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1354) == 0 {
											...
											if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1405) == 0 {
												...
												for {
													if v28 = jj2 < len1; v28 {
														v25 = int32(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+jj2)))))
												...
												if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1411) == 0 {
													...
													for {
														if v33 = jj3 < len1; v33 {
															v30 = int32(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+jj3)))))
