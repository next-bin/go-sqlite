// Code generated for linux/386 by 'generator -DNDEBUG -I /tmp/libsqlite3/sqlite-src-3510100 -ignore-unsupported-alignment -ignore-link-errors -o mptest/ccgo_linux_386.go internal/overlay/mptest/mptest.c -lsqlite3', DO NOT EDIT.
...
func strglob(tls *libc.TLS, zGlob uintptr, z uintptr) (r int32) {
	var c, c2, invert, prior_c, seen, v1, v3 int32
	var v2, v4, v5 uintptr
	var v6 bool
	_, _, _, _, _, _, _, _, _, _, _ = c, c2, invert, prior_c, seen, v1, v2, v3, v4, v5, v6
	for {
		v2 = zGlob
		zGlob = zGlob + 1
		...
		if c == int32('*') {
			...
			for {
				...
				for c2 != c {
					v4 = z
					z = z + 1
					c2 = int32(*(*int8)(unsafe.Pointer(v4)))
					if c2 == 0 {
						return 0
					}
				}
			...
			if c == int32('?') {
				v2 = z
				z = z + 1
				if int32(*(*int8)(unsafe.Pointer(v2))) == 0 {
					return 0
				}
			} else {
				if c == int32('[') {
					...
					v2 = zGlob
					zGlob = zGlob + 1
					c2 = int32(*(*int8)(unsafe.Pointer(v2)))
					if c2 == int32('^') {
						invert = int32(1)
						v2 = zGlob
						zGlob = zGlob + 1
					...
					if c == int32('#') {
						if (int32(*(*int8)(unsafe.Pointer(z))) == int32('-') || int32(*(*int8)(unsafe.Pointer(z))) == int32('+')) && libc.BoolInt32(uint32(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(z + 1))))-uint32('0') < uint32(10)) != 0 {
							z = z + 1
						}
						if !(libc.BoolInt32(uint32(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(z))))-libc.Uint32FromUint8('0') < libc.Uint32FromInt32(10)) != 0) {
							return 0
						}
						z = z + 1
						for libc.BoolInt32(uint32(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(z))))-uint32('0') < uint32(10)) != 0 {
							z = z + 1
						}
					} else {
						v2 = z
						z = z + 1
						if c != int32(*(*int8)(unsafe.Pointer(v2))) {
							return 0
						}
					}
				}
...
func clipLength(tls *libc.TLS, z uintptr) (r int32) {
	...
	for {
		if v4 = n > 0; v4 {
			v1 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(z + uintptr(n-int32(1))))))
...
func stringAppend(tls *libc.TLS, p uintptr, z uintptr, n int32) {
	...
	libc.Xmemcpy(tls, (*String)(unsafe.Pointer(p)).Fz+uintptr((*String)(unsafe.Pointer(p)).Fn), z, libc.Uint32FromInt32(n))
...
func stringAppendTerm(tls *libc.TLS, p uintptr, z uintptr) {
	...
	i = 0
	for {
		if v5 = *(*int8)(unsafe.Pointer(z + uintptr(i))) != 0; v5 {
			v2 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(z + uintptr(i)))))
...
func startClient(tls *libc.TLS, iClient int32) {
	...
	if libsqlite3.Xsqlite3_changes(tls, g.Fdb) != 0 {
		zSys = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+743, libc.VaList(bp+8, g.Fargv0, g.FzDbFile, iClient, g.FiTrace, g.FdefaultTimeout))
		if g.FbSqlTrace != 0 {
			zSys = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+787, libc.VaList(bp+8, zSys))
		}
		if g.FbSync != 0 {
			zSys = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+801, libc.VaList(bp+8, zSys))
		}
		if g.FzVfs != 0 {
			zSys = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+811, libc.VaList(bp+8, zSys, g.FzVfs))
		}
		if g.FiTrace >= int32(2) {
			logMessage(tls, __ccgo_ts+825, libc.VaList(bp+8, zSys))
		}
		zSys = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+838, libc.VaList(bp+8, zSys))
		rc = libc.Xsystem(tls, zSys)
		if rc != 0 {
			errorMessage(tls, __ccgo_ts+843, libc.VaList(bp+8, rc))
		}
...
func readFile(tls *libc.TLS, zFilename uintptr) (r uintptr) {
	...
	var sz int32
	_, _, _ = in, sz, z
	in = libc.Xfopen(tls, zFilename, __ccgo_ts+877)
	if in == uintptr(0) {
		fatalError(tls, __ccgo_ts+880, libc.VaList(bp+8, zFilename))
	}
	libc.Xfseek(tls, in, 0, int32(2))
	sz = libc.Xftell(tls, in)
	libc.Xrewind(tls, in)
	z = libsqlite3.Xsqlite3_malloc(tls, sz+int32(1))
	sz = libc.Int32FromUint32(libc.Xfread(tls, z, uint32(1), libc.Uint32FromInt32(sz), in))
...
func tokenLength(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	var c, c1, delim, inC, n, v1, v2, v4 int32
	var v16 bool
	_, _, _, _, _, _, _, _, _ = c, c1, delim, inC, n, v1, v16, v2, v4
	n = 0
	v1 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(z))))
	v2 = libc.BoolInt32(v1 == int32(' ') || libc.Uint32FromInt32(v1)-uint32('\t') < uint32(5))
	goto _3
_3:
	;
	if v2 != 0 || int32(*(*int8)(unsafe.Pointer(z))) == int32('/') && int32(*(*int8)(unsafe.Pointer(z + 1))) == int32('*') {
		inC = 0
		...
		if int32(*(*int8)(unsafe.Pointer(z))) == int32('-') && int32(*(*int8)(unsafe.Pointer(z + 1))) == int32('-') {
			...
			if int32(*(*int8)(unsafe.Pointer(z))) == int32('"') || int32(*(*int8)(unsafe.Pointer(z))) == int32('\'') {
				...
				n = int32(1)
				for {
					v1 = int32(*(*int8)(unsafe.Pointer(z + uintptr(n))))
					c1 = v1
					if v16 = v1 != 0; v16 {
						v2 = libc.Int32FromUint8(libc.Uint8FromInt32(c1))
						v4 = libc.BoolInt32(v2 == int32(' ') || libc.Uint32FromInt32(v2)-uint32('\t') < uint32(5))
						goto _15
					_15:
					}
					if !(v16 && !(v4 != 0) && c1 != int32('"') && c1 != int32('\'') && c1 != int32(';')) {
						break
					}
					goto _11
				_11:
...
func extractToken(tls *libc.TLS, zIn uintptr, nIn int32, zOut uintptr, nOut int32) (r int32) {
	...
	for {
		if v5 = i < nIn && i < nOut-int32(1); v5 {
			v2 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(zIn + uintptr(i)))))
			v3 = libc.BoolInt32(v2 == int32(' ') || libc.Uint32FromInt32(v2)-uint32('\t') < uint32(5))
			goto _4
		_4:
		}
...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	n = 0
	for {
		if v5 = *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0; v5 {
			if v4 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+909, uint32(5)) != 0; !v4 {
				v1 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(5))))))
				v2 = libc.BoolInt32(v1 == int32(' ') || libc.Uint32FromInt32(v1)-uint32('\t') < uint32(5))
				goto _3
			_3:
			}
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	var len1, n, skip, v1, v2, v5, v6 int32
	var v4, v8, v9 bool
	_, _, _, _, _, _, _, _, _, _ = len1, n, skip, v1, v2, v4, v5, v6, v8, v9
	n = 0
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		len1 = tokenLength(tls, z+uintptr(n), pnLine)
		if v4 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+915, uint32(7)) == 0; v4 {
			v1 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(7))))))
			v2 = libc.BoolInt32(v1 == int32(' ') || libc.Uint32FromInt32(v1)-uint32('\t') < uint32(5))
			goto _3
		_3:
		}
		if v9 = v4 && v2 != 0; !v9 {
			if v8 = stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+923, uint32(6)) == 0; v8 {
				v5 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(6))))))
		...
		if v4 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+930, uint32(4)) == 0; v4 {
			v1 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(4))))))
			v2 = libc.BoolInt32(v1 == int32(' ') || libc.Uint32FromInt32(v1)-uint32('\t') < uint32(5))
			goto _12
		_12:
		}
...
func waitForClient(tls *libc.TLS, iClient int32, iTimeout int32, zErrPrefix uintptr) {
	...
	_, _, _ = pStmt, rc, v1
	if iClient > 0 {
		pStmt = prepareSql(tls, __ccgo_ts+935, libc.VaList(bp+8, iClient))
	} else {
		pStmt = prepareSql(tls, __ccgo_ts+1031, 0)
	}
	g.FiTimeout = 0
	for {
		...
		iTimeout = iTimeout - int32(50)
	}
	libsqlite3.Xsqlite3_finalize(tls, pStmt)
	g.FiTimeout = g.FdefaultTimeout
	if rc != int32(SQLITE_DONE) {
		if zErrPrefix == uintptr(0) {
			zErrPrefix = __ccgo_ts + 1112
		}
		if iClient > 0 {
			errorMessage(tls, __ccgo_ts+1113, libc.VaList(bp+8, zErrPrefix, iClient))
		} else {
			errorMessage(tls, __ccgo_ts+1145, libc.VaList(bp+8, zErrPrefix))
		}
	}
}
...
func booleanValue(tls *libc.TLS, zArg uintptr) (r int32) {
	...
	if libsqlite3.Xsqlite3_stricmp(tls, zArg, __ccgo_ts+1179) == 0 || libsqlite3.Xsqlite3_stricmp(tls, zArg, __ccgo_ts+1182) == 0 {
		return int32(1)
	}
	if libsqlite3.Xsqlite3_stricmp(tls, zArg, __ccgo_ts+1186) == 0 || libsqlite3.Xsqlite3_stricmp(tls, zArg, __ccgo_ts+1190) == 0 {
		return 0
	}
	errorMessage(tls, __ccgo_ts+1193, libc.VaList(bp+8, zArg))
	return 0
}
...
func runScript(tls *libc.TLS, iClient int32, taskId int32, zScript uintptr, zFilename uintptr) {
	bp := tls.Alloc(1296)
	defer tls.Free(1296)
	var c, iBegin, iEnd, iNewClient, iTarget, iTimeout, ii, isGlob, j, jj, jj1, jj2, jj3, k, len1, n, nArg, prevLine, rc, rc1, v1, v2 int32
	...
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = c, iBegin, iEnd, iNewClient, iTarget, iTimeout, ii, isGlob, j, jj, jj1, jj2, jj3, k, len1, n, nArg, pStmt, prevLine, rc, rc1, zAns, zAns1, zCopy, zNewFile, zNewScript, zSql, zSql1, zTName, zTask, zToDel, v1, v2, v23, v9
	*(*int32)(unsafe.Pointer(bp)) = int32(1)
	...
	_4:
		...
		if c != int32('-') || int32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+int32(1))))) != int32('-') || !(libc.BoolInt32(libc.Uint32FromInt8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+int32(2)))))|libc.Uint32FromInt32(32)-libc.Uint32FromUint8('a') < libc.Uint32FromInt32(26)) != 0) {
			ii = ii + len1
			continue
		}
		/* Run any prior SQL before processing the new --command */
		if ii > iBegin {
			zSql = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1215, libc.VaList(bp+1256, ii-iBegin, zScript+uintptr(iBegin)))
		...
		/* Parse the --command */
		if g.FiTrace >= int32(2) {
			logMessage(tls, __ccgo_ts+1215, libc.VaList(bp+1256, len1, zScript+uintptr(ii)))
		}
		...
		for {
			...
			for {
				if v9 = n < len1-int32(2); v9 {
					v1 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+int32(2)+n)))))
					v2 = libc.BoolInt32(v1 == int32(' ') || libc.Uint32FromInt32(v1)-uint32('\t') < uint32(5))
					goto _8
				_8:
				}
			...
			n = n + extractToken(tls, zScript+uintptr(ii)+uintptr(2)+uintptr(n), len1-int32(2)-n, bp+1046+uintptr(nArg)*100, int32(100))
			goto _5
		_5:
			;
			nArg = nArg + 1
		...
		for {
			...
			v1 = j
			j = j + 1
			*(*int8)(unsafe.Pointer(bp + 1046 + uintptr(v1)*100)) = 0
			goto _10
		_10:
			;
			j = j + 1
		 ...
		 */
		if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1220) == 0 {
			 ...
			 */
			if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1226) == 0 {
				 ...
				 ** has begun.
				 */
				if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1231) == 0 {
					if g.FiTrace == int32(1) {
						logMessage(tls, __ccgo_ts+1215, libc.VaList(bp+1256, len1-int32(1), zScript+uintptr(ii)))
					}
					stringReset(tls, bp+4)
				} else {
					/*
					 ...
					 */
					if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1240) == 0 && iClient > 0 {
						finishScript(tls, iClient, taskId, int32(1))
					} else {
						/*
						 **  --reset
						 ...
						 */
						if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1247) == 0 {
							stringReset(tls, bp+4)
						} else {
							/*
							 **  --match ANSWER...
							 ...
							 */
							if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1253) == 0 {
								zAns = zScript + uintptr(ii)
								jj = int32(7)
								for {
									if v9 = jj < len1-int32(1); v9 {
										v1 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(zAns + uintptr(jj)))))
										v2 = libc.BoolInt32(v1 == int32(' ') || libc.Uint32FromInt32(v1)-uint32('\t') < uint32(5))
										goto _15
									_15:
									}
								...
								if len1-jj-int32(1) != (*(*String)(unsafe.Pointer(bp + 4))).Fn || libc.Xstrncmp(tls, (*(*String)(unsafe.Pointer(bp + 4))).Fz, zAns, libc.Uint32FromInt32(len1-jj-int32(1))) != 0 {
									errorMessage(tls, __ccgo_ts+1259, libc.VaList(bp+1256, prevLine, zFilename, len1-jj-int32(1), zAns, (*(*String)(unsafe.Pointer(bp + 4))).Fz))
								}
								g.FnTest = g.FnTest + 1
								stringReset(tls, bp+4)
							} else {
								 ...
								 ** ANSWER.
								 */
								if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1304) == 0 || libc.Xstrcmp(tls, bp+16, __ccgo_ts+1309) == 0 {
									zAns1 = zScript + uintptr(ii)
									isGlob = libc.BoolInt32(int32((*(*[30]int8)(unsafe.Pointer(bp + 16)))[0]) == int32('g'))
									jj1 = int32(9) - int32(3)*isGlob
									for {
										if v9 = jj1 < len1-int32(1); v9 {
											v1 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(zAns1 + uintptr(jj1)))))
											v2 = libc.BoolInt32(v1 == int32(' ') || libc.Uint32FromInt32(v1)-uint32('\t') < uint32(5))
											goto _20
										_20:
										}
									...
									zCopy = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1215, libc.VaList(bp+1256, len1-jj1-int32(1), zAns1))
									if libc.BoolInt32(libsqlite3.Xsqlite3_strglob(tls, zCopy, (*(*String)(unsafe.Pointer(bp + 4))).Fz) == 0)^isGlob != 0 {
										errorMessage(tls, __ccgo_ts+1317, libc.VaList(bp+1256, prevLine, zFilename, zCopy, (*(*String)(unsafe.Pointer(bp + 4))).Fz))
									}
									 ...
									 */
									if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1360) == 0 {
										 ...
										 */
										if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1367) == 0 {
											zToDel = uintptr(0)
											zNewFile = bp + 1046
											if !(int32(*(*int8)(unsafe.Pointer(zNewFile))) == libc.Int32FromUint8('/')) {
												k = libc.Int32FromUint32(libc.Xstrlen(tls, zFilename)) - int32(1)
												for {
												...
												if k > 0 {
													v23 = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1374, libc.VaList(bp+1256, k, zFilename, zNewFile))
													zToDel = v23
													zNewFile = v23
													if zNewFile == uintptr(0) {
														libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+1382, 0)
														libc.Xabort(tls)
													}
												}
											}
											...
											if g.FiTrace != 0 {
												logMessage(tls, __ccgo_ts+1397, libc.VaList(bp+1256, zNewFile))
											}
											runScript(tls, 0, 0, zNewScript, zNewFile)
											libsqlite3.Xsqlite3_free(tls, zNewScript)
											if g.FiTrace != 0 {
												logMessage(tls, __ccgo_ts+1416, libc.VaList(bp+1256, zNewFile))
											}
											 ...
											 */
											if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1433) == 0 {
												jj2 = int32(7)
												for {
													if v9 = jj2 < len1; v9 {
														v1 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+jj2)))))
														v2 = libc.BoolInt32(v1 == int32(' ') || libc.Uint32FromInt32(v1)-uint32('\t') < uint32(5))
														goto _27
													_27:
													}
												...
												logMessage(tls, __ccgo_ts+1215, libc.VaList(bp+1256, len1-jj2, zScript+uintptr(ii)+uintptr(jj2)))
											} else {
												/*
												 **  --if EXPR
												 **
												 ...
												 */
												if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1439) == 0 {
													jj3 = int32(4)
													for {
														if v9 = jj3 < len1; v9 {
															v1 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+jj3)))))
															v2 = libc.BoolInt32(v1 == int32(' ') || libc.Uint32FromInt32(v1)-uint32('\t') < uint32(5))
															goto _32
														_32:
														}
													...
													pStmt = prepareSql(tls, __ccgo_ts+1442, libc.VaList(bp+1256, len1-jj3, zScript+uintptr(ii)+uintptr(jj3)))
													rc1 = libsqlite3.Xsqlite3_step(tls, pStmt)
													if rc1 != int32(SQLITE_ROW) || libsqlite3.Xsqlite3_column_int(tls, pStmt, 0) == 0 {
														ii = ii + findEndif(tls, zScript+uintptr(ii)+uintptr(len1), int32(1), bp)
													}
													libsqlite3.Xsqlite3_finalize(tls, pStmt)
												} else {
													/*
													 ...
													 */
													if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1454) == 0 {
														ii = ii + findEndif(tls, zScript+uintptr(ii)+uintptr(len1), 0, bp)
													} else {
														/*
														 **  --endif
														 **
														 ...
														 */
														if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1459) == 0 {
															/* no-op */
														} else {
															/*
															 **  --start CLIENT
															 ...
															 */
															if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1465) == 0 && iClient == 0 {
																 ...
																 */
																if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1471) == 0 && iClient == 0 {
																	if nArg >= int32(2) {
																		v1 = libc.Xatoi(tls, bp+1046+1*100)
																	} else {
																		v1 = int32(10000)
																	}
																	iTimeout = v1
																	libsqlite3.Xsqlite3_snprintf(tls, int32(1000), bp+46, __ccgo_ts+1476, libc.VaList(bp+1256, prevLine, zFilename))
																	 ...
																	 ** already.
																	 */
																	if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1491) == 0 && iClient == 0 {
																		iTarget = libc.Xatoi(tls, bp+1046)
																		iEnd = findEnd(tls, zScript+uintptr(ii)+uintptr(len1), bp)
																		if iTarget < 0 {
																			errorMessage(tls, __ccgo_ts+1496, libc.VaList(bp+1256, prevLine, zFilename, iTarget))
																		} else {
																			zTask = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1215, libc.VaList(bp+1256, iEnd, zScript+uintptr(ii)+uintptr(len1)))
																			if nArg > int32(1) {
																				zTName = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+438, libc.VaList(bp+1256, bp+1046+1*100))
																			} else {
																				zTName = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1533, libc.VaList(bp+1256, filenameTail(tls, zFilename), prevLine))
																			}
																			startClient(tls, iTarget)
																			runSql(tls, __ccgo_ts+1539, libc.VaList(bp+1256, iTarget, zTask, zTName))
																			libsqlite3.Xsqlite3_free(tls, zTask)
																			libsqlite3.Xsqlite3_free(tls, zTName)
																		}
																		iEnd = iEnd + tokenLength(tls, zScript+uintptr(ii)+uintptr(len1)+uintptr(iEnd), bp)
																		len1 = len1 + iEnd
																		iBegin = ii + len1
																	} else {
																		/*
																		 ...
																		 */
																		if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1595) == 0 {
																			test_breakpoint(tls)
																		} else {
																			/*
																			 ...
																			 */
																			if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1606) == 0 {
																				if nArg >= int32(1) {
																					v1 = libc.BoolInt32(!(booleanValue(tls, bp+1046) != 0))
																				} else {
																					v1 = int32(1)
																				}
																				g.FbIgnoreSqlErrors = v1
																			} else {
																				/* error */
																				errorMessage(tls, __ccgo_ts+1622, libc.VaList(bp+1256, prevLine, zFilename, bp+16))
																			}
																		}
																	}
																}
	...
	if iBegin < ii {
		zSql1 = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1215, libc.VaList(bp+1256, ii-iBegin, zScript+uintptr(iBegin)))
		runSql(tls, zSql1, 0)
	...
	for {
		...
		if libc.Xstrcmp(tls, z, zOption) == 0 {
			if hasArg != 0 && i == nArg-int32(1) {
				fatalError(tls, __ccgo_ts+1658, libc.VaList(bp+8, z))
			}
			if hasArg != 0 {
...
func usage(tls *libc.TLS, argv0 uintptr) {
	...
	libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+1706, libc.VaList(bp+8, zTail))
	libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+1745, 0)
	libc.Xexit(tls, int32(1))
}
...
func unrecognizedArguments(tls *libc.TLS, argv0 uintptr, nArg int32, azArg uintptr) {
	...
	var i int32
	_ = i
	libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+2317, libc.VaList(bp+8, argv0))
	i = 0
	for {
		if !(i < nArg) {
			break
		}
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+2345, libc.VaList(bp+8, *(*uintptr)(unsafe.Pointer(azArg + uintptr(i)*4))))
		goto _1
	_1:
		;
		i = i + 1
	}
	libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+2349, 0)
	libc.Xexit(tls, int32(1))
}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	var i, iClient, iRep, iTimeout, iTmout, nRep, nTry, openFlags, rc, v4 int32
	var pStmt, zCOption, zClient, zJMode, zNRep, zTmout, zTrace, v3 uintptr
	var v5 bool
	var _ /* n at bp+0 */ int32
	var _ /* taskId at bp+8 */ int32
	var _ /* zScript at bp+4 */ uintptr
	var _ /* zTaskName at bp+12 */ uintptr
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = i, iClient, iRep, iTimeout, iTmout, nRep, nTry, openFlags, pStmt, rc, zCOption, zClient, zJMode, zNRep, zTmout, zTrace, v3, v4, v5
	...
	if strglob(tls, __ccgo_ts+2351, g.FzDbFile) != 0 {
		usage(tls, *(*uintptr)(unsafe.Pointer(argv)))
	}
	if libc.Xstrncmp(tls, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2358, uint32(80)) != 0 {
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+2443, libc.VaList(bp+24, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2358))
		libc.Xexit(tls, int32(1))
	}
	*(*int32)(unsafe.Pointer(bp)) = argc - int32(2)
	libsqlite3.Xsqlite3_snprintf(tls, int32(32), uintptr(unsafe.Pointer(&g))+32, __ccgo_ts+2503, libc.VaList(bp+24, libc.Xgetpid(tls)))
	zJMode = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2515, int32(1))
	zNRep = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2527, int32(1))
	if zNRep != 0 {
	...
	g.FzVfs = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2534, int32(1))
	zClient = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2538, int32(1))
	g.FzErrLog = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2545, int32(1))
	g.FzLog = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2552, int32(1))
	zTrace = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2556, int32(1))
	if zTrace != 0 {
		g.FiTrace = libc.Xatoi(tls, zTrace)
	}
	if findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2562, 0) != uintptr(0) {
		g.FiTrace = 0
	}
	zTmout = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2568, int32(1))
	if zTmout != 0 {
		iTmout = libc.Xatoi(tls, zTmout)
	}
	g.FbSqlTrace = libc.BoolInt32(findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2576, 0) != uintptr(0))
	g.FbSync = libc.BoolInt32(findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2585, 0) != uintptr(0))
	if g.FzErrLog != 0 {
		g.FpErrLog = libc.Xfopen(tls, g.FzErrLog, __ccgo_ts+2590)
	} else {
		g.FpErrLog = libc.Xstderr
	}
	if g.FzLog != 0 {
		g.FpLog = libc.Xfopen(tls, g.FzLog, __ccgo_ts+2590)
	} else {
	...
	if zClient != 0 {
		...
		if iClient < int32(1) {
			fatalError(tls, __ccgo_ts+2592, libc.VaList(bp+24, iClient))
		}
		libsqlite3.Xsqlite3_snprintf(tls, int32(32), uintptr(unsafe.Pointer(&g))+32, __ccgo_ts+2619, libc.VaList(bp+24, libc.Xgetpid(tls), iClient))
	} else {
		nTry = 0
		if g.FiTrace > 0 {
			libc.Xprintf(tls, __ccgo_ts+2635, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv))))
			i = int32(1)
			for {
				if !(i < argc) {
					break
				}
				libc.Xprintf(tls, __ccgo_ts+2345, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				goto _1
			_1:
				;
				i = i + 1
			}
			libc.Xprintf(tls, __ccgo_ts+2349, 0)
			libc.Xprintf(tls, __ccgo_ts+2645, 0)
			i = 0
			for {
				...
				libc.Xprintf(tls, __ccgo_ts+2750, libc.VaList(bp+24, zCOption))
				goto _2
			_2:
				;
				i = i + 1
		...
		for {
			if nTry%int32(5) == int32(4) {
				...
				libc.Xprintf(tls, __ccgo_ts+2770, libc.VaList(bp+24, v3, g.FzDbFile))
			}
		...
		if rc != 0 {
			fatalError(tls, __ccgo_ts+2799, libc.VaList(bp+24, g.FzDbFile, nTry))
		}
	...
	if rc != 0 {
		fatalError(tls, __ccgo_ts+2840, libc.VaList(bp+24, g.FzDbFile))
	}
	if iTmout > 0 {
		libsqlite3.Xsqlite3_busy_timeout(tls, g.Fdb, iTmout)
	}
	if zJMode != 0 {
		runSql(tls, __ccgo_ts+2857, libc.VaList(bp+24, zJMode))
	}
	if !(g.FbSync != 0) {
		trySql(tls, __ccgo_ts+2881, 0)
	}
	...
	libsqlite3.Xsqlite3_create_function(tls, g.Fdb, __ccgo_ts+2904, 0, int32(SQLITE_UTF8), uintptr(0), __ccgo_fp(vfsNameFunc), uintptr(0), uintptr(0))
	libsqlite3.Xsqlite3_create_function(tls, g.Fdb, __ccgo_ts+2912, int32(1), int32(SQLITE_UTF8), uintptr(0), __ccgo_fp(evalFunc), uintptr(0), uintptr(0))
	if iTmout > 0 {
		v4 = iTmout
	} else {
		v4 = int32(DEFAULT_TIMEOUT)
	}
	g.FdefaultTimeout = v4
	g.FiTimeout = g.FdefaultTimeout
	if g.FbSqlTrace != 0 {
	...
	if iClient > 0 {
		...
		if g.FiTrace != 0 {
			logMessage(tls, __ccgo_ts+2917, 0)
		}
		for int32(1) != 0 {
			*(*uintptr)(unsafe.Pointer(bp + 12)) = uintptr(0)
			...
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+2930, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(bp + 12)), *(*int32)(unsafe.Pointer(bp + 8))))
			}
			runScript(tls, iClient, *(*int32)(unsafe.Pointer(bp + 8)), *(*uintptr)(unsafe.Pointer(bp + 4)), *(*uintptr)(unsafe.Pointer(bp + 12)))
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+2944, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(bp + 12)), *(*int32)(unsafe.Pointer(bp + 8))))
			}
		...
		if g.FiTrace != 0 {
			logMessage(tls, __ccgo_ts+2956, 0)
		}
	} else {
		if *(*int32)(unsafe.Pointer(bp)) == 0 {
			fatalError(tls, __ccgo_ts+2967, 0)
		}
		if *(*int32)(unsafe.Pointer(bp)) > int32(1) {
			unrecognizedArguments(tls, *(*uintptr)(unsafe.Pointer(argv)), *(*int32)(unsafe.Pointer(bp)), argv+uintptr(2)*4)
		}
		runSql(tls, __ccgo_ts+2991, 0)
		*(*uintptr)(unsafe.Pointer(bp + 4)) = readFile(tls, *(*uintptr)(unsafe.Pointer(argv + 2*4)))
		...
		for {
			...
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+3455, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv + 2*4)), iRep))
			}
			goto _9
		_9:
			;
		...
		waitForClient(tls, 0, int32(2000), __ccgo_ts+3481)
		trySql(tls, __ccgo_ts+3501, 0)
		libsqlite3.Xsqlite3_sleep(tls, int32(10))
		g.FiTimeout = 0
		iTimeout = int32(1000)
		for {
			v4 = trySql(tls, __ccgo_ts+3530, 0)
			rc = v4
			if !((v4 == int32(SQLITE_BUSY) || rc == int32(SQLITE_ROW)) && iTimeout > 0) {
				break
			}
			libsqlite3.Xsqlite3_sleep(tls, int32(10))
			iTimeout = iTimeout - int32(10)
		}
		libsqlite3.Xsqlite3_sleep(tls, int32(100))
		pStmt = prepareSql(tls, __ccgo_ts+3551, 0)
		iTimeout = int32(1000)
		for {
			v4 = libsqlite3.Xsqlite3_step(tls, pStmt)
			rc = v4
			if !(v4 == int32(SQLITE_BUSY) && iTimeout > 0) {
				break
			}
			libsqlite3.Xsqlite3_sleep(tls, int32(10))
			iTimeout = iTimeout - int32(10)
	...
	maybeClose(tls, g.FpErrLog)
	if iClient == 0 {
		libc.Xprintf(tls, __ccgo_ts+3586, libc.VaList(bp+24, g.FnError, g.FnTest))
		libc.Xprintf(tls, __ccgo_ts+3622, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv))))
		i = int32(1)
		for {
			if !(i < argc) {
				break
...
var __ccgo_ts1 = "%s%.*s\n\x00%s:ERROR: \x00%s:FATAL: \x00UPDATE client SET wantHalt=1;\x00%s: \x00main\x00timeout after %dms\x00[%.*s]\x00(info) %s\x00(errcode=%d) %s\x00%s\n%s\n\x00out of memory\x00 \x00nil\x00'\x00error(%d)\x00BEGIN IMMEDIATE\x00in startScript: %s\x00UPDATE counters SET nError=nError+%d, nTest=nTest+%d\x00SELECT 1 FROM client WHERE id=%d AND wantHalt\x00DELETE FROM client WHERE id=%d\x00COMMIT TRANSACTION;\x00SELECT script, id, name FROM task WHERE client=%d AND starttime IS NULL ORDER BY id LIMIT 1\x00%s\x00UPDATE task   SET starttime=strftime('%%Y-%%m-%%d %%H:%%M:%%f','now') WHERE id=%d;\x00Waited over 30 seconds with no work.  Giving up.\x00DELETE FROM client WHERE id=%d; COMMIT;\x00COMMIT\x00UPDATE task   SET endtime=strftime('%%Y-%%m-%%d %%H:%%M:%%f','now') WHERE id=%d;\x00INSERT OR IGNORE INTO client VALUES(%d,0)\x00%s \"%s\" --client %d --trace %d --timeout %d\x00%z --sqltrace\x00%z --sync\x00%z --vfs \"%s\"\x00system('%q')\x00%z &\x00system() fails with error code %d\x00rb\x00cannot open \"%s\" for reading\x00--end\x00--endif\x00--else\x00--if\x00SELECT 1 FROM task WHERE client=%d   AND client IN (SELECT id FROM client)  AND endtime IS NULL\x00SELECT 1 FROM task WHERE client IN (SELECT id FROM client)   AND endtime IS NULL\x00\x00%stimeout waiting for client %d\x00%stimeout waiting for all clients\x00on\x00yes\x00off\x00no\x00unknown boolean: [%s]\x00%.*s\x00sleep\x00exit\x00testcase\x00finish\x00reset\x00match\x00line %d of %s:\nExpected [%.*s]\n     Got [%s]\x00glob\x00notglob\x00line %d of %s:\nExpected [%s]\n     Got [%s]\x00output\x00source\x00%.*s/%s\x00out of memory\n\x00begin script [%s]\n\x00end script [%s]\n\x00print\x00if\x00SELECT %.*s\x00else\x00endif\x00start\x00wait\x00line %d of %s\n\x00task\x00line %d of %s: bad client number: %d\x00%s:%d\x00INSERT INTO task(client,script,name) VALUES(%d,'%q',%Q)\x00breakpoint\x00show-sql-errors\x00line %d of %s: unknown command --%s\x00command-line option \"--%s\" requires an argument\x00Usage: %s DATABASE ?OPTIONS? ?SCRIPT?\n\x00Options:\n   --errlog FILENAME           Write errors to FILENAME\n   --journalmode MODE          Use MODE as the journal_mode\n   --log FILENAME              Log messages to FILENAME\n   --quiet                     Suppress unnecessary output\n   --vfs NAME                  Use NAME as the VFS\n   --repeat N                  Repeat the test N times\n   --sqltrace                  Enable SQL tracing\n   --sync                      Enable synchronous disk writes\n   --timeout MILLISEC          Busy timeout is MILLISEC\n   --trace BOOLEAN             Enable or disable tracing\n\x00%s: unrecognized arguments:\x00 %s\x00\n\x00*.test\x002025-11-28 17:28:25 281fc0e9afc38674b9b0991943b9e9d1e64c6cbdb133d35f6f5c87ff6af3alt1\x00SQLite library and header mismatch\nLibrary: %s\nHeader:  %s\n\x00%05d.mptest\x00journalmode\x00repeat\x00vfs\x00client\x00errlog\x00log\x00trace\x00quiet\x00timeout\x00sqltrace\x00sync\x00a\x00illegal client number: %d\n\x00%05d.client%02d\x00BEGIN: %s\x00With SQLite 3.51.1 2025-11-28 17:28:25 281fc0e9afc38674b9b0991943b9e9d1e64c6cbdb133d35f6f5c87ff6af3alt1\n\x00-DSQLITE_%s\n\x00still \x00... %strying to unlink '%s'\n\x00unable to unlink '%s' after %d attempts\n\x00cannot open [%s]\x00PRAGMA journal_mode=%Q;\x00PRAGMA synchronous=OFF\x00vfsname\x00eval\x00start-client\x00begin %s (%d)\x00end %s (%d)\x00end-client\x00missing script filename\x00DROP TABLE IF EXISTS task;\nDROP TABLE IF EXISTS counters;\nDROP TABLE IF EXISTS client;\nCREATE TABLE task(\n  id INTEGER PRIMARY KEY,\n  name TEXT,\n  client INTEGER,\n  starttime DATE,\n  endtime DATE,\n  script TEXT\n);CREATE INDEX task_i1 ON task(client, starttime);\nCREATE INDEX task_i2 ON task(client, endtime);\nCREATE TABLE counters(nError,nTest);\nINSERT INTO counters VALUES(0,0);\nCREATE TABLE client(id INTEGER PRIMARY KEY, wantHalt);\n\x00begin script [%s] cycle %d\n\x00end script [%s] cycle %d\n\x00during shutdown...\n\x00UPDATE client SET wantHalt=1\x00SELECT 1 FROM client\x00SELECT nError, nTest FROM counters\x00Summary: %d errors out of %d tests\n\x00END: %s\x00"
