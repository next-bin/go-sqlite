// Code generated for linux/386 by 'generator -DNDEBUG -I /tmp/libsqlite3/sqlite-src-3500400 -ignore-unsupported-alignment -ignore-link-errors -o mptest/ccgo_linux_386.go /tmp/libsqlite3/sqlite-src-3500400/mptest/mptest.c -lsqlite3', DO NOT EDIT.
	...
	*(*int32)(unsafe.Pointer(bp)) = argc - int32(2)
	...
	if zClient != 0 {
		...
		for {
			if nTry%int32(5) == int32(4) {
				...
				libc.Xprintf(tls, __ccgo_ts+2742, libc.VaList(bp+24, v3, g.FzDbFile))
			}
	...
	if iClient > 0 {
		...
		*(*uintptr)(unsafe.Pointer(bp + 4)) = readFile(tls, *(*uintptr)(unsafe.Pointer(argv + 2*4)))
		...
		iTimeout = int32(1000)
		for {
			v4 = trySql(tls, __ccgo_ts+3502, 0)
			rc = v4
