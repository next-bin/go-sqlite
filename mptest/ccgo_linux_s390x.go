// Code generated for linux/s390x by 'generator -DNDEBUG -I /tmp/libsqlite3/sqlite-src-3500300 -ignore-unsupported-alignment -ignore-link-errors -o mptest/ccgo_linux_s390x.go /tmp/libsqlite3/sqlite-src-3500300/mptest/mptest.c -lsqlite3', DO NOT EDIT.
