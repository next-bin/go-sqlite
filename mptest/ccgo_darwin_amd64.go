// Code generated for darwin/amd64 by 'generator -o mptest/ccgo_darwin_amd64.go -I /tmp/libsqlite3/sqlite-src-3450100 /tmp/libsqlite3/sqlite-src-3450100/mptest/mptest.c -lsqlite3', DO NOT EDIT.
...
func evalSql(tls *libc.TLS, p uintptr, zFormat uintptr, va uintptr) (r int32) {
	...
	*(*uintptr)(unsafe.Pointer(bp)) = uintptr(0)
	...
	if libc.X__builtin_expect(tls, libc.BoolInt64(!(g.iTimeout > libc.Int32FromInt32(0))), 0) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__)), __ccgo_ts+151, int32(494), __ccgo_ts+202)
	}
...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	for {
		if v11 = *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0; v11 {
			if v10 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+960, uint64(5)) != 0; !v10 {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	...
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if v10 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+966, uint64(7)) == 0; v10 {
		...
		if v21 = v10 && v1 != 0; !v21 {
			if v20 = stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+974, uint64(6)) == 0; v20 {
		...
		if v31 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+981, uint64(4)) == 0; v31 {
									...
									if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1411) == 0 {
										...
										if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1418) == 0 {
											...
											if !(int32(*(*int8)(unsafe.Pointer(zNewFile))) == libc.Int32FromUint8('/')) {
												...
												if k > 0 {
													v57 = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1425, libc.VaList(bp+1264, k, zFilename, zNewFile))
													zToDel = v57
													zNewFile = v57
												}
											}
...
func findOption(tls *libc.TLS, azArg uintptr, pnArg uintptr, zOption uintptr, hasArg int32) (r uintptr) {
	...
	if libc.X__builtin_expect(tls, libc.BoolInt64(!(hasArg == 0 || hasArg == int32(1))), 0) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__1)), __ccgo_ts+151, int32(1211), __ccgo_ts+1694)
	}
	i = 0
	for {
		if !(i < nArg) {
