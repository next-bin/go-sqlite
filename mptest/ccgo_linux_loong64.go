// Code generated for linux/loong64 by 'generator -DNDEBUG -I /tmp/libsqlite3/sqlite-src-3500200 -ignore-unsupported-alignment -ignore-link-errors -o mptest/ccgo_linux_loong64.go /tmp/libsqlite3/sqlite-src-3500200/mptest/mptest.c -lsqlite3', DO NOT EDIT.
	...
	*(*int32)(unsafe.Pointer(bp)) = int32(1)
	...
	_4:
		...
		for {
			...
			v11 = j
			j++
			*(*int8)(unsafe.Pointer(bp + 1054 + uintptr(v11)*100)) = 0
			goto _10
		_10:
			;
			j++
