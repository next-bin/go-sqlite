...
func startClient(tls *libc.TLS, iClient int32) {
	...
	if libsqlite3.Xsqlite3_changes(tls, g.Fdb) != 0 {
		...
		rc = libkernel32.XCreateProcessA(tls, libc.UintptrFromInt32(0), zSys, libc.UintptrFromInt32(0), libc.UintptrFromInt32(0), FALSE, uint32(0), libc.UintptrFromInt32(0), libc.UintptrFromInt32(0), bp, bp+68)
		if rc != 0 {
			libkernel32.XCloseHandle(tls, (*(*PROCESS_INFORMATION)(unsafe.Pointer(bp + 68))).FhThread)
			libkernel32.XCloseHandle(tls, (*(*PROCESS_INFORMATION)(unsafe.Pointer(bp + 68))).FhProcess)
		} else {
			errorMessage(tls, __ccgo_ts+825, libc.VaList(bp+96, libkernel32.XGetLastError(tls)))
		}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	*(*int32)(unsafe.Pointer(bp + 288)) = argc - int32(2)
	libsqlite3.Xsqlite3_snprintf(tls, int32(32), uintptr(unsafe.Pointer(&g))+32, __ccgo_ts+2479, libc.VaList(bp+312, int32(libkernel32.XGetCurrentProcessId(tls))))
	...
	if zClient != 0 {
		...
		libsqlite3.Xsqlite3_snprintf(tls, int32(32), uintptr(unsafe.Pointer(&g))+32, __ccgo_ts+2595, libc.VaList(bp+312, int32(libkernel32.XGetCurrentProcessId(tls)), iClient))
	} else {
		nTry = 0
		if g.FiTrace > 0 {
			v3 = __ccgo_ts + 2611
