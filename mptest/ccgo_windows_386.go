// Code generated for windows/386 by 'generator --cpp /usr/bin/i686-w64-mingw32-gcc --goarch 386 --goos windows -DNDEBUG -DSQLITE_OMIT_SEH -DSQLITE_OS_WIN=1 -I /tmp/libsqlite3/sqlite-src-3510100 -map gcc=i686-w64-mingw32-gcc -o mptest/ccgo_windows_386.go internal/overlay/mptest/mptest.c -lsqlite3', DO NOT EDIT.
...
func startClient(tls *libc.TLS, iClient int32) {
	...
	if libsqlite3.Xsqlite3_changes(tls, g.Fdb) != 0 {
		zSys = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+743, libc.VaList(bp+96, g.Fargv0, g.FzDbFile, iClient, g.FiTrace, g.FdefaultTimeout))
		if g.FbSqlTrace != 0 {
			zSys = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+787, libc.VaList(bp+96, zSys))
		}
		if g.FbSync != 0 {
			zSys = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+801, libc.VaList(bp+96, zSys))
		}
		if g.FzVfs != 0 {
			zSys = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+811, libc.VaList(bp+96, zSys, g.FzVfs))
		}
		if g.FiTrace >= int32(2) {
			logMessage(tls, __ccgo_ts+825, libc.VaList(bp+96, zSys))
		}
		...
		if rc != 0 {
			...
			errorMessage(tls, __ccgo_ts+838, libc.VaList(bp+96, libc.XGetLastError(tls)))
		}
...
func readFile(tls *libc.TLS, zFilename uintptr) (r uintptr) {
	...
	var sz int32
	_, _, _ = in, sz, z
	in = libc.Xfopen(tls, zFilename, __ccgo_ts+881)
	if in == uintptr(0) {
		fatalError(tls, __ccgo_ts+884, libc.VaList(bp+8, zFilename))
	}
...
func tokenLength(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	var c, c1, delim, inC, n, v1, v2 int32
	_, _, _, _, _, _, _ = c, c1, delim, inC, n, v1, v2
	n = 0
		...
		if int32(*(*int8)(unsafe.Pointer(z))) == int32('-') && int32(*(*int8)(unsafe.Pointer(z + 1))) == int32('-') {
			...
			if int32(*(*int8)(unsafe.Pointer(z))) == int32('"') || int32(*(*int8)(unsafe.Pointer(z))) == int32('\'') {
				...
				for {
					...
					c1 = v1
					if !(v1 != 0 && !(libc.Xisspace(tls, int32(uint8(c1))) != 0) && c1 != int32('"') && c1 != int32('\'') && c1 != int32(';')) {
						break
					}
					goto _5
				_5:
...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	_ = n
	n = 0
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 && (libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+913, uint32(5)) != 0 || !(libc.Xisspace(tls, int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(5))))))) != 0)) {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	...
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+919, uint32(7)) == 0 && libc.Xisspace(tls, int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(7))))))) != 0 || stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+927, uint32(6)) == 0 && libc.Xisspace(tls, int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(6))))))) != 0 {
			return n + len1
		}
		if libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+934, uint32(4)) == 0 && libc.Xisspace(tls, int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(4))))))) != 0 {
...
func waitForClient(tls *libc.TLS, iClient int32, iTimeout int32, zErrPrefix uintptr) {
	...
	_, _, _ = pStmt, rc, v1
	if iClient > 0 {
		pStmt = prepareSql(tls, __ccgo_ts+939, libc.VaList(bp+8, iClient))
	} else {
		pStmt = prepareSql(tls, __ccgo_ts+1035, 0)
	}
	g.FiTimeout = 0
	for {
	...
	if rc != int32(SQLITE_DONE) {
		if zErrPrefix == uintptr(0) {
			zErrPrefix = __ccgo_ts + 1116
		}
		if iClient > 0 {
			errorMessage(tls, __ccgo_ts+1117, libc.VaList(bp+8, zErrPrefix, iClient))
		} else {
			errorMessage(tls, __ccgo_ts+1149, libc.VaList(bp+8, zErrPrefix))
		}
	}
}
...
func booleanValue(tls *libc.TLS, zArg uintptr) (r int32) {
	...
	if libsqlite3.Xsqlite3_stricmp(tls, zArg, __ccgo_ts+1183) == 0 || libsqlite3.Xsqlite3_stricmp(tls, zArg, __ccgo_ts+1186) == 0 {
		return int32(1)
	}
	if libsqlite3.Xsqlite3_stricmp(tls, zArg, __ccgo_ts+1190) == 0 || libsqlite3.Xsqlite3_stricmp(tls, zArg, __ccgo_ts+1194) == 0 {
		return 0
	}
	errorMessage(tls, __ccgo_ts+1197, libc.VaList(bp+8, zArg))
	return 0
}
...
func runScript(tls *libc.TLS, iClient int32, taskId int32, zScript uintptr, zFilename uintptr) {
	...
	defer tls.Free(1312)
	var __local_argv __builtin_va_list
	var __retval, c, iBegin, iEnd, iNewClient, iTarget, iTimeout, ii, isGlob, j, jj, jj1, jj2, jj3, k, len1, n, nArg, prevLine, rc, rc1, v1 int32
	var pStmt, zAns, zAns1, zCopy, zNewFile, zNewScript, zSql, zSql1, zTName, zTask, zToDel, v8 uintptr
	var _ /* azArg at bp+1062 */ [2][100]int8
	var _ /* lineno at bp+16 */ int32
	var _ /* sResult at bp+20 */ String
	var _ /* zCmd at bp+32 */ [30]int8
	var _ /* zError at bp+62 */ [1000]int8
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = __local_argv, __retval, c, iBegin, iEnd, iNewClient, iTarget, iTimeout, ii, isGlob, j, jj, jj1, jj2, jj3, k, len1, n, nArg, pStmt, prevLine, rc, rc1, zAns, zAns1, zCopy, zNewFile, zNewScript, zSql, zSql1, zTName, zTask, zToDel, v1, v8
	*(*int32)(unsafe.Pointer(bp + 16)) = int32(1)
	prevLine = int32(1)
	ii = 0
	iBegin = 0
	libc.Xmemset(tls, bp+20, 0, uint32(12))
	stringReset(tls, bp+20)
	for {
		...
		prevLine = *(*int32)(unsafe.Pointer(bp + 16))
		len1 = tokenLength(tls, zScript+uintptr(ii), bp+16)
		...
		if ii > iBegin {
			zSql = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1219, libc.VaList(bp+1272, ii-iBegin, zScript+uintptr(iBegin)))
			evalSql(tls, bp+20, zSql, 0)
			libsqlite3.Xsqlite3_free(tls, zSql)
			iBegin = ii + len1
		}
		/* Parse the --command */
		if g.FiTrace >= int32(2) {
			logMessage(tls, __ccgo_ts+1219, libc.VaList(bp+1272, len1, zScript+uintptr(ii)))
		}
		n = extractToken(tls, zScript+uintptr(ii)+uintptr(2), len1-int32(2), bp+32, int32(30))
		nArg = 0
		for {
			...
			n = n + extractToken(tls, zScript+uintptr(ii)+uintptr(2)+uintptr(n), len1-int32(2)-n, bp+1062+uintptr(nArg)*100, int32(100))
			goto _2
		_2:
			;
			nArg = nArg + 1
		...
		for {
			...
			v1 = j
			j = j + 1
			*(*int8)(unsafe.Pointer(bp + 1062 + uintptr(v1)*100)) = 0
			goto _3
		_3:
			;
			j = j + 1
		 ...
		 */
		if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1224) == 0 {
			libsqlite3.Xsqlite3_sleep(tls, libc.Xatoi(tls, bp+1062))
		} else {
			/*
			 **   --exit N
			 **
			 ...
			 */
			if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1230) == 0 {
				rc = libc.Xatoi(tls, bp+1062)
				 ...
				 ** has begun.
				 */
				if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1235) == 0 {
					if g.FiTrace == int32(1) {
						logMessage(tls, __ccgo_ts+1219, libc.VaList(bp+1272, len1-int32(1), zScript+uintptr(ii)))
					}
					stringReset(tls, bp+20)
				} else {
					/*
					 ...
					 */
					if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1244) == 0 && iClient > 0 {
						finishScript(tls, iClient, taskId, int32(1))
					} else {
						/*
						 **  --reset
						 ...
						 */
						if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1251) == 0 {
							stringReset(tls, bp+20)
						} else {
							/*
							 **  --match ANSWER...
							 ...
							 */
							if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1257) == 0 {
								...
								if len1-jj-int32(1) != (*(*String)(unsafe.Pointer(bp + 20))).Fn || libc.Xstrncmp(tls, (*(*String)(unsafe.Pointer(bp + 20))).Fz, zAns, uint32(len1-jj-int32(1))) != 0 {
									errorMessage(tls, __ccgo_ts+1263, libc.VaList(bp+1272, prevLine, zFilename, len1-jj-int32(1), zAns, (*(*String)(unsafe.Pointer(bp + 20))).Fz))
								}
								g.FnTest = g.FnTest + 1
								stringReset(tls, bp+20)
							} else {
								 ...
								 ** ANSWER.
								 */
								if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1308) == 0 || libc.Xstrcmp(tls, bp+32, __ccgo_ts+1313) == 0 {
									zAns1 = zScript + uintptr(ii)
									isGlob = libc.BoolInt32(int32((*(*[30]int8)(unsafe.Pointer(bp + 32)))[0]) == int32('g'))
									...
									zCopy = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1219, libc.VaList(bp+1272, len1-jj1-int32(1), zAns1))
									if libc.BoolInt32(libsqlite3.Xsqlite3_strglob(tls, zCopy, (*(*String)(unsafe.Pointer(bp + 20))).Fz) == 0)^isGlob != 0 {
										errorMessage(tls, __ccgo_ts+1321, libc.VaList(bp+1272, prevLine, zFilename, zCopy, (*(*String)(unsafe.Pointer(bp + 20))).Fz))
									}
									 ...
									 */
									if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1364) == 0 {
										logMessage(tls, __ccgo_ts+438, libc.VaList(bp+1272, (*(*String)(unsafe.Pointer(bp + 20))).Fz))
									} else {
										/*
										 **  --source FILENAME
										 **
										 ...
										 */
										if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1371) == 0 {
											zToDel = uintptr(0)
											zNewFile = bp + 1062
											if !(int32(*(*int8)(unsafe.Pointer(zNewFile))) == int32('/') || int32(*(*int8)(unsafe.Pointer(zNewFile))) == int32('\\')) {
												...
												if k > 0 {
													v8 = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1378, libc.VaList(bp+1272, k, zFilename, zNewFile))
													zToDel = v8
													zNewFile = v8
											...
											if g.FiTrace != 0 {
												logMessage(tls, __ccgo_ts+1401, libc.VaList(bp+1272, zNewFile))
											}
											runScript(tls, 0, 0, zNewScript, zNewFile)
											libsqlite3.Xsqlite3_free(tls, zNewScript)
											if g.FiTrace != 0 {
												logMessage(tls, __ccgo_ts+1420, libc.VaList(bp+1272, zNewFile))
											}
											 ...
											 */
											if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1437) == 0 {
												jj2 = int32(7)
												for {
												...
												logMessage(tls, __ccgo_ts+1219, libc.VaList(bp+1272, len1-jj2, zScript+uintptr(ii)+uintptr(jj2)))
											} else {
												/*
												 **  --if EXPR
												 **
												 ...
												 */
												if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1443) == 0 {
													jj3 = int32(4)
													for {
													...
													pStmt = prepareSql(tls, __ccgo_ts+1446, libc.VaList(bp+1272, len1-jj3, zScript+uintptr(ii)+uintptr(jj3)))
													rc1 = libsqlite3.Xsqlite3_step(tls, pStmt)
													if rc1 != int32(SQLITE_ROW) || libsqlite3.Xsqlite3_column_int(tls, pStmt, 0) == 0 {
														ii = ii + findEndif(tls, zScript+uintptr(ii)+uintptr(len1), int32(1), bp+16)
													}
													libsqlite3.Xsqlite3_finalize(tls, pStmt)
												} else {
													/*
													 ...
													 */
													if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1458) == 0 {
														ii = ii + findEndif(tls, zScript+uintptr(ii)+uintptr(len1), 0, bp+16)
													} else {
														/*
														 **  --endif
														 **
														 ...
														 */
														if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1463) == 0 {
															/* no-op */
														} else {
															/*
															 **  --start CLIENT
															 ...
															 */
															if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1469) == 0 && iClient == 0 {
																iNewClient = libc.Xatoi(tls, bp+1062)
																if iNewClient > 0 {
																 ...
																 */
																if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1475) == 0 && iClient == 0 {
																	if nArg >= int32(2) {
																		v1 = libc.Xatoi(tls, bp+1062+1*100)
																	} else {
																		v1 = int32(10000)
																	}
																	iTimeout = v1
																	libsqlite3.Xsqlite3_snprintf(tls, int32(1000), bp+62, __ccgo_ts+1480, libc.VaList(bp+1272, prevLine, zFilename))
																	waitForClient(tls, libc.Xatoi(tls, bp+1062), iTimeout, bp+62)
																} else {
																	/*
																	 **  --task CLIENT
																	 **     <task-content-here>
																	 ...
																	 ** already.
																	 */
																	if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1495) == 0 && iClient == 0 {
																		iTarget = libc.Xatoi(tls, bp+1062)
																		iEnd = findEnd(tls, zScript+uintptr(ii)+uintptr(len1), bp+16)
																		if iTarget < 0 {
																			errorMessage(tls, __ccgo_ts+1500, libc.VaList(bp+1272, prevLine, zFilename, iTarget))
																		} else {
																			zTask = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1219, libc.VaList(bp+1272, iEnd, zScript+uintptr(ii)+uintptr(len1)))
																			if nArg > int32(1) {
																				zTName = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+438, libc.VaList(bp+1272, bp+1062+1*100))
																			} else {
																				zTName = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1537, libc.VaList(bp+1272, filenameTail(tls, zFilename), prevLine))
																			}
																			startClient(tls, iTarget)
																			runSql(tls, __ccgo_ts+1543, libc.VaList(bp+1272, iTarget, zTask, zTName))
																			libsqlite3.Xsqlite3_free(tls, zTask)
																			libsqlite3.Xsqlite3_free(tls, zTName)
																		}
																		iEnd = iEnd + tokenLength(tls, zScript+uintptr(ii)+uintptr(len1)+uintptr(iEnd), bp+16)
																		len1 = len1 + iEnd
																		iBegin = ii + len1
																	} else {
																		/*
																		 ...
																		 */
																		if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1599) == 0 {
																			test_breakpoint(tls)
																		} else {
																			/*
																			 ...
																			 */
																			if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1610) == 0 {
																				if nArg >= int32(1) {
																					v1 = libc.BoolInt32(!(booleanValue(tls, bp+1062) != 0))
																				} else {
																					v1 = int32(1)
																				}
																				...
																				/* error */
																				errorMessage(tls, __ccgo_ts+1626, libc.VaList(bp+1272, prevLine, zFilename, bp+32))
																			}
																		}
																	}
																}
	...
	if iBegin < ii {
		zSql1 = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1219, libc.VaList(bp+1272, ii-iBegin, zScript+uintptr(iBegin)))
		runSql(tls, zSql1, 0)
		libsqlite3.Xsqlite3_free(tls, zSql1)
	}
	stringFree(tls, bp+20)
}
	...
	for {
		...
		if libc.Xstrcmp(tls, z, zOption) == 0 {
			if hasArg != 0 && i == nArg-int32(1) {
				fatalError(tls, __ccgo_ts+1662, libc.VaList(bp+8, z))
			}
			if hasArg != 0 {
...
func usage(tls *libc.TLS, argv0 uintptr) {
	...
	var __local_argv __builtin_va_list
	var __retval, i int32
	var zTail, v2 uintptr
	_, _, _, _, _ = __local_argv, __retval, i, zTail, v2
	zTail = argv0
	i = 0
	for {
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	if strglob(tls, __ccgo_ts+2355, g.FzDbFile) != 0 {
		usage(tls, *(*uintptr)(unsafe.Pointer(argv)))
	}
	if libc.Xstrncmp(tls, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2362, uint32(80)) != 0 {
		v1 = __ccgo_ts + 2447
		libc.VaList(bp, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2362)
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v1, __local_argv)
		_ = __local_argv
		_ = __retval
	...
	*(*int32)(unsafe.Pointer(bp + 288)) = argc - int32(2)
	libsqlite3.Xsqlite3_snprintf(tls, int32(32), uintptr(unsafe.Pointer(&g))+32, __ccgo_ts+2507, libc.VaList(bp+312, int32(libc.XGetCurrentProcessId(tls))))
	zJMode = findOption(tls, argv+uintptr(2)*4, bp+288, __ccgo_ts+2519, int32(1))
	zNRep = findOption(tls, argv+uintptr(2)*4, bp+288, __ccgo_ts+2531, int32(1))
	if zNRep != 0 {
	...
	g.FzVfs = findOption(tls, argv+uintptr(2)*4, bp+288, __ccgo_ts+2538, int32(1))
	zClient = findOption(tls, argv+uintptr(2)*4, bp+288, __ccgo_ts+2542, int32(1))
	g.FzErrLog = findOption(tls, argv+uintptr(2)*4, bp+288, __ccgo_ts+2549, int32(1))
	g.FzLog = findOption(tls, argv+uintptr(2)*4, bp+288, __ccgo_ts+2556, int32(1))
	zTrace = findOption(tls, argv+uintptr(2)*4, bp+288, __ccgo_ts+2560, int32(1))
	if zTrace != 0 {
		g.FiTrace = libc.Xatoi(tls, zTrace)
	}
	if findOption(tls, argv+uintptr(2)*4, bp+288, __ccgo_ts+2566, 0) != uintptr(0) {
		g.FiTrace = 0
	}
	zTmout = findOption(tls, argv+uintptr(2)*4, bp+288, __ccgo_ts+2572, int32(1))
	if zTmout != 0 {
		iTmout = libc.Xatoi(tls, zTmout)
	}
	g.FbSqlTrace = libc.BoolInt32(findOption(tls, argv+uintptr(2)*4, bp+288, __ccgo_ts+2580, 0) != uintptr(0))
	g.FbSync = libc.BoolInt32(findOption(tls, argv+uintptr(2)*4, bp+288, __ccgo_ts+2589, 0) != uintptr(0))
	if g.FzErrLog != 0 {
	...
	if g.FzLog != 0 {
		g.FpLog = libc.Xfopen(tls, g.FzLog, __ccgo_ts+2594)
	} else {
	...
	if zClient != 0 {
		...
		if iClient < int32(1) {
			fatalError(tls, __ccgo_ts+2596, libc.VaList(bp+312, iClient))
		}
		libsqlite3.Xsqlite3_snprintf(tls, int32(32), uintptr(unsafe.Pointer(&g))+32, __ccgo_ts+2623, libc.VaList(bp+312, int32(libc.XGetCurrentProcessId(tls)), iClient))
	} else {
		nTry = 0
		if g.FiTrace > 0 {
			v1 = __ccgo_ts + 2639
		...
		_11:
			...
			i = 0
			for {
				v1 = libsqlite3.Xsqlite3_compileoption_get(tls, i)
				zCOption = v1
				if !(v1 != uintptr(0)) {
					break
				}
		...
		if rc != 0 {
			fatalError(tls, __ccgo_ts+2803, libc.VaList(bp+312, g.FzDbFile, nTry))
		}
	...
	if rc != 0 {
		fatalError(tls, __ccgo_ts+2844, libc.VaList(bp+312, g.FzDbFile))
	}
	if iTmout > 0 {
	...
	if zJMode != 0 {
		...
		runSql(tls, __ccgo_ts+2925, libc.VaList(bp+312, zJMode))
	}
	if !(g.FbSync != 0) {
	...
	libsqlite3.Xsqlite3_create_function(tls, g.Fdb, __ccgo_ts+2972, 0, int32(SQLITE_UTF8), uintptr(0), __ccgo_fp(vfsNameFunc), uintptr(0), uintptr(0))
	libsqlite3.Xsqlite3_create_function(tls, g.Fdb, __ccgo_ts+2980, int32(1), int32(SQLITE_UTF8), uintptr(0), __ccgo_fp(evalFunc), uintptr(0), uintptr(0))
	if iTmout > 0 {
		v16 = iTmout
	} else {
		v16 = int32(DEFAULT_TIMEOUT)
	}
	g.FdefaultTimeout = v16
	g.FiTimeout = g.FdefaultTimeout
	if g.FbSqlTrace != 0 {
	...
	if iClient > 0 {
		...
		for int32(1) != 0 {
			*(*uintptr)(unsafe.Pointer(bp + 300)) = uintptr(0)
			...
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+2998, libc.VaList(bp+312, *(*uintptr)(unsafe.Pointer(bp + 300)), *(*int32)(unsafe.Pointer(bp + 296))))
			}
			runScript(tls, iClient, *(*int32)(unsafe.Pointer(bp + 296)), *(*uintptr)(unsafe.Pointer(bp + 292)), *(*uintptr)(unsafe.Pointer(bp + 300)))
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+3012, libc.VaList(bp+312, *(*uintptr)(unsafe.Pointer(bp + 300)), *(*int32)(unsafe.Pointer(bp + 296))))
			}
		...
		*(*uintptr)(unsafe.Pointer(bp + 292)) = readFile(tls, *(*uintptr)(unsafe.Pointer(argv + 2*4)))
		...
		for {
			...
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+3523, libc.VaList(bp+312, *(*uintptr)(unsafe.Pointer(argv + 2*4)), iRep))
			}
			goto _25
		_25:
			;
		...
		iTimeout = int32(1000)
		for {
			v16 = trySql(tls, __ccgo_ts+3598, 0)
			rc = v16
			if !((v16 == int32(SQLITE_BUSY) || rc == int32(SQLITE_ROW)) && iTimeout > 0) {
				break
			}
			libsqlite3.Xsqlite3_sleep(tls, int32(10))
		...
		libsqlite3.Xsqlite3_sleep(tls, int32(100))
		pStmt = prepareSql(tls, __ccgo_ts+3619, 0)
		iTimeout = int32(1000)
		for {
			v16 = libsqlite3.Xsqlite3_step(tls, pStmt)
			rc = v16
			if !(v16 == int32(SQLITE_BUSY) && iTimeout > 0) {
				break
			}
			libsqlite3.Xsqlite3_sleep(tls, int32(10))
			iTimeout = iTimeout - int32(10)
