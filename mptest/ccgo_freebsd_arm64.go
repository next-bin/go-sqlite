// Code generated for freebsd/arm64 by 'generator -I /tmp/libsqlite3/sqlite-src-3450100 -ignore-unsupported-alignment -o mptest/ccgo_freebsd_arm64.go /tmp/libsqlite3/sqlite-src-3450100/mptest/mptest.c -lsqlite3', DO NOT EDIT.
...
func evalSql(tls *libc.TLS, p uintptr, zFormat uintptr, va uintptr) (r int32) {
	...
	*(*uintptr)(unsafe.Pointer(bp)) = uintptr(0)
	...
	_ = ap
	if !(g.iTimeout > 0) {
		libc.X__assert(tls, uintptr(unsafe.Pointer(&__func__)), __ccgo_ts+151, int32(494), __ccgo_ts+202)
	}
...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	for {
		if v10 = *(*uint8)(unsafe.Pointer(z + uintptr(n))) != 0; v10 {
			if v9 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+960, uint64(5)) != 0; !v9 {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	...
	for *(*uint8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if v9 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+966, uint64(7)) == 0; v9 {
		...
		if v19 = v9 && v1 != 0; !v19 {
			if v18 = stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+974, uint64(6)) == 0; v18 {
		...
		if v28 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+981, uint64(4)) == 0; v28 {
									...
									if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1411) == 0 {
										...
										if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1418) == 0 {
											...
											if !(int32(*(*uint8)(unsafe.Pointer(zNewFile))) == libc.Int32FromUint8('/')) {
												...
												if k > 0 {
													v52 = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1425, libc.VaList(bp+1264, k, zFilename, zNewFile))
													zToDel = v52
													zNewFile = v52
												}
											}
...
func findOption(tls *libc.TLS, azArg uintptr, pnArg uintptr, zOption uintptr, hasArg int32) (r uintptr) {
	...
	if !(hasArg == 0 || hasArg == int32(1)) {
		libc.X__assert(tls, uintptr(unsafe.Pointer(&__func__1)), __ccgo_ts+151, int32(1211), __ccgo_ts+1694)
	}
	i = 0
	for {
		if !(i < nArg) {
...
func usage(tls *libc.TLS, argv0 uintptr) {
	...
	libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+1765, libc.VaList(bp+8, zTail))
	libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+1804, 0)
	libc.Xexit(tls, int32(1))
}
...
func unrecognizedArguments(tls *libc.TLS, argv0 uintptr, nArg int32, azArg uintptr) {
	...
	var i int32
	_ = i
	libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+2376, libc.VaList(bp+8, argv0))
	i = 0
	for {
		if !(i < nArg) {
			break
		}
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+2404, libc.VaList(bp+8, *(*uintptr)(unsafe.Pointer(azArg + uintptr(i)*8))))
		goto _1
	_1:
		i++
	}
	libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+2408, 0)
	libc.Xexit(tls, int32(1))
}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	if libc.Bool(0 != 0) && libc.Xstrcmp(tls, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2417) != 0 {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+2502, libc.VaList(bp+40, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2417))
		libc.Xexit(tls, int32(1))
	}
