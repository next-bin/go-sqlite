// Code generated for freebsd/amd64 by 'generator -I /tmp/libsqlite3/sqlite-src-3450100 -ignore-unsupported-alignment -o mptest/ccgo_freebsd_amd64.go /tmp/libsqlite3/sqlite-src-3450100/mptest/mptest.c -lsqlite3', DO NOT EDIT.
			...
			if c == int32('?') {
				...
				if c == int32('[') {
					...
					if c == int32('#') {
						...
						v28 = int32(uint8(*(*int8)(unsafe.Pointer(z))))
					...
					_27:
						...
						z++
						for {
							v36 = int32(uint8(*(*int8)(unsafe.Pointer(z))))
	...
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if v19 = v9 && v1 != 0; !v19 {
			if v18 = stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+974, uint64(6)) == 0; v18 {
				v12 = int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(6))))))
		...
		if v28 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+981, uint64(4)) == 0; v28 {
			v22 = int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(4))))))
		...
		for {
			...
			for {
				if v28 = n < len1-int32(2); v28 {
					v22 = int32(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+int32(2)+n)))))
					if v22 < 0 || v22 >= libc.X__mb_sb_limit {
						v25 = uint64(0)
					} else {
						if libc.X_ThreadRuneLocale != 0 {
							...
							if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1304) == 0 {
								...
								for {
									if v40 = jj < len1-int32(1); v40 {
										v34 = int32(uint8(*(*int8)(unsafe.Pointer(zAns + uintptr(jj)))))
								...
								if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1355) == 0 || libc.Xstrcmp(tls, bp+24, __ccgo_ts+1360) == 0 {
									...
									for {
										if v50 = jj1 < len1-int32(1); v50 {
											v44 = int32(uint8(*(*int8)(unsafe.Pointer(zAns1 + uintptr(jj1)))))
									...
									if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1411) == 0 {
										...
										if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1418) == 0 {
											...
											if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1469) == 0 {
												...
												for {
													if v62 = jj2 < len1; v62 {
														v56 = int32(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+jj2)))))
												...
												if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1475) == 0 {
													...
													for {
														if v72 = jj3 < len1; v72 {
															v66 = int32(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+jj3)))))
