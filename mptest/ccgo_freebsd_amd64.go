// Code generated for freebsd/amd64 by 'generator -DNDEBUG -I /tmp/libsqlite3/sqlite-src-3510100 -ignore-unsupported-alignment -ignore-link-errors -o mptest/ccgo_freebsd_amd64.go internal/overlay/mptest/mptest.c -lsqlite3', DO NOT EDIT.
...
func strglob(tls *libc.TLS, zGlob uintptr, z uintptr) (r int32) {
	...
	var v22 uint64
	var v6 bool
	_, _, _, _, _, _, _, _, _, _, _, _, _ = c, c2, invert, prior_c, seen, v1, v19, v2, v22, v3, v4, v5, v6
	for {
		v2 = zGlob
		zGlob = zGlob + 1
...
func tokenLength(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	var c, c1, delim, inC, n, v1, v4, v9 int32
	var v3 __ct_rune_t
	var v6 uint64
	var v7 uintptr
	var v31 bool
...
_2:
	...
	if v1 != 0 || int32(*(*int8)(unsafe.Pointer(z))) == int32('/') && int32(*(*int8)(unsafe.Pointer(z + 1))) == int32('*') {
		...
		for {
			v4 = n
			n = n + 1
			v1 = int32(*(*int8)(unsafe.Pointer(z + uintptr(v4))))
			c = v1
			if !(v1 != 0) {
				break
			}
			...
			if int32(*(*int8)(unsafe.Pointer(z))) == int32('"') || int32(*(*int8)(unsafe.Pointer(z))) == int32('\'') {
				...
				for {
					...
					if v31 = v1 != 0; v31 {
						...
						goto _27
					_27:
						v4 = libc.BoolInt32(!!(v9 != 0))
						goto _24
					_24:
					}
					if !(v31 && !(v4 != 0) && c1 != int32('"') && c1 != int32('\'') && c1 != int32(';')) {
						break
					}
					goto _21
				_21:
...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	for {
		if v10 = *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0; v10 {
			if v9 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+909, uint64(5)) != 0; !v9 {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	var len1, n, skip, v1, v10, v13, v4 int32
	var v12, v3 __ct_rune_t
	var v15, v6 uint64
	var v16, v7 uintptr
	var v18, v19, v9 bool
	...
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if v9 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+915, uint64(7)) == 0; v9 {
		...
		if v19 = v9 && v1 != 0; !v19 {
			if v18 = stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+923, uint64(6)) == 0; v18 {
		...
		if v9 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+930, uint64(4)) == 0; v9 {
									...
									if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1360) == 0 {
										...
										if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1367) == 0 {
											...
											if !(int32(*(*int8)(unsafe.Pointer(zNewFile))) == libc.Int32FromUint8('/')) {
												...
												if k > 0 {
													v8 = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1374, libc.VaList(bp+1264, k, zFilename, zNewFile))
													zToDel = v8
													zNewFile = v8
