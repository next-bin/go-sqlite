...
func XdeflateResetKeep(tls *libc.TLS, strm Tz_streamp) (r int32) {
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fwrap == int32(2) {
		v4 = Xcrc32(tls, uint32(0), uintptr(m_Z_NULL), uint32(0))
	} else {
		v4 = Xadler32(tls, uint32(0), uintptr(m_Z_NULL), uint32(0))
	}
...
func Xinflate(tls *libc.TLS, strm Tz_streamp, flush int32) (r int32) {
	...
	_10:
		...
		v54 = Xcrc32(tls, uint32(0), uintptr(m_Z_NULL), uint32(0))
	...
	_12:
		...
		v57 = Xadler32(tls, uint32(0), uintptr(m_Z_NULL), uint32(0))
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint32(1), __ccgo_ts+585, libc.VaList(bp+8, path))
...
func Xgzdopen(tls *libc.TLS, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, path, libc.Uint32FromInt32(7)+libc.Uint32FromInt32(3)*libc.Uint32FromInt64(4), __ccgo_ts+588, libc.VaList(bp+8, fd))
...
func Xgz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint32(3), __ccgo_ts+610, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, __ccgo_ts+617, msg))
}
...
func _gz_look(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fsize == uint32(0) {
		...
		if XinflateInit2_(tls, state+96, libc.Int32FromInt32(15)+libc.Int32FromInt32(16), __ccgo_ts, libc.Int32FromInt64(56)) != m_Z_OK { /* gunzip */
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
