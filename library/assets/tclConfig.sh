...
TCL_EXTRA_CFLAGS='-UHAVE_CPUID -UHAVE_FTS -DNDEBUG -mlong-double-64 -pipe '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/tmp/libtcl8.6/tcl8.6.11/unix -ltcl8.6'
...
# compiled.
TCL_SRC_DIR='/tmp/libtcl8.6/tcl8.6.11'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/tmp/libtcl8.6/tcl8.6.11/unix -ltclstub8.6'
...
TCL_BUILD_STUB_LIB_PATH='/tmp/libtcl8.6/tcl8.6.11/unix/libtclstub8.6.a'
