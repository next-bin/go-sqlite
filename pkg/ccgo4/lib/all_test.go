...
package ccgo // import "github.com/next-bin/go-sqlite3/pkg/ccgo4/lib"
...
import (
	...
	"github.com/next-bin/go-sqlite3/pkg/ccorpus2"
	"github.com/next-bin/go-sqlite3/pkg/fileutil"
	"github.com/next-bin/go-sqlite3/pkg/gc2"
	_ "github.com/next-bin/go-sqlite3/pkg/libc"
...
var (
	...
	oLibc         = flag.String("libc", "github.com/next-bin/go-sqlite3/pkg/libc", "")
...
func getLatest() string {
	...
	for _, v := range a {
		...
		if strings.HasPrefix(v, "github.com/next-bin/go-sqlite3/pkg/libc") {
			a := strings.Fields(v)
			return "@" + a[1]
		}
	}
...
func TestCSmith(t *testing.T) {
	...
	blacklist := []struct{ target, seed string }{
		...
		{"linux/ppc64le", "3088696074888013"}, // TODO https://gitlab.com/cznic/builder/-/tree/91efcffac0cf3a1618f47d117864b76435ed87a2/logs/github.com/next-bin/go-sqlite3/pkg/ccgo4/lib
		...
		//
		// https://gitlab.com/cznic/builder/-/blob/a796cec9f649d055ac3e20294c0d577b28315806/logs/github.com/next-bin/go-sqlite3/pkg/ccgo4/lib/pi64
		//
