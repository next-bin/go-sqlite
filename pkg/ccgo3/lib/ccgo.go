...
package ccgo // import "github.com/next-bin/go-sqlite3/pkg/ccgo3/lib"
...
import (
	...
	"github.com/next-bin/go-sqlite3/pkg/cc3"
...
typedef struct { __INT64_TYPE__ lo, hi; } __int128_t;   // must match github.com/next-bin/go-sqlite3/pkg/mathutil.Int128
typedef struct { __UINT64_TYPE__ lo, hi; } __uint128_t; // must match github.com/next-bin/go-sqlite3/pkg/mathutil.Int128
#endif;
...
`
	defaultCrt = "github.com/next-bin/go-sqlite3/pkg/libc"
)
