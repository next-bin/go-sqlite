...
//	in github.com/next-bin/go-sqlite3/pkg/fileutil go get -d github.com/next-bin/go-sqlite3/pkg/mathutil@v1.5.0
//	in github.com/next-bin/go-sqlite3/pkg/hash go get -d github.com/next-bin/go-sqlite3/pkg/mathutil@v1.5.0
//	in github.com/next-bin/go-sqlite3/pkg/memory go get -d github.com/next-bin/go-sqlite3/pkg/mathutil@v1.5.0
//	in github.com/next-bin/go-sqlite3/pkg/sortutil go get -d github.com/next-bin/go-sqlite3/pkg/mathutil@v1.5.0
//	in github.com/next-bin/go-sqlite3/pkg/strutil go get -d github.com/next-bin/go-sqlite3/pkg/mathutil@v1.5.0
//	~ $
//
// # Subcommand update
//
...
// this command
//
//	$ go install github.com/next-bin/go-sqlite3/pkg/gomod@v1.0.0
//
