...
//	in github.com/next-bin/go-sqlite3/pkg/fileutil go get -d github.com/next-bin/go-sqlite3/pkg/mathutil@v1.0.7
//	in github.com/next-bin/go-sqlite3/pkg/hash go get -d github.com/next-bin/go-sqlite3/pkg/mathutil@v1.0.7
//	in github.com/next-bin/go-sqlite3/pkg/memory go get -d github.com/next-bin/go-sqlite3/pkg/mathutil@v1.0.7
//	in github.com/next-bin/go-sqlite3/pkg/sortutil go get -d github.com/next-bin/go-sqlite3/pkg/mathutil@v1.0.7
//	in github.com/next-bin/go-sqlite3/pkg/strutil go get -d github.com/next-bin/go-sqlite3/pkg/mathutil@v1.0.7
//	~ $
//
// # Subcommand update
//
...
// this command
//
//	$ go install github.com/next-bin/go-sqlite3/pkg/gomod@v1.0.7
//
...
import (
	...
	"github.com/next-bin/go-sqlite3/pkg/gomod/engine"
)
