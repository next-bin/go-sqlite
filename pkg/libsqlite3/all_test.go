...
package libsqlite3 // import "github.com/next-bin/go-sqlite3/pkg/libsqlite3"
...
import (
	...
	_ "github.com/next-bin/go-sqlite3/pkg/ccgo4/lib"
	util "github.com/next-bin/go-sqlite3/pkg/fileutil/ccgo"
	"github.com/next-bin/go-sqlite3/pkg/libtcl8.6/library"
)
...
func TestConcurrentProcesses(t *testing.T) {
	...
	args = append(args, "github.com/next-bin/go-sqlite3/pkg/libsqlite3/mptest")
