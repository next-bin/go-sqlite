// Code generated for openbsd/amd64 by 'generator -DNDEBUG -DSQLITE_ENABLE_DBPAGE_VTAB -DSQLITE_ENABLE_RTREE -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_openbsd_amd64.go -I /tmp/libsqlite3/sqlite-src-3530000 /tmp/libsqlite3/sqlite-src-3530000/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func integerValue(tls *libc.TLS, zArg uintptr) (r int32) {
	...
	if int32(*(*int8)(unsafe.Pointer(zArg))) == int32('0') && int32(*(*int8)(unsafe.Pointer(zArg + 1))) == int32('x') {
		...
		for {
			v1 = int32(*(*int8)(unsafe.Pointer(zArg)))
			if v1 == -int32(1) {
				v3 = 0
			} else {
				v3 = int32(*(*int8)(unsafe.Pointer(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_N)
			}
			v2 = v3
			goto _4
		_4:
...
func printSql(tls *libc.TLS, zSql uintptr) {
	...
	for {
		if v6 = n > 0; v6 {
			if v5 = int32(*(*int8)(unsafe.Pointer(zSql + uintptr(n-int32(1))))) == int32(';'); !v5 {
				v1 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(zSql + uintptr(n-int32(1))))))
				if v1 == -int32(1) {
					v4 = 0
				} else {
					v4 = int32(*(*int8)(unsafe.Pointer(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_S)
				}
				v2 = v4
				goto _3
			_3:
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	for cond := true; cond; cond = *(*int8)(unsafe.Pointer(zTSet)) != 0 {
		...
		if zSep != 0 {
			kk = int32(1)
			for {
				if v21 = *(*int8)(unsafe.Pointer(zSep + uintptr(kk))) != 0; v21 {
					v2 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(zSep + uintptr(kk)))))
					if v2 == -int32(1) {
						v4 = 0
					} else {
						v4 = int32(*(*int8)(unsafe.Pointer(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v2))))) & int32(_CTYPE_N)
					}
					v3 = v4
					goto _19
				_19:
