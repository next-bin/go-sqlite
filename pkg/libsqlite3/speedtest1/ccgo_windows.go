// Code generated for windows/amd64 by 'generator --cpp /usr/bin/x86_64-w64-mingw32-gcc --goarch amd64 --goos windows -DNDEBUG -DSQLITE_ENABLE_DBPAGE_VTAB -DSQLITE_OMIT_SEH -DSQLITE_OS_WIN=1 -DSQLITE_ENABLE_RTREE -I /tmp/libsqlite3/sqlite-src-3530000 -build-lines \/\/go:build windows && (amd64 || arm64)\n\/\/ \x2bbuild windows\n\/\/ \x2bbuild amd64 arm64 -map gcc=x86_64-w64-mingw32-gcc -o speedtest1/ccgo_windows.go /tmp/libsqlite3/sqlite-src-3530000/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func HashUpdate(tls *libc.TLS, aData uintptr, nData uint32) {
	...
	for {
		...
		j = uint8(int32(j) + (int32(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3168 + 3 + uintptr(i)))) + int32(*(*uint8)(unsafe.Pointer(aData + uintptr(k))))))
...
func HashFinal(tls *libc.TLS) {
	...
	for {
		...
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3168 + 3 + uintptr(j))) = t
		t = uint8(int32(t) + int32(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3168 + 3 + uintptr(i)))))
...
func speedtest1_final(tls *libc.TLS) {
	...
	_4:
		...
		for {
			...
			v1 = __ccgo_ts + 459
			libc.VaList(bp, int32(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3168 + 259 + uintptr(i)))))
			__local_argv = bp
			__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(1)), v1, __local_argv)
			_ = __local_argv
			_ = __retval
...
func speedtest1_run(tls *libc.TLS) {
	...
	for libsqlite3.Xsqlite3_step(tls, g.FpStmt) == int32(SQLITE_ROW) {
		...
		for {
			...
			if uint64(g.FnResult+len1) < libc.Uint64FromInt64(3000)-libc.Uint64FromInt32(2) {
				if g.FnResult > 0 {
					v1 = uintptr(unsafe.Pointer(&g)) + 144
					v5 = *(*int32)(unsafe.Pointer(v1))
					*(*int32)(unsafe.Pointer(v1)) = *(*int32)(unsafe.Pointer(v1)) + 1
					*(*int8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 148 + uintptr(v5))) = int8(' ')
				}
				libc.Xmemcpy(tls, uintptr(unsafe.Pointer(&g))+148+uintptr(g.FnResult), z1, uint64(len1+int32(1)))
				g.FnResult += len1
			}
			goto _3
		_3:
	...
	if g.FbReprepare != 0 {
		...
		if rc != SQLITE_OK {
			fatal_error(tls, __ccgo_ts+562, libc.VaList(bp+48, libsqlite3.Xsqlite3_sql(tls, *(*uintptr)(unsafe.Pointer(bp + 32))), rc, libsqlite3.Xsqlite3_errmsg(tls, g.Fdb)))
		}
		g.FpStmt = *(*uintptr)(unsafe.Pointer(bp + 32))
	} else {
		rc = libsqlite3.Xsqlite3_reset(tls, g.FpStmt)
		if rc != SQLITE_OK {
			fatal_error(tls, __ccgo_ts+562, libc.VaList(bp+48, libsqlite3.Xsqlite3_sql(tls, g.FpStmt), rc, libsqlite3.Xsqlite3_errmsg(tls, g.Fdb)))
		}
	}
	speedtest1_shrink_memory(tls)
}
...
func testset_rtree(tls *libc.TLS, p1 int32, p2 int32) {
	...
	aCheck = libsqlite3.Xsqlite3_malloc(tls, int32(uint64(4)*uint64(g.FszTest)*uint64(500)))
	...
	for {
		...
		if int32(*(*int8)(unsafe.Pointer(z))) == int32('-') {
			...
			if libc.Xstrcmp(tls, z, __ccgo_ts+36561) == 0 {
				...
				if libc.Xstrcmp(tls, z, __ccgo_ts+36572) == 0 {
					...
					if libc.Xstrcmp(tls, z, __ccgo_ts+36589) == 0 {
						if i >= argc-int32(1) {
							fatal_error(tls, __ccgo_ts+36599, libc.VaList(bp+504, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
						}
						i = i + 1
						v4 = i
											...
											if libc.Xstrcmp(tls, z, __ccgo_ts+36678) == 0 {
												...
												if libc.Xstrcmp(tls, z, __ccgo_ts+36683) == 0 {
													...
													if libc.Xstrcmp(tls, z, __ccgo_ts+36694) == 0 {
														...
														i = i + 1
														v4 = i
														zJMode = *(*uintptr)(unsafe.Pointer(argv + uintptr(v4)*8))
													} else {
																	...
																	if libc.Xstrcmp(tls, z, __ccgo_ts+36722) == 0 {
																		...
																		if libc.Xstrcmp(tls, z, __ccgo_ts+36734) == 0 {
																			...
																			if libc.Xstrcmp(tls, z, __ccgo_ts+36744) == 0 {
																				...
																				i = i + 1
																				v4 = i
																				mmapSize = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v4)*8)))
																			} else {
																							...
																							if libc.Xstrcmp(tls, z, __ccgo_ts+36781) == 0 {
																								...
																								if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), __ccgo_ts+36788) == 0 {
																									...
																									if g.FhashFile == uintptr(0) {
																										fatal_error(tls, __ccgo_ts+36793, libc.VaList(bp+504, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																									}
																								}
																							} else {
																								if libc.Xstrcmp(tls, z, __ccgo_ts+36823) == 0 {
																									...
																									i = i + 1
																									v4 = i
																									pageSize = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v4)*8)))
																								} else {
																									if libc.Xstrcmp(tls, z, __ccgo_ts+36832) == 0 {
																										...
																										if libc.Xstrcmp(tls, z, __ccgo_ts+36839) == 0 {
																											...
																											if libc.Xstrcmp(tls, z, __ccgo_ts+36862) == 0 {
																												...
																												i = i + 1
																												v4 = i
																												g.FnRepeat = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v4)*8)))
																											} else {
																													...
																													if libc.Xstrcmp(tls, z, __ccgo_ts+36879) == 0 {
																														...
																														if libc.Xstrcmp(tls, z, __ccgo_ts+36890) == 0 {
																															...
																															if libc.Xstrcmp(tls, z, __ccgo_ts+36903) == 0 {
																																...
																																i = i + 1
																																v4 = i
																																g.FpScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v4)*8)), __ccgo_ts+36790)
																																if g.FpScript == uintptr(0) {
																																	fatal_error(tls, __ccgo_ts+36910, libc.VaList(bp+504, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																																}
																															} else {
																																if libc.Xstrcmp(tls, z, __ccgo_ts+36943) == 0 {
																																	...
																																	if libc.Xstrcmp(tls, z, __ccgo_ts+36951) == 0 {
																																		...
																																		if libc.Xstrcmp(tls, z, __ccgo_ts+36965) == 0 {
																																			...
																																			i = i + 1
																																			v5 = i
																																			v4 = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v5)*8)))
																																			g.FszBase = v4
																																			g.FszTest = v4
																																		} else {
																																				...
																																				if libc.Xstrcmp(tls, z, __ccgo_ts+36986) == 0 {
																																					...
																																					if libc.Xstrcmp(tls, z, __ccgo_ts+36992) == 0 {
																																						...
																																						if libc.Xstrcmp(tls, z, __ccgo_ts+37050) == 0 {
																																							...
																																							i = i + 1
																																							v4 = i
																																							zTSet = *(*uintptr)(unsafe.Pointer(argv + uintptr(v4)*8))
																																						} else {
																																							if libc.Xstrcmp(tls, z, __ccgo_ts+37058) == 0 {
																																								...
																																								if libc.Xstrcmp(tls, z, __ccgo_ts+37064) == 0 {
																																									...
																																									i = i + 1
																																									v4 = i
																																									nThread = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v4)*8)))
																																								} else {
																																										...
																																										if libc.Xstrcmp(tls, z, __ccgo_ts+37080) == 0 {
																																											...
																																											if libc.Xstrcmp(tls, z, __ccgo_ts+37088) == 0 {
																																												...
																																												if libc.Xstrcmp(tls, z, __ccgo_ts+37095) == 0 {
																																													...
																																													i = i + 1
																																													v4 = i
																																													g.FzVfs = *(*uintptr)(unsafe.Pointer(argv + uintptr(v4)*8))
																																												} else {
																																													if libc.Xstrcmp(tls, z, __ccgo_ts+37099) == 0 {
																																														...
																																														i = i + 1
																																														v4 = i
																																														g.FnReserve = libc.Xatoi(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v4)*8)))
																																													} else {
																																															...
																																															if libc.Xstrcmp(tls, z, __ccgo_ts+37122) == 0 {
																																																...
																																																if libc.Xstrcmp(tls, z, __ccgo_ts+37172) == 0 {
																																																	...
																																																	_18:
																																																		...
																																																		fatal_error(tls, __ccgo_ts+37186, libc.VaList(bp+504, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), *(*uintptr)(unsafe.Pointer(argv))))
																																																	}
																																																}
																																															}
																																														}
			...
			if g.FzDbName == uintptr(0) {
				...
				fatal_error(tls, __ccgo_ts+37227, libc.VaList(bp+504, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), *(*uintptr)(unsafe.Pointer(argv))))
			}
		}
		goto _3
	_3:
