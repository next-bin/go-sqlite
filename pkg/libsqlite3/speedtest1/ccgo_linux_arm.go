// Code generated for linux/arm by 'generator -DNDEBUG -DSQLITE_ENABLE_DBPAGE_VTAB -DSQLITE_ENABLE_RTREE -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_linux_arm.go -I /tmp/libsqlite3/sqlite-src-3530000 /tmp/libsqlite3/sqlite-src-3530000/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
import (
	...
	"github.com/next-bin/go-sqlite3/pkg/libsqlite3"
)
...
func HashInit(tls *libc.TLS) {
	...
	for {
		...
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(k))) = uint8(k)
		goto _1
	_1:
		;
		k = k + 1
...
func HashUpdate(tls *libc.TLS, aData uintptr, nData uint32) {
	...
	j = g.Fhash.Fj
	if g.FhashFile != 0 {
		libc.Xfwrite(tls, aData, uint32(1), nData, g.FhashFile)
	}
	k = uint32(0)
	for {
		if !(k < nData) {
		...
		j = libc.Uint8FromInt32(int32(j) + (libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(i)))) + libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(aData + uintptr(k))))))
		t = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(j)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(j))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(i)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(i))) = t
		i = i + 1
		goto _1
	_1:
		;
...
func HashFinal(tls *libc.TLS) {
	...
	for {
		...
		i = i + 1
		t = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(i)))
		j = libc.Uint8FromInt32(int32(j) + libc.Int32FromUint8(t))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(i))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(j)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(j))) = t
		t = libc.Uint8FromInt32(int32(t) + libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(i)))))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 259 + uintptr(k))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(t)))
		goto _1
	_1:
		;
		k = k + 1
...
func integerValue(tls *libc.TLS, zArg uintptr) (r int32) {
	...
	i = 0
	for {
		if !(libc.Uint32FromInt32(i) < libc.Uint32FromInt64(72)/libc.Uint32FromInt64(8)) {
			break
		}
		if libsqlite3.Xsqlite3_stricmp(tls, aMult[i].FzSuffix, zArg) == 0 {
			v = v * int64(aMult[i].FiMult)
			break
		}
		goto _2
	_2:
...
func speedtest1_numbername(tls *libc.TLS, n uint32, zOut uintptr, nOut int32) (r int32) {
	...
	if n >= uint32(1000000000) {
		...
		i = i + libc.Int32FromUint32(libc.Xstrlen(tls, zOut+uintptr(i)))
...
func speedtest1_begin_test(tls *libc.TLS, iTestNum int32, zTestName uintptr, va uintptr) {
	...
	var zName uintptr
	_, _, _ = ap, n, zName
	n = libc.Int32FromUint32(libc.Xstrlen(tls, zTestName))
	iTestNumber = iTestNum
	ap = va
	zName = libsqlite3.Xsqlite3_vmprintf(tls, zTestName, ap)
	_ = ap
	n = libc.Int32FromUint32(libc.Xstrlen(tls, zName))
...
func speedtest1_final(tls *libc.TLS) {
	...
	if g.FbVerify != 0 {
		...
		for {
			...
			libc.Xprintf(tls, __ccgo_ts+459, libc.VaList(bp+8, libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3132 + 259 + uintptr(i))))))
			goto _1
		_1:
			;
			i = i + 1
...
func printSql(tls *libc.TLS, zSql uintptr) {
	...
	n = libc.Int32FromUint32(libc.Xstrlen(tls, zSql))
	for {
		if v5 = n > 0; v5 {
...
func speedtest1_once(tls *libc.TLS, zFormat uintptr, va uintptr) (r uintptr) {
	...
	_, _, _, _, _, _ = ap, rc1, z, z1, zResult, zSql
	zResult = uintptr(0)
	ap = va
	zSql = libsqlite3.Xsqlite3_vmprintf(tls, zFormat, ap)
	_ = ap
...
func speedtest1_prepare(tls *libc.TLS, zFormat uintptr, va uintptr) {
	...
	if g.FbSqlOnly != 0 {
		...
		rc = libsqlite3.Xsqlite3_prepare_v2(tls, g.Fdb, zSql, -int32(1), uintptr(unsafe.Pointer(&g))+12, uintptr(0))
		if rc != 0 {
...
func speedtest1_run(tls *libc.TLS) {
	...
	for libsqlite3.Xsqlite3_step(tls, g.FpStmt) == int32(SQLITE_ROW) {
		...
		for {
			...
			len1 = libc.Int32FromUint32(libc.Xstrlen(tls, z1))
			if g.FbVerify != 0 {
				eType = libsqlite3.Xsqlite3_column_type(tls, g.FpStmt, i)
				(*(*[2]uint8)(unsafe.Pointer(bp)))[0] = uint8('\n')
				(*(*[2]uint8)(unsafe.Pointer(bp)))[int32(1)] = *(*uint8)(unsafe.Pointer(__ccgo_ts + 588 + uintptr(eType)))
				if g.FnResByte != 0 {
				...
				if eType == int32(SQLITE_FLOAT) {
					...
					if eType == int32(SQLITE_BLOB) {
						...
						for {
							...
							(*(*[2]uint8)(unsafe.Pointer(bp + 2)))[0] = *(*uint8)(unsafe.Pointer(__ccgo_ts + 595 + uintptr(libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(aBlob + uintptr(iBlob))))>>int32(4))))
							(*(*[2]uint8)(unsafe.Pointer(bp + 2)))[int32(1)] = *(*uint8)(unsafe.Pointer(__ccgo_ts + 595 + uintptr(libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(aBlob + uintptr(iBlob))))&int32(15))))
			...
			if libc.Uint32FromInt32(g.FnResult+len1) < libc.Uint32FromInt64(3000)-libc.Uint32FromInt32(2) {
				if g.FnResult > 0 {
					v4 = uintptr(unsafe.Pointer(&g)) + 120
					v3 = *(*int32)(unsafe.Pointer(v4))
					*(*int32)(unsafe.Pointer(v4)) = *(*int32)(unsafe.Pointer(v4)) + 1
					*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 124 + uintptr(v3))) = uint8(' ')
				}
				libc.Xmemcpy(tls, uintptr(unsafe.Pointer(&g))+124+uintptr(g.FnResult), z1, libc.Uint32FromInt32(len1+int32(1)))
				g.FnResult += len1
			}
			goto _1
		_1:
	...
	if g.FbReprepare != 0 {
		libsqlite3.Xsqlite3_prepare_v2(tls, g.Fdb, libsqlite3.Xsqlite3_sql(tls, g.FpStmt), -int32(1), bp+4, uintptr(0))
		rc = libsqlite3.Xsqlite3_finalize(tls, g.FpStmt)
		if rc != SQLITE_OK {
			fatal_error(tls, __ccgo_ts+562, libc.VaList(bp+16, libsqlite3.Xsqlite3_sql(tls, *(*uintptr)(unsafe.Pointer(bp + 4))), rc, libsqlite3.Xsqlite3_errmsg(tls, g.Fdb)))
		}
		g.FpStmt = *(*uintptr)(unsafe.Pointer(bp + 4))
	} else {
		rc = libsqlite3.Xsqlite3_reset(tls, g.FpStmt)
		if rc != SQLITE_OK {
			fatal_error(tls, __ccgo_ts+562, libc.VaList(bp+16, libsqlite3.Xsqlite3_sql(tls, g.FpStmt), rc, libsqlite3.Xsqlite3_errmsg(tls, g.Fdb)))
		}
	}
	speedtest1_shrink_memory(tls)
}
...
func testset_main(tls *libc.TLS) {
	bp := tls.Alloc(2064)
	defer tls.Free(2064)
	var i, len1, maxb, n, sz, v1 int32
	var x1, x2 uint32
	var v21 uintptr
	var _ /* zNum at bp+0 */ [2000]uint8
	_, _, _, _, _, _, _, _, _ = i, len1, maxb, n, sz, x1, x2, v1, v21 /* Maximum swizzled value */
	x1 = uint32(0)
	...
	for {
		...
		if (i-int32(1))%g.FnRepeat == 0 {
			...
			len1 = speedtest1_numbername(tls, libc.Uint32FromInt32(i), bp+uintptr(1), libc.Int32FromUint32(libc.Uint32FromInt64(2000)-libc.Uint32FromInt32(2)))
	...
	for {
		...
		if (i-int32(1))%g.FnRepeat == 0 {
			x1 = swizzle(tls, libc.Uint32FromInt32(i), libc.Uint32FromInt32(maxb))
			len1 = speedtest1_numbername(tls, x1, bp, libc.Int32FromUint32(libc.Uint32FromInt64(2000)-libc.Uint32FromInt32(1)))
		}
	...
	speedtest1_run(tls)
	speedtest1_end_test(tls)
	v1 = g.FszTest * libc.Int32FromInt32(700)
	n = v1
	sz = v1
	(*(*[2000]uint8)(unsafe.Pointer(bp)))[0] = uint8(0)
...
func testset_app(tls *libc.TLS) {
	...
	for {
		...
		dbMain = g.Fdb
		*(*uintptr)(unsafe.Pointer(bp)) = uintptr(0)
		if g.FzDbName != 0 && *(*uint8)(unsafe.Pointer(g.FzDbName)) != 0 {
...
func twoCoords(tls *libc.TLS, p1 int32, p2 int32, mx uint32, pX0 uintptr, pX1 uintptr) {
	var d, span, x0, x1 uint32
	_, _, _, _ = d, span, x0, x1
	span = mx/uint32(100) + uint32(1)
	if speedtest1_random(tls)%uint32(3) == uint32(0) {
		span = span * libc.Uint32FromInt32(p1)
	}
	if speedtest1_random(tls)%libc.Uint32FromInt32(p2) == uint32(0) {
		span = mx / uint32(2)
	}
...
//	*/
func xsliceGeometryCallback(tls *libc.TLS, p uintptr, nCoord int32, aCoord uintptr, pRes uintptr) (r int32) {
	*(*int32)(unsafe.Pointer(pRes)) = libc.BoolInt32(*(*float64)(unsafe.Pointer(aCoord + 3*8)) >= *(*sqlite3_rtree_dbl)(unsafe.Pointer((*sqlite3_rtree_geometry)(unsafe.Pointer(p)).FaParam)) && *(*float64)(unsafe.Pointer(aCoord + 2*8)) <= *(*sqlite3_rtree_dbl)(unsafe.Pointer((*sqlite3_rtree_geometry)(unsafe.Pointer(p)).FaParam + 1*8)))
	return SQLITE_OK
}
...
func testset_rtree(tls *libc.TLS, p1 int32, p2 int32) {
	...
	defer tls.Free(80)
	var aCheck uintptr
	var i, iStep, mxCoord, mxRowid, n, v1 uint32
	var _ /* x0 at bp+0 */ uint32
	var _ /* x1 at bp+4 */ uint32
	var _ /* y0 at bp+8 */ uint32
	var _ /* y1 at bp+12 */ uint32
	var _ /* z0 at bp+16 */ uint32
	var _ /* z1 at bp+20 */ uint32
	_, _, _, _, _, _, _ = aCheck, i, iStep, mxCoord, mxRowid, n, v1
	aCheck = libsqlite3.Xsqlite3_malloc(tls, libc.Int32FromUint32(uint32(4)*libc.Uint32FromInt32(g.FszTest)*uint32(500)))
	mxCoord = uint32(15000)
	v1 = libc.Uint32FromInt32(g.FszTest * libc.Int32FromInt32(500))
	n = v1
	mxRowid = v1
	speedtest1_begin_test(tls, int32(100), __ccgo_ts+20381, libc.VaList(bp+32, n))
	speedtest1_exec(tls, __ccgo_ts+648, 0)
	speedtest1_exec(tls, __ccgo_ts+20407, 0)
	speedtest1_prepare(tls, __ccgo_ts+20466, 0)
	i = uint32(1)
	for {
		if !(i <= n) {
			break
		}
		twoCoords(tls, p1, p2, mxCoord, bp, bp+4)
		twoCoords(tls, p1, p2, mxCoord, bp+8, bp+12)
		twoCoords(tls, p1, p2, mxCoord, bp+16, bp+20)
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(1), libc.Int32FromUint32(i))
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(2), libc.Int32FromUint32(*(*uint32)(unsafe.Pointer(bp))))
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(3), libc.Int32FromUint32(*(*uint32)(unsafe.Pointer(bp + 4))))
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(4), libc.Int32FromUint32(*(*uint32)(unsafe.Pointer(bp + 8))))
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(5), libc.Int32FromUint32(*(*uint32)(unsafe.Pointer(bp + 12))))
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(6), libc.Int32FromUint32(*(*uint32)(unsafe.Pointer(bp + 16))))
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(7), libc.Int32FromUint32(*(*uint32)(unsafe.Pointer(bp + 20))))
		speedtest1_run(tls)
		goto _2
	_2:
		;
	...
	speedtest1_exec(tls, __ccgo_ts+758, 0)
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(101), __ccgo_ts+20532, 0)
	speedtest1_exec(tls, __ccgo_ts+20567, 0)
	speedtest1_exec(tls, __ccgo_ts+20625, 0)
	speedtest1_end_test(tls)
	n = libc.Uint32FromInt32(g.FszTest * int32(200))
	speedtest1_begin_test(tls, int32(110), __ccgo_ts+20658, libc.VaList(bp+32, n))
	speedtest1_prepare(tls, __ccgo_ts+20701, 0)
	iStep = mxCoord / n
	i = uint32(0)
	for {
		if !(i < n) {
		...
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(1), libc.Int32FromUint32(i*iStep))
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(2), libc.Int32FromUint32((i+uint32(1))*iStep))
		speedtest1_run(tls)
	...
	if g.FbVerify != 0 {
		n = libc.Uint32FromInt32(g.FszTest * int32(200))
		speedtest1_begin_test(tls, int32(111), __ccgo_ts+20750, 0)
		speedtest1_prepare(tls, __ccgo_ts+20797, 0)
		iStep = mxCoord / n
		i = uint32(0)
		for {
			if !(i < n) {
			...
			if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+124) {
				fatal_error(tls, __ccgo_ts+20845, libc.VaList(bp+32, i, i*iStep, (i+uint32(1))*iStep, *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+124)))
			}
			goto _4
		_4:
			;
	...
	n = libc.Uint32FromInt32(g.FszTest * int32(200))
	speedtest1_begin_test(tls, int32(120), __ccgo_ts+20887, libc.VaList(bp+32, n))
	speedtest1_prepare(tls, __ccgo_ts+20928, 0)
	iStep = mxCoord / n
	i = uint32(0)
	for {
		if !(i < n) {
	...
	if g.FbVerify != 0 {
		n = libc.Uint32FromInt32(g.FszTest * int32(200))
		speedtest1_begin_test(tls, int32(121), __ccgo_ts+20977, 0)
		speedtest1_prepare(tls, __ccgo_ts+21022, 0)
		iStep = mxCoord / n
		i = uint32(0)
		for {
			if !(i < n) {
	...
	n = libc.Uint32FromInt32(g.FszTest * int32(200))
	speedtest1_begin_test(tls, int32(125), __ccgo_ts+21070, libc.VaList(bp+32, n))
	libsqlite3.Xsqlite3_rtree_geometry_callback(tls, g.Fdb, __ccgo_ts+21106, __ccgo_fp(xsliceGeometryCallback), uintptr(0))
	speedtest1_prepare(tls, __ccgo_ts+21113, 0)
	iStep = mxCoord / n
	i = uint32(0)
	for {
		if !(i < n) {
	...
	speedtest1_end_test(tls)
	n = libc.Uint32FromInt32(g.FszTest * int32(400))
	speedtest1_begin_test(tls, int32(130), __ccgo_ts+21167, libc.VaList(bp+32, n))
	speedtest1_prepare(tls, __ccgo_ts+21210, 0)
	iStep = mxCoord / n
	i = uint32(0)
	for {
		if !(i < n) {
	...
	speedtest1_end_test(tls)
	n = libc.Uint32FromInt32(g.FszTest * int32(500))
	speedtest1_begin_test(tls, int32(140), __ccgo_ts+21303, libc.VaList(bp+32, n))
	speedtest1_prepare(tls, __ccgo_ts+21320, 0)
	i = uint32(1)
	for {
		if !(i <= n) {
			break
	...
	speedtest1_end_test(tls)
	n = libc.Uint32FromInt32(g.FszTest * int32(50))
	speedtest1_begin_test(tls, int32(150), __ccgo_ts+21350, libc.VaList(bp+32, n))
	speedtest1_prepare(tls, __ccgo_ts+21373, 0)
	i = uint32(1)
	for {
		if !(i <= n) {
			break
		}
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(1), libc.Int32FromUint32(i*uint32(251)%mxRowid+uint32(1)))
		speedtest1_run(tls)
		goto _10
	_10:
		;
	...
	speedtest1_end_test(tls)
	n = libc.Uint32FromInt32(g.FszTest * int32(5))
	speedtest1_begin_test(tls, int32(155), __ccgo_ts+21421, libc.VaList(bp+32, n))
	speedtest1_prepare(tls, __ccgo_ts+21462, 0)
	iStep = mxCoord / n
	i = uint32(0)
	for {
		if !(i < n) {
	...
	speedtest1_end_test(tls)
	n = libc.Uint32FromInt32(g.FszTest * int32(50))
	speedtest1_begin_test(tls, int32(160), __ccgo_ts+21524, libc.VaList(bp+32, n))
	speedtest1_prepare(tls, __ccgo_ts+21547, 0)
	i = uint32(1)
	for {
		if !(i <= n) {
			break
		}
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(1), libc.Int32FromUint32(i*uint32(257)%mxRowid+uint32(1)))
		speedtest1_run(tls)
		goto _12
	_12:
		;
	...
	speedtest1_end_test(tls)
	n = libc.Uint32FromInt32(g.FszTest * int32(5))
	speedtest1_begin_test(tls, int32(165), __ccgo_ts+21575, libc.VaList(bp+32, n))
	speedtest1_prepare(tls, __ccgo_ts+21616, 0)
	iStep = mxCoord / n
	i = uint32(0)
	for {
		if !(i < n) {
	...
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(170), __ccgo_ts+21658, 0)
	speedtest1_exec(tls, __ccgo_ts+21705, 0)
	speedtest1_end_test(tls)
}
...
func testset_orm(tls *libc.TLS) {
	...
	n = v1
	nRow = v1
	speedtest1_begin_test(tls, int32(100), __ccgo_ts+21748, libc.VaList(bp+2008, n))
	speedtest1_exec(tls, __ccgo_ts+21761, 0)
	speedtest1_prepare(tls, __ccgo_ts+25661, 0)
	i = uint32(0)
	for {
		if !(i < n) {
			break
		...
		len1 = libc.Uint32FromInt32(libc.Int32FromUint32(libc.Xstrlen(tls, bp)))
	...
	speedtest1_begin_test(tls, int32(110), __ccgo_ts+28905, libc.VaList(bp+2008, n))
	speedtest1_prepare(tls, __ccgo_ts+28928, 0)
	i = uint32(0)
	for {
		if !(i < n) {
			break
...
func testset_trigger(tls *libc.TLS) {
	...
	speedtest1_exec(tls, __ccgo_ts+31681, 0)
	jj = int32(1)
	for {
		if !(jj <= int32(3)) {
			break
		}
		speedtest1_prepare(tls, __ccgo_ts+32009, libc.VaList(bp+2008, jj))
		ii = 0
		for {
			if !(ii < NROW) {
				break
	...
	speedtest1_exec(tls, __ccgo_ts+32044, 0)
	speedtest1_begin_test(tls, int32(100), __ccgo_ts+32127, 0)
	speedtest1_prepare(tls, __ccgo_ts+32141, 0)
	speedtest1_run(tls)
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(110), __ccgo_ts+32208, 0)
	speedtest1_prepare(tls, __ccgo_ts+32222, 0)
	speedtest1_run(tls)
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(120), __ccgo_ts+32281, 0)
	jj = int32(1)
	for {
		if !(jj <= int32(3)) {
			break
		}
		speedtest1_prepare(tls, __ccgo_ts+32295, libc.VaList(bp+2008, jj))
		ii = 0
		for {
			if !(ii < NROW2) {
				break
	...
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(130), __ccgo_ts+32329, 0)
	jj = int32(1)
	for {
		if !(jj <= int32(3)) {
			break
		}
		speedtest1_prepare(tls, __ccgo_ts+32344, libc.VaList(bp+2008, jj))
		ii = 0
		for {
			if !(ii < NROW2) {
				break
	...
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(140), __ccgo_ts+32329, 0)
	jj = int32(1)
	for {
		if !(jj <= int32(3)) {
			break
	...
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(150), __ccgo_ts+32378, 0)
	speedtest1_prepare(tls, __ccgo_ts+32397, 0)
	jj = 0
	for {
		if !(jj < NROW2) {
			break
	...
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(160), __ccgo_ts+32512, 0)
	speedtest1_exec(tls, __ccgo_ts+648, 0)
	speedtest1_prepare(tls, __ccgo_ts+32533, 0)
	jj = 0
	for {
		if !(jj < NROW2) {
			break
	...
	speedtest1_exec(tls, __ccgo_ts+758, 0)
	speedtest1_end_test(tls)
	speedtest1_exec(tls, __ccgo_ts+32568, 0)
	speedtest1_begin_test(tls, int32(170), __ccgo_ts+32616, 0)
	speedtest1_exec(tls, __ccgo_ts+32638, 0)
	speedtest1_end_test(tls)
	speedtest1_exec(tls, __ccgo_ts+32683, 0)
	speedtest1_begin_test(tls, int32(180), __ccgo_ts+33173, 0)
	speedtest1_prepare(tls, __ccgo_ts+33190, 0)
	jj = 0
	for {
		if !(jj < NROW2) {
			break
	 ...
	 ** inadvertantly.
	 */
	speedtest1_begin_test(tls, int32(190), __ccgo_ts+33226, 0)
	speedtest1_prepare(tls, __ccgo_ts+33243, 0)
	jj = int32(1)
	for {
		if !(jj <= NROW2*int32(2)) {
			break
	 ...
	 ** Note: Same again.
	 */
	speedtest1_begin_test(tls, int32(200), __ccgo_ts+33289, 0)
	speedtest1_prepare(tls, __ccgo_ts+33306, 0)
	jj = int32(1)
	for {
		if !(jj <= NROW2*int32(2)) {
			break
	 ...
	 */
	speedtest1_exec(tls, __ccgo_ts+33338, 0)
	speedtest1_begin_test(tls, int32(210), __ccgo_ts+33443, 0)
	speedtest1_prepare(tls, __ccgo_ts+33190, 0)
	jj = 0
	for {
		if !(jj < NROW2) {
	...
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(210), __ccgo_ts+33462, 0)
	speedtest1_prepare(tls, __ccgo_ts+33243, 0)
	jj = int32(1)
	for {
		if !(jj <= NROW2*int32(2)) {
	...
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(220), __ccgo_ts+33481, 0)
	speedtest1_prepare(tls, __ccgo_ts+33306, 0)
	jj = int32(1)
	for {
		if !(jj <= NROW2*int32(2)) {
...
func testset_debug1(tls *libc.TLS) {
	...
	for {
		...
		x2 = swizzle(tls, x1, n)
		speedtest1_numbername(tls, x1, bp, int32(2000))
		libc.Xprintf(tls, __ccgo_ts+33500, libc.VaList(bp+2008, i, x1, x2, bp))
		goto _1
	_1:
		;
		i = i + 1
...
func testset_json(tls *libc.TLS) {
	...
	speedtest1_begin_test(tls, int32(100), __ccgo_ts+33516, libc.VaList(bp+8, g.FszTest*int32(5)))
	speedtest1_exec(tls, __ccgo_ts+33545, libc.VaList(bp+8, g.FszTest*int32(5)))
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(110), __ccgo_ts+34505, libc.VaList(bp+8, g.FszTest))
	speedtest1_exec(tls, __ccgo_ts+34551, libc.VaList(bp+8, g.FszTest))
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(120), __ccgo_ts+34631, 0)
	speedtest1_exec(tls, __ccgo_ts+34672, 0)
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(130), __ccgo_ts+34790, 0)
	speedtest1_exec(tls, __ccgo_ts+34831, 0)
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(140), __ccgo_ts+34949, 0)
	speedtest1_exec(tls, __ccgo_ts+34968, 0)
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(141), __ccgo_ts+35329, 0)
	speedtest1_exec(tls, __ccgo_ts+35359, 0)
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(150), __ccgo_ts+35541, 0)
	speedtest1_exec(tls, __ccgo_ts+35589, 0)
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(160), __ccgo_ts+35839, 0)
	speedtest1_exec(tls, __ccgo_ts+35887, 0)
	speedtest1_end_test(tls)
}
...
func testset_parsenumber(tls *libc.TLS) {
	...
	zSql1 = __ccgo_ts + 36038
	zSql2 = __ccgo_ts + 36077
	zSql3 = __ccgo_ts + 36209
	zSql4 = __ccgo_ts + 36255
	NROW = int32(100) * g.FszTest
	speedtest1_begin_test(tls, int32(100), __ccgo_ts+36393, libc.VaList(bp+8, NROW))
	ii = 0
	for {
		if !(ii < NROW) {
			break
	...
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(110), __ccgo_ts+36419, libc.VaList(bp+8, NROW))
	ii = 0
	for {
		if !(ii < NROW) {
			break
	...
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(200), __ccgo_ts+36445, libc.VaList(bp+8, NROW))
	ii = 0
	for {
		if !(ii < NROW) {
			break
	...
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, int32(210), __ccgo_ts+36468, libc.VaList(bp+8, NROW))
	ii = 0
	for {
		if !(ii < NROW) {
			break
...
func displayLinuxIoStats(tls *libc.TLS, out uintptr) {
	...
	_, _, _ = i, in, n
	libsqlite3.Xsqlite3_snprintf(tls, int32(200), bp, __ccgo_ts+36491, libc.VaList(bp+208, libc.Xgetpid(tls)))
	in = libc.Xfopen(tls, bp, __ccgo_ts+36503)
	if in == uintptr(0) {
		return
	}
	for libc.Xfgets(tls, bp, int32(200), in) != uintptr(0) {
		i = 0
		for {
			if !(libc.Uint32FromInt32(i) < libc.Uint32FromInt64(56)/libc.Uint32FromInt64(8)) {
				break
			}
			n = libc.Int32FromUint32(libc.Xstrlen(tls, aTrans[i].FzPattern))
			if libc.Xstrncmp(tls, aTrans[i].FzPattern, bp, libc.Uint32FromInt32(n)) == 0 {
				libc.Xfprintf(tls, out, __ccgo_ts+36752, libc.VaList(bp+208, aTrans[i].FzDesc, bp+uintptr(n)))
				break
			}
			goto _1
		_1:
...
var aTrans = [7]struct {
	...
	0: {
		FzPattern: __ccgo_ts + 36506,
		FzDesc:    __ccgo_ts + 36514,
	},
	1: {
		FzPattern: __ccgo_ts + 36540,
		FzDesc:    __ccgo_ts + 36548,
	},
	2: {
		FzPattern: __ccgo_ts + 36571,
		FzDesc:    __ccgo_ts + 36579,
	},
	3: {
		FzPattern: __ccgo_ts + 36600,
		FzDesc:    __ccgo_ts + 36608,
	},
	4: {
		FzPattern: __ccgo_ts + 36630,
		FzDesc:    __ccgo_ts + 36643,
	},
	5: {
		FzPattern: __ccgo_ts + 36668,
		FzDesc:    __ccgo_ts + 36682,
	},
	6: {
		FzPattern: __ccgo_ts + 36705,
		FzDesc:    __ccgo_ts + 36729,
	},
}
...
func xCompileOptions(tls *libc.TLS, pCtx uintptr, nVal int32, azVal uintptr, azCol uintptr) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	libc.Xprintf(tls, __ccgo_ts+36764, libc.VaList(bp+8, *(*uintptr)(unsafe.Pointer(azVal))))
	return SQLITE_OK
}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	var cacheSize, doAutovac, doExclusive, doFullFSync, doIncrvac, doPCache, doTrace, i, kk, memDb, mmapSize, mnHeap, nHardHeapLmt, nHeap, nLook, nPCache, nSoftHeapLmt, nThread, noSync, openFlags, pageSize, rc, showStats, szLook, szPCache, v2, v3 int32
	...
	zTSet = __ccgo_ts + 36787                                                                        /* Which --testset torun */
	...
	libc.Xprintf(tls, __ccgo_ts+36792, libc.VaList(bp+16, libsqlite3.Xsqlite3_libversion(tls), libsqlite3.Xsqlite3_sourceid(tls)))
	/* Process command-line arguments */
	g.FzDbName = uintptr(0)
	g.FzVfs = uintptr(0)
	g.FzWR = __ccgo_ts + 6
	g.FzNN = __ccgo_ts + 6
	g.FzPK = __ccgo_ts + 36827
	g.FszTest = int32(100)
	g.FszBase = int32(100)
	g.FnRepeat = int32(1)
	i = int32(1)
	for {
		...
		if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(z))) == int32('-') {
			...
			if libc.Xstrcmp(tls, z, __ccgo_ts+36834) == 0 {
				doAutovac = int32(1)
			} else {
				if libc.Xstrcmp(tls, z, __ccgo_ts+36845) == 0 {
					g.FdoBigTransactions = int32(1)
				} else {
					if libc.Xstrcmp(tls, z, __ccgo_ts+36862) == 0 {
						if i >= argc-int32(1) {
							fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
						}
						i = i + 1
						v2 = i
						cacheSize = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*4)))
					} else {
						if libc.Xstrcmp(tls, z, __ccgo_ts+36896) == 0 {
							doExclusive = int32(1)
						} else {
							if libc.Xstrcmp(tls, z, __ccgo_ts+36906) == 0 {
								doFullFSync = int32(1)
							} else {
								if libc.Xstrcmp(tls, z, __ccgo_ts+36916) == 0 {
									g.FdoCheckpoint = int32(1)
								} else {
									if libc.Xstrcmp(tls, z, __ccgo_ts+36927) == 0 {
										g.FbSqlOnly = int32(1)
										g.FbExplain = int32(1)
									} else {
										if libc.Xstrcmp(tls, z, __ccgo_ts+36935) == 0 {
											if i >= argc-int32(1) {
												fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
											}
											nHardHeapLmt = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i+int32(1))*4)))
											i = i + int32(1)
										} else {
											if libc.Xstrcmp(tls, z, __ccgo_ts+36951) == 0 {
												if i >= argc-int32(2) {
													fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
												}
												...
												if libc.Xstrcmp(tls, z, __ccgo_ts+36956) == 0 {
													doIncrvac = int32(1)
												} else {
													if libc.Xstrcmp(tls, z, __ccgo_ts+36967) == 0 {
														if i >= argc-int32(1) {
															fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
														}
														i = i + 1
														v2 = i
														zJMode = *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*4))
													} else {
														if libc.Xstrcmp(tls, z, __ccgo_ts+36975) == 0 {
															if i >= argc-int32(1) {
																fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
															}
															i = i + 1
															v2 = i
															zKey = *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*4))
														} else {
															if libc.Xstrcmp(tls, z, __ccgo_ts+36979) == 0 {
																if i >= argc-int32(2) {
																	fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																}
																...
																if libc.Xstrcmp(tls, z, __ccgo_ts+36989) == 0 {
																	memDb = int32(1)
																} else {
																	if libc.Xstrcmp(tls, z, __ccgo_ts+36995) == 0 {
																		libsqlite3.Xsqlite3_config(tls, int32(SQLITE_CONFIG_MULTITHREAD), 0)
																	} else {
																		if libc.Xstrcmp(tls, z, __ccgo_ts+37007) == 0 {
																			libsqlite3.Xsqlite3_config(tls, int32(SQLITE_CONFIG_MEMSTATUS), libc.VaList(bp+16, 0))
																		} else {
																			if libc.Xstrcmp(tls, z, __ccgo_ts+37017) == 0 {
																				if i >= argc-int32(1) {
																					fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																				}
																				i = i + 1
																				v2 = i
																				mmapSize = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*4)))
																			} else {
																				if libc.Xstrcmp(tls, z, __ccgo_ts+37022) == 0 {
																					openFlags = openFlags | int32(SQLITE_OPEN_NOMUTEX)
																				} else {
																					if libc.Xstrcmp(tls, z, __ccgo_ts+37030) == 0 {
																						noSync = int32(1)
																					} else {
																						if libc.Xstrcmp(tls, z, __ccgo_ts+37037) == 0 {
																							g.FzNN = __ccgo_ts + 37045
																						} else {
																							if libc.Xstrcmp(tls, z, __ccgo_ts+37054) == 0 {
																								if i >= argc-int32(1) {
																									fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																								}
																								i = i + 1
																								if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), __ccgo_ts+37061) == 0 {
																									g.FhashFile = libc.Xstdout
																								} else {
																									g.FhashFile = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), __ccgo_ts+37063)
																									if g.FhashFile == uintptr(0) {
																										fatal_error(tls, __ccgo_ts+37066, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																									}
																								}
																							} else {
																								if libc.Xstrcmp(tls, z, __ccgo_ts+37096) == 0 {
																									if i >= argc-int32(1) {
																										fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																									}
																									i = i + 1
																									v2 = i
																									pageSize = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*4)))
																								} else {
																									if libc.Xstrcmp(tls, z, __ccgo_ts+37105) == 0 {
																										if i >= argc-int32(2) {
																											fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																										}
																										...
																										if libc.Xstrcmp(tls, z, __ccgo_ts+37112) == 0 {
																											g.FzPK = __ccgo_ts + 37123
																										} else {
																											if libc.Xstrcmp(tls, z, __ccgo_ts+37135) == 0 {
																												if i >= argc-int32(1) {
																													fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																												}
																												i = i + 1
																												v2 = i
																												g.FnRepeat = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*4)))
																											} else {
																												if libc.Xstrcmp(tls, z, __ccgo_ts+37142) == 0 {
																													g.FbReprepare = int32(1)
																												} else {
																													if libc.Xstrcmp(tls, z, __ccgo_ts+37152) == 0 {
																														libsqlite3.Xsqlite3_config(tls, int32(SQLITE_CONFIG_SERIALIZED), 0)
																													} else {
																														if libc.Xstrcmp(tls, z, __ccgo_ts+37163) == 0 {
																															libsqlite3.Xsqlite3_config(tls, int32(SQLITE_CONFIG_SINGLETHREAD), 0)
																														} else {
																															if libc.Xstrcmp(tls, z, __ccgo_ts+37176) == 0 {
																																if i >= argc-int32(1) {
																																	fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																																}
																																if g.FpScript != 0 {
																																...
																																i = i + 1
																																v2 = i
																																g.FpScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*4)), __ccgo_ts+37063)
																																if g.FpScript == uintptr(0) {
																																	fatal_error(tls, __ccgo_ts+37183, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																																}
																															} else {
																																if libc.Xstrcmp(tls, z, __ccgo_ts+37216) == 0 {
																																	g.FbSqlOnly = int32(1)
																																} else {
																																	if libc.Xstrcmp(tls, z, __ccgo_ts+37224) == 0 {
																																		g.FbMemShrink = int32(1)
																																	} else {
																																		if libc.Xstrcmp(tls, z, __ccgo_ts+37238) == 0 {
																																			if i >= argc-int32(1) {
																																				fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																																			}
																																			i = i + 1
																																			v3 = i
																																			v2 = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v3)*4)))
																																			g.FszBase = v2
																																			g.FszTest = v2
																																		} else {
																																			if libc.Xstrcmp(tls, z, __ccgo_ts+37243) == 0 {
																																				if i >= argc-int32(1) {
																																					fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																																				}
																																				nSoftHeapLmt = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i+int32(1))*4)))
																																				i = i + int32(1)
																																			} else {
																																				if libc.Xstrcmp(tls, z, __ccgo_ts+37259) == 0 {
																																					showStats = int32(1)
																																				} else {
																																					if libc.Xstrcmp(tls, z, __ccgo_ts+37265) == 0 {
																																						if i >= argc-int32(1) {
																																							fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																																						}
																																						i = i + 1
																																						if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))) < int32('0') || libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))) > int32('9') || libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)) + 1))) != 0 {
																																							fatal_error(tls, __ccgo_ts+37270, 0)
																																						}
																																						g.FeTemp = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))) - int32('0')
																																					} else {
																																						if libc.Xstrcmp(tls, z, __ccgo_ts+37323) == 0 {
																																							if i >= argc-int32(1) {
																																								fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																																							}
																																							i = i + 1
																																							v2 = i
																																							zTSet = *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*4))
																																						} else {
																																							if libc.Xstrcmp(tls, z, __ccgo_ts+37331) == 0 {
																																								doTrace = int32(1)
																																							} else {
																																								if libc.Xstrcmp(tls, z, __ccgo_ts+37337) == 0 {
																																									if i >= argc-int32(1) {
																																										fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																																									}
																																									i = i + 1
																																									v2 = i
																																									nThread = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*4)))
																																								} else {
																																									if libc.Xstrcmp(tls, z, __ccgo_ts+37345) == 0 {
																																										zEncoding = __ccgo_ts + 37345
																																									} else {
																																										if libc.Xstrcmp(tls, z, __ccgo_ts+37353) == 0 {
																																											zEncoding = __ccgo_ts + 37353
																																										} else {
																																											if libc.Xstrcmp(tls, z, __ccgo_ts+37361) == 0 {
																																												g.FbVerify = int32(1)
																																												HashInit(tls)
																																											} else {
																																												if libc.Xstrcmp(tls, z, __ccgo_ts+37368) == 0 {
																																													if i >= argc-int32(1) {
																																														fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																																													}
																																													i = i + 1
																																													v2 = i
																																													g.FzVfs = *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*4))
																																												} else {
																																													if libc.Xstrcmp(tls, z, __ccgo_ts+37372) == 0 {
																																														if i >= argc-int32(1) {
																																															fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
																																														}
																																														i = i + 1
																																														v2 = i
																																														g.FnReserve = libc.Xatoi(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*4)))
																																													} else {
																																														if libc.Xstrcmp(tls, z, __ccgo_ts+37380) == 0 {
																																															g.FstmtScanStatus = int32(1)
																																														} else {
																																															if libc.Xstrcmp(tls, z, __ccgo_ts+37395) == 0 {
																																																if libc.Xstrstr(tls, g.FzWR, __ccgo_ts+37409) != uintptr(0) {
																																																	/* no-op */
																																																} else {
																																																	if libc.Xstrstr(tls, g.FzWR, __ccgo_ts+37417) != uintptr(0) {
																																																		g.FzWR = __ccgo_ts + 37424
																																																	} else {
																																																...
																																																if libc.Xstrcmp(tls, z, __ccgo_ts+37445) == 0 {
																																																	if libc.Xstrstr(tls, g.FzWR, __ccgo_ts+37417) != uintptr(0) {
																																																		/* no-op */
																																																	} else {
																																																		if libc.Xstrstr(tls, g.FzWR, __ccgo_ts+37409) != uintptr(0) {
																																																			...
																																																			g.FzWR = __ccgo_ts + 37417
																																																		}
																																																	}
																																																} else {
																																																	if libc.Xstrcmp(tls, z, __ccgo_ts+37452) == 0 || libc.Xstrcmp(tls, z, __ccgo_ts+37457) == 0 {
																																																		libc.Xprintf(tls, uintptr(unsafe.Pointer(&zHelp)), libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv))))
																																																		libc.Xexit(tls, 0)
																																																	} else {
																																																		fatal_error(tls, __ccgo_ts+37459, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), *(*uintptr)(unsafe.Pointer(argv))))
																																																	}
																																																}
																																															}
																																														}
			...
			if g.FzDbName == uintptr(0) {
				g.FzDbName = *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))
			} else {
				fatal_error(tls, __ccgo_ts+37500, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), *(*uintptr)(unsafe.Pointer(argv))))
			}
		}
		goto _1
	_1:
	...
	if nHeap > 0 {
		pHeap = libc.Xmalloc(tls, libc.Uint32FromInt32(nHeap))
		if pHeap == uintptr(0) {
			fatal_error(tls, __ccgo_ts+37543, libc.VaList(bp+16, nHeap))
		}
		rc = libsqlite3.Xsqlite3_config(tls, int32(SQLITE_CONFIG_HEAP), libc.VaList(bp+16, pHeap, nHeap, mnHeap))
		if rc != 0 {
			fatal_error(tls, __ccgo_ts+37573, libc.VaList(bp+16, rc))
		}
	}
	if doPCache != 0 {
		if nPCache > 0 && szPCache > 0 {
			pPCache = libc.Xmalloc(tls, libc.Uint32FromInt64(int64(nPCache)*int64(szPCache)))
			if pPCache == uintptr(0) {
				fatal_error(tls, __ccgo_ts+37604, libc.VaList(bp+16, int64(nPCache)*int64(szPCache)))
			}
		}
		rc = libsqlite3.Xsqlite3_config(tls, int32(SQLITE_CONFIG_PAGECACHE), libc.VaList(bp+16, pPCache, szPCache, nPCache))
		if rc != 0 {
			fatal_error(tls, __ccgo_ts+37638, libc.VaList(bp+16, rc))
		}
	}
	if nLook >= 0 {
	...
	if nLook > 0 && szLook > 0 {
		pLook = libc.Xmalloc(tls, libc.Uint32FromInt32(nLook*szLook))
		rc = libsqlite3.Xsqlite3_db_config(tls, g.Fdb, int32(SQLITE_DBCONFIG_LOOKASIDE), libc.VaList(bp+16, pLook, szLook, nLook))
		if rc != 0 {
			fatal_error(tls, __ccgo_ts+37680, libc.VaList(bp+16, rc))
		}
	}
	if g.FnReserve > 0 {
		libsqlite3.Xsqlite3_file_control(tls, g.Fdb, uintptr(0), int32(SQLITE_FCNTL_RESERVE_BYTES), uintptr(unsafe.Pointer(&g))+76)
	}
	...
	libsqlite3.Xsqlite3_create_function(tls, g.Fdb, __ccgo_ts+37716, 0, int32(SQLITE_UTF8), uintptr(0), __ccgo_fp(randomFunc), uintptr(0), uintptr(0))
	if doTrace != 0 {
		libsqlite3.Xsqlite3_trace(tls, g.Fdb, __ccgo_fp(traceCallback), uintptr(0))
	}
	if memDb > 0 {
		speedtest1_exec(tls, __ccgo_ts+37723, 0)
	}
	if mmapSize > 0 {
		speedtest1_exec(tls, __ccgo_ts+37748, libc.VaList(bp+16, mmapSize))
	}
	speedtest1_exec(tls, __ccgo_ts+37768, libc.VaList(bp+16, nThread))
	if zKey != 0 {
		speedtest1_exec(tls, __ccgo_ts+37786, libc.VaList(bp+16, zKey))
	}
	if zEncoding != 0 {
		speedtest1_exec(tls, __ccgo_ts+37803, libc.VaList(bp+16, zEncoding))
	}
	if doAutovac != 0 {
		speedtest1_exec(tls, __ccgo_ts+37822, 0)
	} else {
		if doIncrvac != 0 {
			speedtest1_exec(tls, __ccgo_ts+37846, 0)
		}
	}
	if pageSize != 0 {
		speedtest1_exec(tls, __ccgo_ts+37877, libc.VaList(bp+16, pageSize))
	}
	if cacheSize != 0 {
		speedtest1_exec(tls, __ccgo_ts+37897, libc.VaList(bp+16, cacheSize))
	}
	if noSync != 0 {
		speedtest1_exec(tls, __ccgo_ts+37918, 0)
	} else {
		if doFullFSync != 0 {
			speedtest1_exec(tls, __ccgo_ts+37941, 0)
		}
	}
	if doExclusive != 0 {
		speedtest1_exec(tls, __ccgo_ts+37961, 0)
	}
	if zJMode != 0 {
		speedtest1_exec(tls, __ccgo_ts+37991, libc.VaList(bp+16, zJMode))
	}
	if nHardHeapLmt > 0 {
		speedtest1_exec(tls, __ccgo_ts+38014, libc.VaList(bp+16, nHardHeapLmt))
	}
	if nSoftHeapLmt > 0 {
		speedtest1_exec(tls, __ccgo_ts+38040, libc.VaList(bp+16, nSoftHeapLmt))
	}
	if zJMode != 0 {
		speedtest1_exec(tls, __ccgo_ts+37991, libc.VaList(bp+16, zJMode))
	}
	if g.FbExplain != 0 {
		libc.Xprintf(tls, __ccgo_ts+38066, 0)
	}
	if libc.Xstrcmp(tls, zTSet, __ccgo_ts+36787) == 0 {
	...
	for cond := true; cond; cond = *(*uint8)(unsafe.Pointer(zTSet)) != 0 {
		...
		if zSep != 0 {
			kk = int32(1)
			for {
				if !(*(*uint8)(unsafe.Pointer(zSep + uintptr(kk))) != 0 && libc.BoolInt32(uint32(*(*uint8)(unsafe.Pointer(zSep + uintptr(kk))))-uint32('0') < uint32(10)) != 0) {
					break
				}
				goto _16
			_16:
			...
			if kk == int32(1) || libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(zSep + uintptr(kk)))) != 0 {
				fatal_error(tls, __ccgo_ts+38085, libc.VaList(bp+16, zThisTest))
			}
			g.FszTest = g.FszBase * integerValue(tls, zSep+uintptr(1)) / int32(100)
			if g.FszTest <= 0 {
				g.FszTest = int32(1)
			}
			*(*uint8)(unsafe.Pointer(zSep)) = uint8(0)
		} else {
			g.FszTest = g.FszBase
		}
		if g.FiTotal > 0 || zComma == uintptr(0) {
			libc.Xprintf(tls, __ccgo_ts+38120, libc.VaList(bp+16, zThisTest))
		}
		if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+38147) == 0 {
			testset_main(tls)
		} else {
			if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+38152) == 0 {
				testset_debug1(tls)
			} else {
				if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+38159) == 0 {
					testset_orm(tls)
				} else {
					if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+38163) == 0 {
						testset_cte(tls)
					} else {
						if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+38167) == 0 {
							testset_star(tls)
						} else {
							if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+38172) == 0 {
								testset_app(tls)
							} else {
								if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+38176) == 0 {
									testset_fp(tls)
								} else {
									if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+38179) == 0 {
										testset_json(tls)
									} else {
										if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+38184) == 0 {
											testset_trigger(tls)
										} else {
											if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+38192) == 0 {
												testset_parsenumber(tls)
											} else {
												if libc.Xstrcmp(tls, zThisTest, __ccgo_ts+38204) == 0 {
													testset_rtree(tls, int32(6), int32(147))
												} else {
													fatal_error(tls, __ccgo_ts+38210, libc.VaList(bp+16, zThisTest))
												}
											}
										}
									}
		...
		if *(*uint8)(unsafe.Pointer(zTSet)) != 0 {
			speedtest1_begin_test(tls, int32(999), __ccgo_ts+38279, 0)
			for int32(1) != 0 {
				zObj = speedtest1_once(tls, __ccgo_ts+38298, 0)
				if zObj == uintptr(0) {
					break
				}
				zSql = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+38368, libc.VaList(bp+16, zObj))
				speedtest1_exec(tls, zSql, 0)
				libsqlite3.Xsqlite3_free(tls, zSql)
				libsqlite3.Xsqlite3_free(tls, zObj)
			}
			for int32(1) != 0 {
				zObj = speedtest1_once(tls, __ccgo_ts+38389, 0)
				if zObj == uintptr(0) {
					break
				}
				zSql = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+38368, libc.VaList(bp+16, zObj))
	...
	if showStats != 0 {
		...
		libc.Xprintf(tls, __ccgo_ts+38869, libc.VaList(bp+16, *(*int32)(unsafe.Pointer(bp)), *(*int32)(unsafe.Pointer(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_MALLOC_COUNT), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+38914, libc.VaList(bp+16, *(*int32)(unsafe.Pointer(bp)), *(*int32)(unsafe.Pointer(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_PAGECACHE_OVERFLOW), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+38959, libc.VaList(bp+16, *(*int32)(unsafe.Pointer(bp)), *(*int32)(unsafe.Pointer(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_MALLOC_SIZE), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+39004, libc.VaList(bp+16, *(*int32)(unsafe.Pointer(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_PAGECACHE_SIZE), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+39046, libc.VaList(bp+16, *(*int32)(unsafe.Pointer(bp + 4))))
	}
	if showStats != 0 {
...
var zMix1Tests = [62]uint8{'m', 'a', 'i', 'n', ',', 'o', 'r', 'm', '/', '2', '5', ',', 'c', 't', 'e', '/', '2', '0', ',', 'j', 's', 'o', 'n', ',', 'f', 'p', '/', '3', ',', 'p', 'a', 'r', 's', 'e', 'n', 'u', 'm', 'b', 'e', 'r', '/', '2', '5', ',', 'r', 't', 'r', 'e', 'e', '/', '1', '0', ',', 's', 't', 'a', 'r', ',', 'a', 'p', 'p'}
