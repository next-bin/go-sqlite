// Code generated for linux/ppc64le by 'generator -DNDEBUG -DSQLITE_ENABLE_DBPAGE_VTAB -DSQLITE_ENABLE_RTREE -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_linux_ppc64le.go -I /tmp/libsqlite3/sqlite-src-3530000 /tmp/libsqlite3/sqlite-src-3530000/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func HashUpdate(tls *libc.TLS, aData uintptr, nData uint32) {
	...
	for {
		...
		j = libc.Uint8FromInt32(int32(j) + (libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3168 + 3 + uintptr(i)))) + libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(aData + uintptr(k))))))
...
func HashFinal(tls *libc.TLS) {
	...
	for {
		...
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3168 + 3 + uintptr(j))) = t
		t = libc.Uint8FromInt32(int32(t) + libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3168 + 3 + uintptr(i)))))
...
func speedtest1_numbername(tls *libc.TLS, n uint32, zOut uintptr, nOut int32) (r int32) {
	...
	if n >= uint32(1000000000) {
		...
		i = i + libc.Int32FromUint64(libc.Xstrlen(tls, zOut+uintptr(i)))
		...
		for {
			...
			if libc.Uint64FromInt32(g.FnResult+len1) < libc.Uint64FromInt64(3000)-libc.Uint64FromInt32(2) {
				if g.FnResult > 0 {
					...
					*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 148 + uintptr(v3))) = uint8(' ')
				}
...
func testset_rtree(tls *libc.TLS, p1 int32, p2 int32) {
	...
	aCheck = libsqlite3.Xsqlite3_malloc(tls, libc.Int32FromUint64(uint64(4)*libc.Uint64FromInt32(g.FszTest)*uint64(500)))
	...
	for {
		...
		speedtest1_run(tls)
		*(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) = libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+148)
		goto _3
	_3:
		;
		i = i + 1
	...
	if g.FbVerify != 0 {
		...
		for {
			...
			libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(2), libc.Int32FromUint32((i+uint32(1))*iStep))
			speedtest1_run(tls)
			if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+148) {
				fatal_error(tls, __ccgo_ts+20845, libc.VaList(bp+32, i, i*iStep, (i+uint32(1))*iStep, *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+148)))
			}
			goto _4
		_4:
			;
	...
	for {
		...
		if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(z))) == int32('-') {
			...
			if libc.Xstrcmp(tls, z, __ccgo_ts+36834) == 0 {
				...
				if libc.Xstrcmp(tls, z, __ccgo_ts+36845) == 0 {
					...
					if libc.Xstrcmp(tls, z, __ccgo_ts+36862) == 0 {
						if i >= argc-int32(1) {
							fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
						}
						i = i + 1
						v2 = i
											...
											if libc.Xstrcmp(tls, z, __ccgo_ts+36951) == 0 {
												...
												if libc.Xstrcmp(tls, z, __ccgo_ts+36956) == 0 {
													...
													if libc.Xstrcmp(tls, z, __ccgo_ts+36967) == 0 {
														...
														i = i + 1
														v2 = i
														zJMode = *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*8))
													} else {
														if libc.Xstrcmp(tls, z, __ccgo_ts+36975) == 0 {
															...
															i = i + 1
															v2 = i
															zKey = *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*8))
														} else {
																	...
																	if libc.Xstrcmp(tls, z, __ccgo_ts+36995) == 0 {
																		...
																		if libc.Xstrcmp(tls, z, __ccgo_ts+37007) == 0 {
																			...
																			if libc.Xstrcmp(tls, z, __ccgo_ts+37017) == 0 {
																				...
																				i = i + 1
																				v2 = i
																				mmapSize = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*8)))
																			} else {
																					...
																					if libc.Xstrcmp(tls, z, __ccgo_ts+37030) == 0 {
																						...
																						if libc.Xstrcmp(tls, z, __ccgo_ts+37037) == 0 {
																							...
																							if libc.Xstrcmp(tls, z, __ccgo_ts+37054) == 0 {
																								...
																								i = i + 1
																								if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), __ccgo_ts+37061) == 0 {
																									g.FhashFile = libc.Xstdout
																								} else {
																									g.FhashFile = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), __ccgo_ts+37063)
																									if g.FhashFile == uintptr(0) {
																										fatal_error(tls, __ccgo_ts+37066, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																									}
																								}
																							} else {
																								if libc.Xstrcmp(tls, z, __ccgo_ts+37096) == 0 {
																									...
																									i = i + 1
																									v2 = i
																									pageSize = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*8)))
																								} else {
																									if libc.Xstrcmp(tls, z, __ccgo_ts+37105) == 0 {
																										...
																										if libc.Xstrcmp(tls, z, __ccgo_ts+37112) == 0 {
																											...
																											if libc.Xstrcmp(tls, z, __ccgo_ts+37135) == 0 {
																												...
																												i = i + 1
																												v2 = i
																												g.FnRepeat = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*8)))
																											} else {
																													...
																													if libc.Xstrcmp(tls, z, __ccgo_ts+37152) == 0 {
																														...
																														if libc.Xstrcmp(tls, z, __ccgo_ts+37163) == 0 {
																															...
																															if libc.Xstrcmp(tls, z, __ccgo_ts+37176) == 0 {
																																...
																																i = i + 1
																																v2 = i
																																g.FpScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*8)), __ccgo_ts+37063)
																																if g.FpScript == uintptr(0) {
																																	fatal_error(tls, __ccgo_ts+37183, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
																																}
																															} else {
																																if libc.Xstrcmp(tls, z, __ccgo_ts+37216) == 0 {
																																	...
																																	if libc.Xstrcmp(tls, z, __ccgo_ts+37224) == 0 {
																																		...
																																		if libc.Xstrcmp(tls, z, __ccgo_ts+37238) == 0 {
																																			...
																																			i = i + 1
																																			v3 = i
																																			v2 = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v3)*8)))
																																			g.FszBase = v2
																																			g.FszTest = v2
																																		} else {
																																				...
																																				if libc.Xstrcmp(tls, z, __ccgo_ts+37259) == 0 {
																																					...
																																					if libc.Xstrcmp(tls, z, __ccgo_ts+37265) == 0 {
																																						...
																																						if libc.Xstrcmp(tls, z, __ccgo_ts+37323) == 0 {
																																							...
																																							i = i + 1
																																							v2 = i
																																							zTSet = *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*8))
																																						} else {
																																							if libc.Xstrcmp(tls, z, __ccgo_ts+37331) == 0 {
																																								...
																																								if libc.Xstrcmp(tls, z, __ccgo_ts+37337) == 0 {
																																									...
																																									i = i + 1
																																									v2 = i
																																									nThread = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*8)))
																																								} else {
																																										...
																																										if libc.Xstrcmp(tls, z, __ccgo_ts+37353) == 0 {
																																											...
																																											if libc.Xstrcmp(tls, z, __ccgo_ts+37361) == 0 {
																																												...
																																												if libc.Xstrcmp(tls, z, __ccgo_ts+37368) == 0 {
																																													...
																																													i = i + 1
																																													v2 = i
																																													g.FzVfs = *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*8))
																																												} else {
																																													if libc.Xstrcmp(tls, z, __ccgo_ts+37372) == 0 {
																																														...
																																														i = i + 1
																																														v2 = i
																																														g.FnReserve = libc.Xatoi(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(v2)*8)))
																																													} else {
																																															...
																																															if libc.Xstrcmp(tls, z, __ccgo_ts+37395) == 0 {
																																																...
																																																if libc.Xstrcmp(tls, z, __ccgo_ts+37445) == 0 {
																																																	...
																																																	if libc.Xstrcmp(tls, z, __ccgo_ts+37452) == 0 || libc.Xstrcmp(tls, z, __ccgo_ts+37457) == 0 {
																																																		...
																																																		fatal_error(tls, __ccgo_ts+37459, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), *(*uintptr)(unsafe.Pointer(argv))))
																																																	}
																																																}
																																															}
																																														}
			...
			if g.FzDbName == uintptr(0) {
				...
				fatal_error(tls, __ccgo_ts+37500, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), *(*uintptr)(unsafe.Pointer(argv))))
			}
		}
		goto _1
	_1:
