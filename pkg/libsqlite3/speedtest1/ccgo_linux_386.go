// Code generated for linux/386 by 'generator -DNDEBUG -DSQLITE_ENABLE_DBPAGE_VTAB -DSQLITE_ENABLE_RTREE -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_linux_386.go -I /tmp/libsqlite3/sqlite-src-3530000 /tmp/libsqlite3/sqlite-src-3530000/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func HashInit(tls *libc.TLS) {
	...
	for {
		...
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(k))) = uint8(k)
		goto _1
	_1:
		;
		k = k + 1
...
func HashUpdate(tls *libc.TLS, aData uintptr, nData uint32) {
	...
	for {
		...
		j = libc.Uint8FromInt32(int32(j) + (libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(i)))) + libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(aData + uintptr(k))))))
		t = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(j)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(j))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(i)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(i))) = t
		i = i + 1
		goto _1
	_1:
		;
...
func HashFinal(tls *libc.TLS) {
	...
	for {
		...
		i = i + 1
		t = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(i)))
		j = libc.Uint8FromInt32(int32(j) + libc.Int32FromUint8(t))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(i))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(j)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(j))) = t
		t = libc.Uint8FromInt32(int32(t) + libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(i)))))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3128 + 259 + uintptr(k))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(t)))
		goto _1
	_1:
		;
		k = k + 1
...
func speedtest1_final(tls *libc.TLS) {
	...
	if g.FbVerify != 0 {
		...
		for {
			...
			libc.Xprintf(tls, __ccgo_ts+459, libc.VaList(bp+8, libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3128 + 259 + uintptr(i))))))
			goto _1
		_1:
			;
			i = i + 1
	...
	for libsqlite3.Xsqlite3_step(tls, g.FpStmt) == int32(SQLITE_ROW) {
		...
		for {
			...
			if libc.Uint32FromInt32(g.FnResult+len1) < libc.Uint32FromInt64(3000)-libc.Uint32FromInt32(2) {
				if g.FnResult > 0 {
					v4 = uintptr(unsafe.Pointer(&g)) + 116
					v3 = *(*int32)(unsafe.Pointer(v4))
					*(*int32)(unsafe.Pointer(v4)) = *(*int32)(unsafe.Pointer(v4)) + 1
					*(*int8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 120 + uintptr(v3))) = int8(' ')
				}
				libc.Xmemcpy(tls, uintptr(unsafe.Pointer(&g))+120+uintptr(g.FnResult), z1, libc.Uint32FromInt32(len1+int32(1)))
				g.FnResult += len1
			}
			goto _1
		_1:
...
func testset_rtree(tls *libc.TLS, p1 int32, p2 int32) {
	...
	for {
		...
		speedtest1_run(tls)
		*(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) = libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+120)
		goto _3
	_3:
		;
		i = i + 1
	...
	if g.FbVerify != 0 {
		...
		for {
			...
			libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(2), libc.Int32FromUint32((i+uint32(1))*iStep))
			speedtest1_run(tls)
			if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+120) {
				fatal_error(tls, __ccgo_ts+20845, libc.VaList(bp+32, i, i*iStep, (i+uint32(1))*iStep, *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+120)))
			}
			goto _4
		_4:
			;
																																			...
																																			if libc.Xstrcmp(tls, z, __ccgo_ts+37243) == 0 {
																																				...
																																				if libc.Xstrcmp(tls, z, __ccgo_ts+37259) == 0 {
																																					...
																																					if libc.Xstrcmp(tls, z, __ccgo_ts+37265) == 0 {
																																						...
																																						g.FeTemp = int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))) - int32('0')
																																					} else {
