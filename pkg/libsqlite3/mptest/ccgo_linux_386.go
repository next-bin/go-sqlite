// Code generated for linux/386 by 'generator -DNDEBUG -I /tmp/libsqlite3/sqlite-src-3530000 -ignore-unsupported-alignment -ignore-link-errors -o mptest/ccgo_linux_386.go /tmp/libsqlite3/sqlite-src-3530000/mptest/mptest.c -lsqlite3', DO NOT EDIT.
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	...
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if v4 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+917, uint32(4)) == 0; v4 {
								...
								if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1291) == 0 || libc.Xstrcmp(tls, bp+16, __ccgo_ts+1296) == 0 {
									...
									if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1347) == 0 {
										...
										if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1354) == 0 {
											...
											if !(int32(*(*int8)(unsafe.Pointer(zNewFile))) == libc.Int32FromUint8('/')) {
												...
												if k > 0 {
													...
													if zNewFile == uintptr(0) {
														libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+1369, 0)
														libc.Xabort(tls)
													}
												}
											}
											...
											if g.FiTrace != 0 {
												logMessage(tls, __ccgo_ts+1384, libc.VaList(bp+1256, zNewFile))
											}
											runScript(tls, 0, 0, zNewScript, zNewFile)
											libsqlite3.Xsqlite3_free(tls, zNewScript)
											if g.FiTrace != 0 {
												logMessage(tls, __ccgo_ts+1403, libc.VaList(bp+1256, zNewFile))
											}
											 ...
											 */
											if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1420) == 0 {
												jj2 = int32(7)
												for {
													if v9 = jj2 < len1; v9 {
												...
												if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1426) == 0 {
													...
													pStmt = prepareSql(tls, __ccgo_ts+1429, libc.VaList(bp+1256, len1-jj3, zScript+uintptr(ii)+uintptr(jj3)))
													 ...
													 */
													if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1441) == 0 {
														 ...
														 */
														if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1446) == 0 {
															/* no-op */
														} else {
															/*
															 **  --start CLIENT
															 ...
															 */
															if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1452) == 0 && iClient == 0 {
																 ...
																 */
																if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1458) == 0 && iClient == 0 {
																	if nArg >= int32(2) {
																	...
																	iTimeout = v1
																	libsqlite3.Xsqlite3_snprintf(tls, int32(1000), bp+46, __ccgo_ts+1463, libc.VaList(bp+1256, prevLine, zFilename))
																	 ...
																	 ** already.
																	 */
																	if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1478) == 0 && iClient == 0 {
																		iTarget = libc.Xatoi(tls, bp+1046)
																		iEnd = findEnd(tls, zScript+uintptr(ii)+uintptr(len1), bp)
																		if iTarget < 0 {
																			errorMessage(tls, __ccgo_ts+1483, libc.VaList(bp+1256, prevLine, zFilename, iTarget))
																		} else {
																			...
																			if nArg > int32(1) {
																				...
																				zTName = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1520, libc.VaList(bp+1256, filenameTail(tls, zFilename), prevLine))
																			}
																			startClient(tls, iTarget)
																			runSql(tls, __ccgo_ts+1526, libc.VaList(bp+1256, iTarget, zTask, zTName))
																		...
																		if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1582) == 0 {
																			 ...
																			 */
																			if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1593) == 0 {
																				if nArg >= int32(1) {
																				...
																				/* error */
																				errorMessage(tls, __ccgo_ts+1609, libc.VaList(bp+1256, prevLine, zFilename, bp+16))
																			}
																		}
																	}
																}
...
func usage(tls *libc.TLS, argv0 uintptr) {
	...
	libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+1693, libc.VaList(bp+8, zTail))
	libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+1732, 0)
	libc.Xexit(tls, int32(1))
}
...
func unrecognizedArguments(tls *libc.TLS, argv0 uintptr, nArg int32, azArg uintptr) {
	...
	var i int32
	_ = i
	libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+2304, libc.VaList(bp+8, argv0))
	i = 0
	for {
		if !(i < nArg) {
			break
		}
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+2332, libc.VaList(bp+8, *(*uintptr)(unsafe.Pointer(azArg + uintptr(i)*4))))
		goto _1
	_1:
		;
		i = i + 1
	}
	libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+2336, 0)
	libc.Xexit(tls, int32(1))
}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	if libc.Bool(0 != 0) && libc.Xstrcmp(tls, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2345) != 0 {
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+2430, libc.VaList(bp+24, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2345))
		libc.Xexit(tls, int32(1))
	}
	*(*int32)(unsafe.Pointer(bp)) = argc - int32(2)
	libsqlite3.Xsqlite3_snprintf(tls, int32(32), uintptr(unsafe.Pointer(&g))+32, __ccgo_ts+2490, libc.VaList(bp+24, libc.Xgetpid(tls)))
	zJMode = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2502, int32(1))
	zNRep = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2514, int32(1))
	if zNRep != 0 {
	...
	g.FzVfs = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2521, int32(1))
	zClient = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2525, int32(1))
	g.FzErrLog = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2532, int32(1))
	g.FzLog = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2539, int32(1))
	zTrace = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2543, int32(1))
	if zTrace != 0 {
		g.FiTrace = libc.Xatoi(tls, zTrace)
	}
	if findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2549, 0) != uintptr(0) {
		g.FiTrace = 0
	}
	zTmout = findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2555, int32(1))
	if zTmout != 0 {
		iTmout = libc.Xatoi(tls, zTmout)
	}
	g.FbSqlTrace = libc.BoolInt32(findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2563, 0) != uintptr(0))
	g.FbSync = libc.BoolInt32(findOption(tls, argv+uintptr(2)*4, bp, __ccgo_ts+2572, 0) != uintptr(0))
	if g.FzErrLog != 0 {
		g.FpErrLog = libc.Xfopen(tls, g.FzErrLog, __ccgo_ts+2577)
	} else {
		g.FpErrLog = libc.Xstderr
	}
	if g.FzLog != 0 {
		g.FpLog = libc.Xfopen(tls, g.FzLog, __ccgo_ts+2577)
	} else {
	...
	if zClient != 0 {
		...
		if iClient < int32(1) {
			fatalError(tls, __ccgo_ts+2579, libc.VaList(bp+24, iClient))
		}
		libsqlite3.Xsqlite3_snprintf(tls, int32(32), uintptr(unsafe.Pointer(&g))+32, __ccgo_ts+2606, libc.VaList(bp+24, libc.Xgetpid(tls), iClient))
	} else {
		nTry = 0
		if g.FiTrace > 0 {
			libc.Xprintf(tls, __ccgo_ts+2622, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv))))
			i = int32(1)
			for {
				if !(i < argc) {
					break
				}
				libc.Xprintf(tls, __ccgo_ts+2332, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				goto _1
			_1:
				;
				i = i + 1
			}
			libc.Xprintf(tls, __ccgo_ts+2336, 0)
			libc.Xprintf(tls, __ccgo_ts+2632, 0)
			i = 0
			for {
				...
				libc.Xprintf(tls, __ccgo_ts+2737, libc.VaList(bp+24, zCOption))
				goto _2
			_2:
				;
				i = i + 1
		...
		for {
			if nTry%int32(5) == int32(4) {
				...
				libc.Xprintf(tls, __ccgo_ts+2757, libc.VaList(bp+24, v3, g.FzDbFile))
			}
		...
		if rc != 0 {
			fatalError(tls, __ccgo_ts+2786, libc.VaList(bp+24, g.FzDbFile, nTry))
		}
	...
	if rc != 0 {
		fatalError(tls, __ccgo_ts+2827, libc.VaList(bp+24, g.FzDbFile))
	}
	if iTmout > 0 {
		libsqlite3.Xsqlite3_busy_timeout(tls, g.Fdb, iTmout)
	}
	if zJMode != 0 {
		runSql(tls, __ccgo_ts+2844, libc.VaList(bp+24, zJMode))
	}
	if !(g.FbSync != 0) {
		trySql(tls, __ccgo_ts+2868, 0)
	}
	...
	libsqlite3.Xsqlite3_create_function(tls, g.Fdb, __ccgo_ts+2891, 0, int32(SQLITE_UTF8), uintptr(0), __ccgo_fp(vfsNameFunc), uintptr(0), uintptr(0))
	libsqlite3.Xsqlite3_create_function(tls, g.Fdb, __ccgo_ts+2899, int32(1), int32(SQLITE_UTF8), uintptr(0), __ccgo_fp(evalFunc), uintptr(0), uintptr(0))
	g.FiTimeout = int32(DEFAULT_TIMEOUT)
	if g.FbSqlTrace != 0 {
	...
	if iClient > 0 {
		...
		for int32(1) != 0 {
			*(*uintptr)(unsafe.Pointer(bp + 12)) = uintptr(0)
			...
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+2917, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(bp + 12)), *(*int32)(unsafe.Pointer(bp + 8))))
			}
			runScript(tls, iClient, *(*int32)(unsafe.Pointer(bp + 8)), *(*uintptr)(unsafe.Pointer(bp + 4)), *(*uintptr)(unsafe.Pointer(bp + 12)))
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+2931, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(bp + 12)), *(*int32)(unsafe.Pointer(bp + 8))))
			}
		...
		*(*uintptr)(unsafe.Pointer(bp + 4)) = readFile(tls, *(*uintptr)(unsafe.Pointer(argv + 2*4)))
		...
		for {
			...
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+3414, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv + 2*4)), iRep))
			}
			runScript(tls, 0, 0, *(*uintptr)(unsafe.Pointer(bp + 4)), *(*uintptr)(unsafe.Pointer(argv + 2*4)))
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+3442, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv + 2*4)), iRep))
			}
			goto _8
		_8:
			;
		...
		iTimeout = int32(1000)
		for {
			v4 = trySql(tls, __ccgo_ts+3517, 0)
			rc = v4
		...
		libsqlite3.Xsqlite3_sleep(tls, int32(100))
		pStmt = prepareSql(tls, __ccgo_ts+3538, 0)
		iTimeout = int32(1000)
		for {
	...
	maybeClose(tls, g.FpErrLog)
	if iClient == 0 {
		libc.Xprintf(tls, __ccgo_ts+3573, libc.VaList(bp+24, g.FnError, g.FnTest))
		libc.Xprintf(tls, __ccgo_ts+3609, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv))))
		i = int32(1)
		for {
			if !(i < argc) {
				break
