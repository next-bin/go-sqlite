// Code generated for darwin/amd64 by 'generator -DNDEBUG -I /var/folders/4f/mc8mts295pqf7gmnfcwh6g8w0000gn/T/libsqlite3/sqlite-src-3530000 -ignore-unsupported-alignment -ignore-link-errors -o mptest/ccgo_darwin_amd64.go /var/folders/4f/mc8mts295pqf7gmnfcwh6g8w0000gn/T/libsqlite3/sqlite-src-3530000/mptest/mptest.c -lsqlite3', DO NOT EDIT.
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	...
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if v10 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+917, uint64(4)) == 0; v10 {
											...
											if !(int32(*(*int8)(unsafe.Pointer(zNewFile))) == libc.Int32FromUint8('/')) {
												...
												if k > 0 {
													...
													if zNewFile == uintptr(0) {
														libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+1369, 0)
														libc.Xabort(tls)
													}
												}
											}
...
func usage(tls *libc.TLS, argv0 uintptr) {
	...
	libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+1693, libc.VaList(bp+8, zTail))
	libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+1732, 0)
	libc.Xexit(tls, int32(1))
}
...
func unrecognizedArguments(tls *libc.TLS, argv0 uintptr, nArg int32, azArg uintptr) {
	...
	var i int32
	_ = i
	libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+2304, libc.VaList(bp+8, argv0))
	i = 0
	for {
		if !(i < nArg) {
			break
	...
	libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+2336, 0)
	libc.Xexit(tls, int32(1))
}
