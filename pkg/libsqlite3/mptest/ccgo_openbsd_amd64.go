// Code generated for openbsd/amd64 by 'generator -DNDEBUG -I /tmp/libsqlite3/sqlite-src-3530000 -ignore-unsupported-alignment -ignore-link-errors -o mptest/ccgo_openbsd_amd64.go /tmp/libsqlite3/sqlite-src-3530000/mptest/mptest.c -lsqlite3', DO NOT EDIT.
...
func strglob(tls *libc.TLS, zGlob uintptr, z uintptr) (r int32) {
	...
	var v6 bool
	_, _, _, _, _, _, _, _, _, _, _, _ = c, c2, invert, prior_c, seen, v1, v2, v3, v4, v5, v6, v7
	for {
		v2 = zGlob
		zGlob = zGlob + 1
				...
				if c == int32('[') {
					...
					if c == int32('#') {
						if v6 = int32(*(*int8)(unsafe.Pointer(z))) == int32('-') || int32(*(*int8)(unsafe.Pointer(z))) == int32('+'); v6 {
							v1 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(z + 1))))
							if v1 == -int32(1) {
								v7 = 0
							} else {
								v7 = int32(*(*int8)(unsafe.Pointer(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_N)
							}
							v3 = v7
							goto _19
						_19:
...
func maybeClose(tls *libc.TLS, pOut uintptr) {
	if pOut != uintptr(unsafe.Pointer(libc.Xstdout)) && pOut != uintptr(unsafe.Pointer(libc.Xstderr)) {
	...
	for {
		if v6 = *(*int8)(unsafe.Pointer(z + uintptr(i))) != 0; v6 {
			...
			if v2 == -int32(1) {
				...
				v5 = int32(*(*int8)(unsafe.Pointer(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v2))))) & int32(_CTYPE_S)
			}
			v3 = v5
			goto _4
		_4:
...
func tokenLength(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	var c, c1, delim, inC, n, v1, v2, v4, v5 int32
	var v19 bool
	_, _, _, _, _, _, _, _, _, _ = c, c1, delim, inC, n, v1, v19, v2, v4, v5
	n = 0
	v1 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(z))))
	if v1 == -int32(1) {
		v4 = 0
		...
		if int32(*(*int8)(unsafe.Pointer(z))) == int32('-') && int32(*(*int8)(unsafe.Pointer(z + 1))) == int32('-') {
			...
			if int32(*(*int8)(unsafe.Pointer(z))) == int32('"') || int32(*(*int8)(unsafe.Pointer(z))) == int32('\'') {
				...
				for {
					...
					if !(v19 && !(v4 != 0) && c1 != int32('"') && c1 != int32('\'') && c1 != int32(';')) {
						break
					}
					goto _13
				_13:
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	var len1, n, skip, v1, v2, v4, v6, v7, v9 int32
	var v10, v11, v5 bool
	_, _, _, _, _, _, _, _, _, _, _, _ = len1, n, skip, v1, v10, v11, v2, v4, v5, v6, v7, v9
	n = 0
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if v11 = v5 && v2 != 0; !v11 {
			if v10 = stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+910, uint64(6)) == 0; v10 {
				v6 = libc.Int32FromUint8(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(z + uintptr(n+int32(6))))))
				if v6 == -int32(1) {
					v9 = 0
				} else {
					v9 = int32(*(*int8)(unsafe.Pointer(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v6))))) & int32(_CTYPE_S)
				}
				v7 = v9
				goto _8
			_8:
		...
		if v5 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+917, uint64(4)) == 0; v5 {
...
func runScript(tls *libc.TLS, iClient int32, taskId int32, zScript uintptr, zFilename uintptr) {
	bp := tls.Alloc(1312)
	defer tls.Free(1312)
	var c, iBegin, iEnd, iNewClient, iTarget, iTimeout, ii, isGlob, j, jj, jj1, jj2, jj3, k, len1, n, nArg, prevLine, rc, rc1, v1, v2, v3 int32
	...
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = c, iBegin, iEnd, iNewClient, iTarget, iTimeout, ii, isGlob, j, jj, jj1, jj2, jj3, k, len1, n, nArg, pStmt, prevLine, rc, rc1, zAns, zAns1, zCopy, zNewFile, zNewScript, zSql, zSql1, zTName, zTask, zToDel, v1, v10, v2, v3, v32
	*(*int32)(unsafe.Pointer(bp)) = int32(1)
	...
	for {
		...
		if v1 == -int32(1) {
			...
			v3 = int32(*(*int8)(unsafe.Pointer(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_S)
		}
		v2 = v3
		goto _4
	_4:
		...
		if v10 = c != int32('-') || int32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+int32(1))))) != int32('-'); !v10 {
			v1 = int32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+int32(2)))))
			if v1 == -int32(1) {
				v3 = 0
			} else {
				v3 = int32(*(*int8)(unsafe.Pointer(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & (libc.Int32FromInt32(_CTYPE_U) | libc.Int32FromInt32(_CTYPE_L))
			}
			v2 = v3
			goto _8
		_8:
								...
								if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1291) == 0 || libc.Xstrcmp(tls, bp+24, __ccgo_ts+1296) == 0 {
									...
									if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1347) == 0 {
										...
										if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1354) == 0 {
											...
											if !(int32(*(*int8)(unsafe.Pointer(zNewFile))) == libc.Int32FromUint8('/')) {
												...
												if k > 0 {
													...
													if zNewFile == uintptr(0) {
														libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+1369, 0)
														libc.Xabort(tls)
													}
												}
											}
											...
											if g.FiTrace != 0 {
												logMessage(tls, __ccgo_ts+1384, libc.VaList(bp+1264, zNewFile))
											}
											runScript(tls, 0, 0, zNewScript, zNewFile)
											libsqlite3.Xsqlite3_free(tls, zNewScript)
											if g.FiTrace != 0 {
												logMessage(tls, __ccgo_ts+1403, libc.VaList(bp+1264, zNewFile))
											}
											 ...
											 */
											if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1420) == 0 {
												jj2 = int32(7)
												for {
													if v10 = jj2 < len1; v10 {
												...
												if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1426) == 0 {
													...
													pStmt = prepareSql(tls, __ccgo_ts+1429, libc.VaList(bp+1264, len1-jj3, zScript+uintptr(ii)+uintptr(jj3)))
													 ...
													 */
													if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1441) == 0 {
														 ...
														 */
														if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1446) == 0 {
															/* no-op */
														} else {
															/*
															 **  --start CLIENT
															 ...
															 */
															if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1452) == 0 && iClient == 0 {
																 ...
																 */
																if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1458) == 0 && iClient == 0 {
																	if nArg >= int32(2) {
																	...
																	iTimeout = v1
																	libsqlite3.Xsqlite3_snprintf(tls, int32(1000), bp+54, __ccgo_ts+1463, libc.VaList(bp+1264, prevLine, zFilename))
																	 ...
																	 ** already.
																	 */
																	if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1478) == 0 && iClient == 0 {
																		iTarget = libc.Xatoi(tls, bp+1054)
																		iEnd = findEnd(tls, zScript+uintptr(ii)+uintptr(len1), bp)
																		if iTarget < 0 {
																			errorMessage(tls, __ccgo_ts+1483, libc.VaList(bp+1264, prevLine, zFilename, iTarget))
																		} else {
																			...
																			if nArg > int32(1) {
																				...
																				zTName = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1520, libc.VaList(bp+1264, filenameTail(tls, zFilename), prevLine))
																			}
																			startClient(tls, iTarget)
																			runSql(tls, __ccgo_ts+1526, libc.VaList(bp+1264, iTarget, zTask, zTName))
																		...
																		if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1582) == 0 {
																			 ...
																			 */
																			if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1593) == 0 {
																				if nArg >= int32(1) {
																				...
																				/* error */
																				errorMessage(tls, __ccgo_ts+1609, libc.VaList(bp+1264, prevLine, zFilename, bp+24))
																			}
																		}
																	}
																}
...
func usage(tls *libc.TLS, argv0 uintptr) {
	...
	libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+1693, libc.VaList(bp+8, zTail))
	libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+1732, 0)
	libc.Xexit(tls, int32(1))
}
...
func unrecognizedArguments(tls *libc.TLS, argv0 uintptr, nArg int32, azArg uintptr) {
	...
	var i int32
	_ = i
	libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+2304, libc.VaList(bp+8, argv0))
	i = 0
	for {
		if !(i < nArg) {
			break
		}
		libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+2332, libc.VaList(bp+8, *(*uintptr)(unsafe.Pointer(azArg + uintptr(i)*8))))
		goto _1
	_1:
		;
		i = i + 1
	}
	libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+2336, 0)
	libc.Xexit(tls, int32(1))
}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	if libc.Bool(0 != 0) && libc.Xstrcmp(tls, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2345) != 0 {
		libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+2430, libc.VaList(bp+40, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2345))
		libc.Xexit(tls, int32(1))
	}
	*(*int32)(unsafe.Pointer(bp)) = argc - int32(2)
	...
	g.FzVfs = findOption(tls, argv+uintptr(2)*8, bp, __ccgo_ts+2521, int32(1))
	zClient = findOption(tls, argv+uintptr(2)*8, bp, __ccgo_ts+2525, int32(1))
	g.FzErrLog = findOption(tls, argv+uintptr(2)*8, bp, __ccgo_ts+2532, int32(1))
	g.FzLog = findOption(tls, argv+uintptr(2)*8, bp, __ccgo_ts+2539, int32(1))
	zTrace = findOption(tls, argv+uintptr(2)*8, bp, __ccgo_ts+2543, int32(1))
	if zTrace != 0 {
		g.FiTrace = libc.Xatoi(tls, zTrace)
	}
	if findOption(tls, argv+uintptr(2)*8, bp, __ccgo_ts+2549, 0) != uintptr(0) {
		g.FiTrace = 0
	}
	zTmout = findOption(tls, argv+uintptr(2)*8, bp, __ccgo_ts+2555, int32(1))
	if zTmout != 0 {
		iTmout = libc.Xatoi(tls, zTmout)
	}
	g.FbSqlTrace = libc.BoolInt32(findOption(tls, argv+uintptr(2)*8, bp, __ccgo_ts+2563, 0) != uintptr(0))
	g.FbSync = libc.BoolInt32(findOption(tls, argv+uintptr(2)*8, bp, __ccgo_ts+2572, 0) != uintptr(0))
	if g.FzErrLog != 0 {
		g.FpErrLog = libc.Xfopen(tls, g.FzErrLog, __ccgo_ts+2577)
	} else {
		g.FpErrLog = uintptr(unsafe.Pointer(libc.Xstderr))
	}
	if g.FzLog != 0 {
		g.FpLog = libc.Xfopen(tls, g.FzLog, __ccgo_ts+2577)
	} else {
		g.FpLog = uintptr(unsafe.Pointer(libc.Xstdout))
	}
	...
	if zClient != 0 {
		...
		if iClient < int32(1) {
			fatalError(tls, __ccgo_ts+2579, libc.VaList(bp+40, iClient))
		}
		libsqlite3.Xsqlite3_snprintf(tls, int32(32), uintptr(unsafe.Pointer(&g))+64, __ccgo_ts+2606, libc.VaList(bp+40, libc.Xgetpid(tls), iClient))
	} else {
		nTry = 0
		if g.FiTrace > 0 {
			...
			for {
				...
				libc.Xprintf(tls, __ccgo_ts+2737, libc.VaList(bp+40, zCOption))
				goto _2
			_2:
				;
				i = i + 1
		...
		if rc != 0 {
			fatalError(tls, __ccgo_ts+2786, libc.VaList(bp+40, g.FzDbFile, nTry))
		}
	...
	if rc != 0 {
		fatalError(tls, __ccgo_ts+2827, libc.VaList(bp+40, g.FzDbFile))
	}
	if iTmout > 0 {
		libsqlite3.Xsqlite3_busy_timeout(tls, g.Fdb, iTmout)
	}
	if zJMode != 0 {
		runSql(tls, __ccgo_ts+2844, libc.VaList(bp+40, zJMode))
	}
	if !(g.FbSync != 0) {
