// Code generated for openbsd/arm64 by 'generator -DNDEBUG -I /tmp/libsqlite3/sqlite-src-3530000 -ignore-unsupported-alignment -ignore-link-errors -o mptest/ccgo_openbsd_arm64.go /tmp/libsqlite3/sqlite-src-3530000/mptest/mptest.c -lsqlite3', DO NOT EDIT.
				...
				if c == int32('[') {
					...
					if c == int32('#') {
						if v6 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(z))) == int32('-') || libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(z))) == int32('+'); v6 {
							v1 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(z + 1)))
							if v1 == -int32(1) {
								v7 = 0
							} else {
								v7 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_N)
							}
							v3 = v7
							goto _19
						_19:
...
func stringAppendTerm(tls *libc.TLS, p uintptr, z uintptr) {
	...
	i = 0
	for {
		if v6 = *(*uint8)(unsafe.Pointer(z + uintptr(i))) != 0; v6 {
			v2 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(z + uintptr(i))))
			if v2 == -int32(1) {
				v5 = 0
			} else {
				v5 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v2))))) & int32(_CTYPE_S)
			}
			v3 = v5
			goto _4
		_4:
...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	n = 0
	for {
		if v6 = *(*uint8)(unsafe.Pointer(z + uintptr(n))) != 0; v6 {
	...
	for *(*uint8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if v11 = v5 && v2 != 0; !v11 {
			if v10 = stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+910, uint64(6)) == 0; v10 {
				v6 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(z + uintptr(n+int32(6)))))
				if v6 == -int32(1) {
					v9 = 0
				} else {
					v9 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v6))))) & int32(_CTYPE_S)
				}
				v7 = v9
				goto _8
			_8:
	...
	*(*int32)(unsafe.Pointer(bp)) = int32(1)
	...
	for {
		...
		if v1 == -int32(1) {
			...
			v3 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_S)
		}
		v2 = v3
		goto _4
	_4:
		...
		if v10 = c != int32('-') || libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(zScript + uintptr(ii+int32(1))))) != int32('-'); !v10 {
			v1 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(zScript + uintptr(ii+int32(2)))))
			if v1 == -int32(1) {
				v3 = 0
			} else {
				v3 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & (libc.Int32FromInt32(_CTYPE_U) | libc.Int32FromInt32(_CTYPE_L))
			}
			v2 = v3
			goto _8
		_8:
