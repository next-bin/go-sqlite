...
package scanner // github.com/next-bin/go-sqlite3/pkg/scanner
...
import (
	...
	mtoken "github.com/next-bin/go-sqlite3/pkg/token"
)
...
// false.
func (t Token) IsValid() bool { return t.source != nil && len(t.source.toks) != 0 }
...
// [github.com/next-bin/go-sqlite3/pkg/rec compiler].
//
// [github.com/next-bin/go-sqlite3/pkg/rec compiler]: https://pkg.go.dev/github.com/next-bin/go-sqlite3/pkg/rec
...
// github.com/next-bin/go-sqlite3/pkg/rec compiler produces. 'whiteSpace' is the id the 'scan'
