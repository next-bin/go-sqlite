...
//go:generate yy -o /dev/null -position -astImport "\"fmt\"\n\n\"github.com/next-bin/go-sqlite3/pkg/token"" -prettyString PrettyString -kind Case -noListKind -noPrivateHelpers -forceOptPos parser.yy
...
//
//	$ go get [-u] github.com/next-bin/go-sqlite3/pkg/cc3
//
// # Online documentation
//
// See https://godoc.org/github.com/next-bin/go-sqlite3/pkg/cc3.
//
// # Status
//
...
package cc // import "github.com/next-bin/go-sqlite3/pkg/cc3"
