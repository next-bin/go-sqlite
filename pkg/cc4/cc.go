...
//go:generate yy -o /dev/null -position -astImport "\"fmt\"\n\n\"github.com/next-bin/go-sqlite3/pkg/btoken\"" -prettyString PrettyString -kind Case -noListKind -noPrivateHelpers -forceOptPos parser.yy
...
//
// See https://godoc.org/github.com/next-bin/go-sqlite3/pkg/cc4.
//
// # Links
//
...
package cc // import "github.com/next-bin/go-sqlite3/pkg/cc4"
