...
import (
	...
	gomod "github.com/next-bin/go-sqlite3/pkg/gomod/engine"
...
// k={pi400 github.com/next-bin/go-sqlite3/pkg/tcl} v="2023-09-22T16:52:46+02:00\teeb09a874245b41a6720d97279954f96f1c252ff\twindows\tarm64\tFAIL\tgo1.21.1\tv0.1.0"
//                           0                             1                                         2        3      4     5         6
...
func (task *task) removeLibcV2() {
	if task.importPath != "github.com/next-bin/go-sqlite3/pkg/libc" {
		return
	}
...
func (task *task) url() string {
	switch {
	case strings.HasPrefix(task.importPath, "github.com/next-bin/go-sqlite3/pkg/"):
		return fmt.Sprintf("https://gitlab.com/cznic/%s.git", task.importPath[len("github.com/next-bin/go-sqlite3/pkg/"):])
...
func initTasks() {
	...
	for _, builder := range []string{
		...
		for _, importPath := range []string{
			"github.com/next-bin/go-sqlite3/pkg/ace",
			"github.com/next-bin/go-sqlite3/pkg/b",
			"github.com/next-bin/go-sqlite3/pkg/bitz",
			"github.com/next-bin/go-sqlite3/pkg/cc4",
			"github.com/next-bin/go-sqlite3/pkg/ccgo4",
			"github.com/next-bin/go-sqlite3/pkg/css",
			"github.com/next-bin/go-sqlite3/pkg/db",
			"github.com/next-bin/go-sqlite3/pkg/doomgeneric",
			"github.com/next-bin/go-sqlite3/pkg/dyd",
			"github.com/next-bin/go-sqlite3/pkg/egg",
			"github.com/next-bin/go-sqlite3/pkg/equ",
			"github.com/next-bin/go-sqlite3/pkg/file",
			"github.com/next-bin/go-sqlite3/pkg/fileutil",
			"github.com/next-bin/go-sqlite3/pkg/fsm",
			"github.com/next-bin/go-sqlite3/pkg/gc2",
			"github.com/next-bin/go-sqlite3/pkg/gc3",
			"github.com/next-bin/go-sqlite3/pkg/go0",
			"github.com/next-bin/go-sqlite3/pkg/goabi0",
			"github.com/next-bin/go-sqlite3/pkg/gs",
			"github.com/next-bin/go-sqlite3/pkg/htmlview",
			"github.com/next-bin/go-sqlite3/pkg/internal",
			"github.com/next-bin/go-sqlite3/pkg/knuth",
			"github.com/next-bin/go-sqlite3/libX11",
			"github.com/next-bin/go-sqlite3/libXau",
			"github.com/next-bin/go-sqlite3/libXdmcp",
			"github.com/next-bin/go-sqlite3/libXft",
			"github.com/next-bin/go-sqlite3/libXrender",
			"github.com/next-bin/go-sqlite3/libbsd",
			"github.com/next-bin/go-sqlite3/pkg/libc",
			"github.com/next-bin/go-sqlite3/libexpat",
			"github.com/next-bin/go-sqlite3/libfontconfig",
			"github.com/next-bin/go-sqlite3/libfreetype",
			"github.com/next-bin/go-sqlite3/libgmp",
			"github.com/next-bin/go-sqlite3/libmd",
			"github.com/next-bin/go-sqlite3/libmpc",
			"github.com/next-bin/go-sqlite3/libmpfr",
			"github.com/next-bin/go-sqlite3/libpcre",
			"github.com/next-bin/go-sqlite3/libpcre16",
			"github.com/next-bin/go-sqlite3/libpcre2-16",
			"github.com/next-bin/go-sqlite3/libpcre2-32",
			"github.com/next-bin/go-sqlite3/libpcre2-8",
			"github.com/next-bin/go-sqlite3/libpcre2-posix",
			"github.com/next-bin/go-sqlite3/libpcre32",
			"github.com/next-bin/go-sqlite3/libpcreposix",
			"github.com/next-bin/go-sqlite3/libqbe",
			"github.com/next-bin/go-sqlite3/libquickjs",
			"github.com/next-bin/go-sqlite3/libsamplerate", // was paused, see https://github.com/golang/go/issues/73425
			"github.com/next-bin/go-sqlite3/pkg/libsqlite3",
			"github.com/next-bin/go-sqlite3/libsqlite_vec",
			"github.com/next-bin/go-sqlite3/pkg/libtcl8.6",
			"github.com/next-bin/go-sqlite3/pkg/libtcl9.0",
			"github.com/next-bin/go-sqlite3/libtk9.0",
			"github.com/next-bin/go-sqlite3/libxcb",
			"github.com/next-bin/go-sqlite3/pkg/libz",
			"github.com/next-bin/go-sqlite3/pkg/mathutil",
			"github.com/next-bin/go-sqlite3/pkg/memory",
			"github.com/next-bin/go-sqlite3/pkg/nerdamer",
			"github.com/next-bin/go-sqlite3/pkg/opt",
			"github.com/next-bin/go-sqlite3/pkg/purego",
			"github.com/next-bin/go-sqlite3/pkg/qbecc",
			"github.com/next-bin/go-sqlite3/pkg/ql",
			"github.com/next-bin/go-sqlite3/pkg/quickjs",
			"github.com/next-bin/go-sqlite3/pkg/rec",
			"github.com/next-bin/go-sqlite3/pkg/regexp",
			"github.com/next-bin/go-sqlite3/pkg/sortutil",
			"github.com/next-bin/go-sqlite3",
			"github.com/next-bin/go-sqlite3/pkg/sqlite-bench",
			"github.com/next-bin/go-sqlite3/pkg/sqlite-bench2",
			"github.com/next-bin/go-sqlite3/pkg/strutil",
			"github.com/next-bin/go-sqlite3/pkg/tcl8.6",
			"github.com/next-bin/go-sqlite3/pkg/tcl9.0",
			"github.com/next-bin/go-sqlite3/pkg/tfs",
			"github.com/next-bin/go-sqlite3/pkg/tk9.0",
			"github.com/next-bin/go-sqlite3/pkg/visualmd",
			"github.com/next-bin/go-sqlite3/pkg/y",
			// obsolete "github.com/next-bin/go-sqlite3/pkg/cc3",
			// obsolete "github.com/next-bin/go-sqlite3/pkg/cc5",
			// obsolete "github.com/next-bin/go-sqlite3/pkg/ccgo3",
			// obsolete "github.com/next-bin/go-sqlite3/pkg/ccorpus",
			// obsolete "github.com/next-bin/go-sqlite3/libadvapi32",
			// obsolete "github.com/next-bin/go-sqlite3/libcomctl32",
			// obsolete "github.com/next-bin/go-sqlite3/libcomdlg32",
			// obsolete "github.com/next-bin/go-sqlite3/libgdi32",
			// obsolete "github.com/next-bin/go-sqlite3/libimm32",
			// obsolete "github.com/next-bin/go-sqlite3/libkernel32",
			// obsolete "github.com/next-bin/go-sqlite3/libnetapi32",
			// obsolete "github.com/next-bin/go-sqlite3/libole32",
			// obsolete "github.com/next-bin/go-sqlite3/libshell32",
			// obsolete "github.com/next-bin/go-sqlite3/libuser32",
			// obsolete "github.com/next-bin/go-sqlite3/libuserenv",
			// obsolete "github.com/next-bin/go-sqlite3/libwinspool",
			// obsolete "github.com/next-bin/go-sqlite3/libws2_32",
			// obsolete "github.com/next-bin/go-sqlite3/pkg/tcl",
			// obsolete "github.com/next-bin/go-sqlite3/pkg/z",
			...
			// paused "github.com/next-bin/go-sqlite3/pkg/assets",
			// paused "github.com/next-bin/go-sqlite3/pkg/ccorpus2",
			// paused "github.com/next-bin/go-sqlite3/pkg/ebnf",
			// paused "github.com/next-bin/go-sqlite3/pkg/ebnfutil",
			// paused "github.com/next-bin/go-sqlite3/pkg/gc3/internal/ebnf",
			// paused "github.com/next-bin/go-sqlite3/pkg/golex",
			// paused "github.com/next-bin/go-sqlite3/pkg/goyacc",
			// paused "github.com/next-bin/go-sqlite3/pkg/hash",
			// paused "github.com/next-bin/go-sqlite3/pkg/httpfs",
			// paused "github.com/next-bin/go-sqlite3/pkg/immutable",
			// paused "github.com/next-bin/go-sqlite3/pkg/kv",
			// paused "github.com/next-bin/go-sqlite3/pkg/lex",
			// paused "github.com/next-bin/go-sqlite3/pkg/lexer",
			// paused "github.com/next-bin/go-sqlite3/pkg/lldb",
			// paused "github.com/next-bin/go-sqlite3/pkg/ngrab",
			// paused "github.com/next-bin/go-sqlite3/pkg/parser",
			// paused "github.com/next-bin/go-sqlite3/pkg/qbe",
			// paused "github.com/next-bin/go-sqlite3/pkg/readline",
			// paused "github.com/next-bin/go-sqlite3/pkg/run",
			// paused "github.com/next-bin/go-sqlite3/pkg/scanner",
			// paused "github.com/next-bin/go-sqlite3/pkg/scannertest",
			// paused "github.com/next-bin/go-sqlite3/pkg/token",
			// paused "github.com/next-bin/go-sqlite3/pkg/uncomment",
			// paused "github.com/next-bin/go-sqlite3/pkg/xc",
			// paused "github.com/next-bin/go-sqlite3/pkg/yy",
			// paused "github.com/next-bin/go-sqlite3/pkg/zappy",
			...
			case "gonum.org/v1/gonum/v1/gonum":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/ace":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/b":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/dyd":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, ".", "./dyd"}
			case "github.com/next-bin/go-sqlite3/pkg/run":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/internal":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/ql":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "-tags=purego", "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/qbe":
				task.test = []string{"go", "test", "-vet", "off", "-v", "-failfast", "-timeout", tmax, "./...", "-bestof", "1", "-gcc", "7,8,9,10,11"}
			case "zombiezen.com/go/sqlite":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/scanner":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/parser":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/lexer":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/knuth":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/gs":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/egg":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/regexp":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/rec":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/tfs":
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "./..."}
			case "github.com/next-bin/go-sqlite3/pkg/gc2":
				task.importPath = "github.com/next-bin/go-sqlite3/pkg/gc"
				task.testPath = "github.com/next-bin/go-sqlite3/pkg/gc2"
			case "github.com/next-bin/go-sqlite3/pkg/gc3":
				task.importPath = "github.com/next-bin/go-sqlite3/pkg/gc"
				task.testPath = "github.com/next-bin/go-sqlite3/pkg/gc3"
			case "github.com/next-bin/go-sqlite3/pkg/gc3/internal/ebnf":
				task.importPath = "github.com/next-bin/go-sqlite3/pkg/gc"
				task.testPath = "github.com/next-bin/go-sqlite3/pkg/gc3/internal/ebnf"
			case "github.com/next-bin/go-sqlite3/pkg/cc3":
				task.importPath = "github.com/next-bin/go-sqlite3/pkg/cc"
				task.testPath = "github.com/next-bin/go-sqlite3/pkg/cc3"
			case "github.com/next-bin/go-sqlite3/pkg/cc4":
				task.importPath = "github.com/next-bin/go-sqlite3/pkg/cc"
				task.testPath = "github.com/next-bin/go-sqlite3/pkg/cc4"
			case "github.com/next-bin/go-sqlite3/pkg/cc5":
				task.importPath = "github.com/next-bin/go-sqlite3/pkg/cc"
				task.testPath = "github.com/next-bin/go-sqlite3/pkg/cc5"
			case "github.com/next-bin/go-sqlite3/pkg/ccgo3":
				task.importPath = "github.com/next-bin/go-sqlite3/pkg/ccgo"
				task.testPath = "github.com/next-bin/go-sqlite3/pkg/ccgo3/lib"
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "-tags=ccgo.assert"}
			case "github.com/next-bin/go-sqlite3/pkg/ngrab":
				task.importPath = "github.com/next-bin/go-sqlite3/pkg/ngrab"
				task.testPath = "github.com/next-bin/go-sqlite3/pkg/ngrab/lib"
			case "github.com/next-bin/go-sqlite3/pkg/ccgo4":
				task.importPath = "github.com/next-bin/go-sqlite3/pkg/ccgo"
				task.testPath = "github.com/next-bin/go-sqlite3/pkg/ccgo4/lib"
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax, "-tags=ccgo.assert"}
			case "github.com/next-bin/go-sqlite3/pkg/qbecc":
				task.importPath = "github.com/next-bin/go-sqlite3/pkg/qbecc"
				task.testPath = "github.com/next-bin/go-sqlite3/pkg/qbecc/lib"
				task.test = []string{"go", "test", "-vet", "off", "-failfast", "-timeout", tmax}
			}
...
func (t *task) autotag(cfg *builderCfg, dir string) (out []byte, err error) {
	...
	const mtag = "github.com/next-bin/go-sqlite3"
	asBuilder := builder
	if asBuilder != leader {
		return nil, nil
	}
