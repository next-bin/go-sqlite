...
func _adler32_combine_(tls *libc.TLS, adler1 TuLong, adler2 TuLong, len2 int64) (r TuLong) {
	...
	sum2 = rem * sum1
	sum2 = sum2 % uint32(65521)
	sum1 = sum1 + (adler2&uint32(0xffff) + uint32(65521) - uint32(1))
	sum2 = sum2 + (adler1>>libc.Int32FromInt32(16)&uint32(0xffff) + adler2>>libc.Int32FromInt32(16)&uint32(0xffff) + uint32(65521) - rem)
	if sum1 >= uint32(65521) {
		sum1 = sum1 - uint32(65521)
	}
	if sum1 >= uint32(65521) {
		sum1 = sum1 - uint32(65521)
	}
	if sum2 >= libc.Uint32FromUint32(65521)<<libc.Int32FromInt32(1) {
		sum2 = sum2 - libc.Uint32FromUint32(65521)<<libc.Int32FromInt32(1)
	}
	if sum2 >= uint32(65521) {
		sum2 = sum2 - uint32(65521)
	}
...
func Xcompress2_z(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen Tz_size_t, level int32) (r int32) {
	...
	*(*Tz_size_t)(unsafe.Pointer(destLen)) = uint64(0)
	...
	err = XdeflateInit_(tls, bp, level, __ccgo_ts, libc.Int32FromInt64(88))
	if err != m_Z_OK {
		return err
	}
...
func Xcompress2(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen TuLong, level int32) (r int32) {
	...
	*(*Tz_size_t)(unsafe.Pointer(bp)) = uint64(*(*TuLongf)(unsafe.Pointer(destLen)))
	ret = Xcompress2_z(tls, dest, bp, source, uint64(sourceLen), level)
...
func XcompressBound(tls *libc.TLS, sourceLen TuLong) (r TuLong) {
	...
	var v1 uint32
	_, _ = bound, v1
	bound = XcompressBound_z(tls, uint64(sourceLen))
	if uint64(uint32(bound)) != bound {
...
func XdeflatePrime(tls *libc.TLS, strm Tz_streamp, bits int32, value int32) (r int32) {
	...
	for cond := true; cond; cond = bits != 0 {
		...
		v1 = s + 5900
		*(*Tush)(unsafe.Pointer(v1)) = Tush(int32(*(*Tush)(unsafe.Pointer(v1))) | int32(uint16(value&(libc.Int32FromInt32(1)<<put-libc.Int32FromInt32(1))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)))
...
func XdeflateBound_z(tls *libc.TLS, strm Tz_streamp, sourceLen Tz_size_t) (r Tz_size_t) {
	...
	if fixedlen < sourceLen {
		fixedlen = uint64(-libc.Int32FromInt32(1))
	}
	...
	if storelen < sourceLen {
		storelen = uint64(-libc.Int32FromInt32(1))
	}
...
func XdeflateBound(tls *libc.TLS, strm Tz_streamp, sourceLen TuLong) (r TuLong) {
	...
	var v1 uint32
	_, _ = bound, v1
	bound = XdeflateBound_z(tls, strm, uint64(sourceLen))
	if uint64(uint32(bound)) != bound {
		v1 = uint32(-libc.Int32FromInt32(1))
	} else {
		v1 = uint32(bound)
		...
		*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v4))) = uint8(libc.Int32FromInt32(8))
		if (*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead == uintptr(m_Z_NULL) {
			...
			*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v4))) = uint8((*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fos & libc.Int32FromInt32(0xff))
			...
			if (*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fhcrc != 0 {
				(*Tz_stream)(unsafe.Pointer(strm)).Fadler = Xcrc32_z(tls, (*Tz_stream)(unsafe.Pointer(strm)).Fadler, (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf, uint64((*Tdeflate_state)(unsafe.Pointer(s)).Fpending))
			}
		...
		if (*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fextra != uintptr(m_Z_NULL) {
			...
			for (*Tdeflate_state)(unsafe.Pointer(s)).Fpending+left > (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf_size {
				...
				if (*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fhcrc != 0 && (*Tdeflate_state)(unsafe.Pointer(s)).Fpending > beg {
					(*Tz_stream)(unsafe.Pointer(strm)).Fadler = Xcrc32_z(tls, (*Tz_stream)(unsafe.Pointer(strm)).Fadler, (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf+uintptr(beg), uint64((*Tdeflate_state)(unsafe.Pointer(s)).Fpending-beg))
				}
			...
			for cond := true; cond; cond = val != 0 {
				if (*Tdeflate_state)(unsafe.Pointer(s)).Fpending == (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf_size {
					if (*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fhcrc != 0 && (*Tdeflate_state)(unsafe.Pointer(s)).Fpending > beg1 {
						(*Tz_stream)(unsafe.Pointer(strm)).Fadler = Xcrc32_z(tls, (*Tz_stream)(unsafe.Pointer(strm)).Fadler, (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf+uintptr(beg1), uint64((*Tdeflate_state)(unsafe.Pointer(s)).Fpending-beg1))
					}
					_flush_pending(tls, strm)
					if (*Tdeflate_state)(unsafe.Pointer(s)).Fpending != uint32(0) {
						(*Tdeflate_state)(unsafe.Pointer(s)).Flast_flush = -int32(1)
			...
			for cond := true; cond; cond = val1 != 0 {
				if (*Tdeflate_state)(unsafe.Pointer(s)).Fpending == (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf_size {
					if (*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fhcrc != 0 && (*Tdeflate_state)(unsafe.Pointer(s)).Fpending > beg2 {
						(*Tz_stream)(unsafe.Pointer(strm)).Fadler = Xcrc32_z(tls, (*Tz_stream)(unsafe.Pointer(strm)).Fadler, (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf+uintptr(beg2), uint64((*Tdeflate_state)(unsafe.Pointer(s)).Fpending-beg2))
					}
					_flush_pending(tls, strm)
					if (*Tdeflate_state)(unsafe.Pointer(s)).Fpending != uint32(0) {
						(*Tdeflate_state)(unsafe.Pointer(s)).Flast_flush = -int32(1)
...
func XdeflateCopy(tls *libc.TLS, dest Tz_streamp, source Tz_streamp) (r int32) {
	...
	ds = (*(*func(*libc.TLS, Tvoidpf, TuInt, TuInt) Tvoidpf)(unsafe.Pointer(&struct{ uintptr }{(*Tz_stream)(unsafe.Pointer(dest)).Fzalloc})))(tls, (*Tz_stream)(unsafe.Pointer(dest)).Fopaque, uint32(libc.Int32FromInt32(1)), uint32(libc.Uint64FromInt64(5920)))
	if ds == uintptr(m_Z_NULL) {
		return -int32(4)
	}
	libc.Xmemset(tls, ds, 0, uint64(5920))
	(*Tz_stream)(unsafe.Pointer(dest)).Fstate = ds
	libc.Xmemcpy(tls, ds, ss, uint64(5920))
	...
	libc.Xmemcpy(tls, (*Tdeflate_state)(unsafe.Pointer(ds)).Fwindow, (*Tdeflate_state)(unsafe.Pointer(ss)).Fwindow, uint64((*Tdeflate_state)(unsafe.Pointer(ss)).Fhigh_water))
	...
	libc.Xmemcpy(tls, (*Tdeflate_state)(unsafe.Pointer(ds)).Fpending_out, (*Tdeflate_state)(unsafe.Pointer(ss)).Fpending_out, uint64((*Tdeflate_state)(unsafe.Pointer(ss)).Fpending))
...
//
//	/* -- see zlib.h -- */
func Xgzopen_w(tls *libc.TLS, path uintptr, mode uintptr) (r TgzFile) {
...
func _gz_look(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fsize == uint32(0) {
		...
		if XinflateInit2_(tls, state+136, libc.Int32FromInt32(15)+libc.Int32FromInt32(16), __ccgo_ts, libc.Int32FromInt64(88)) != m_Z_OK { /* gunzip */
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
...
func _gz_skip(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	for cond := true; cond; cond = (*Tgz_state)(unsafe.Pointer(state)).Fskip != 0 {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave != 0 {
			if libc.Bool(libc.Bool(uint64(4) == uint64(8)) && (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave > Xgz_intmax(tls)) || int64((*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave) > (*Tgz_state)(unsafe.Pointer(state)).Fskip {
...
func _gz_init(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if !((*Tgz_state)(unsafe.Pointer(state)).Fdirect != 0) {
		...
		ret = XdeflateInit2_(tls, strm, (*Tgz_state)(unsafe.Pointer(state)).Flevel, int32(m_Z_DEFLATED), libc.Int32FromInt32(m_MAX_WBITS)+libc.Int32FromInt32(16), int32(m_DEF_MEM_LEVEL), (*Tgz_state)(unsafe.Pointer(state)).Fstrategy, __ccgo_ts, libc.Int32FromInt64(88))
		if ret != m_Z_OK {
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
			Xgz_error(tls, state, -int32(4), __ccgo_ts+17)
...
func _gz_zero(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	first = int32(1)
	for cond := true; cond; cond = (*Tgz_state)(unsafe.Pointer(state)).Fskip != 0 {
		if libc.Bool(libc.Bool(uint64(4) == uint64(8)) && (*Tgz_state)(unsafe.Pointer(state)).Fsize > Xgz_intmax(tls)) || int64((*Tgz_state)(unsafe.Pointer(state)).Fsize) > (*Tgz_state)(unsafe.Pointer(state)).Fskip {
			v1 = uint32((*Tgz_state)(unsafe.Pointer(state)).Fskip)
		} else {
...
func XinflateBackInit_(tls *libc.TLS, strm Tz_streamp, windowBits int32, window uintptr, version uintptr, stream_size int32) (r int32) {
	var state uintptr
	_ = state
	if version == uintptr(m_Z_NULL) || int32(*(*int8)(unsafe.Pointer(version))) != int32(*(*int8)(unsafe.Pointer(__ccgo_ts))) || stream_size != int32(libc.Uint64FromInt64(88)) {
		return -int32(6)
	}
	...
	*(*uintptr)(unsafe.Pointer(bp)) = (*Tz_stream)(unsafe.Pointer(strm)).Fnext_in
	...
	_5:
		...
		for (*Tinflate_state)(unsafe.Pointer(state)).Fhave < (*Tinflate_state)(unsafe.Pointer(state)).Fncode {
			...
			*(*uint16)(unsafe.Pointer(state + 144 + uintptr(_order[v1])*2)) = uint16(hold & (libc.Uint32FromUint32(1)<<libc.Int32FromInt32(3) - libc.Uint32FromInt32(1)))
		...
		for (*Tinflate_state)(unsafe.Pointer(state)).Fhave < uint32(19) {
			...
			v1 = *(*uint32)(unsafe.Pointer(v11))
			*(*uint32)(unsafe.Pointer(v11)) = *(*uint32)(unsafe.Pointer(v11)) + 1
			*(*uint16)(unsafe.Pointer(state + 144 + uintptr(_order[v1])*2)) = uint16(0)
		}
		...
		ret = Xinflate_table(tls, int32(_CODES), state+144, uint32(19), state+136, state+112, state+784)
		if ret != 0 {
		...
		for (*Tinflate_state)(unsafe.Pointer(state)).Fhave < (*Tinflate_state)(unsafe.Pointer(state)).Fnlen+(*Tinflate_state)(unsafe.Pointer(state)).Fndist {
			...
			if int32(here.Fval) < int32(16) {
				...
				v1 = *(*uint32)(unsafe.Pointer(v11))
				*(*uint32)(unsafe.Pointer(v11)) = *(*uint32)(unsafe.Pointer(v11)) + 1
				*(*uint16)(unsafe.Pointer(state + 144 + uintptr(v1)*2)) = here.Fval
			} else {
				if int32(here.Fval) == int32(16) {
				...
				for {
					...
					*(*uint32)(unsafe.Pointer(v11)) = *(*uint32)(unsafe.Pointer(v11)) + 1
					*(*uint16)(unsafe.Pointer(state + 144 + uintptr(v18)*2)) = uint16(len1)
				}
			}
		}
		...
		ret = Xinflate_table(tls, int32(_LENS), state+144, (*Tinflate_state)(unsafe.Pointer(state)).Fnlen, state+136, state+112, state+784)
		if ret != 0 {
		...
		ret = Xinflate_table(tls, int32(_DISTS), state+144+uintptr((*Tinflate_state)(unsafe.Pointer(state)).Fnlen)*2, (*Tinflate_state)(unsafe.Pointer(state)).Fndist, state+136, state+116, state+784)
		if ret != 0 {
...
func XinflatePrime(tls *libc.TLS, strm Tz_streamp, bits int32, value int32) (r int32) {
	...
	*(*uint32)(unsafe.Pointer(state + 72)) += uint32(value) << (*Tinflate_state)(unsafe.Pointer(state)).Fbits
	*(*uint32)(unsafe.Pointer(state + 76)) += uint32(bits)
	return m_Z_OK
}
...
func XinflateCopy(tls *libc.TLS, dest Tz_streamp, source Tz_streamp) (r int32) {
	...
	libc.Xmemset(tls, copy1, 0, uint64(7152))
...
func x__tr_tally(tls *libc.TLS, s uintptr, dist uint32, lc uint32) (r int32) {
	...
	*(*Tuchf)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fsym_buf + uintptr(v1))) = uint8(lc)
	if dist == uint32(0) {
		...
		*(*Tush)(unsafe.Pointer(s + 188 + uintptr(lc)*4)) = *(*Tush)(unsafe.Pointer(s + 188 + uintptr(lc)*4)) + 1
	} else {
		(*Tdeflate_state)(unsafe.Pointer(s)).Fmatches = (*Tdeflate_state)(unsafe.Pointer(s)).Fmatches + 1
		/* Here, lc is the match length - MIN_MATCH */
		dist = dist - 1 /* dist = match distance - 1 */
		*(*Tush)(unsafe.Pointer(s + 188 + uintptr(int32(x__length_code[lc])+int32(m_LITERALS)+int32(1))*4)) = *(*Tush)(unsafe.Pointer(s + 188 + uintptr(int32(x__length_code[lc])+int32(m_LITERALS)+int32(1))*4)) + 1
		if dist < uint32(256) {
			v7 = int32(x__dist_code[dist])
		} else {
			v7 = int32(x__dist_code[uint32(256)+dist>>int32(7)])
		}
		*(*Tush)(unsafe.Pointer(s + 2480 + uintptr(v7)*4)) = *(*Tush)(unsafe.Pointer(s + 2480 + uintptr(v7)*4)) + 1
	}
...
func Xuncompress2_z(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen uintptr) (r int32) {
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fzfree = libc.UintptrFromInt32(0)
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fopaque = libc.UintptrFromInt32(0)
	err = XinflateInit_(tls, bp, __ccgo_ts, libc.Int32FromInt64(88))
	if err != m_Z_OK {
		return err
	}
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fnext_out = dest
