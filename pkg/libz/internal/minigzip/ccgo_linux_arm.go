...
func _gz_compress(tls *libc.TLS, in uintptr, out TgzFile) {
	...
	_ = len1
	for {
		len1 = libc.Int32FromUint32(libc.Xfread(tls, bp, uint32(1), uint32(16384), in))
...
func _gz_uncompress(tls *libc.TLS, in TgzFile, out uintptr) {
	...
	for {
		...
		if libc.Int32FromUint32(libc.Xfwrite(tls, bp, uint32(1), libc.Uint32FromInt32(len1), out)) != len1 {
...
func _file_compress(tls *libc.TLS, file uintptr, mode uintptr) {
	...
	_, _, _ = end, in, out
	if libc.Xstrlen(tls, file)+libc.Xstrlen(tls, __ccgo_ts+57) >= uint32(1025) {
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+61, libc.VaList(bp+1040, _prog))
		libc.Xexit(tls, int32(1))
	}
	end = _string_copy(tls, bp, file, uint32(1025))
	_string_copy(tls, end, __ccgo_ts+57, uint32(1025)-libc.Uint32FromInt32(int32(end)-T__predefined_ptrdiff_t(bp)))
...
func _file_uncompress(tls *libc.TLS, file uintptr) {
	...
	if len1+libc.Xstrlen(tls, __ccgo_ts+57) >= uint32(1025) {
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+61, libc.VaList(bp+1040, _prog))
		libc.Xexit(tls, int32(1))
	}
	_string_copy(tls, bp, file, uint32(1025))
	if len1 > libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1) && libc.Xstrcmp(tls, file+uintptr(len1)-uintptr(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)), __ccgo_ts+57) == 0 {
		infile = file
		outfile = bp
		*(*uint8)(unsafe.Pointer(outfile + uintptr(len1-uint32(3)))) = uint8('\000')
	} else {
		outfile = file
		infile = bp
		_string_copy(tls, bp+uintptr(len1), __ccgo_ts+57, uint32(1025)-len1)
	}
...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	copyout = 0
	uncompr = 0
	_string_copy(tls, bp, __ccgo_ts+111, uint32(5))
...
func x_inflateInit2_(tls *libc.TLS, strm Tz_streamp, windowBits int32, version uintptr, stream_size int32) (r int32) {
	...
	var state uintptr
	_, _ = ret, state
	if version == uintptr(m_Z_NULL) || libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(version))) != libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(__ccgo_ts + 184))) || stream_size != libc.Int32FromUint32(libc.Uint32FromInt64(56)) {
		return -int32(6)
	}
	if strm == uintptr(m_Z_NULL) {
		return -int32(2)
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint32(1), __ccgo_ts+768, libc.VaList(bp+8, path))
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, path, libc.Uint32FromInt32(7)+libc.Uint32FromInt32(3)*libc.Uint32FromInt64(4), __ccgo_ts+771, libc.VaList(bp+8, fd))
...
func x_gz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint32(3), __ccgo_ts+793, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, __ccgo_ts+800, msg))
}
...
func _gz_look(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fsize == uint32(0) {
		...
		if x_inflateInit2_(tls, state+112, libc.Int32FromInt32(15)+libc.Int32FromInt32(16), __ccgo_ts+184, libc.Int32FromInt64(56)) != m_Z_OK { /* gunzip */
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
...
func _gz_init(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if !((*Tgz_state)(unsafe.Pointer(state)).Fdirect != 0) {
		...
		ret = x_deflateInit2_(tls, strm, (*Tgz_state)(unsafe.Pointer(state)).Flevel, int32(m_Z_DEFLATED), libc.Int32FromInt32(m_MAX_WBITS)+libc.Int32FromInt32(16), int32(m_DEF_MEM_LEVEL), (*Tgz_state)(unsafe.Pointer(state)).Fstrategy, __ccgo_ts+184, libc.Int32FromInt64(56))
		if ret != m_Z_OK {
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
			x_gz_error(tls, state, -int32(4), __ccgo_ts+779)
