// Code generated for openbsd/arm64 by 'cc --libc github.com/next-bin/go-sqlite3/pkg/libc --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -extended-errors -ignore-unsupported-alignment --package-name=main -DNDEBUG -DHAVE_HIDDEN -o minigzip64.go minigzip64.o.go -L. libz.a', DO NOT EDIT.
...
func _string_copy(tls *libc.TLS, dst uintptr, src uintptr, len1 Tz_size_t) (r uintptr) {
	...
	for {
		...
		v2 = src
		src = src + 1
		*(*uint8)(unsafe.Pointer(dst)) = *(*uint8)(unsafe.Pointer(v2))
		if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(dst))) == 0 {
			return dst
		}
		dst = dst + 1
	}
...
func _file_compress(tls *libc.TLS, file uintptr, mode uintptr) {
	...
	var end, in uintptr
	var out TgzFile
	var _ /* outfile at bp+0 */ [1025]uint8
	_, _, _ = end, in, out
	if libc.Xstrlen(tls, file)+libc.Xstrlen(tls, __ccgo_ts+57) >= uint64(1025) {
		libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+61, libc.VaList(bp+1040, _prog))
		libc.Xexit(tls, int32(1))
	}
	...
	if out == libc.UintptrFromInt32(0) {
		libc.Xfclose(tls, in)
		libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+87, libc.VaList(bp+1040, _prog, bp))
		libc.Xexit(tls, int32(1))
	}
...
func _file_uncompress(tls *libc.TLS, file uintptr) {
	...
	if len1 > libc.Uint64FromInt64(4)-libc.Uint64FromInt32(1) && libc.Xstrcmp(tls, file+uintptr(len1)-uintptr(libc.Uint64FromInt64(4)-libc.Uint64FromInt32(1)), __ccgo_ts+57) == 0 {
		infile = file
		outfile = bp
		*(*uint8)(unsafe.Pointer(outfile + uintptr(len1-uint64(3)))) = uint8('\000')
	} else {
		outfile = file
		infile = bp
	...
	if in == libc.UintptrFromInt32(0) {
		libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+87, libc.VaList(bp+1040, _prog, infile))
		libc.Xexit(tls, int32(1))
	}
...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
		...
		if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+128) == 0 {
			...
			if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+131) == 0 {
				...
				if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+134) == 0 {
					(*(*[5]uint8)(unsafe.Pointer(bp)))[int32(3)] = uint8('f')
				} else {
					if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+137) == 0 {
						(*(*[5]uint8)(unsafe.Pointer(bp)))[int32(3)] = uint8('h')
					} else {
						if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+140) == 0 {
							(*(*[5]uint8)(unsafe.Pointer(bp)))[int32(3)] = uint8('R')
						} else {
							if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv))))) == int32('-') && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 1))) >= int32('1') && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 1))) <= int32('9') && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 2))) == 0 {
								(*(*[5]uint8)(unsafe.Pointer(bp)))[int32(2)] = *(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 1))
							} else {
								break
							}
						}
	...
	if libc.Int32FromUint8((*(*[5]uint8)(unsafe.Pointer(bp)))[int32(3)]) == int32(' ') {
		(*(*[5]uint8)(unsafe.Pointer(bp)))[int32(3)] = uint8(0)
	}
	if argc == 0 {
		if uncompr != 0 {
			file = x_gzdopen(tls, libc.Xfileno(tls, uintptr(unsafe.Pointer(libc.Xstdin))), __ccgo_ts+84)
		...
		for {
			if uncompr != 0 {
				if copyout != 0 {
					...
					if file == libc.UintptrFromInt32(0) {
						libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+87, libc.VaList(bp+16, _prog, *(*uintptr)(unsafe.Pointer(argv))))
					} else {
						_gz_uncompress(tls, file, uintptr(unsafe.Pointer(libc.Xstdout)))
					}
				} else {
...
func x_inflateInit2_(tls *libc.TLS, strm Tz_streamp, windowBits int32, version uintptr, stream_size int32) (r int32) {
	...
	var state uintptr
	_, _ = ret, state
	if version == uintptr(m_Z_NULL) || libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(version))) != libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(__ccgo_ts + 184))) || stream_size != libc.Int32FromUint64(libc.Uint64FromInt64(112)) {
		return -int32(6)
	}
	if strm == uintptr(m_Z_NULL) {
		return -int32(2)
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint64(1), __ccgo_ts+768, libc.VaList(bp+8, path))
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, path, libc.Uint64FromInt32(7)+libc.Uint64FromInt32(3)*libc.Uint64FromInt64(4), __ccgo_ts+771, libc.VaList(bp+8, fd))
...
func x_gz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint64(3), __ccgo_ts+793, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, __ccgo_ts+800, msg))
}
