// Code generated for darwin/arm64 by 'gcc --libc github.com/next-bin/go-sqlite3/pkg/libc --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -extended-errors -ignore-unsupported-alignment --package-name=main -DNDEBUG -U__ARM_FEATURE_CRC32 -DHAVE_HIDDEN -o minigzip64.go minigzip64.o.go -L. libz.a', DO NOT EDIT.
...
//	 */
func _string_copy(tls *libc.TLS, dst uintptr, src uintptr, len1 Tz_size_t) (r uintptr) {
	var v1 Tz_size_t
	var v2 uintptr
	_, _ = v1, v2
	if len1 == uint64(0) {
	...
	for {
		...
		v2 = src
		src = src + 1
		*(*int8)(unsafe.Pointer(dst)) = *(*int8)(unsafe.Pointer(v2))
		if int32(*(*int8)(unsafe.Pointer(dst))) == 0 {
			return dst
		}
		dst = dst + 1
	}
	*(*int8)(unsafe.Pointer(dst)) = 0
	return dst
}
...
func _error(tls *libc.TLS, msg uintptr) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts, libc.VaList(bp+8, _prog, msg))
...
func _file_compress(tls *libc.TLS, file uintptr, mode uintptr) {
	...
	var end, in uintptr
	var out TgzFile
	var _ /* outfile at bp+0 */ [1025]int8
	_, _, _ = end, in, out
	if libc.Xstrlen(tls, file)+libc.Xstrlen(tls, __ccgo_ts+57) >= uint64(1025) {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+61, libc.VaList(bp+1040, _prog))
		libc.Xexit(tls, int32(1))
	}
	end = _string_copy(tls, bp, file, uint64(1025))
	_string_copy(tls, end, __ccgo_ts+57, uint64(1025)-libc.Uint64FromInt64(int64(end)-T__predefined_ptrdiff_t(bp)))
	in = libc.Xfopen(tls, file, __ccgo_ts+84)
	...
	if out == libc.UintptrFromInt32(0) {
		libc.Xfclose(tls, in)
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+87, libc.VaList(bp+1040, _prog, bp))
		libc.Xexit(tls, int32(1))
	}
...
func _file_uncompress(tls *libc.TLS, file uintptr) {
	...
	var len1 Tz_size_t
	var _ /* buf at bp+0 */ [1025]int8
	_, _, _, _, _ = in, infile, len1, out, outfile
	len1 = libc.Xstrlen(tls, file)
	if len1+libc.Xstrlen(tls, __ccgo_ts+57) >= uint64(1025) {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+61, libc.VaList(bp+1040, _prog))
		libc.Xexit(tls, int32(1))
	}
	_string_copy(tls, bp, file, uint64(1025))
	if len1 > libc.Uint64FromInt64(4)-libc.Uint64FromInt32(1) && libc.Xstrcmp(tls, file+uintptr(len1)-uintptr(libc.Uint64FromInt64(4)-libc.Uint64FromInt32(1)), __ccgo_ts+57) == 0 {
		...
		*(*int8)(unsafe.Pointer(outfile + uintptr(len1-uint64(3)))) = int8('\000')
		...
		outfile = file
		infile = bp
		_string_copy(tls, bp+uintptr(len1), __ccgo_ts+57, uint64(1025)-len1)
	}
	in = x_gzopen(tls, infile, __ccgo_ts+84)
	if in == libc.UintptrFromInt32(0) {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+87, libc.VaList(bp+1040, _prog, infile))
		libc.Xexit(tls, int32(1))
	}
	out = libc.Xfopen(tls, outfile, __ccgo_ts+108)
	if out == libc.UintptrFromInt32(0) {
		x_gzclose(tls, in)
		libc.Xperror(tls, file)
		libc.Xexit(tls, int32(1))
...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	var file TgzFile
	var _ /* outmode at bp+0 */ [5]int8
	_, _, _, _, _, _ = bname, copyout, file, in, uncompr, v1
	copyout = 0
	uncompr = 0
	_string_copy(tls, bp, __ccgo_ts+111, uint64(5))
	...
	argc = argc - 1
	argv += 8
	if !(libc.Xstrcmp(tls, bname, __ccgo_ts+116) != 0) {
		uncompr = int32(1)
	} else {
		if !(libc.Xstrcmp(tls, bname, __ccgo_ts+123) != 0) {
	...
	for argc > 0 {
		if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+128) == 0 {
			copyout = int32(1)
		} else {
			if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+131) == 0 {
				uncompr = int32(1)
			} else {
				if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+134) == 0 {
					(*(*[5]int8)(unsafe.Pointer(bp)))[int32(3)] = int8('f')
				} else {
					if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+137) == 0 {
						(*(*[5]int8)(unsafe.Pointer(bp)))[int32(3)] = int8('h')
					} else {
						if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+140) == 0 {
							(*(*[5]int8)(unsafe.Pointer(bp)))[int32(3)] = int8('R')
						} else {
							if int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv))))) == int32('-') && int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 1))) >= int32('1') && int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 1))) <= int32('9') && int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 2))) == 0 {
								(*(*[5]int8)(unsafe.Pointer(bp)))[int32(2)] = *(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 1))
							} else {
								break
							}
						}
	...
	if int32((*(*[5]int8)(unsafe.Pointer(bp)))[int32(3)]) == int32(' ') {
		(*(*[5]int8)(unsafe.Pointer(bp)))[int32(3)] = 0
	}
	if argc == 0 {
		if uncompr != 0 {
			file = x_gzdopen(tls, libc.Xfileno(tls, libc.X__stdinp), __ccgo_ts+84)
			if file == libc.UintptrFromInt32(0) {
				_error(tls, __ccgo_ts+143)
			}
			_gz_uncompress(tls, file, libc.X__stdoutp)
		} else {
			file = x_gzdopen(tls, libc.Xfileno(tls, libc.X__stdoutp), bp)
			if file == libc.UintptrFromInt32(0) {
				_error(tls, __ccgo_ts+163)
			}
			_gz_compress(tls, libc.X__stdinp, file)
		}
	} else {
		if copyout != 0 {
		}
		for {
			if uncompr != 0 {
				if copyout != 0 {
					file = x_gzopen(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+84)
					if file == libc.UintptrFromInt32(0) {
						libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+87, libc.VaList(bp+16, _prog, *(*uintptr)(unsafe.Pointer(argv))))
					} else {
						_gz_uncompress(tls, file, libc.X__stdoutp)
					}
				} else {
				...
				if copyout != 0 {
					in = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+84)
					if in == libc.UintptrFromInt32(0) {
			...
			dodist:
					...
					if dist > op {                                     /* see if copy from window */
						...
						if op > whave {
							if (*Tinflate_state)(unsafe.Pointer(state)).Fsane != 0 {
								(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 462
				...
				if op&uint32(64) == uint32(0) { /* 2nd level length code */
					...
					if op&uint32(32) != 0 { /* end-of-block */
						...
						(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 412
						(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
						break
					}
				}
...
func x_inflateInit2_(tls *libc.TLS, strm Tz_streamp, windowBits int32, version uintptr, stream_size int32) (r int32) {
	...
	var state uintptr
	_, _ = ret, state
	if version == uintptr(m_Z_NULL) || int32(*(*int8)(unsafe.Pointer(version))) != int32(*(*int8)(unsafe.Pointer(__ccgo_ts + 184))) || stream_size != libc.Int32FromUint64(libc.Uint64FromInt64(112)) {
		return -int32(6)
	}
	if strm == uintptr(m_Z_NULL) {
		return -int32(2)
...
func x_inflate(tls *libc.TLS, strm Tz_streamp, flush int32) (r int32) {
	...
	_2:
		...
		if len1 > uint32(15) || len1 > (*Tinflate_state)(unsafe.Pointer(state)).Fwbits {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 542
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
	...
	_39:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0xe000) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 562
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		if (*Tinflate_state)(unsafe.Pointer(state)).Fhead != uintptr(m_Z_NULL) {
	...
	_10:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0x0200) != 0 {
			...
			if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && hold != (*Tinflate_state)(unsafe.Pointer(state)).Fcheck&uint64(0xffff) {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 587
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint64(0)
	...
	_14:
		...
		default:
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 190
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
		}
		hold = hold >> libc.Uint64FromInt32(libc.Int32FromInt32(2))
		bits = bits - libc.Uint32FromInt32(libc.Int32FromInt32(2))
	...
	_15:
		...
		if hold&uint64(0xffff) != hold>>int32(16)^uint64(0xffff) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 209
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
	...
	_18:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fnlen > uint32(286) || (*Tinflate_state)(unsafe.Pointer(state)).Fndist > uint32(30) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 238
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
	...
	_19:
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 274
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		(*Tinflate_state)(unsafe.Pointer(state)).Fhave = uint32(0)
	...
	_20:
				...
				*(*uint16)(unsafe.Pointer(state + 152 + uintptr(v46)*2)) = here.Fval
				...
				if libc.Int32FromUint16(here.Fval) == int32(16) {
					...
					if (*Tinflate_state)(unsafe.Pointer(state)).Fhave == uint32(0) {
						(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 299
						(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
						break
					}
		...
		if libc.Int32FromUint16(*(*uint16)(unsafe.Pointer(state + 152 + 256*2))) == 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 325
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 362
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 {
			...
			*(*uint64)(unsafe.Pointer(state + 40)) += uint64(out)
			...
			if v47 && v37 != (*Tinflate_state)(unsafe.Pointer(state)).Fcheck {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 607
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint64(0)
	...
	_29:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 && (*Tinflate_state)(unsafe.Pointer(state)).Fflags != 0 {
			...
			if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && hold != (*Tinflate_state)(unsafe.Pointer(state)).Ftotal&uint64(0xffffffff) {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 628
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint64(0)
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin___snprintf_chk(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint64(1), 0, ^T__predefined_size_t(0), __ccgo_ts+768, libc.VaList(bp+8, path))
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin___snprintf_chk(tls, path, libc.Uint64FromInt32(7)+libc.Uint64FromInt32(3)*libc.Uint64FromInt64(4), 0, ^T__predefined_size_t(0), __ccgo_ts+771, libc.VaList(bp+8, fd))
...
func x_gz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	libc.X__builtin___snprintf_chk(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint64(3), 0, ^T__predefined_size_t(0), __ccgo_ts+793, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, __ccgo_ts+800, msg))
}
...
func _gz_look(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fsize == uint32(0) {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fin == libc.UintptrFromInt32(0) || (*Tgz_state)(unsafe.Pointer(state)).Fout == libc.UintptrFromInt32(0) {
			...
			x_gz_error(tls, state, -int32(4), __ccgo_ts+779)
			return -int32(1)
		}
		...
		if x_inflateInit2_(tls, state+136, libc.Int32FromInt32(15)+libc.Int32FromInt32(16), __ccgo_ts+184, libc.Int32FromInt64(112)) != m_Z_OK { /* gunzip */
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
	...
	for cond := true; cond; cond = (*Tz_stream)(unsafe.Pointer(strm)).Favail_out != 0 && ret != int32(m_Z_STREAM_END) {
		...
		if (*Tz_stream)(unsafe.Pointer(strm)).Favail_in == uint32(0) {
			if !((*Tgz_state)(unsafe.Pointer(state)).Fagain != 0) {
				x_gz_error(tls, state, -int32(5), __ccgo_ts+803)
			}
			break
		}
		...
		if ret == -int32(2) || ret == int32(m_Z_NEED_DICT) {
			x_gz_error(tls, state, -int32(2), __ccgo_ts+826)
			break
		}
		if ret == -int32(4) {
			x_gz_error(tls, state, -int32(4), __ccgo_ts+779)
...
func _gz_fetch(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	for cond := true; cond; cond = (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave == uint32(0) && (!((*Tgz_state)(unsafe.Pointer(state)).Feof != 0) || (*Tz_stream)(unsafe.Pointer(strm)).Favail_in != 0) {
		...
		default:
			x_gz_error(tls, state, -int32(2), __ccgo_ts+887)
			return -int32(1)
		}
	}
	return 0
...
func x_gzread(tls *libc.TLS, file TgzFile, buf Tvoidp, len1 uint32) (r int32) {
	...
	if libc.Int32FromUint32(len1) < 0 {
		x_gz_error(tls, state, -int32(2), __ccgo_ts+901)
		return -int32(1)
	}
...
func _gz_init(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if !((*Tgz_state)(unsafe.Pointer(state)).Fdirect != 0) {
		...
		ret = x_deflateInit2_(tls, strm, (*Tgz_state)(unsafe.Pointer(state)).Flevel, int32(m_Z_DEFLATED), libc.Int32FromInt32(m_MAX_WBITS)+libc.Int32FromInt32(16), int32(m_DEF_MEM_LEVEL), (*Tgz_state)(unsafe.Pointer(state)).Fstrategy, __ccgo_ts+184, libc.Int32FromInt64(112))
		if ret != m_Z_OK {
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
			x_gz_error(tls, state, -int32(4), __ccgo_ts+779)
...
func _gz_comp(tls *libc.TLS, state Tgz_statep, flush int32) (r int32) {
	...
	for cond := true; cond; cond = have != 0 {
		...
		if ret == -int32(2) {
			x_gz_error(tls, state, -int32(2), __ccgo_ts+996)
			return -int32(1)
		}
...
func x_gzwrite(tls *libc.TLS, file TgzFile, buf Tvoidpc, len1 uint32) (r int32) {
	...
	/* since an int is returned, make sure len fits in one, otherwise return
	   with an error (this avoids a flaw in the interface) */
	if libc.Int32FromUint32(len1) < 0 {
		x_gz_error(tls, state, -int32(3), __ccgo_ts+1035)
		return 0
	}
