...
func _file_compress(tls *libc.TLS, file uintptr, mode uintptr) {
	...
	end = _string_copy(tls, bp+56, file, uint32(1025))
	_string_copy(tls, end, __ccgo_ts+57, uint32(1025)-uint32(int32(end)-T__predefined_ptrdiff_t(bp+56)))
...
func _file_uncompress(tls *libc.TLS, file uintptr) {
	...
	_string_copy(tls, bp+56, file, uint32(1025))
	if len1 > libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1) && libc.Xstrcmp(tls, file+uintptr(len1)-uintptr(libc.Uint32FromInt64(4)-libc.Uint32FromInt32(1)), __ccgo_ts+57) == 0 {
		...
		*(*int8)(unsafe.Pointer(outfile + uintptr(len1-uint32(3)))) = int8('\000')
		...
		outfile = file
		infile = bp + 56
		_string_copy(tls, bp+56+uintptr(len1), __ccgo_ts+57, uint32(1025)-len1)
	}
...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	copyout = 0
	uncompr = 0
	_string_copy(tls, bp+35, __ccgo_ts+111, uint32(5))
