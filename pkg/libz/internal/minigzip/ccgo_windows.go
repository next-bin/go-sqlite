...
func _gz_compress(tls *libc.TLS, in uintptr, out TgzFile) {
	...
	for {
		...
		if x_gzwrite(tls, out, bp, uint32(len1)) != len1 {
...
func _file_compress(tls *libc.TLS, file uintptr, mode uintptr) {
	...
	var __local_argv T__builtin_va_list
	var __retval int32
	var end, in, v1 uintptr
	var out TgzFile
	var _ /* outfile at bp+56 */ [1025]int8
	_, _, _, _, _, _ = __local_argv, __retval, end, in, out, v1
	if libc.Xstrlen(tls, file)+libc.Xstrlen(tls, __ccgo_ts+57) >= uint64(1025) {
		v1 = __ccgo_ts + 61
		libc.VaList(bp, _prog)
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v1, __local_argv)
		_ = __local_argv
		_ = __retval
	...
	end = _string_copy(tls, bp+56, file, uint64(1025))
	_string_copy(tls, end, __ccgo_ts+57, uint64(1025)-uint64(int64(end)-T__predefined_ptrdiff_t(bp+56)))
	in = libc.Xfopen(tls, file, __ccgo_ts+84)
	if in == libc.UintptrFromInt32(0) {
		libc.Xperror(tls, file)
		libc.Xexit(tls, int32(1))
	}
	out = x_gzopen(tls, bp+56, mode)
	if out == libc.UintptrFromInt32(0) {
		libc.Xfclose(tls, in)
		v1 = __ccgo_ts + 87
		libc.VaList(bp, _prog, bp+56)
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v1, __local_argv)
		_ = __local_argv
		_ = __retval
...
func _file_uncompress(tls *libc.TLS, file uintptr) {
	...
	var __retval int32
	var in TgzFile
	var infile, out, outfile, v1 uintptr
	var len1 Tz_size_t
	var _ /* buf at bp+56 */ [1025]int8
	_, _, _, _, _, _, _, _ = __local_argv, __retval, in, infile, len1, out, outfile, v1
	...
	_string_copy(tls, bp+56, file, uint64(1025))
	if len1 > libc.Uint64FromInt64(4)-libc.Uint64FromInt32(1) && libc.Xstrcmp(tls, file+uintptr(len1)-uintptr(libc.Uint64FromInt64(4)-libc.Uint64FromInt32(1)), __ccgo_ts+57) == 0 {
		...
		*(*int8)(unsafe.Pointer(outfile + uintptr(len1-uint64(3)))) = int8('\000')
		...
		outfile = file
		infile = bp + 56
		_string_copy(tls, bp+56+uintptr(len1), __ccgo_ts+57, uint64(1025)-len1)
	}
	in = x_gzopen(tls, infile, __ccgo_ts+84)
	if in == libc.UintptrFromInt32(0) {
		v1 = __ccgo_ts + 87
		libc.VaList(bp, _prog, infile)
		__local_argv = bp
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v1, __local_argv)
		_ = __local_argv
		_ = __retval
...
func x_main(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	defer tls.Free(48)
	var __local_argv T__builtin_va_list
	var __retval, copyout, uncompr, v1 int32
	var bname, in, v4 uintptr
	var file TgzFile
	var _ /* outmode at bp+35 */ [5]int8
	_, _, _, _, _, _, _, _, _ = __local_argv, __retval, bname, copyout, file, in, uncompr, v1, v4
	copyout = 0
	uncompr = 0
	_string_copy(tls, bp+35, __ccgo_ts+111, uint64(5))
		...
		if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+128) == 0 {
			...
			if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+131) == 0 {
				...
				if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+134) == 0 {
					(*(*[5]int8)(unsafe.Pointer(bp + 35)))[int32(3)] = int8('f')
				} else {
					if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+137) == 0 {
						(*(*[5]int8)(unsafe.Pointer(bp + 35)))[int32(3)] = int8('h')
					} else {
						if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv)), __ccgo_ts+140) == 0 {
							(*(*[5]int8)(unsafe.Pointer(bp + 35)))[int32(3)] = int8('R')
						} else {
							if int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv))))) == int32('-') && int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 1))) >= int32('1') && int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 1))) <= int32('9') && int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 2))) == 0 {
								(*(*[5]int8)(unsafe.Pointer(bp + 35)))[int32(2)] = *(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv)) + 1))
							} else {
								break
							}
						}
	...
	if int32((*(*[5]int8)(unsafe.Pointer(bp + 35)))[int32(3)]) == int32(' ') {
		(*(*[5]int8)(unsafe.Pointer(bp + 35)))[int32(3)] = 0
	}
	if argc == 0 {
		...
		if uncompr != 0 {
			file = x_gzdopen(tls, libc.Xfileno(tls, libc.X__acrt_iob_func(tls, uint32(0))), __ccgo_ts+84)
			if file == libc.UintptrFromInt32(0) {
				_error(tls, __ccgo_ts+143)
			}
			_gz_uncompress(tls, file, libc.X__acrt_iob_func(tls, uint32(1)))
		} else {
			file = x_gzdopen(tls, libc.Xfileno(tls, libc.X__acrt_iob_func(tls, uint32(1))), bp+35)
			if file == libc.UintptrFromInt32(0) {
		...
		for {
			if uncompr != 0 {
				if copyout != 0 {
					...
					if file == libc.UintptrFromInt32(0) {
						v4 = __ccgo_ts + 87
						libc.VaList(bp, _prog, *(*uintptr)(unsafe.Pointer(argv)))
						__local_argv = bp
				...
				if copyout != 0 {
					...
					_file_compress(tls, *(*uintptr)(unsafe.Pointer(argv)), bp+35)
				}
			}
			goto _3
		_3:
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	if fd == -int32(2) {
		...
		libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint64(1), __ccgo_ts+190, libc.VaList(bp+8, path))
	}
	...
	oflag = oflag | (int32(m__O_BINARY2) | v1)
...
func x_gzdopen(tls *libc.TLS, fd int32, mode uintptr) (r TgzFile) {
	...
	libc.X__builtin_snprintf(tls, path, libc.Uint64FromInt32(7)+libc.Uint64FromInt32(3)*libc.Uint64FromInt64(4), __ccgo_ts+193, libc.VaList(bp+8, fd))
...
func x_gz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint64(3), __ccgo_ts+216, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, __ccgo_ts+223, msg))
}
...
func _gz_look(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fsize == uint32(0) {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fin == libc.UintptrFromInt32(0) || (*Tgz_state)(unsafe.Pointer(state)).Fout == libc.UintptrFromInt32(0) {
			...
			x_gz_error(tls, state, -int32(4), __ccgo_ts+201)
			return -int32(1)
		}
		...
		if x_inflateInit2_(tls, state+136, libc.Int32FromInt32(15)+libc.Int32FromInt32(16), __ccgo_ts+184, libc.Int32FromInt64(88)) != m_Z_OK { /* gunzip */
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
	...
	for cond := true; cond; cond = (*Tz_stream)(unsafe.Pointer(strm)).Favail_out != 0 && ret != int32(m_Z_STREAM_END) {
		...
		if (*Tz_stream)(unsafe.Pointer(strm)).Favail_in == uint32(0) {
			if !((*Tgz_state)(unsafe.Pointer(state)).Fagain != 0) {
				x_gz_error(tls, state, -int32(5), __ccgo_ts+226)
			}
			break
		}
		...
		if ret == -int32(2) || ret == int32(m_Z_NEED_DICT) {
			x_gz_error(tls, state, -int32(2), __ccgo_ts+249)
			break
		}
		if ret == -int32(4) {
			x_gz_error(tls, state, -int32(4), __ccgo_ts+201)
...
func _gz_fetch(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	for cond := true; cond; cond = (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave == uint32(0) && (!((*Tgz_state)(unsafe.Pointer(state)).Feof != 0) || (*Tz_stream)(unsafe.Pointer(strm)).Favail_in != 0) {
		...
		default:
			x_gz_error(tls, state, -int32(2), __ccgo_ts+310)
			return -int32(1)
		}
	}
	return 0
...
func x_gzread(tls *libc.TLS, file TgzFile, buf Tvoidp, len1 uint32) (r int32) {
	...
	if int32(len1) < 0 {
		x_gz_error(tls, state, -int32(2), __ccgo_ts+324)
		return -int32(1)
	}
...
func _gz_init(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if !((*Tgz_state)(unsafe.Pointer(state)).Fdirect != 0) {
		...
		ret = x_deflateInit2_(tls, strm, (*Tgz_state)(unsafe.Pointer(state)).Flevel, int32(m_Z_DEFLATED), libc.Int32FromInt32(m_MAX_WBITS)+libc.Int32FromInt32(16), int32(m_DEF_MEM_LEVEL), (*Tgz_state)(unsafe.Pointer(state)).Fstrategy, __ccgo_ts+184, libc.Int32FromInt64(88))
		if ret != m_Z_OK {
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
			x_gz_error(tls, state, -int32(4), __ccgo_ts+201)
...
func _gz_comp(tls *libc.TLS, state Tgz_statep, flush int32) (r int32) {
	...
	for cond := true; cond; cond = have != 0 {
		...
		if ret == -int32(2) {
			x_gz_error(tls, state, -int32(2), __ccgo_ts+419)
			return -int32(1)
		}
...
func x_gzwrite(tls *libc.TLS, file TgzFile, buf Tvoidpc, len1 uint32) (r int32) {
	...
	/* since an int is returned, make sure len fits in one, otherwise return
	   with an error (this avoids a flaw in the interface) */
	if int32(len1) < 0 {
		x_gz_error(tls, state, -int32(3), __ccgo_ts+458)
		return 0
	}
			...
			dodist:
				...
				if op&uint32(16) != 0 { /* distance base */
					...
					if dist > op {                       /* see if copy from window */
						...
						if op > whave {
							if (*Tinflate_state)(unsafe.Pointer(state)).Fsane != 0 {
								(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 827
					...
					if op&uint32(64) == uint32(0) { /* 2nd level distance code */
						...
						(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 805
						(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
						break
					}
				}
				...
				if op&uint32(64) == uint32(0) { /* 2nd level length code */
					...
					if op&uint32(32) != 0 { /* end-of-block */
						...
						(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 777
						(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
						break
					}
				}
...
func x_inflateInit2_(tls *libc.TLS, strm Tz_streamp, windowBits int32, version uintptr, stream_size int32) (r int32) {
	...
	var state uintptr
	_, _ = ret, state
	if version == uintptr(m_Z_NULL) || int32(*(*int8)(unsafe.Pointer(version))) != int32(*(*int8)(unsafe.Pointer(__ccgo_ts + 184))) || stream_size != int32(libc.Uint64FromInt64(88)) {
		return -int32(6)
	}
	if strm == uintptr(m_Z_NULL) {
		return -int32(2)
...
func x_inflate(tls *libc.TLS, strm Tz_streamp, flush int32) (r int32) {
	...
	_2:
		...
		if !((*Tinflate_state)(unsafe.Pointer(state)).Fwrap&libc.Int32FromInt32(1) != 0) || (uint32(hold&(libc.Uint32FromUint32(1)<<libc.Int32FromInt32(8)-libc.Uint32FromInt32(1))<<libc.Int32FromInt32(8))+hold>>int32(8))%uint32(31) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 857
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		if hold&(libc.Uint32FromUint32(1)<<libc.Int32FromInt32(4)-libc.Uint32FromInt32(1)) != uint32(m_Z_DEFLATED) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 880
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		...
		if len1 > uint32(15) || len1 > (*Tinflate_state)(unsafe.Pointer(state)).Fwbits {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 907
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
	...
	_39:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0xe000) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 927
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		if (*Tinflate_state)(unsafe.Pointer(state)).Fhead != uintptr(m_Z_NULL) {
	...
	_10:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0x0200) != 0 {
			...
			if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && hold != (*Tinflate_state)(unsafe.Pointer(state)).Fcheck&uint32(0xffff) {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 952
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint32(0)
	...
	_14:
		...
		default:
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 555
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
		}
		hold = hold >> uint32(libc.Int32FromInt32(2))
		bits = bits - uint32(libc.Int32FromInt32(2))
	...
	_15:
		...
		if hold&uint32(0xffff) != hold>>int32(16)^uint32(0xffff) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 574
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
	...
	_19:
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 639
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		(*Tinflate_state)(unsafe.Pointer(state)).Fhave = uint32(0)
	...
	_20:
				...
				*(*uint16)(unsafe.Pointer(state + 144 + uintptr(v37)*2)) = here.Fval
				...
				if int32(here.Fval) == int32(16) {
					...
					if (*Tinflate_state)(unsafe.Pointer(state)).Fhave == uint32(0) {
						(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 664
						(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
						break
					}
		...
		if int32(*(*uint16)(unsafe.Pointer(state + 144 + 256*2))) == 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 690
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 727
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		...
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 755
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 {
			...
			*(*uint32)(unsafe.Pointer(state + 36)) += out
			...
			if v47 && v37 != (*Tinflate_state)(unsafe.Pointer(state)).Fcheck {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 972
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint32(0)
	...
	_29:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 && (*Tinflate_state)(unsafe.Pointer(state)).Fflags != 0 {
			...
			if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && hold != (*Tinflate_state)(unsafe.Pointer(state)).Ftotal&uint32(0xffffffff) {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 993
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint32(0)
