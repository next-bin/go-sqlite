// Code generated for openbsd/arm64 by 'cc --libc github.com/next-bin/go-sqlite3/pkg/libc --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -extended-errors -ignore-unsupported-alignment --package-name=main -DNDEBUG -DHAVE_HIDDEN -o example64.go example64.o.go -L. libz.a', DO NOT EDIT.
