...
func _test_gzio(tls *libc.TLS, fname uintptr, uncompr uintptr, uncomprLen TuLong) {
	...
	if pos != int64(6) || x_gztell(tls, file) != pos {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts+193, libc.VaList(bp+16, int32(pos), int32(x_gztell(tls, file))))
		libc.Xexit(tls, int32(1))
	}
...
func _test_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong) {
	...
	err = x_deflateInit_(tls, bp, -int32(1), __ccgo_ts+339, libc.Int32FromInt64(88))
	if err != m_Z_OK {
...
func _test_inflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	err = x_inflateInit_(tls, bp, __ccgo_ts+339, libc.Int32FromInt64(88))
	if err != m_Z_OK {
...
func _test_large_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong, uncompr uintptr, uncomprLen TuLong) {
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fopaque = libc.UintptrFromInt32(0)
	err = x_deflateInit_(tls, bp, int32(m_Z_BEST_SPEED), __ccgo_ts+339, libc.Int32FromInt64(88))
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts, libc.VaList(bp+96, __ccgo_ts+345, err))
		libc.Xexit(tls, int32(1))
	}
...
func _test_dict_deflate(tls *libc.TLS, compr uintptr, comprLen TuLong) {
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fzfree = _zfree
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fopaque = libc.UintptrFromInt32(0)
	err = x_deflateInit_(tls, bp, int32(m_Z_BEST_COMPRESSION), __ccgo_ts+339, libc.Int32FromInt64(88))
	if err != m_Z_OK {
		libc.Xfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), __ccgo_ts, libc.VaList(bp+96, __ccgo_ts+345, err))
		libc.Xexit(tls, int32(1))
	}
...
func x_compress2_z(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen Tz_size_t, level int32) (r int32) {
	...
	*(*Tz_size_t)(unsafe.Pointer(destLen)) = uint64(0)
	...
	(*(*Tz_stream)(unsafe.Pointer(bp))).Fopaque = libc.UintptrFromInt32(0)
	err = x_deflateInit_(tls, bp, level, __ccgo_ts+339, libc.Int32FromInt64(88))
	if err != m_Z_OK {
		return err
	}
	...
	*(*Tz_size_t)(unsafe.Pointer(destLen)) = uint64(int64((*(*Tz_stream)(unsafe.Pointer(bp))).Fnext_out) - int64(dest))
	x_deflateEnd(tls, bp)
	if err == int32(m_Z_STREAM_END) {
		v3 = m_Z_OK
	} else {
...
func x_compress2(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen TuLong, level int32) (r int32) {
	...
	_ = ret
	*(*Tz_size_t)(unsafe.Pointer(bp)) = uint64(*(*TuLongf)(unsafe.Pointer(destLen)))
	ret = x_compress2_z(tls, dest, bp, source, uint64(sourceLen), level)
	*(*TuLongf)(unsafe.Pointer(destLen)) = uint32(*(*Tz_size_t)(unsafe.Pointer(bp)))
	return ret
}
		...
		if *(*uint8)(unsafe.Pointer(bp)) != 0 {
			...
			*/
			...
			/*
			   ...
			   same time.
			*/
			crc = _crc_word(tls, uint64(crc0)^*(*Tz_word_t)(unsafe.Pointer(words)))
			crc = _crc_word(tls, uint64(crc1)^*(*Tz_word_t)(unsafe.Pointer(words + 1*8))^uint64(crc))
			crc = _crc_word(tls, uint64(crc2)^*(*Tz_word_t)(unsafe.Pointer(words + 2*8))^uint64(crc))
			crc = _crc_word(tls, uint64(crc3)^*(*Tz_word_t)(unsafe.Pointer(words + 3*8))^uint64(crc))
			crc = _crc_word(tls, uint64(crc4)^*(*Tz_word_t)(unsafe.Pointer(words + 4*8))^uint64(crc))
			words = words + uintptr(m_N)*8
		} else {
			/* Initialize the CRC for each braid. */
			crc01 = _byte_swap(tls, uint64(crc))
			crc11 = uint64(0)
			crc21 = uint64(0)
			crc31 = uint64(0)
			crc41 = uint64(0)
...
func _read_buf(tls *libc.TLS, strm Tz_streamp, buf uintptr, size uint32) (r uint32) {
	...
	*(*TuLong)(unsafe.Pointer(strm + 12)) += len1
	return len1
}
...
func _fill_window(tls *libc.TLS, s uintptr) {
	...
	for cond := true; cond; cond = (*Tdeflate_state)(unsafe.Pointer(s)).Flookahead < uint32(libc.Int32FromInt32(m_MAX_MATCH)+libc.Int32FromInt32(m_MIN_MATCH)+libc.Int32FromInt32(1)) && (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_in != uint32(0) {
		...
		if (*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart >= wsize+((*Tdeflate_state)(unsafe.Pointer(s)).Fw_size-uint32(libc.Int32FromInt32(m_MAX_MATCH)+libc.Int32FromInt32(m_MIN_MATCH)+libc.Int32FromInt32(1))) {
			...
			*(*int32)(unsafe.Pointer(s + 132)) -= int32(wsize)
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fhigh_water < (*Tdeflate_state)(unsafe.Pointer(s)).Fwindow_size {
		...
		if (*Tdeflate_state)(unsafe.Pointer(s)).Fhigh_water < curr {
			...
			libc.Xmemset(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fwindow+uintptr(curr), 0, uint64(init1))
			...
			if (*Tdeflate_state)(unsafe.Pointer(s)).Fhigh_water < curr+uint32(m_MAX_MATCH) {
				...
				libc.Xmemset(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fwindow+uintptr((*Tdeflate_state)(unsafe.Pointer(s)).Fhigh_water), 0, uint64(init1))
				*(*Tulg)(unsafe.Pointer(s + 5912)) += init1
			}
		}
	}
}
...
func x_deflateInit2_(tls *libc.TLS, strm Tz_streamp, level int32, method int32, windowBits int32, memLevel int32, strategy int32, version uintptr, stream_size int32) (r int32) {
	...
	_, _ = s, wrap
	wrap = int32(1)
	if version == uintptr(m_Z_NULL) || int32(*(*int8)(unsafe.Pointer(version))) != int32(_my_version[0]) || uint64(stream_size) != uint64(88) {
		return -int32(6)
	}
	...
	s = (*(*func(*libc.TLS, Tvoidpf, TuInt, TuInt) Tvoidpf)(unsafe.Pointer(&struct{ uintptr }{(*Tz_stream)(unsafe.Pointer(strm)).Fzalloc})))(tls, (*Tz_stream)(unsafe.Pointer(strm)).Fopaque, uint32(libc.Int32FromInt32(1)), uint32(libc.Uint64FromInt64(5920)))
	if s == uintptr(m_Z_NULL) {
		return -int32(4)
	}
	libc.Xmemset(tls, s, 0, uint64(5920))
...
func x_deflateParams(tls *libc.TLS, strm Tz_streamp, level int32, strategy int32) (r int32) {
	...
	if (strategy != (*Tdeflate_state)(unsafe.Pointer(s)).Fstrategy || func1 != _configuration_table[level].Ffunc1) && (*Tdeflate_state)(unsafe.Pointer(s)).Flast_flush != -int32(2) {
		...
		if (*Tz_stream)(unsafe.Pointer(strm)).Favail_in != 0 || (*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart-uint32((*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start)+(*Tdeflate_state)(unsafe.Pointer(s)).Flookahead != 0 {
			return -int32(5)
		}
	}
...
func _flush_pending(tls *libc.TLS, strm Tz_streamp) {
	...
	*(*TuLong)(unsafe.Pointer(strm + 28)) += len1
	*(*TuInt)(unsafe.Pointer(strm + 24)) -= len1
	*(*Tulg)(unsafe.Pointer(s + 40)) -= len1
...
func x_deflate(tls *libc.TLS, strm Tz_streamp, flush int32) (r int32) {
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fstatus == int32(m_GZIP_STATE) {
		...
		*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v4))) = uint8(libc.Int32FromInt32(31))
		...
		v4 = *(*Tulg)(unsafe.Pointer(v5))
		*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
		*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v4))) = uint8(libc.Int32FromInt32(139))
		v5 = s + 40
		v4 = *(*Tulg)(unsafe.Pointer(v5))
		*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
		*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v4))) = uint8(libc.Int32FromInt32(8))
		if (*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead == uintptr(m_Z_NULL) {
			v5 = s + 40
			v4 = *(*Tulg)(unsafe.Pointer(v5))
			*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
			*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v4))) = uint8(libc.Int32FromInt32(0))
			v5 = s + 40
			v4 = *(*Tulg)(unsafe.Pointer(v5))
			*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
			*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v4))) = uint8(libc.Int32FromInt32(0))
			...
			*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v4))) = uint8(v1)
			v5 = s + 40
			v4 = *(*Tulg)(unsafe.Pointer(v5))
			*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
			*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v4))) = uint8(libc.Int32FromInt32(m_OS_CODE))
			(*Tdeflate_state)(unsafe.Pointer(s)).Fstatus = int32(m_BUSY_STATE)
			/* Compression must start with an empty pending buffer */
			_flush_pending(tls, strm)
			if (*Tdeflate_state)(unsafe.Pointer(s)).Fpending != uint32(0) {
			...
			*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v4))) = uint8(v1 + v2 + v22 + v23 + v28)
			v5 = s + 40
			v4 = *(*Tulg)(unsafe.Pointer(v5))
			*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
			...
			*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v4))) = uint8(v1)
			...
			v4 = *(*Tulg)(unsafe.Pointer(v5))
			*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
			*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v4))) = uint8((*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fos & libc.Int32FromInt32(0xff))
			if (*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fextra != uintptr(m_Z_NULL) {
				v5 = s + 40
				v4 = *(*Tulg)(unsafe.Pointer(v5))
				*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
			...
			if (*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fhcrc != 0 {
				(*Tz_stream)(unsafe.Pointer(strm)).Fadler = x_crc32_z(tls, (*Tz_stream)(unsafe.Pointer(strm)).Fadler, (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf, uint64((*Tdeflate_state)(unsafe.Pointer(s)).Fpending))
			}
		...
		if (*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fextra != uintptr(m_Z_NULL) {
			...
			for (*Tdeflate_state)(unsafe.Pointer(s)).Fpending+left > (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf_size {
				...
				if (*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fhcrc != 0 && (*Tdeflate_state)(unsafe.Pointer(s)).Fpending > beg {
					(*Tz_stream)(unsafe.Pointer(strm)).Fadler = x_crc32_z(tls, (*Tz_stream)(unsafe.Pointer(strm)).Fadler, (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf+uintptr(beg), uint64((*Tdeflate_state)(unsafe.Pointer(s)).Fpending-beg))
				}
				*(*Tulg)(unsafe.Pointer(s + 56)) += copy1
				_flush_pending(tls, strm)
				if (*Tdeflate_state)(unsafe.Pointer(s)).Fpending != uint32(0) {
					(*Tdeflate_state)(unsafe.Pointer(s)).Flast_flush = -int32(1)
					return m_Z_OK
			...
			for cond := true; cond; cond = val != 0 {
				if (*Tdeflate_state)(unsafe.Pointer(s)).Fpending == (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf_size {
					if (*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fhcrc != 0 && (*Tdeflate_state)(unsafe.Pointer(s)).Fpending > beg1 {
						(*Tz_stream)(unsafe.Pointer(strm)).Fadler = x_crc32_z(tls, (*Tz_stream)(unsafe.Pointer(strm)).Fadler, (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf+uintptr(beg1), uint64((*Tdeflate_state)(unsafe.Pointer(s)).Fpending-beg1))
					}
					_flush_pending(tls, strm)
					if (*Tdeflate_state)(unsafe.Pointer(s)).Fpending != uint32(0) {
						(*Tdeflate_state)(unsafe.Pointer(s)).Flast_flush = -int32(1)
				...
				v4 = *(*Tulg)(unsafe.Pointer(v5))
				*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
				val = int32(*(*TBytef)(unsafe.Pointer((*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fname + uintptr(v4))))
				v5 = s + 40
				v4 = *(*Tulg)(unsafe.Pointer(v5))
				*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
			...
			for cond := true; cond; cond = val1 != 0 {
				if (*Tdeflate_state)(unsafe.Pointer(s)).Fpending == (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf_size {
					if (*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fhcrc != 0 && (*Tdeflate_state)(unsafe.Pointer(s)).Fpending > beg2 {
						(*Tz_stream)(unsafe.Pointer(strm)).Fadler = x_crc32_z(tls, (*Tz_stream)(unsafe.Pointer(strm)).Fadler, (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf+uintptr(beg2), uint64((*Tdeflate_state)(unsafe.Pointer(s)).Fpending-beg2))
					}
					_flush_pending(tls, strm)
					if (*Tdeflate_state)(unsafe.Pointer(s)).Fpending != uint32(0) {
						(*Tdeflate_state)(unsafe.Pointer(s)).Flast_flush = -int32(1)
				...
				v4 = *(*Tulg)(unsafe.Pointer(v5))
				*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
				val1 = int32(*(*TBytef)(unsafe.Pointer((*Tgz_header)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fgzhead)).Fcomment + uintptr(v4))))
				v5 = s + 40
				v4 = *(*Tulg)(unsafe.Pointer(v5))
				*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
...
func _longest_match(tls *libc.TLS, s uintptr, cur_match TIPos) (r TuInt) {
	...
	for {
		 ...
		 */
		if v4 = int32(*(*TBytef)(unsafe.Pointer(match + uintptr(best_len)))) != int32(scan_end) || int32(*(*TBytef)(unsafe.Pointer(match + uintptr(best_len-int32(1))))) != int32(scan_end1) || int32(*(*TBytef)(unsafe.Pointer(match))) != int32(*(*TBytef)(unsafe.Pointer(scan))); !v4 {
			match = match + 1
			v6 = match
		}
		if v4 || int32(*(*TBytef)(unsafe.Pointer(v6))) != int32(*(*TBytef)(unsafe.Pointer(scan + 1))) {
			goto _5
		}
		...
		_31:
			...
			match = match + 1
			v8 = match
			if v4 = int32(*(*TBytef)(unsafe.Pointer(v6))) == int32(*(*TBytef)(unsafe.Pointer(v8))); v4 {
				scan = scan + 1
				v9 = scan
				match = match + 1
				v10 = match
			}
			if v7 = v4 && int32(*(*TBytef)(unsafe.Pointer(v9))) == int32(*(*TBytef)(unsafe.Pointer(v10))); v7 {
				scan = scan + 1
				v11 = scan
				match = match + 1
				v13 = match
			}
			if v12 = v7 && int32(*(*TBytef)(unsafe.Pointer(v11))) == int32(*(*TBytef)(unsafe.Pointer(v13))); v12 {
				scan = scan + 1
				v14 = scan
				match = match + 1
				v16 = match
			}
			if v15 = v12 && int32(*(*TBytef)(unsafe.Pointer(v14))) == int32(*(*TBytef)(unsafe.Pointer(v16))); v15 {
				scan = scan + 1
				v17 = scan
				match = match + 1
				v19 = match
			}
			if v18 = v15 && int32(*(*TBytef)(unsafe.Pointer(v17))) == int32(*(*TBytef)(unsafe.Pointer(v19))); v18 {
				scan = scan + 1
				v20 = scan
				match = match + 1
				v22 = match
			}
			if v21 = v18 && int32(*(*TBytef)(unsafe.Pointer(v20))) == int32(*(*TBytef)(unsafe.Pointer(v22))); v21 {
				scan = scan + 1
				v23 = scan
				match = match + 1
				v25 = match
			}
			if v24 = v21 && int32(*(*TBytef)(unsafe.Pointer(v23))) == int32(*(*TBytef)(unsafe.Pointer(v25))); v24 {
				scan = scan + 1
				v26 = scan
				match = match + 1
				v28 = match
			}
			if !(v24 && int32(*(*TBytef)(unsafe.Pointer(v26))) == int32(*(*TBytef)(unsafe.Pointer(v28))) && scan < strend) {
				break
			}
		}
...
func _deflate_stored(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
	...
	for cond := true; cond; cond = last == 0 {
		...
		*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr((*Tdeflate_state)(unsafe.Pointer(s)).Fpending-uint32(1)))) = uint8(^len1 >> libc.Int32FromInt32(8))
		...
		if left != 0 {
			...
			*(*TuLong)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm + 28)) += left
			v3 = s + 132
		...
		if len1 != 0 {
			...
			*(*TuLong)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm + 28)) += len1
		}
	}
	...
	if used != 0 {
		...
		if used >= (*Tdeflate_state)(unsafe.Pointer(s)).Fw_size { /* supplant the previous history */
			...
			*(*TuInt)(unsafe.Pointer(s + 5896)) += v1
		}
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
	}
...
func _deflate_fast(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
	...
	for {
		...
		if (*Tdeflate_state)(unsafe.Pointer(s)).Fmatch_length >= uint32(m_MIN_MATCH) {
			...
			*(*Tuchf)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fsym_buf + uintptr(v3))) = uint8(dist)
			...
			v3 = *(*TuInt)(unsafe.Pointer(v4))
			*(*TuInt)(unsafe.Pointer(v4)) = *(*TuInt)(unsafe.Pointer(v4)) + 1
			*(*Tuchf)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fsym_buf + uintptr(v3))) = uint8(int32(dist) >> libc.Int32FromInt32(8))
			v4 = s + 5876
			v3 = *(*TuInt)(unsafe.Pointer(v4))
			*(*TuInt)(unsafe.Pointer(v4)) = *(*TuInt)(unsafe.Pointer(v4)) + 1
			*(*Tuchf)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fsym_buf + uintptr(v3))) = len1
			dist = dist - 1
			*(*Tush)(unsafe.Pointer(s + 188 + uintptr(int32(x__length_code[len1])+int32(m_LITERALS)+int32(1))*4)) = *(*Tush)(unsafe.Pointer(s + 188 + uintptr(int32(x__length_code[len1])+int32(m_LITERALS)+int32(1))*4)) + 1
			if int32(dist) < int32(256) {
				v9 = int32(x__dist_code[dist])
			} else {
				v9 = int32(x__dist_code[int32(256)+int32(dist)>>int32(7)])
			}
			*(*Tush)(unsafe.Pointer(s + 2480 + uintptr(v9)*4)) = *(*Tush)(unsafe.Pointer(s + 2480 + uintptr(v9)*4)) + 1
			...
			*(*Tush)(unsafe.Pointer(s + 188 + uintptr(cc)*4)) = *(*Tush)(unsafe.Pointer(s + 188 + uintptr(cc)*4)) + 1
			bflush = libc.BoolInt32((*Tdeflate_state)(unsafe.Pointer(s)).Fsym_next == (*Tdeflate_state)(unsafe.Pointer(s)).Fsym_end)
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart < uint32(libc.Int32FromInt32(m_MIN_MATCH)-libc.Int32FromInt32(1)) {
		...
		v21 = uint32(libc.Int32FromInt32(m_MIN_MATCH) - libc.Int32FromInt32(1))
	}
	...
	if flush == int32(m_Z_FINISH) {
		...
		x__tr_flush_block(tls, s, v4, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), int32(1))
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
...
func _deflate_slow(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fmatch_available != 0 {
		...
		*(*Tush)(unsafe.Pointer(s + 188 + uintptr(cc1)*4)) = *(*Tush)(unsafe.Pointer(s + 188 + uintptr(cc1)*4)) + 1
		bflush = libc.BoolInt32((*Tdeflate_state)(unsafe.Pointer(s)).Fsym_next == (*Tdeflate_state)(unsafe.Pointer(s)).Fsym_end)
		(*Tdeflate_state)(unsafe.Pointer(s)).Fmatch_available = 0
	}
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart < uint32(libc.Int32FromInt32(m_MIN_MATCH)-libc.Int32FromInt32(1)) {
		...
		v30 = uint32(libc.Int32FromInt32(m_MIN_MATCH) - libc.Int32FromInt32(1))
	}
...
func _deflate_rle(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
	...
	for {
		...
		if (*Tdeflate_state)(unsafe.Pointer(s)).Fmatch_length >= uint32(m_MIN_MATCH) {
			...
			*(*Tuchf)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fsym_buf + uintptr(v23))) = uint8(dist)
			...
			v23 = *(*TuInt)(unsafe.Pointer(v2))
			*(*TuInt)(unsafe.Pointer(v2)) = *(*TuInt)(unsafe.Pointer(v2)) + 1
			*(*Tuchf)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fsym_buf + uintptr(v23))) = uint8(int32(dist) >> libc.Int32FromInt32(8))
			v2 = s + 5876
			v23 = *(*TuInt)(unsafe.Pointer(v2))
			*(*TuInt)(unsafe.Pointer(v2)) = *(*TuInt)(unsafe.Pointer(v2)) + 1
			...
			*(*Tush)(unsafe.Pointer(s + 2480 + uintptr(v29)*4)) = *(*Tush)(unsafe.Pointer(s + 2480 + uintptr(v29)*4)) + 1
			bflush = libc.BoolInt32((*Tdeflate_state)(unsafe.Pointer(s)).Fsym_next == (*Tdeflate_state)(unsafe.Pointer(s)).Fsym_end)
			*(*TuInt)(unsafe.Pointer(s + 156)) -= (*Tdeflate_state)(unsafe.Pointer(s)).Fmatch_length
			*(*TuInt)(unsafe.Pointer(s + 148)) += (*Tdeflate_state)(unsafe.Pointer(s)).Fmatch_length
			(*Tdeflate_state)(unsafe.Pointer(s)).Fmatch_length = uint32(0)
		...
		if bflush != 0 {
			if (*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start >= 0 {
				v2 = (*Tdeflate_state)(unsafe.Pointer(s)).Fwindow + uintptr(uint32((*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start))
			} else {
				v2 = libc.UintptrFromInt32(m_Z_NULL)
			}
			x__tr_flush_block(tls, s, v2, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), 0)
			(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
			_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
			if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
				return int32(_need_more)
	...
	if flush == int32(m_Z_FINISH) {
		...
		x__tr_flush_block(tls, s, v2, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), int32(1))
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
			return int32(_finish_started)
...
func _deflate_huff(tls *libc.TLS, s uintptr, flush int32) (r Tblock_state) {
	...
	for {
		...
		*(*Tush)(unsafe.Pointer(s + 188 + uintptr(cc)*4)) = *(*Tush)(unsafe.Pointer(s + 188 + uintptr(cc)*4)) + 1
		...
		if bflush != 0 {
			if (*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start >= 0 {
				v3 = (*Tdeflate_state)(unsafe.Pointer(s)).Fwindow + uintptr(uint32((*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start))
			} else {
				v3 = libc.UintptrFromInt32(m_Z_NULL)
			}
			x__tr_flush_block(tls, s, v3, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), 0)
			(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
			_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
			if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
				return int32(_need_more)
	...
	if flush == int32(m_Z_FINISH) {
		...
		x__tr_flush_block(tls, s, v3, uint32(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)-(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start), int32(1))
		(*Tdeflate_state)(unsafe.Pointer(s)).Fblock_start = int32((*Tdeflate_state)(unsafe.Pointer(s)).Fstrstart)
		_flush_pending(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)
		if (*Tz_stream)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fstrm)).Favail_out == uint32(0) {
			return int32(_finish_started)
...
func _gz_open(tls *libc.TLS, path uintptr, fd int32, mode uintptr) (r TgzFile) {
	...
	state = libc.Xmalloc(tls, uint64(224))
	...
	if fd == -int32(2) {
		...
		libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath, len1+uint64(1), __ccgo_ts+881, libc.VaList(bp+8, path))
	}
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fmode == int32(m_GZ_APPEND) {
		libc.X_lseeki64(tls, (*Tgz_state)(unsafe.Pointer(state)).Ffd, 0, int32(m_SEEK_END)) /* so gzoffset() is correct */
...
//
//	/* -- see zlib.h -- */
func x_gzseek64(tls *libc.TLS, file TgzFile, offset int64, whence int32) (r int64) {
	var n, v2 uint32
	var ret, v1 int64
	var state Tgz_statep
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fmode == int32(m_GZ_READ) {
		if libc.Bool(libc.Bool(uint64(4) == uint64(8)) && (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave > x_gz_intmax(tls)) || int64((*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave) > offset {
			v2 = uint32(offset)
		} else {
...
//
//	/* -- see zlib.h -- */
func x_gzseek(tls *libc.TLS, file TgzFile, offset int64, whence int32) (r int64) {
	var ret, v1 int64
	_, _ = ret, v1
...
//
//	/* -- see zlib.h -- */
func x_gztell64(tls *libc.TLS, file TgzFile) (r int64) {
	var state Tgz_statep
	var v1 int64
	_, _ = state, v1
	/* get internal structure and check integrity */
...
//
//	/* -- see zlib.h -- */
func x_gztell(tls *libc.TLS, file TgzFile) (r int64) {
	var ret, v1 int64
	_, _ = ret, v1
...
func x_gz_error(tls *libc.TLS, state Tgz_statep, err int32, msg uintptr) {
	...
	libc.X__builtin_snprintf(tls, (*Tgz_state)(unsafe.Pointer(state)).Fmsg, libc.Xstrlen(tls, (*Tgz_state)(unsafe.Pointer(state)).Fpath)+libc.Xstrlen(tls, msg)+uint64(3), __ccgo_ts+907, libc.VaList(bp+8, (*Tgz_state)(unsafe.Pointer(state)).Fpath, __ccgo_ts+914, msg))
}
...
func _gz_look(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fsize == uint32(0) {
		...
		if x_inflateInit2_(tls, state+136, libc.Int32FromInt32(15)+libc.Int32FromInt32(16), __ccgo_ts+339, libc.Int32FromInt64(88)) != m_Z_OK { /* gunzip */
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
...
func _gz_skip(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	for cond := true; cond; cond = (*Tgz_state)(unsafe.Pointer(state)).Fskip != 0 {
		...
		if (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave != 0 {
			if libc.Bool(libc.Bool(uint64(4) == uint64(8)) && (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave > x_gz_intmax(tls)) || int64((*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave) > (*Tgz_state)(unsafe.Pointer(state)).Fskip {
			...
			(*Tgz_state)(unsafe.Pointer(state)).Fx.Fnext += uintptr(n)
			(*Tgz_state)(unsafe.Pointer(state)).Fx.Fpos += int64(n)
			*(*int64)(unsafe.Pointer(state + 112)) -= int64(n)
		} else {
...
func x_gzread(tls *libc.TLS, file TgzFile, buf Tvoidp, len1 uint32) (r int32) {
	...
	if int32(len1) < 0 {
		x_gz_error(tls, state, -int32(2), __ccgo_ts+1015)
		return -int32(1)
	}
...
func x_gzungetc(tls *libc.TLS, c int32, file TgzFile) (r int32) {
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Fx.Fhave == (*Tgz_state)(unsafe.Pointer(state)).Fsize<<int32(1) {
		x_gz_error(tls, state, -int32(3), __ccgo_ts+1079)
		return -int32(1)
	}
...
func _gz_init(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	if !((*Tgz_state)(unsafe.Pointer(state)).Fdirect != 0) {
		...
		ret = x_deflateInit2_(tls, strm, (*Tgz_state)(unsafe.Pointer(state)).Flevel, int32(m_Z_DEFLATED), libc.Int32FromInt32(m_MAX_WBITS)+libc.Int32FromInt32(16), int32(m_DEF_MEM_LEVEL), (*Tgz_state)(unsafe.Pointer(state)).Fstrategy, __ccgo_ts+339, libc.Int32FromInt64(88))
		if ret != m_Z_OK {
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fout)
			libc.Xfree(tls, (*Tgz_state)(unsafe.Pointer(state)).Fin)
			x_gz_error(tls, state, -int32(4), __ccgo_ts+892)
...
func _gz_comp(tls *libc.TLS, state Tgz_statep, flush int32) (r int32) {
	...
	for cond := true; cond; cond = have != 0 {
			...
			for (*Tz_stream)(unsafe.Pointer(strm)).Fnext_out > (*Tgz_state)(unsafe.Pointer(state)).Fx.Fnext {
				*(*int32)(unsafe.Pointer(libc.X_errno(tls))) = 0
				...
				if int64((*Tz_stream)(unsafe.Pointer(strm)).Fnext_out)-int64((*Tgz_state)(unsafe.Pointer(state)).Fx.Fnext) > int64(int32(max)) {
					...
					v1 = uint32(int64((*Tz_stream)(unsafe.Pointer(strm)).Fnext_out) - int64((*Tgz_state)(unsafe.Pointer(state)).Fx.Fnext))
				}
				put = v1
		...
		if ret == -int32(2) {
			x_gz_error(tls, state, -int32(2), __ccgo_ts+1110)
			return -int32(1)
		}
...
func _gz_zero(tls *libc.TLS, state Tgz_statep) (r int32) {
	...
	first = int32(1)
	for cond := true; cond; cond = (*Tgz_state)(unsafe.Pointer(state)).Fskip != 0 {
		if libc.Bool(libc.Bool(uint64(4) == uint64(8)) && (*Tgz_state)(unsafe.Pointer(state)).Fsize > x_gz_intmax(tls)) || int64((*Tgz_state)(unsafe.Pointer(state)).Fsize) > (*Tgz_state)(unsafe.Pointer(state)).Fskip {
			v1 = uint32((*Tgz_state)(unsafe.Pointer(state)).Fskip)
		} else {
...
func x_gzputs(tls *libc.TLS, file TgzFile, s uintptr) (r int32) {
	...
	if int32(len1) < 0 || uint64(uint32(len1)) != len1 {
		x_gz_error(tls, state, -int32(2), __ccgo_ts+1186)
		return -int32(1)
	}
	...
	if (*Tgz_state)(unsafe.Pointer(state)).Ferr != 0 {
		if ret != 0 && (*Tgz_state)(unsafe.Pointer(state)).Fagain != 0 {
			/* There was a non-blocking stall on write, resulting in the part
			   ...
			   needs to be retried. */
			x_gz_error(tls, state, -int32(5), __ccgo_ts+1220)
		}
		if !((*Tgz_state)(unsafe.Pointer(state)).Fagain != 0) {
			return (*Tgz_state)(unsafe.Pointer(state)).Ferr
		}
			...
			dodist:
				...
				if op&uint32(16) != 0 { /* distance base */
					...
					if dist > op {                       /* see if copy from window */
						...
						if op > whave {
							if (*Tinflate_state)(unsafe.Pointer(state)).Fsane != 0 {
								(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1518
					...
					if op&uint32(64) == uint32(0) { /* 2nd level distance code */
						...
						(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1496
						(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
						break
					}
				}
				...
				if op&uint32(64) == uint32(0) { /* 2nd level length code */
					...
					if op&uint32(32) != 0 { /* end-of-block */
						...
						(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1468
						(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
						break
					}
				}
...
func x_inflateInit2_(tls *libc.TLS, strm Tz_streamp, windowBits int32, version uintptr, stream_size int32) (r int32) {
	...
	var state uintptr
	_, _ = ret, state
	if version == uintptr(m_Z_NULL) || int32(*(*int8)(unsafe.Pointer(version))) != int32(*(*int8)(unsafe.Pointer(__ccgo_ts + 339))) || stream_size != int32(libc.Uint64FromInt64(88)) {
		return -int32(6)
	}
	if strm == uintptr(m_Z_NULL) {
		return -int32(2)
	...
	libc.Xmemset(tls, state, 0, uint64(7152))
...
func x_inflate(tls *libc.TLS, strm Tz_streamp, flush int32) (r int32) {
	...
	_2:
		...
		if !((*Tinflate_state)(unsafe.Pointer(state)).Fwrap&libc.Int32FromInt32(1) != 0) || (uint32(hold&(libc.Uint32FromUint32(1)<<libc.Int32FromInt32(8)-libc.Uint32FromInt32(1))<<libc.Int32FromInt32(8))+hold>>int32(8))%uint32(31) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1548
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		if hold&(libc.Uint32FromUint32(1)<<libc.Int32FromInt32(4)-libc.Uint32FromInt32(1)) != uint32(m_Z_DEFLATED) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1571
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		...
		if len1 > uint32(15) || len1 > (*Tinflate_state)(unsafe.Pointer(state)).Fwbits {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1598
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
	...
	_39:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0xe000) != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1618
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		if (*Tinflate_state)(unsafe.Pointer(state)).Fhead != uintptr(m_Z_NULL) {
	...
	_10:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags&int32(0x0200) != 0 {
			...
			if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && hold != (*Tinflate_state)(unsafe.Pointer(state)).Fcheck&uint32(0xffff) {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1643
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint32(0)
	...
	_14:
		...
		default:
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1246
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
		}
		hold = hold >> uint32(libc.Int32FromInt32(2))
		bits = bits - uint32(libc.Int32FromInt32(2))
	...
	_15:
		...
		if hold&uint32(0xffff) != hold>>int32(16)^uint32(0xffff) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1265
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
	...
	_18:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fnlen > uint32(286) || (*Tinflate_state)(unsafe.Pointer(state)).Fndist > uint32(30) {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1294
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
	...
	_19:
		...
		for (*Tinflate_state)(unsafe.Pointer(state)).Fhave < (*Tinflate_state)(unsafe.Pointer(state)).Fncode {
			...
			v37 = *(*uint32)(unsafe.Pointer(v36))
			*(*uint32)(unsafe.Pointer(v36)) = *(*uint32)(unsafe.Pointer(v36)) + 1
			*(*uint16)(unsafe.Pointer(state + 144 + uintptr(_order1[v37])*2)) = uint16(hold & (libc.Uint32FromUint32(1)<<libc.Int32FromInt32(3) - libc.Uint32FromInt32(1)))
		...
		for (*Tinflate_state)(unsafe.Pointer(state)).Fhave < uint32(19) {
			...
			v37 = *(*uint32)(unsafe.Pointer(v36))
			*(*uint32)(unsafe.Pointer(v36)) = *(*uint32)(unsafe.Pointer(v36)) + 1
			*(*uint16)(unsafe.Pointer(state + 144 + uintptr(_order1[v37])*2)) = uint16(0)
		}
		...
		ret = x_inflate_table(tls, int32(_CODES), state+144, uint32(19), state+136, state+112, state+784)
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1330
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		(*Tinflate_state)(unsafe.Pointer(state)).Fhave = uint32(0)
	...
	_20:
		...
		for (*Tinflate_state)(unsafe.Pointer(state)).Fhave < (*Tinflate_state)(unsafe.Pointer(state)).Fnlen+(*Tinflate_state)(unsafe.Pointer(state)).Fndist {
			...
			if int32(here.Fval) < int32(16) {
				...
				v37 = *(*uint32)(unsafe.Pointer(v36))
				*(*uint32)(unsafe.Pointer(v36)) = *(*uint32)(unsafe.Pointer(v36)) + 1
				*(*uint16)(unsafe.Pointer(state + 144 + uintptr(v37)*2)) = here.Fval
			} else {
				if int32(here.Fval) == int32(16) {
					...
					if (*Tinflate_state)(unsafe.Pointer(state)).Fhave == uint32(0) {
						(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1355
						(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
						break
					}
				...
				for {
					...
					*(*uint32)(unsafe.Pointer(v36)) = *(*uint32)(unsafe.Pointer(v36)) + 1
					*(*uint16)(unsafe.Pointer(state + 144 + uintptr(v46)*2)) = uint16(len1)
				}
			}
		}
		...
		if int32(*(*uint16)(unsafe.Pointer(state + 144 + 256*2))) == 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1381
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		...
		ret = x_inflate_table(tls, int32(_LENS), state+144, (*Tinflate_state)(unsafe.Pointer(state)).Fnlen, state+136, state+112, state+784)
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1418
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
		...
		ret = x_inflate_table(tls, int32(_DISTS), state+144+uintptr((*Tinflate_state)(unsafe.Pointer(state)).Fnlen)*2, (*Tinflate_state)(unsafe.Pointer(state)).Fndist, state+136, state+116, state+784)
		if ret != 0 {
			(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1446
			(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
			goto _35
		}
	...
	_23:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fextra != 0 {
			...
			*(*uint32)(unsafe.Pointer(state + 80)) += hold & (uint32(1)<<(*Tinflate_state)(unsafe.Pointer(state)).Fextra - uint32(1))
	...
	_25:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fextra != 0 {
			...
			*(*uint32)(unsafe.Pointer(state + 84)) += hold & (uint32(1)<<(*Tinflate_state)(unsafe.Pointer(state)).Fextra - uint32(1))
			hold = hold >> (*Tinflate_state)(unsafe.Pointer(state)).Fextra
			bits = bits - (*Tinflate_state)(unsafe.Pointer(state)).Fextra
			v36 = state + 7140
			*(*int32)(unsafe.Pointer(v36)) = int32(uint32(*(*int32)(unsafe.Pointer(v36))) + (*Tinflate_state)(unsafe.Pointer(state)).Fextra)
	...
	_28:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 {
			...
			out = out - left
			*(*TuLong)(unsafe.Pointer(strm + 28)) += out
			*(*uint32)(unsafe.Pointer(state + 36)) += out
			...
			if v47 && v37 != (*Tinflate_state)(unsafe.Pointer(state)).Fcheck {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1663
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint32(0)
	...
	_29:
		...
		if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap != 0 && (*Tinflate_state)(unsafe.Pointer(state)).Fflags != 0 {
			...
			if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && hold != (*Tinflate_state)(unsafe.Pointer(state)).Ftotal&uint32(0xffffffff) {
				(*Tz_stream)(unsafe.Pointer(strm)).Fmsg = __ccgo_ts + 1684
				(*Tinflate_state)(unsafe.Pointer(state)).Fmode = int32(_BAD)
				goto _35
			}
			hold = uint32(0)
...
inf_leave:
	...
	*(*TuLong)(unsafe.Pointer(strm + 12)) += in
	*(*TuLong)(unsafe.Pointer(strm + 28)) += out
	*(*uint32)(unsafe.Pointer(state + 36)) += out
	if (*Tinflate_state)(unsafe.Pointer(state)).Fwrap&int32(4) != 0 && out != 0 {
		if (*Tinflate_state)(unsafe.Pointer(state)).Fflags != 0 {
...
func x_inflateSync(tls *libc.TLS, strm Tz_streamp) (r int32) {
	...
	if (*Tinflate_state)(unsafe.Pointer(state)).Fmode != int32(_SYNC) {
		...
		*(*uint32)(unsafe.Pointer(state + 72)) >>= (*Tinflate_state)(unsafe.Pointer(state)).Fbits & uint32(7)
...
func _bi_flush(tls *libc.TLS, s uintptr) {
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid == int32(16) {
		...
		*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v1))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
		...
		v1 = *(*Tulg)(unsafe.Pointer(v2))
		*(*Tulg)(unsafe.Pointer(v2)) = *(*Tulg)(unsafe.Pointer(v2)) + 1
		*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v1))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) >> libc.Int32FromInt32(8))
...
func _gen_bitlen(tls *libc.TLS, s uintptr, desc uintptr) {
	...
	*(*Tush)(unsafe.Pointer(tree + uintptr(*(*int32)(unsafe.Pointer(s + 2984 + uintptr((*Tdeflate_state)(unsafe.Pointer(s)).Fheap_max)*4)))*4 + 2)) = uint16(0) /* root of the heap */
	...
	for {
		...
		*(*Tush)(unsafe.Pointer(s + 2952 + uintptr(bits)*2)) = *(*Tush)(unsafe.Pointer(s + 2952 + uintptr(bits)*2)) + 1
		xbits = 0
		if n >= base {
			xbits = *(*Tintf)(unsafe.Pointer(extra + uintptr(n-base)*4))
		}
		f = *(*Tush)(unsafe.Pointer(tree + uintptr(n)*4))
		*(*Tulg)(unsafe.Pointer(s + 5884)) += uint32(f) * uint32(bits+xbits)
		if stree != 0 {
			*(*Tulg)(unsafe.Pointer(s + 5888)) += uint32(f) * uint32(int32(*(*Tush)(unsafe.Pointer(stree + uintptr(n)*4 + 2)))+xbits)
		}
		goto _2
	_2:
		;
	...
	for cond := true; cond; cond = overflow > 0 {
		...
		*(*Tush)(unsafe.Pointer(s + 2952 + uintptr(bits)*2)) = *(*Tush)(unsafe.Pointer(s + 2952 + uintptr(bits)*2)) - 1 /* move one leaf down the tree */
		v3 = s + 2952 + uintptr(bits+int32(1))*2
		*(*Tush)(unsafe.Pointer(v3)) = Tush(int32(*(*Tush)(unsafe.Pointer(v3))) + libc.Int32FromInt32(2)) /* move one overflow item as its brother */
		*(*Tush)(unsafe.Pointer(s + 2952 + uintptr(max_length)*2)) = *(*Tush)(unsafe.Pointer(s + 2952 + uintptr(max_length)*2)) - 1
	...
	for {
		...
		for n != 0 {
			...
			if uint32(*(*Tush)(unsafe.Pointer(tree + uintptr(m)*4 + 2))) != uint32(bits) {
				*(*Tulg)(unsafe.Pointer(s + 5884)) += (uint32(bits) - uint32(*(*Tush)(unsafe.Pointer(tree + uintptr(m)*4 + 2)))) * uint32(*(*Tush)(unsafe.Pointer(tree + uintptr(m)*4)))
...
func _build_tree(tls *libc.TLS, s uintptr, desc uintptr) {
	...
	for (*Tdeflate_state)(unsafe.Pointer(s)).Fheap_len < int32(2) {
		...
		*(*int32)(unsafe.Pointer(s + 2984 + uintptr(v6)*4)) = v2
		node = v2
	...
	for cond := true; cond; cond = (*Tdeflate_state)(unsafe.Pointer(s)).Fheap_len >= int32(2) {
		...
		v2 = *(*int32)(unsafe.Pointer(v3))
		*(*int32)(unsafe.Pointer(v3)) = *(*int32)(unsafe.Pointer(v3)) - 1
		*(*int32)(unsafe.Pointer(s + 2984 + 1*4)) = *(*int32)(unsafe.Pointer(s + 2984 + uintptr(v2)*4))
		...
		*(*int32)(unsafe.Pointer(v3)) = *(*int32)(unsafe.Pointer(v3)) - 1
		v2 = *(*int32)(unsafe.Pointer(v3))
		*(*int32)(unsafe.Pointer(s + 2984 + uintptr(v2)*4)) = n /* keep the nodes sorted by frequency */
		v3 = s + 5280
		*(*int32)(unsafe.Pointer(v3)) = *(*int32)(unsafe.Pointer(v3)) - 1
		v2 = *(*int32)(unsafe.Pointer(v3))
		*(*int32)(unsafe.Pointer(s + 2984 + uintptr(v2)*4)) = m
		...
		*(*Tush)(unsafe.Pointer(tree + uintptr(node)*4)) = uint16(int32(*(*Tush)(unsafe.Pointer(tree + uintptr(n)*4))) + int32(*(*Tush)(unsafe.Pointer(tree + uintptr(m)*4))))
		if int32(*(*Tuch)(unsafe.Pointer(s + 5284 + uintptr(n)))) >= int32(*(*Tuch)(unsafe.Pointer(s + 5284 + uintptr(m)))) {
			v2 = int32(*(*Tuch)(unsafe.Pointer(s + 5284 + uintptr(n))))
		} else {
			v2 = int32(*(*Tuch)(unsafe.Pointer(s + 5284 + uintptr(m))))
		}
		*(*Tuch)(unsafe.Pointer(s + 5284 + uintptr(node))) = uint8(v2 + libc.Int32FromInt32(1))
		v18 = uint16(node)
		...
		*(*Tush)(unsafe.Pointer(tree + uintptr(n)*4 + 2)) = v18
		...
		v2 = node
		node = node + 1
		*(*int32)(unsafe.Pointer(s + 2984 + 1*4)) = v2
		_pqdownheap(tls, s, tree, int32(m_SMALLEST))
	}
	v3 = s + 5280
	*(*int32)(unsafe.Pointer(v3)) = *(*int32)(unsafe.Pointer(v3)) - 1
	v2 = *(*int32)(unsafe.Pointer(v3))
	*(*int32)(unsafe.Pointer(s + 2984 + uintptr(v2)*4)) = *(*int32)(unsafe.Pointer(s + 2984 + 1*4))
	...
	*(*Tush)(unsafe.Pointer(tree + uintptr(max_code+int32(1))*4 + 2)) = libc.Uint16FromInt32(0xffff) /* guard */
	...
	for {
		...
		if v2 < max_count && curlen == nextlen {
			...
			if count < min_count {
				v3 = s + 2724 + uintptr(curlen)*4
				*(*Tush)(unsafe.Pointer(v3)) = Tush(int32(*(*Tush)(unsafe.Pointer(v3))) + int32(uint16(count)))
			} else {
				if curlen != 0 {
					if curlen != prevlen {
						*(*Tush)(unsafe.Pointer(s + 2724 + uintptr(curlen)*4)) = *(*Tush)(unsafe.Pointer(s + 2724 + uintptr(curlen)*4)) + 1
					}
					*(*Tush)(unsafe.Pointer(s + 2724 + 16*4)) = *(*Tush)(unsafe.Pointer(s + 2724 + 16*4)) + 1
				} else {
					if count <= int32(10) {
						*(*Tush)(unsafe.Pointer(s + 2724 + 17*4)) = *(*Tush)(unsafe.Pointer(s + 2724 + 17*4)) + 1
					} else {
						*(*Tush)(unsafe.Pointer(s + 2724 + 18*4)) = *(*Tush)(unsafe.Pointer(s + 2724 + 18*4)) + 1
					}
				}
			}
		}
			...
			if count < min_count {
				for {
					...
					if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len1 {
						...
						v5 = s + 5900
						*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(uint16(val))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
						v5 = s + 40
						...
						*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v6))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
						...
						v6 = *(*Tulg)(unsafe.Pointer(v5))
						*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
						*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v6))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) >> libc.Int32FromInt32(8))
						...
						*(*int32)(unsafe.Pointer(s + 5904)) += len1 - int32(m_Buf_size)
						...
						v5 = s + 5900
						*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(*(*Tush)(unsafe.Pointer(s + 2724 + uintptr(curlen)*4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
				...
				if curlen != 0 {
					if curlen != prevlen {
						...
						if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len11 {
							...
							v5 = s + 5900
							*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(uint16(val1))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
							v5 = s + 40
							v6 = *(*Tulg)(unsafe.Pointer(v5))
							*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
							*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v6))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
					...
					if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len2 {
						...
						v5 = s + 5900
						*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(uint16(val2))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
						v5 = s + 40
						v6 = *(*Tulg)(unsafe.Pointer(v5))
						*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
						*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v6))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
						...
						*(*int32)(unsafe.Pointer(s + 5904)) += len2 - int32(m_Buf_size)
						...
						v5 = s + 5900
						*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(*(*Tush)(unsafe.Pointer(s + 2724 + 16*4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
					...
					if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len3 {
						val3 = count - int32(3)
						v5 = s + 5900
						*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(uint16(val3))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
						v5 = s + 40
						v6 = *(*Tulg)(unsafe.Pointer(v5))
						*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
						*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v6))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
						...
						*(*int32)(unsafe.Pointer(s + 5904)) += len3 - int32(m_Buf_size)
						...
						v5 = s + 5900
						*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(uint16(count-libc.Int32FromInt32(3)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
					...
					if count <= int32(10) {
						...
						if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len4 {
							...
							v5 = s + 5900
							*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(uint16(val4))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
							v5 = s + 40
							v6 = *(*Tulg)(unsafe.Pointer(v5))
							*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
							*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v6))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
							...
							*(*int32)(unsafe.Pointer(s + 5904)) += len4 - int32(m_Buf_size)
							...
							v5 = s + 5900
							*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(*(*Tush)(unsafe.Pointer(s + 2724 + 17*4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
						...
						if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len5 {
							val5 = count - int32(3)
							v5 = s + 5900
							*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(uint16(val5))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
							v5 = s + 40
							v6 = *(*Tulg)(unsafe.Pointer(v5))
							*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
							*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v6))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
						...
						if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len6 {
							...
							v5 = s + 5900
							*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(uint16(val6))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
							v5 = s + 40
							v6 = *(*Tulg)(unsafe.Pointer(v5))
							*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
							*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v6))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
							...
							*(*int32)(unsafe.Pointer(s + 5904)) += len6 - int32(m_Buf_size)
							...
							v5 = s + 5900
							*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(*(*Tush)(unsafe.Pointer(s + 2724 + 18*4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
						...
						if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len7 {
							val7 = count - int32(11)
							v5 = s + 5900
							*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(uint16(val7))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
							v5 = s + 40
							v6 = *(*Tulg)(unsafe.Pointer(v5))
							*(*Tulg)(unsafe.Pointer(v5)) = *(*Tulg)(unsafe.Pointer(v5)) + 1
							*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v6))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
							...
							*(*int32)(unsafe.Pointer(s + 5904)) += len7 - int32(m_Buf_size)
							...
							v5 = s + 5900
							*(*Tush)(unsafe.Pointer(v5)) = Tush(int32(*(*Tush)(unsafe.Pointer(v5))) | int32(uint16(count-libc.Int32FromInt32(11)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
...
func _build_bl_tree(tls *libc.TLS, s uintptr) (r int32) {
	...
	*(*Tulg)(unsafe.Pointer(s + 5884)) += uint32(3)*(uint32(max_blindex)+uint32(1)) + uint32(5) + uint32(5) + uint32(4)
	return max_blindex
}
...
func _send_all_trees(tls *libc.TLS, s uintptr, lcodes int32, dcodes int32, blcodes int32) {
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len1 {
		...
		v1 = s + 5900
		*(*Tush)(unsafe.Pointer(v1)) = Tush(int32(*(*Tush)(unsafe.Pointer(v1))) | int32(uint16(val))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
		v1 = s + 40
		...
		*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v2))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
		...
		v2 = *(*Tulg)(unsafe.Pointer(v1))
		*(*Tulg)(unsafe.Pointer(v1)) = *(*Tulg)(unsafe.Pointer(v1)) + 1
		*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v2))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) >> libc.Int32FromInt32(8))
		(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf = uint16(int32(uint16(val)) >> (int32(m_Buf_size) - (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid))
		*(*int32)(unsafe.Pointer(s + 5904)) += len1 - int32(m_Buf_size)
	} else {
		v1 = s + 5900
		*(*Tush)(unsafe.Pointer(v1)) = Tush(int32(*(*Tush)(unsafe.Pointer(v1))) | int32(uint16(lcodes-libc.Int32FromInt32(257)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
		*(*int32)(unsafe.Pointer(s + 5904)) += len1
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len11 {
		val1 = dcodes - int32(1)
		v1 = s + 5900
		*(*Tush)(unsafe.Pointer(v1)) = Tush(int32(*(*Tush)(unsafe.Pointer(v1))) | int32(uint16(val1))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
		v1 = s + 40
		v2 = *(*Tulg)(unsafe.Pointer(v1))
		*(*Tulg)(unsafe.Pointer(v1)) = *(*Tulg)(unsafe.Pointer(v1)) + 1
		*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v2))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
		...
		*(*int32)(unsafe.Pointer(s + 5904)) += len11 - int32(m_Buf_size)
		...
		v1 = s + 5900
		*(*Tush)(unsafe.Pointer(v1)) = Tush(int32(*(*Tush)(unsafe.Pointer(v1))) | int32(uint16(dcodes-libc.Int32FromInt32(1)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
		*(*int32)(unsafe.Pointer(s + 5904)) += len11
	}
	len2 = int32(4)
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len2 {
		...
		v1 = s + 5900
		*(*Tush)(unsafe.Pointer(v1)) = Tush(int32(*(*Tush)(unsafe.Pointer(v1))) | int32(uint16(val2))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
		v1 = s + 40
		v2 = *(*Tulg)(unsafe.Pointer(v1))
		*(*Tulg)(unsafe.Pointer(v1)) = *(*Tulg)(unsafe.Pointer(v1)) + 1
		*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v2))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
		...
		*(*int32)(unsafe.Pointer(s + 5904)) += len2 - int32(m_Buf_size)
		...
		v1 = s + 5900
		*(*Tush)(unsafe.Pointer(v1)) = Tush(int32(*(*Tush)(unsafe.Pointer(v1))) | int32(uint16(blcodes-libc.Int32FromInt32(4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
		*(*int32)(unsafe.Pointer(s + 5904)) += len2
	...
	for {
		...
		if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len3 {
			...
			v1 = s + 5900
			*(*Tush)(unsafe.Pointer(v1)) = Tush(int32(*(*Tush)(unsafe.Pointer(v1))) | int32(uint16(val3))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
			v1 = s + 40
			v2 = *(*Tulg)(unsafe.Pointer(v1))
			*(*Tulg)(unsafe.Pointer(v1)) = *(*Tulg)(unsafe.Pointer(v1)) + 1
			*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v2))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
			...
			*(*int32)(unsafe.Pointer(s + 5904)) += len3 - int32(m_Buf_size)
			...
			v1 = s + 5900
			*(*Tush)(unsafe.Pointer(v1)) = Tush(int32(*(*Tush)(unsafe.Pointer(v1))) | int32(*(*Tush)(unsafe.Pointer(s + 2724 + uintptr(_bl_order[rank])*4 + 2)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
			*(*int32)(unsafe.Pointer(s + 5904)) += len3
		}
		goto _19
	_19:
...
func x__tr_stored_block(tls *libc.TLS, s uintptr, buf uintptr, stored_len Tulg, last int32) {
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len1 {
		...
		*(*int32)(unsafe.Pointer(s + 5904)) += len1 - int32(m_Buf_size)
		...
		v1 = s + 5900
		*(*Tush)(unsafe.Pointer(v1)) = Tush(int32(*(*Tush)(unsafe.Pointer(v1))) | int32(uint16(libc.Int32FromInt32(m_STORED_BLOCK)<<libc.Int32FromInt32(1)+last))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
		*(*int32)(unsafe.Pointer(s + 5904)) += len1
	} /* send block type */
	...
	v2 = *(*Tulg)(unsafe.Pointer(v1))
	*(*Tulg)(unsafe.Pointer(v1)) = *(*Tulg)(unsafe.Pointer(v1)) + 1
	*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v2))) = uint8(int32(uint16(stored_len)) & libc.Int32FromInt32(0xff))
	v1 = s + 40
	v2 = *(*Tulg)(unsafe.Pointer(v1))
	*(*Tulg)(unsafe.Pointer(v1)) = *(*Tulg)(unsafe.Pointer(v1)) + 1
	*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v2))) = uint8(int32(uint16(stored_len)) >> libc.Int32FromInt32(8))
	v1 = s + 40
	v2 = *(*Tulg)(unsafe.Pointer(v1))
	*(*Tulg)(unsafe.Pointer(v1)) = *(*Tulg)(unsafe.Pointer(v1)) + 1
	*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v2))) = uint8(int32(uint16(^stored_len)) & libc.Int32FromInt32(0xff))
	...
	*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v2))) = uint8(int32(uint16(^stored_len)) >> libc.Int32FromInt32(8))
	if stored_len != 0 {
		libc.Xmemcpy(tls, (*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf+uintptr((*Tdeflate_state)(unsafe.Pointer(s)).Fpending), buf, uint64(stored_len))
	}
...
func x__tr_align(tls *libc.TLS, s uintptr) {
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len1 {
		...
		*(*int32)(unsafe.Pointer(s + 5904)) += len1 - int32(m_Buf_size)
		...
		v1 = s + 5900
		*(*Tush)(unsafe.Pointer(v1)) = Tush(int32(*(*Tush)(unsafe.Pointer(v1))) | int32(uint16(libc.Int32FromInt32(m_STATIC_TREES)<<libc.Int32FromInt32(1)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
		*(*int32)(unsafe.Pointer(s + 5904)) += len1
	}
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len11 {
		...
		*(*int32)(unsafe.Pointer(s + 5904)) += len11 - int32(m_Buf_size)
		...
		v1 = s + 5900
		*(*Tush)(unsafe.Pointer(v1)) = Tush(int32(*(*Tush)(unsafe.Pointer(v1))) | int32(*(*Tush)(unsafe.Pointer(uintptr(unsafe.Pointer(&_static_ltree)) + 256*4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
		*(*int32)(unsafe.Pointer(s + 5904)) += len11
	}
	_bi_flush(tls, s)
}
...
func _compress_block(tls *libc.TLS, s uintptr, ltree uintptr, dtree uintptr) {
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fsym_next != uint32(0) {
		for cond := true; cond; cond = sx < (*Tdeflate_state)(unsafe.Pointer(s)).Fsym_next {
			v1 = sx
			sx = sx + 1
			dist = uint32(int32(*(*Tuchf)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fsym_buf + uintptr(v1)))) & int32(0xff))
			v1 = sx
			sx = sx + 1
			dist = dist + uint32(int32(*(*Tuchf)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fsym_buf + uintptr(v1))))&libc.Int32FromInt32(0xff))<<int32(8)
			v1 = sx
			sx = sx + 1
			lc = int32(*(*Tuchf)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fsym_buf + uintptr(v1))))
			if dist == uint32(0) {
				len1 = int32(*(*Tush)(unsafe.Pointer(ltree + uintptr(lc)*4 + 2)))
				if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len1 {
					val = int32(*(*Tush)(unsafe.Pointer(ltree + uintptr(lc)*4)))
					v4 = s + 5900
					*(*Tush)(unsafe.Pointer(v4)) = Tush(int32(*(*Tush)(unsafe.Pointer(v4))) | int32(uint16(val))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
					v4 = s + 40
					...
					*(*int32)(unsafe.Pointer(s + 5904)) += len1 - int32(m_Buf_size)
					...
					v4 = s + 5900
					*(*Tush)(unsafe.Pointer(v4)) = Tush(int32(*(*Tush)(unsafe.Pointer(v4))) | int32(*(*Tush)(unsafe.Pointer(ltree + uintptr(lc)*4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
					*(*int32)(unsafe.Pointer(s + 5904)) += len1
				} /* send a literal byte */
			} else {
				...
				if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len11 {
					...
					v4 = s + 5900
					*(*Tush)(unsafe.Pointer(v4)) = Tush(int32(*(*Tush)(unsafe.Pointer(v4))) | int32(uint16(val1))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
					v4 = s + 40
					v5 = *(*Tulg)(unsafe.Pointer(v4))
					*(*Tulg)(unsafe.Pointer(v4)) = *(*Tulg)(unsafe.Pointer(v4)) + 1
					*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v5))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
					...
					*(*int32)(unsafe.Pointer(s + 5904)) += len11 - int32(m_Buf_size)
					...
					v4 = s + 5900
					*(*Tush)(unsafe.Pointer(v4)) = Tush(int32(*(*Tush)(unsafe.Pointer(v4))) | int32(*(*Tush)(unsafe.Pointer(ltree + uintptr(code+uint32(m_LITERALS)+uint32(1))*4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
					*(*int32)(unsafe.Pointer(s + 5904)) += len11
				} /* send length code */
				...
				if extra != 0 {
					...
					if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len2 {
						val2 = lc
						v4 = s + 5900
						*(*Tush)(unsafe.Pointer(v4)) = Tush(int32(*(*Tush)(unsafe.Pointer(v4))) | int32(uint16(val2))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
						v4 = s + 40
						v5 = *(*Tulg)(unsafe.Pointer(v4))
						*(*Tulg)(unsafe.Pointer(v4)) = *(*Tulg)(unsafe.Pointer(v4)) + 1
						*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v5))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
						...
						*(*int32)(unsafe.Pointer(s + 5904)) += len2 - int32(m_Buf_size)
						...
						v4 = s + 5900
						*(*Tush)(unsafe.Pointer(v4)) = Tush(int32(*(*Tush)(unsafe.Pointer(v4))) | int32(uint16(lc))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
						*(*int32)(unsafe.Pointer(s + 5904)) += len2
				...
				if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len3 {
					...
					v4 = s + 5900
					*(*Tush)(unsafe.Pointer(v4)) = Tush(int32(*(*Tush)(unsafe.Pointer(v4))) | int32(uint16(val3))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
					v4 = s + 40
					v5 = *(*Tulg)(unsafe.Pointer(v4))
					*(*Tulg)(unsafe.Pointer(v4)) = *(*Tulg)(unsafe.Pointer(v4)) + 1
					*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v5))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
					...
					*(*int32)(unsafe.Pointer(s + 5904)) += len3 - int32(m_Buf_size)
					...
					v4 = s + 5900
					*(*Tush)(unsafe.Pointer(v4)) = Tush(int32(*(*Tush)(unsafe.Pointer(v4))) | int32(*(*Tush)(unsafe.Pointer(dtree + uintptr(code)*4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
					*(*int32)(unsafe.Pointer(s + 5904)) += len3
				} /* send the distance code */
				extra = _extra_dbits[code]
				if extra != 0 {
					dist = dist - uint32(_base_dist[code])
					len4 = extra
					if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len4 {
						val4 = int32(dist)
						v4 = s + 5900
						*(*Tush)(unsafe.Pointer(v4)) = Tush(int32(*(*Tush)(unsafe.Pointer(v4))) | int32(uint16(val4))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
						v4 = s + 40
						v5 = *(*Tulg)(unsafe.Pointer(v4))
						*(*Tulg)(unsafe.Pointer(v4)) = *(*Tulg)(unsafe.Pointer(v4)) + 1
						*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v5))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
	...
	if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len5 {
		...
		v4 = s + 5900
		*(*Tush)(unsafe.Pointer(v4)) = Tush(int32(*(*Tush)(unsafe.Pointer(v4))) | int32(uint16(val5))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
		v4 = s + 40
		v5 = *(*Tulg)(unsafe.Pointer(v4))
		*(*Tulg)(unsafe.Pointer(v4)) = *(*Tulg)(unsafe.Pointer(v4)) + 1
		*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v5))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
		...
		*(*int32)(unsafe.Pointer(s + 5904)) += len5 - int32(m_Buf_size)
		...
		v4 = s + 5900
		*(*Tush)(unsafe.Pointer(v4)) = Tush(int32(*(*Tush)(unsafe.Pointer(v4))) | int32(*(*Tush)(unsafe.Pointer(ltree + 256*4)))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
		*(*int32)(unsafe.Pointer(s + 5904)) += len5
	}
}
	...
	if stored_len+uint32(4) <= opt_lenb && buf != libc.UintptrFromInt32(0) {
		...
		if static_lenb == opt_lenb {
			...
			if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len1 {
				...
				v2 = s + 5900
				*(*Tush)(unsafe.Pointer(v2)) = Tush(int32(*(*Tush)(unsafe.Pointer(v2))) | int32(uint16(val))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
				v2 = s + 40
				v1 = *(*Tulg)(unsafe.Pointer(v2))
				*(*Tulg)(unsafe.Pointer(v2)) = *(*Tulg)(unsafe.Pointer(v2)) + 1
				*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v1))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
				...
				*(*int32)(unsafe.Pointer(s + 5904)) += len1 - int32(m_Buf_size)
				...
				v2 = s + 5900
				*(*Tush)(unsafe.Pointer(v2)) = Tush(int32(*(*Tush)(unsafe.Pointer(v2))) | int32(uint16(libc.Int32FromInt32(m_STATIC_TREES)<<libc.Int32FromInt32(1)+last))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
				*(*int32)(unsafe.Pointer(s + 5904)) += len1
			}
			...
			if (*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid > libc.Int32FromInt32(m_Buf_size)-len11 {
				...
				v2 = s + 5900
				*(*Tush)(unsafe.Pointer(v2)) = Tush(int32(*(*Tush)(unsafe.Pointer(v2))) | int32(uint16(val1))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
				v2 = s + 40
				v1 = *(*Tulg)(unsafe.Pointer(v2))
				*(*Tulg)(unsafe.Pointer(v2)) = *(*Tulg)(unsafe.Pointer(v2)) + 1
				*(*TBytef)(unsafe.Pointer((*Tdeflate_state)(unsafe.Pointer(s)).Fpending_buf + uintptr(v1))) = uint8(int32((*Tdeflate_state)(unsafe.Pointer(s)).Fbi_buf) & libc.Int32FromInt32(0xff))
				...
				*(*int32)(unsafe.Pointer(s + 5904)) += len11 - int32(m_Buf_size)
				...
				v2 = s + 5900
				*(*Tush)(unsafe.Pointer(v2)) = Tush(int32(*(*Tush)(unsafe.Pointer(v2))) | int32(uint16(libc.Int32FromInt32(m_DYN_TREES)<<libc.Int32FromInt32(1)+last))<<(*Tdeflate_state)(unsafe.Pointer(s)).Fbi_valid)
				*(*int32)(unsafe.Pointer(s + 5904)) += len11
			}
...
func x_uncompress2(tls *libc.TLS, dest uintptr, destLen uintptr, source uintptr, sourceLen uintptr) (r int32) {
	...
	_ = ret
	*(*Tz_size_t)(unsafe.Pointer(bp)) = uint64(*(*TuLongf)(unsafe.Pointer(destLen)))
	*(*Tz_size_t)(unsafe.Pointer(bp + 8)) = uint64(*(*TuLong)(unsafe.Pointer(sourceLen)))
	ret = x_uncompress2_z(tls, dest, bp, source, bp+8)
	*(*TuLong)(unsafe.Pointer(sourceLen)) = uint32(*(*Tz_size_t)(unsafe.Pointer(bp + 8)))
	*(*TuLongf)(unsafe.Pointer(destLen)) = uint32(*(*Tz_size_t)(unsafe.Pointer(bp)))
	return ret
}
...
func x_zlibCompileFlags(tls *libc.TLS) (r TuLong) {
	...
	case int32(2):
	case int32(4):
		flags = flags + uint32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(2))
	case int32(8):
		flags = flags + uint32(libc.Int32FromInt32(2)<<libc.Int32FromInt32(2))
	default:
		flags = flags + uint32(libc.Int32FromInt32(3)<<libc.Int32FromInt32(2))
	}
	switch int32(libc.Uint64FromInt64(8)) {
	case int32(2):
	case int32(4):
		flags = flags + uint32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(4))
	case int32(8):
		flags = flags + uint32(libc.Int32FromInt32(2)<<libc.Int32FromInt32(4))
	default:
	...
	case int32(8):
		flags = flags + uint32(libc.Int32FromInt32(2)<<libc.Int32FromInt32(6))
	default:
		flags = flags + uint32(libc.Int32FromInt32(3)<<libc.Int32FromInt32(6))
	}
	/*
