...
//go:generate yy -kind Case -o parser.y -astImport "\"github.com/next-bin/go-sqlite3/pkg/xc";\"go/token\";\"fmt\"" -prettyString PrettyString parser.yy
...
//
//	https://github.com/next-bin/go-sqlite3/pkg/cc3
package cc // import "github.com/next-bin/go-sqlite3/pkg/cc/v2"
