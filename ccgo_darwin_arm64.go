...
const m___MAC_OS_X_VERSION_MAX_ALLOWED = "__MAC_26_1"
...
const m___VERSION__ = "Apple LLVM 17.0.0 (clang-1700.4.4.1)"
...
const m___apple_build_version__ = 17000404
const m___arm64 = 1
const m___arm64__ = 1
const m___clang__ = 1
...
const m___clang_version__ = "17.0.0 (clang-1700.4.4.1)"
...
func XinflateBack(tls *libc.TLS, strm Tz_streamp, __ccgo_fp_in Tin_func, in_desc uintptr, __ccgo_fp_out Tout_func, out_desc uintptr) (r int32) {
	...
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = bits, copy1, from, have, here, hold, last, left, len1, put, ret, state, v1, v11, v15, v18
