...
./configure \
	CC=ccgo \
	CFLAGS='-D__typeof=typeof --ccgo-define-values --ccgo-full-paths' \
...
ccgo -ffreestanding -D_XOPEN_SOURCE=700 -I./arch/x86_64 -I./arch/generic -Iobj/src/internal \
	-I./src/internal -Iobj/include -I./include -D__typeof=typeof --ccgo-import os,runtime/debug,sync/atomic,syscall \
